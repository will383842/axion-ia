...
- **Email** : `nodemailer` + `@react-email` → SMTP **Zoho Mail** authentifié (`smtppro.zoho.eu:465`, plan payant Mail Lite, depuis le 2026-05-13) — **Resend interdit**. PowerMTA / MailWizz : jamais déployés, mention retirée le 2026-08-16.
