...
src/server/actions/content-gen/brand-voice.ts:7: _ Trace dans ContentGenAuditLog (SOC2).
src/server/actions/content-gen/brand-voice.ts:10: _ Retourne les stats de dérive des 30 derniers jours depuis ContentGenAuditLog.
