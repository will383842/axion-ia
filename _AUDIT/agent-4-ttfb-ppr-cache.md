...
| #     | Critère                                                                                       |       Score | Observation                                                                                                                                                                                                                                                                                                                                                                                            |
| ----- | --------------------------------------------------------------------------------------------- | ----------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 13.1  | `Cache-Control` granulaire (HTML s-maxage=600, swr=86400 ; assets immutable max-age=31536000) |  **5 / 15** | Next pose automatiquement `public,max-age=31536000,immutable` sur `/_next/static/*` (vérifié doc self-hosting.md). Sur HTML SSG, Next pose `s-maxage=31536000` par défaut (cf. cdn-caching.md). Mais c'est trop long pour Axion-IA qui veut publier des révisions blog/casconcrets quotidien — cible doctrine = `s-maxage=600, swr=86400`. Aucun override custom. Caddy + CF doivent override en aval. |
