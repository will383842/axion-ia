...
*Note méthodologique : agents × max = 1000, cross-cutting = 100 bonus = 1100 total théorique. Score ramené à 1000 par proportionnalité : 897/1100 × 1000 = **815/1000** pour les items vérifiés. Score de confiance (après discordances et révisions) : **662/1000** (voir calcul ci-dessous).*
