...
const PATTERNS: ReadonlyArray<{ regex: RegExp; hookBuilder: (m: RegExpMatchArray) => string }> = [
  ...
  {
    regex: /\b(?:agglo|agglomération|métropole|Grand)\s+([A-ZÀ-Ý][a-zà-ÿ\-]+(?:\s[A-ZÀ-Ý][a-zà-ÿ\-]+)?)/,
  ...
  {
    regex: /\b(Côte\s+(?:Émeraude|Granit\s+Rose|Vermeille|d'Azur|d'Opale|de\s+Jade|Fleurie|de\s+Beauté|de\s+Nacre|Sauvage|de\s+Lumière))/i,
...
const ALL_DEPT_LABELS: Record<string, string> = {
  ...
  "30": "Gard", "31": "Hte-Garonne", "32": "Gers", "33": "Gironde", "34": "Hérault",
  "35": "Ille-et-Vilaine", "36": "Indre", "37": "Indre-et-Loire", "38": "Isère", "39": "Jura",
  "40": "Landes", "41": "Loir-et-Cher", "42": "Loire", "43": "Haute-Loire", "44": "Loire-Atlantique",
  "45": "Loiret", "46": "Lot", "47": "Lot-et-Garonne", "48": "Lozère", "49": "Maine-et-Loire",
  "50": "Manche", "51": "Marne", "52": "Hte-Marne", "53": "Mayenne", "54": "Meurthe-et-Moselle",
  "55": "Meuse", "56": "Morbihan", "57": "Moselle", "58": "Nièvre", "59": "Nord",
  "60": "Oise", "61": "Orne", "62": "Pas-de-Calais", "63": "Puy-de-Dôme", "64": "Pyrénées-Atlant.",
  "65": "Hautes-Pyrénées", "66": "Pyrénées-Or.", "67": "Bas-Rhin", "68": "Haut-Rhin", "69": "Rhône",
  "70": "Hte-Saône", "71": "Saône-et-Loire", "72": "Sarthe", "73": "Savoie", "74": "Hte-Savoie",
  "75": "Paris", "76": "Seine-Maritime", "77": "Seine-et-Marne", "78": "Yvelines", "79": "Deux-Sèvres",
  "80": "Somme", "81": "Tarn", "82": "Tarn-et-Garonne", "83": "Var", "84": "Vaucluse",
  "85": "Vendée", "86": "Vienne", "87": "Hte-Vienne", "88": "Vosges", "89": "Yonne",
  "90": "Territ. Belfort", "91": "Essonne", "92": "Hauts-de-Seine", "93": "Seine-Saint-Denis",
  "94": "Val-de-Marne", "95": "Val-d'Oise",
};

function extractDept(content: string): string | null {
  const m = content.match(/^\/\/.*\((\d{2,3}[ABab]?),/m) || content.match(/^(?:export const \w+ = )?\{[\s\S]*?\((\d{2,3}[ABab]?),/m);
  if (m) return m[1]!;
  return null;
}
