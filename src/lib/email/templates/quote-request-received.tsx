...
const COPY = {
  fr: {
    ...
    body: (company: string) =>
      `Nous avons bien reçu votre demande de devis pour ${company}. William vous recontactera sous 24 à 48 heures ouvrées pour un appel de cadrage personnalisé.`,
  ...
  en: {
    ...
    body: (company: string) =>
      `We received your quote request for ${company}. William will get back to you within 24 to 48 business hours for a personalized scoping call.`,
