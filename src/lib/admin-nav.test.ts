...
describe("buildAdminNav SSOT", () => {
  it("returns 107 items (snapshot count — +5 console chatbot ADR-CB-07, +20 Qualiopi T0-T16, +1 RGPD T19, +1 Formateurs R9, +1 Stagiaires R10, +1 Config Qualiopi, +2 carrières, +6 Documents interventions dont Importer un kit, +3 Coaching 1-to-1, content_gen refonte UX 2026-06-16 = 30 items en 6 pôles ; /orchestrator et /queue fusionnés → pas d'entrée nav, redirections seules)", () => {
