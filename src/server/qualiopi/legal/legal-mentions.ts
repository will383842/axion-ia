...
export const LEGAL_MENTIONS = {
  ...
  afestProtocole:
    "Action de formation en situation de travail (AFEST) organisée conformément aux articles L.6313-1-2 et D.6313-3-1 du Code du travail : analyse de l'activité, mises en situation de travail et phases réflexives, évaluation des acquis.",
