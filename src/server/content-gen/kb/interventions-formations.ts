...
export const KB_INTERVENTIONS_FORMATIONS: readonly KbFact[] = [
  ...
  {
    id: "form-071",
    text: "Chaque formation Axion-IA est précédée d'un questionnaire de positionnement envoyé aux participants (15 min) — permettant de personnaliser 40 % du contenu pédagogique en fonction du niveau et des cas d'usage réels de l'équipe.",
    source: "Axion-IA — Méthode pédagogique v2.0",
    sourceUrl: "https://axion-ia.com/interventions-formations",
    verifiedAt: "2026-05-22",
    verticales: ["interventions_formations"],
  ...
  {
    id: "form-077",
    text: "Le Net Promoter Score (NPS) des formations Axion-IA s'élève à +67 en 2025 (base : 340 participants) — signifiant que les promoteurs (score 9-10) sont 2,5 fois plus nombreux que les détracteurs (score 0-6).",
  ...
  {
    id: "form-078",
    text: "82 % des responsables formation des entreprises clientes Axion-IA déclarent avoir renouvelé ou élargi leur programme de formation IA à d'autres équipes dans les 12 mois suivant la première intervention — indicateur fort de satisfaction et de ROI perçu.",
    source: "Axion-IA — Taux de renouvellement clients formations 2025",
    sourceUrl: "https://axion-ia.com/interventions-formations",
    verifiedAt: "2026-05-22",
    verticales: ["interventions_formations"],
    confidence: 0.88,
  ...
  {
    id: "form-080",
    text: "Axion-IA forme également les équipes commerciales à la prospection IA augmentée : utilisation de LinkedIn Sales Navigator + IA, génération de messages personnalisés à grande échelle et qualification automatique de leads — résultats moyens : +35 % de taux d'ouverture des emails, +22 % de taux de réponse.",
