...
export const PAYLOAD_EXEMPLE: Readonly<Record<string, unknown>> = {
  ...
  dateValiditeLabel: "valable jusqu'au 30 septembre 2026",
  demandes: 7,
  ...
  fteRecovered: "0,4 ETP",
  headcount: "24 salariés",
  heure: "11:00",
  implType: "Audit IA",
  industry: "Industrie",
  ...
  ton: "professionnel",
  topTasks: "Devis, relances, comptes rendus",
  type: "Audit IA",
