...
export const PAYLOAD_EXEMPLE: Readonly<Record<string, unknown>> = {
  ...
  consignesAcces:
    "Se présenter à l'accueil du bâtiment B, badge visiteur à retirer. Parking visiteurs au sous-sol -1.",
  ...
  lienReponse: "https://exemple.invalid/lien-de-demonstration",
  lieu: "+33 7 00 00 00 00",
  lieuAdresseComplete: "12 rue de l'Exemple, 38000 Grenoble",
  ...
  roleLibelle: "formateur principal",
