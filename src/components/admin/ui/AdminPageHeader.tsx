      ...
      >
        ...
        {actions ? (
          ...
          <div
            ...
            // précédés de dix sections et d'une barre de sommaire. `tabIndex`
            // à -1 rend la zone atteignable par le lien SANS l'insérer dans
            // l'ordre de tabulation — sinon on gagnerait un arrêt parasite à
            // chaque parcours au clavier.
            id={ID_ACTIONS_PAGE}
            tabIndex={-1}
            className={cn(
