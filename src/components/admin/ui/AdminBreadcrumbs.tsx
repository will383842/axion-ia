...
//
// NB (refonte visuelle console 2026-08, chantier icônes) : le résolveur
// `buildBreadcrumbsFromPath()` (2026-06-16) et ses helpers, exportés mais
// jamais importés nulle part, ont été supprimés (code mort). Bénéfice
// collatéral : ce Server Component n'importe plus `admin-nav.ts` — seul le
// composant `<AdminBreadcrumbs items={…}>` alimenté par les pages subsiste.
