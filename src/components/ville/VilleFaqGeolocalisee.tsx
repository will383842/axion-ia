...
export function VilleFaqGeolocalisee({ villeContext, faqs, isFr }: VilleFaqGeolocaliseeProps) {
  ...
  const description = isFr
    ? `Questions des dirigeants de PME / ETI / grands groupes de ${villeContext.name}. Notre équipe d'experts répond sous 48 h ouvrées si la vôtre n'y est pas.`
    : `Questions from PME / ETI / grands groupes leaders in ${villeContext.name}. Our expert team replies within 48 business hours if yours isn't listed.`;
