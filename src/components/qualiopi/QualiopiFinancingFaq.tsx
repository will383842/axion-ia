  ...
  const items = isFr
    ? [
        ...
        },
        {
          ...
          answer:
            "Oui. La certification Qualiopi rend les formations Axion-IA finançables par les OPCO ; selon le dispositif et l'éligibilité, elles peuvent aussi être mobilisées via le CPF ou France Travail (AIF). Nous fournissons les pièces nécessaires : devis, convention, programme détaillé, certificat de réalisation.",
        },
        {
    ...
    : [
        ...
        {
          question: "Are the trainings fundable (OPCO, CPF)?",
          answer:
            "Yes. Qualiopi certification makes Axion-IA trainings fundable by OPCOs; depending on the scheme and eligibility, they may also be mobilised via CPF or France Travail. We provide the required documents: quote, agreement, detailed programme, completion certificate.",
        },
        {
