  ...
  return (
    ...
    >
      ...
      <p className="text-fg-muted mx-auto mt-10 max-w-2xl text-center text-sm leading-relaxed">
        {isFr
          ? "… et tout le reste. On cartographie précisément ce qui s'applique à votre projet, et on le chiffre en 48 h."
          : "… and everything else. We map exactly what fits your project, and cost it within 48 h."}
      </p>
    </Section>
  );
}
