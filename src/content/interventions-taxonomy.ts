...
export const FAMILIES: ReadonlyArray<FamilyDef> = [
  {
    ...
    taglineFr:
      "Formations IA opérationnelles pour vos équipes sur site — durée modulable de 4 heures à plusieurs jours, de 2 à 15 personnes.",
    taglineEn:
      "Operational AI trainings for your teams on site — flexible duration from 4 hours to several days, 2 to 15 people.",
...
export const INTERVENTION_FORMATS: ReadonlyArray<InterventionFormatEntry> = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    audienceFr: "Équipes qui découvrent l'IA · PME, ETI",
