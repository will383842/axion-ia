  ...
  },
  {
    ...
    fr: {
      ...
      sections: [
        ...
        {
          title: "Cookies tiers",
          body: "Aucun cookie publicitaire, aucun cookie réseau social, aucun cookie de tracking cross-site. Le seul tiers susceptible de déposer un cookie est Microsoft Clarity, après acceptation du bandeau. Sur la page /appel, Calendly n'en dépose que dans le mode de secours décrit ci-dessus, et seulement après votre clic sur « Afficher le calendrier » — en fonctionnement normal, votre navigateur ne contacte jamais Calendly.",
        },
        {
    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "No advertising cookies, no social network cookies, no cross-site tracking cookies. The only third party that may set a cookie is Microsoft Clarity, after the banner is accepted. On the /appel page, Calendly only sets cookies in the fallback mode described above, and only after you click “Show the calendar” — in normal operation your browser never contacts Calendly.",
        },
        {
