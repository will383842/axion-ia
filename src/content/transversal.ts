  ...
  },
  {
    ...
    fr: {
      ...
      keyPoints: [
        ...
        "Rien à installer : sur place, un smartphone ou un ordinateur et une connexion internet suffisent (un ordinateur pour IA pour l'IT et IA pour l'automatisation, recommandé pour les exercices sur tableur) ; à distance, un ordinateur avec caméra et micro, une connexion internet et Google Meet dans le navigateur",
    ...
    en: {
      ...
      answer:
        "No. Axion-IA sessions are designed for non-technical teams. Nothing to install, on site or remotely. On site, participants need a smartphone or a computer and an internet connection (a computer for AI for IT and AI for automation, and recommended for spreadsheet exercises). Remote sessions require a computer with a camera and a microphone and an internet connection: the videoconference runs on Google Meet, in the browser, with nothing to install, and is tested before the session. Access to the tools is prepared with you in advance if needed. Examples are adapted to your real business roles (HR, accounting, sales, operations, etc.).",
    },
  },
  {
    id: "roi-mesurer",
    ...
    fr: {
      ...
      nuances: [
        ...
        },
        {
          ...
          detail:
            "Les formations sont conçues pour des équipes non techniques : aucune installation n'est requise, ni sur place ni à distance (Google Meet s'ouvre dans le navigateur), et les exemples sont pris dans vos métiers réels.",
        },
        {
  ...
  },
  {
    ...
    fr: {
      ...
      keyPoints: [
        ...
        "À distance, un ordinateur avec caméra et micro est nécessaire",
    ...
    en: {
      ...
      answer:
        "Both. The preferred format is on site (France and internationally) as it allows working directly on your tools and data. Remote sessions are possible via videoconference for geographically dispersed teams or follow-up training. On site, participants need a smartphone or a computer and an internet connection (a computer for AI for IT and AI for automation, and recommended for spreadsheet exercises). For remote sessions, they need a computer with a camera and a microphone and an internet connection; the videoconference runs on Google Meet, in the browser, with nothing to install, and is tested before the session. During the session, the trainer answers in the videoconference chat; outside it, contact@axion-ia.com replies within 1 business day.",
    },
  },
  {
