...
export const FAQ_GLOBAL: ReadonlyArray<FaqEntry> = [
  ...
  },
  {
    ...
    fr: {
      ...
      keyPoints: [
        ...
        "Rien à installer : sur place, un smartphone ou un ordinateur et une connexion internet suffisent (un ordinateur pour IA pour l'IT et IA pour l'automatisation, recommandé pour les exercices sur tableur) ; à distance, un ordinateur avec caméra et micro",
    ...
    en: {
      ...
      answer:
        "No. Axion-IA sessions are designed for non-technical teams. Nothing to install: on site, participants need a smartphone or a computer and an internet connection (a computer for AI for IT and AI for automation, and recommended for spreadsheet exercises); remote sessions require a computer with a camera and a microphone. Access to the tools is prepared with you in advance if needed. Examples are adapted to your real business roles (HR, accounting, sales, operations, etc.).",
    },
  },
  {
    id: "roi-mesurer",
  ...
  },
  {
    ...
    en: {
      ...
      answer:
        "Both. The preferred format is on site (France and internationally) as it allows working directly on your tools and data. Remote sessions are possible via videoconference for geographically dispersed teams or follow-up training. On site, participants need a smartphone or a computer and an internet connection (a computer for AI for IT and AI for automation, and recommended for spreadsheet exercises). For remote sessions, they need a computer with a camera and a microphone, and an internet connection.",
    },
  },
  {
