...
export const KW_GEO_I: KeywordSeed[] = [
  ...
  // #32
  {
    ...
    injection: {
      ...
      metaDescription:
        "Axion-IA intervient en 4 formats : audit (1 jour à 6 semaines), formation collective (0,5 à 2 jours), implémentation (4 à 16 semaines), coaching 1-to-1",
      h2Variants: [
  ...
  // #33
  {
    ...
    variables: { resultat: "à partir de 1 190 €", delai: "devis sous 48h" },
