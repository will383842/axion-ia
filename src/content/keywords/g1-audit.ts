...
export const KW_AUDIT_G1: KeywordSeed[] = [
...

  {
    ...
    canonicalParent: "/fr/audit/",
    source: "manuel",
    note: "Mot-clé secondaire de la page /fr/audit/tpe — ne pas créer une URL séparée",
  },
...

  {
    ...
    canonicalParent: "/fr/audit/tpe",
    source: "manuel",
    note: "Article blog généré par Content Engine — lien interne vers /fr/audit/tpe",
  },
...

  {
    ...
    canonicalParent: "/fr/audit/tpe",
    source: "manuel",
    note: "Top du funnel informationnel — lien CTA vers /fr/audit/tpe",
  },
...

  {
    ...
    canonicalParent: "/fr/audit/tpe",
    source: "manuel",
    note: "Lien interne vers /fr/audit/tpe ET /fr/interventions-formations/tpe",
  },
