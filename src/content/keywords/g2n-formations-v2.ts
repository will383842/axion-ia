...
export const KEYWORDS_FORMATIONS_V2: KeywordSeed[] = [
  {
    ...
    injection: {
      ...
      metaDescription: "Formation IA d'initiation, 4 h, sans prérequis : démystifier l'IA, maîtriser un prompt efficace avec la méthode AXION, créer son premier assistant.",
    },
  },
  {
    ...
    injection: {
      ...
      metaDescription: "Formation IA d'initiation sur une journée, sans prérequis : démystifier l'IA, rédiger un prompt efficace avec la méthode AXION, créer son assistant IA.",
    },
  },
  {
    ...
    injection: {
      ...
      metaDescription: "Formation IA de 4 h pour structurer sa pratique du prompt avec la méthode AXION, créer un master prompt et déployer ses assistants IA. Présentiel ou distanciel.",
    },
  },
  {
    ...
    injection: {
      ...
      metaDescription: "Formation IA d'une journée pour passer d'un usage basique à avancé : prompts experts avec la méthode AXION, assistants IA avec base de connaissances, agent.",
    },
  },
  {
    ...
    injection: {
      ...
      metaDescription: "Formation Claude d'une journée pour utilisateurs réguliers : prompt avancé, Artifacts, paramétrage, création de Skills, connecteurs et production de.",
    },
  },
  {
    ...
    injection: {
      ...
      metaDescription: "Formation Claude avancée, 2 jours : Projects, Skills, connecteurs et Cowork. Déployez plusieurs assistants, un prototype et des tâches automatisées.",
    },
  },
  {
    ...
    injection: {
      ...
      metaDescription: "Formation Claude Code, 3 jours, pour profils non techniques : concevoir, construire et publier un vrai projet de bout en bout sans écrire de code. Présentiel.",
    },
  },
  {
    ...
    injection: {
      ...
      metaDescription: "Formation IA Act d'1 jour : comprendre le calendrier et les obligations, cartographier vos usages par niveau de risque, sécuriser vos données et bâtir votre.",
    },
  },
  {
    ...
    injection: {
      ...
      metaDescription: "Formation référent IA (1 jour) : cartographier les usages, construire charte et procédures, piloter la conformité et animer l'IA en interne. Présentiel ou.",
    },
  },
  {
    ...
    injection: {
      ...
      metaDescription: "Formation IA RH, 1 jour : maîtriser le prompt RH avec la méthode AXION, respecter le cadre légal, créer un assistant RH et outiller sourcing, annonces et.",
    },
  },
  {
    ...
    injection: {
      ...
      metaDescription: "Formation IA d'1 jour pour assistants et office managers : reprendre la main sur sa boîte mail, produire ses comptes-rendus et documents plus vite avec la.",
    },
  },
  {
    ...
    injection: {
      ...
      metaDescription: "Formation IA marketing, 1 jour : prompts avec la méthode AXION, assistant calibré sur votre marque, contenus sans « style IA », SEO et visuels. Présentiel ou.",
    },
  },
  {
    ...
    injection: {
      ...
      metaDescription: "Formation IA pour commerciaux, 1 jour : prospecter, préparer ses rendez-vous et relancer avec la méthode AXION, créer ses assistants IA commerciaux.",
    },
  },
  {
    ...
    injection: {
      ...
      metaDescription: "Formation IA finance, 1 jour : produire commentaires de gestion, analyses d'écarts et synthèses en une fraction du temps avec la méthode AXION. Présentiel ou.",
    },
  },
  {
