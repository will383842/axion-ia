...
export const FAQ_IMAGES: Record<string, FaqImage> = {
  ...
  general: {
    ...
    altFr:
      "Équipe Axion-IA en réunion — cabinet IA opérationnel français qui accompagne PME, ETI et grands groupes dans leur transformation par l'intelligence artificielle.",
    altEn:
