...
// Villefranche-sur-Mer (06, Alpes-Maritimes) — Rade mythique, Cocteau, croisières Riviera.
...
export const VILLEFRANCHE_SUR_MER_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Villefranche-sur-Mer (5 008 hab) est une commune littorale de la Riviera, limitrophe de Nice. Économie centrée sur tourisme haut de gamme (hôtellerie de luxe, yachting, croisières internationales), patrimoine culturel (chapelle Cocteau), restauration gastronomique, commerces, art et services. Proximité immédiate Nice (15 min), Monaco (20 min), Cannes (45 min). Forte saisonnalité internationale.",
  distancesFr:
    "Nice centre à 15 min. Monaco à 20 min. Menton à 35 min. Cannes à 45 min. Gare SNCF Villefranche-sur-Mer (TER Côte d'Azur). Aéroport Nice-Côte d'Azur à 20 min. Port de Villefranche (escale croisières Riviera).",
  distancesEn:
    "Nice centre à 15 min. Monaco à 20 min. Menton à 35 min. Cannes à 45 min. Gare SNCF Villefranche-sur-Mer (TER Côte d'Azur). Aéroport Nice-Côte d'Azur à 20 min. Port de Villefranche (escale croisières Riviera).",
  topSectorsNaf: [
    "Tourisme & hôtellerie haut de gamme",
    "Restauration gastronomique & commerce",
    "Yachting & croisières",
    "Art, patrimoine & culture",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Villefranche-sur-Mer ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons hôtels de luxe, restaurants gastronomiques, galeries d'art, yacht charter, conciergeries et acteurs des croisières internationales de la Riviera : yield management, agents IA multilingues, CRM clientèle internationale et automatisation accueil premium.",
    },
    {
      q: "Quels services pour les restaurateurs et commerçants de Villefranche ?",
      a: "Audit sur place {{price:audit-flash|flat}}, intervention 1 journée formation, coaching 1-to-1. Cas typiques : agents IA réservation multilingues, gestion stocks intelligente, automatisation comptabilité, fidélisation clientèle internationale augmentée.",
    },
    {
