...
// Loireauxence (44, Loire-Atlantique) — Commune nouvelle, bords Loire.
...
export const LOIREAUXENCE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Loireauxence (44), commune nouvelle de Loire-Atlantique en bords de Loire entre Nantes et Ancenis, regroupe TPE artisanales, commerces de proximité, PME tertiaires et exploitations agricoles. Axion-IA collabore avec toutes les structures locales du bassin nantais est.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Loireauxence (44). Nous accompagnons les TPE artisans, commerçants, PME tertiaires, professions libérales et exploitants agricoles de cette commune nouvelle en bords de Loire. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Loireauxence (44). Nous accompagnons les TPE artisans, commerçants, PME tertiaires, professions libérales et exploitants agricoles de cette commune nouvelle en bords de Loire. Audit sur place sur mesure.",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Loireauxence : formats courts adaptés atelier, exploitation, bureau ou commerce. Vos équipes repartent autonomes sur outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Loireauxence : agents conversationnels, automatisation devis/facturation, gestion documentaire, CRM augmentés. Adapté aux PME et cabinets en bords de Loire.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Loireauxence ?",
