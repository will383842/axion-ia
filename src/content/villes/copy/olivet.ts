...
// Olivet (45, Loiret) — sud d'Orléans, Cosmetic Valley (parfumerie-cosmétique), tradition horticole et pépinières, services et commerce de la métropole orléanaise.
...
export const OLIVET_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Auditer à Olivet les processus d'une PME de la cosmétique, d'une pépinière ou d'un prestataire de services — cartographie des tâches automatisables et feuille de route IA priorisée par retour réel.",
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui. Axion-IA publie une grille tarifaire claire, sans devis opaque ni abonnement caché. Vous connaissez le coût d'un audit ou d'une intervention à Olivet avant de vous engager.",
    },
    {
      q: "Mes données sont-elles protégées et conformes au RGPD ?",
      a: "Oui. Chaque solution IA déployée à Olivet est conçue dans le respect du RGPD et sans dépendance forcée à un éditeur, pour que vous gardiez la maîtrise et la portabilité de vos données.",
    },
  ],
};
