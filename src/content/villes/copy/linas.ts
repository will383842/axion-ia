...
// Linas (91, Essonne) — autodrome Montlhéry, zone activités, Hurepoix.
...
export const LINAS_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Linas et Montlhéry ?",
      a: "Oui, Axion-IA intervient à Linas et tout le Hurepoix (Montlhéry à 3 min, Longjumeau à 8 min, Évry à 20 min, Paris à 35 min). Aéroport Orly à 20 min.",
    },
    {
    ...
    },
    {
      ...
      a: "Audit sur place {{price:audit-flash|flat}}, devis et facturation automatisés par IA, gestion stocks, relances clients, coaching 1-to-1 dirigeant.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous couvrons Linas, Montlhéry, La Ville-du-Bois, Ballainvilliers, Longjumeau et tout le Hurepoix essonnien.",
    },
  ],
};
