...
// Lucé (28, Eure-et-Loir) — Agglo Chartres, zones activités/commerciales.
...
export const LUCE_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Lucé : formats adaptés au bureau tertiaire, enseigne commerciale, entrepôt logistique. Vos équipes repartent autonomes.",
    },
    implementation: {
      fr: "Implémentation IA à Lucé : automatisation workflow tertiaire, CRM augmenté, agents conversationnels retail, optimisation tournées logistique, classification documents PME chartraine.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Lucé et agglomération Chartres ?",
    ...
    {
      q: "Travaillez-vous avec les enseignes commerciales ?",
    ...
    },
    {
      ...
      a: "Audit Flash 490 € HT, intervention 1 journée formation, coaching 1-to-1. Optimisation tournées, classification colis, prévision demande.",
    },
    {
