...
// Kingersheim (68, Haut-Rhin) — agglomération mulhousienne nord, zones commerciales, industrie.
...
export const KINGERSHEIM_COPY: VilleCopy = {
  ...
  pitchEn:
    "Kingersheim (68), ville de 13 354 habitants au nord de l'agglomération mulhousienne en Haut-Rhin, est un pôle économique structurant avec ses vastes zones commerciales et son tissu industriel. Tissu TPE/PME commerce, distribution, industrie, services, artisanat. Axion-IA y intervient pour tous types d'activités.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Kingersheim (68). Nous accompagnons tous types d'activités : TPE/PME commerce, distribution et industrie, artisans, professions de services et acteurs de l'agglomération mulhousienne nord.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Kingersheim (68). Nous accompagnons tous types d'activités : TPE/PME commerce, distribution et industrie, artisans, professions de services et acteurs de l'agglomération mulhousienne nord.",
  ecosystemFr:
  ...
  distancesEn:
    "Mulhouse centre à 10 min. Autoroute A36 accès direct. Colmar à 35 min. Bâle (Suisse) à 35 min. Aéroport Bâle-Mulhouse-Fribourg à 20 min. Gare Mulhouse-Ville à 15 min. Strasbourg à 1h15.",
  seoHook: "commerce, distribution & industrie",
  topSectorsNaf: [
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Kingersheim ?",
    ...
    },
    {
      ...
      a: "Oui, industriels, sous-traitants et artisans kingersheimois : traçabilité production, workflow atelier, gestion commerciale, présence en ligne, automatisation administrative. Audit Flash 490 € HT.",
    },
    {
