...
// Gentilly (94, Val-de-Marne) — sud Paris, Cité internationale universitaire, campus Gentilly.
...
export const GENTILLY_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Gentilly : diagnostic adapté aux TPE tertiaires, PME de conseil, commerçants et professions libérales du sud parisien. ROI chiffré, Audit Flash 490 € HT.",
      en: "Audit IA à Gentilly : diagnostic adapté aux TPE tertiaires, PME de conseil, commerçants et professions libérales du sud parisien. ROI chiffré, Audit Flash 490 € HT.",
    },
    interventions: {
      ...
      en: "Interventions IA sur site à Gentilly : formats adaptés au cabinet, agence ou commerce. Vos équipes repartent autonomes sur les outils IA configurés pour leur métier.",
    },
    implementation: {
      fr: "Implémentation IA à Gentilly : automatisation processus tertiaires, agents conversationnels PME conseil, digitalisation cabinets libéraux, outils IA sur mesure startups. Tissu sud Paris.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Gentilly dans le Val-de-Marne ?",
      a: "Oui, Axion-IA intervient à Gentilly et dans tout le sud parisien (Arcueil, Le Kremlin-Bicêtre, Montrouge, Cachan, Villejuif). Nos consultants se déplacent sur site ou en visio, RER B direct.",
    },
    {
      q: "Quel est le prix d'un audit IA à Gentilly ?",
      a: "L'Audit Flash IA à Gentilly démarre à 490 € HT. Ce diagnostic couvre l'analyse de vos processus métier, l'identification des cas d'usage IA prioritaires et un plan d'action chiffré avec ROI estimé.",
    },
    {
