...
export const J_UF_COPY: VilleCopy = {
  ...
  pitchEn:
    "Jœuf (54), commune du Pays Haut en Meurthe-et-Moselle dans la vallée de l'Orne, est une ancienne ville sidérurgique reconvertie au cœur du bassin transfrontalier lorrain-luxembourgeois. Tissu de TPE/PME industrie, artisanat, commerce, services et frontaliers. Axion-IA y intervient pour tous types d'activités.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Jœuf (54). Nous accompagnons TPE et PME : industriels, artisans, commerçants, prestataires de services et frontaliers du Pays Haut et de la vallée de l'Orne en Lorraine. Audit Flash dès 490 € HT.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Jœuf (54). Nous accompagnons TPE et PME : industriels, artisans, commerçants, prestataires de services et frontaliers du Pays Haut et de la vallée de l'Orne en Lorraine. Audit Flash dès 490 € HT.",
  ecosystemFr:
  ...
  faqGeolocalisee: [
    ...
    {
      q: "Quel est le tarif d'un audit IA à Jœuf ?",
