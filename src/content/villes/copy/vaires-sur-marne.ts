...
export const VAIRES_SUR_MARNE_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Vaires-sur-Marne : sessions dans vos locaux ou en visio. Dirigeants TPE/PME, gérants structures sport-loisirs, professions libérales, entrepreneurs des bords de Marne.",
      en: "Coaching 1-to-1 à Vaires-sur-Marne : sessions dans vos locaux ou en visio. Dirigeants TPE/PME, gérants structures sport-loisirs, professions libérales, entrepreneurs des bords de Marne.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    {
      q: "Proposez-vous des formations IA pour les TPE à Vaires-sur-Marne ?",
      a: "Oui, nos interventions IA sur site à Vaires-sur-Marne sont adaptées aux TPE artisans et commerces. Formats demi-journée ou journée complète, vos équipes repartent autonomes sur les outils IA configurés métier.",
    },
    {
