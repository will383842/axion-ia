...
// Soisy-sur-Seine (91, Essonne) — 24 km SE Paris, forêt de Sénart, bords de Seine.
...
export const SOISY_SUR_SEINE_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Soisy-sur-Seine : formats adaptés au cabinet, commerce ou bureau. Vos équipes repartent autonomes sur outils IA configurés métier réel.",
    },
    implementation: {
      fr: "Implémentation IA à Soisy-sur-Seine : agents conversationnels cabinet médical, automatisation facturation, classification documents, gestion planning. Tous secteurs sud francilien.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Soisy-sur-Seine ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les professions libérales (médecins, avocats, architectes, consultants) de Soisy-sur-Seine sur des cas IA pratiques : agents conversationnels accueil patient, automatisation facturation, classification dossiers, gestion agenda.",
    },
    {
      q: "Quels services pour les PME du bassin Évry-Corbeil ?",
