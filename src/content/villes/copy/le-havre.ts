...
export const LE_HAVRE_COPY: VilleCopy = {
  ...
  services: {
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente au Havre des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 24-48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel au Havre, itérations à distance.",
        whyHere: [
