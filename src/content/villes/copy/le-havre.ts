...
export const LE_HAVRE_COPY: VilleCopy = {
  ...
  services: {
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente au Havre des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel au Havre, itérations à distance.",
        whyHere: [
          "Projets web & SaaS havrais : logistique & portuaire (HAROPA Port, 1er port français à conteneurs), industrie (pétrochimie, aéronautique, automobile), PME et ETI de la ZIP.",
          ...
          "Plateformes logistiques & portuaires : tracking, automatisations métier et agents branchés sur vos outils (TMS, ERP, douane) — un terrain naturel avec HAROPA. Hébergement UE, RGPD strict.",
        ],
        methodology: [
          {
            step: "Cadrage au Havre",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une application avec UX/UI et IA intégrée, pour PME et scale-ups havraises.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Plateforme métier, logistique ou portail client sur mesure, IA intégrée, branchée sur votre SI (TMS, ERP, datalake).",
          },
          {
            sizeLabel: "Grande entreprise",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète au Havre — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Vous gérez les plateformes logistiques et portuaires ?",
            a: "Oui : portails de suivi, automatisations métier, agents branchés sur vos outils (TMS, ERP, douane), recherche sémantique documentaire. Un terrain naturel au Havre avec HAROPA Port. Hébergement UE, RGPD strict.",
          },
          {
        ...
        guarantees:
          "Devis ferme en forfait fixe (à partir de 48 h selon la complexité) : pas de dérive horaire cachée. Mise en ligne sans downtime quand on augmente l'existant. Web Vitals et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD : propriété totale, aucun abonnement imposé, transférable à tout prestataire de la région havraise ou repris en interne.",
      },
      en: {
        hero: "In Le Havre, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 48 h depending on project complexity, EU hosting, code and data yours. On-site Le Havre kick-off, remote iterations.",
        whyHere: [
          "Le Havre web & SaaS projects: logistics & port (HAROPA Port, France's leading container port), industry (petrochemicals, aeronautics, automotive), ZIP SMEs and mid-caps.",
          ...
          "Logistics & port platforms: tracking, business automations and agents wired to your tools (TMS, ERP, customs) — a natural fit with HAROPA. EU hosting, strict GDPR.",
        ],
        methodology: [
          {
            step: "Scoping in Le Havre",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Design or rebuild of a site or app with UX/UI and built-in AI, for Le Havre SMEs and scale-ups.",
          },
          {
            sizeLabel: "Mid-cap",
            price: "AI-native SaaS platform",
            detail:
              "Bespoke business, logistics or customer portal platform, AI built in, wired into your IS (TMS, ERP, datalake).",
          },
          {
            sizeLabel: "Large enterprise",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Le Havre — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Do you handle logistics and port platforms?",
            a: "Yes: tracking portals, business automations, agents wired to your tools (TMS, ERP, customs), semantic document search. A natural fit in Le Havre with HAROPA Port. EU hosting, strict GDPR.",
          },
          {
