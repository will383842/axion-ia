  ...
  faqGeolocalisee: [
    {
      ...
      a: "Audit Flash 4h dès {{price:audit-flash|flat}}, Intervention Essentielle dès {{price:intervention-4h|flat}}, implémentation et sessions un-à-un dès {{price:intervention-dirigeants|flat}}. Frais de déplacement à Forbach (Moselle) inclus dans le devis. Tarifs publics consultables sur axion-ia.com.",
    },
    {
