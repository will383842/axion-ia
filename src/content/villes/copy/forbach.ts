...
export const FORBACH_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit sur place 4h à Forbach pour PME et ETI de Moselle — diagnostic des processus (gestion commerciale, logistique transfrontalière FR/DE, suivi production industrielle). À partir de {{price:audit-flash|flat}}.",
      en: "Audit sur place 4h à Forbach pour PME et ETI de Moselle — diagnostic des processus (gestion commerciale, logistique transfrontalière FR/DE, suivi production industrielle). À partir de {{price:audit-flash|flat}}.",
    },
    interventions: {
    ...
    implementation: {
      ...
      en: "Implémentation IA code-first à Forbach : intégrations API métier, agents internes multilingues FR/DE, automatisations pour commerces, industries et services. À partir de {{price:impl-poc|entry}}.",
    },
    unAUn: {
      fr: "Sessions un-à-un avec dirigeants forbachois pour bâtir la feuille de route IA : priorisation, ROI, conformité RGPD côté FR et données transfrontalières. À partir de {{price:intervention-dirigeants|flat}}.",
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Les PME et ETI du commerce de détail (434 établissements locaux), des services aux entreprises, de l'industrie, de la logistique transfrontalière, de la construction et de la restauration du bassin houiller mosellan.",
    },
  ],
};
