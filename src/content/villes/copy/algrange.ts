...
// Algrange (57, Moselle) — Vallée de la Fensch, frontalier Luxembourg, ancienne ville minière.
...
export const ALGRANGE_COPY: VilleCopy = {
  ...
  distancesEn:
    "Hayange à 5 min. Thionville à 15 min. Luxembourg-Ville à 30 min. Metz à 35 min. Gare SNCF Hayange à proximité (ligne Metz–Luxembourg). Autoroute A30 accès direct. Aéroport Luxembourg à 40 min. Aéroport Metz-Nancy-Lorraine à 45 min.",
  seoHook: "vallée de la Fensch & frontaliers",
  topSectorsNaf: [
    "Industrie reconvertie et sous-traitance métallurgique",
    "BTP et second œuvre",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Algrange ?",
    ...
    },
    {
      ...
      a: "Oui, nombreux frontaliers et entrepreneurs algrangeois travaillant avec le Luxembourg : automatisation administrative transfrontalière, gestion multilingue FR/DE/EN, conformité, outils collaboratifs. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
