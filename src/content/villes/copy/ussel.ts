...
// Ussel (19, Corrèze) — Sous-préfecture, plateau de Millevaches.
...
export const USSEL_COPY: VilleCopy = {
  ...
  pitchEn:
    "Ussel (19), sous-préfecture de la Corrèze aux portes du plateau de Millevaches. Tissu TPE/PME commerce, artisanat, bois-forêt, services de santé, BTP et tourisme nature en haute Corrèze. Axion-IA collabore avec toutes les structures locales.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Ussel (19). Nous accompagnons TPE/PME du commerce, de l'artisanat, de la filière bois, des services de santé et du tourisme nature en haute Corrèze. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Ussel (19). Nous accompagnons TPE/PME du commerce, de l'artisanat, de la filière bois, des services de santé et du tourisme nature en haute Corrèze. Audit sur place sur mesure.",
  ecosystemFr:
  ...
  ecosystemEn:
    "Ussel, sous-préfecture de la Corrèze, est la porte d'entrée du plateau de Millevaches (PNR). Économie locale : commerce et artisanat de proximité, filière bois-forêt (scieries, exploitation forestière), services de santé (hôpital, maisons médicales), BTP montagne et tourisme nature (randonnée, lac de Séchemailles).",
  distancesFr:
    "Tulle à 1h RN89. Brive-la-Gaillarde à 1h20. Clermont-Ferrand à 1h30. Paris-Austerlitz à 4h30 (Intercités via Brive). Gare SNCF Ussel ligne Brive–Clermont.",
  distancesEn:
    "Tulle à 1h RN89. Brive-la-Gaillarde à 1h20. Clermont-Ferrand à 1h30. Paris-Austerlitz à 4h30 (Intercités via Brive). Gare SNCF Ussel ligne Brive–Clermont.",
  seoHook: "bois, santé & Millevaches",
  topSectorsNaf: [
    "Commerce de détail et artisanat",
    "Filière bois-forêt & scieries",
    "Services de santé & médico-social",
    "BTP et second œuvre",
    "Tourisme nature & hébergement",
  ],
  servicesContext: {
    audit: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Ussel : formations pratiques pour commerçants, artisans bois, professionnels de santé et gérants du tourisme nature.",
    },
    implementation: {
      fr: "Implémentation IA à Ussel : gestion stock bois-forêt, optimisation plannings santé, automatisation administrative, outils IA accueil tourisme nature Millevaches.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Ussel et en haute Corrèze ?",
    ...
    },
    {
      ...
      a: "Oui, cas IA filière bois : optimisation stock scieries, traçabilité exploitation forestière, automatisation devis et facturation, planification coupes et transport grumes.",
    },
    {
      q: "Quel délai pour démarrer une mission IA à Ussel ?",
      a: "Intervention sous 5 à 7 jours ouvrés. Tulle à 1h, Brive à 1h20, Clermont à 1h30. Déplacements sur site ou sessions en visio.",
    },
    {
