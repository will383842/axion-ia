...
// Quetigny (21, Côte-d'Or) — est Dijon, centre commercial, zones d'activités.
...
export const QUETIGNY_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Quetigny et dans l'est dijonnais ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons commerçants et restaurateurs de Quetigny sur des cas IA concrets : agents conversationnels réservation, automatisation stocks et commandes, gestion planning équipes, fidélisation client IA, optimisation marketing local.",
    },
    {
    ...
    },
    {
      ...
      a: "Après un premier échange gratuit, nous planifions l'intervention sous 5 jours. Nos consultants interviennent sur site à Quetigny ou en visio. Chaque mission inclut un livrable actionnable, un plan IA chiffré et un suivi post-mission de 30 jours.",
    },
  ],
};
