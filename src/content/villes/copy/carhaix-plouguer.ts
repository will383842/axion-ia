...
// Carhaix-Plouguer (29, Finistère) — Centre Finistère, festival Vieilles Charrues, sous-préfecture.
...
export const CARHAIX_PLOUGUER_COPY: VilleCopy = {
  ...
  pitchEn:
    "Carhaix-Plouguer (29), sous-préfecture du centre Finistère, est le bourg-centre du Poher et accueille chaque été le festival des Vieilles Charrues (plus grand festival de musique de France). Tissu TPE artisans, PME agroalimentaires, commerces, services publics et professions libérales. Axion-IA y travaille avec les organisations du territoire.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Carhaix-Plouguer (29). Nous accompagnons tous types d'activités: TPE artisans, PME agroalimentaires centre Finistère, commerçants, acteurs de l'événementiel (Vieilles Charrues), professions libérales et services. Audit sur place à",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Carhaix-Plouguer (29). Nous accompagnons tous types d'activités: TPE artisans, PME agroalimentaires centre Finistère, commerçants, acteurs de l'événementiel (Vieilles Charrues), professions libérales et services. Audit sur place à",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Carhaix-Plouguer : formats adaptés à la laiterie, l'atelier artisan, le commerce ou l'organisation événementielle. Vos équipes repartent autonomes sur outils IA configurés métier.",
    },
    implementation: {
      fr: "Implémentation IA à Carhaix-Plouguer : automatisation traçabilité laitière, gestion logistique festival, agents conversationnels, prédiction stocks. Adapté agroalimentaire + événementiel centre Finistère.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Carhaix-Plouguer et centre Finistère ?",
      a: "Oui, Axion-IA intervient à Carhaix-Plouguer et tout le centre Finistère (Huelgoat, Châteauneuf-du-Faou, Pleyben, Rostrenen). Nos consultants viennent de Brest (1h N164) ou Quimper (55 min).",
    },
    {
      q: "Accompagnez-vous les PME agroalimentaires du Poher ?",
      a: "Oui, nous accompagnons les PME agroalimentaires du centre Finistère (laiteries, filière porcine, abattoirs) sur leurs cas IA : automatisation traçabilité, contrôle qualité par vision, optimisation production, gestion réglementaire.",
    },
    {
      q: "Travaillez-vous avec les acteurs de l'événementiel (Vieilles Charrues) ?",
