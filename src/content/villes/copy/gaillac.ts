...
// Gaillac (81, Tarn) — AOC Gaillac (vignoble plus ancien de France), bords Tarn.
...
export const GAILLAC_COPY: VilleCopy = {
  ...
  distancesEn:
    "Albi à 25 min. Toulouse centre à 50 min (A68). Gare SNCF Gaillac (TER Toulouse-Albi). Aéroport Toulouse-Blagnac à 55 min. Castres à 50 min. Montauban à 45 min.",
  topSectorsNaf: [
    "Viticulture & oenologie (AOC Gaillac)",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Gaillac : formats adaptés au domaine viticole, cave coopérative, commerce de centre-ville ou PME agroalimentaire. Vos équipes repartent autonomes sur les outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Gaillac : traçabilité parcellaire augmentée, gestion stocks cave, CRM oenotourisme, automatisation facturation négoce, agents conversationnels clients pour le vignoble gaillacois.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Gaillac et dans le vignoble tarnais ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons caves coopératives et domaines viticoles sur leurs projets IA : traçabilité parcellaire, optimisation stocks, gestion adhérents, CRM oenotourisme, automatisation administratif et facturation.",
    },
    {
      q: "Quels services IA pour les commerçants de Gaillac centre ?",
      a: "Audit sur place {{price:audit-flash|flat}}, intervention 1 journée formation, coaching 1-to-1. Cas typiques : gestion stocks IA, agents IA prise de RDV, automatisation comptabilité, fidélisation client augmentée pour les commerces gaillacois.",
    },
    {
      q: "L'IA peut-elle aider la filière agroalimentaire gaillacoise ?",
      a: "Oui, l'IA optimise traçabilité, gestion qualité, prévision récoltes, facturation négoce et logistique. Axion-IA adapte chaque solution au contexte viticole et agroalimentaire spécifique du Gaillacois.",
    },
  ],
};
