...
// Revin (08, Ardennes) — Méandre Meuse, industrie métallurgique.
...
export const REVIN_COPY: VilleCopy = {
  ...
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Revin (08). Nous accompagnons tous types d'activités : TPE artisans, PME industrielles métallurgiques, commerçants, acteurs touristiques nature et professions libérales de la vallée de la Meuse. Audit sur place sur mesure, démarrage sous 5 jours.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Revin (08). Nous accompagnons tous types d'activités : TPE artisans, PME industrielles métallurgiques, commerçants, acteurs touristiques nature et professions libérales de la vallée de la Meuse. Audit sur place sur mesure, démarrage sous 5 jours.",
  ecosystemFr:
  ...
  ecosystemEn:
    "Revin (environ 5 700 habitants) est une commune ardennaise située dans un méandre remarquable de la Meuse, au cœur du Parc naturel régional des Ardennes. Héritière d'un puissant passé industriel métallurgique (visseries, robinetterie, électroménager), la ville se reconvertit progressivement vers le tourisme nature (randonnée, pêche, kayak), l'artisanat et les services. L'économie locale s'appuie sur l'industrie résiduelle, le commerce de proximité, le tourisme vert et les services publics.",
  distancesFr:
    "Charleville-Mézières à 35 km via N51. Givet à 25 km via N51. Reims à 1h25 via A34. Dinant (Belgique) à 45 km. Gare de Revin (ligne Givet-Charleville). Aéroport Reims-Champagne à 1h30.",
  distancesEn:
    "Charleville-Mézières à 35 km via N51. Givet à 25 km via N51. Reims à 1h25 via A34. Dinant (Belgique) à 45 km. Gare de Revin (ligne Givet-Charleville). Aéroport Reims-Champagne à 1h30.",
  topSectorsNaf: [
    "Industrie métallurgique & visserie",
    "Tourisme nature & sports outdoor",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Revin : formations pratiques pour équipes industrielles métallurgie, commerce, tourisme nature et services de la vallée de la Meuse. Vos collaborateurs repartent autonomes sur les outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Revin : maintenance prédictive lignes métallurgie, contrôle qualité visuel pièces, agents conversationnels accueil touristique nature, gestion documentaire PME industrielles. Adapté au tissu industriel et naturel ardennais.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Revin et dans la vallée de la Meuse ?",
      a: "Oui, Axion-IA intervient à Revin et dans toute la vallée de la Meuse (Fumay, Monthermé, Bogny-sur-Meuse, Haybes). Couverture Charleville-Mézières à 35 km et Givet à 25 km par la N51.",
    },
    {
      q: "Accompagnez-vous les PME métallurgiques et industrielles de Revin ?",
      a: "Oui, nous accompagnons les PME métallurgiques, visseries et industriels de Revin avec des solutions IA adaptées : maintenance prédictive lignes, contrôle qualité visuel, optimisation flux production, gestion documentaire. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
    ...
    },
    {
      ...
      a: "Pour les acteurs du tourisme nature à Revin (hébergeurs, loueurs activités outdoor, guides), nous proposons : agents IA réservation et accueil multilingue, automatisation planning saisonnier, chatbot itinéraires randonnée. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
      q: "Comment se déroule une mission Axion-IA à Revin ?",
      a: "Après un premier échange gratuit, nous planifions l'intervention sous 5 jours. Nos consultants se déplacent depuis Charleville-Mézières (35 km) ou via Reims (1h25). Intervention sur site ou en visio. Livrable actionnable et suivi post-mission de 30 jours inclus.",
    },
  ],
};
