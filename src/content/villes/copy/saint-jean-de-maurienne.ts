...
// Saint-Jean-de-Maurienne (73, Savoie) — sous-préfecture, vallée Maurienne (plus grande vallée alpine intra), industrie aluminium historique, accès cols alpins.
...
export const SAINT_JEAN_DE_MAURIENNE_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Jean-de-Maurienne et en Maurienne ?",
      a: "Oui, Axion-IA intervient à Saint-Jean-de-Maurienne et dans toute la vallée de la Maurienne (Saint-Michel-de-Maurienne, Modane, La Chambre, Saint-Étienne-de-Cuines, Valloire). Couverture étendue jusqu'à la frontière italienne.",
    },
    {
      q: "Travaillez-vous avec les industriels aluminium et métallurgie ?",
      a: "Oui, nous accompagnons les industriels aluminium et métallurgie de la vallée de la Maurienne sur leurs cas IA : prédiction maintenance équipements lourds, contrôle qualité par vision artificielle, optimisation chaînes de production, classification documents techniques, gestion stocks matières.",
    },
    {
      q: "Accompagnez-vous les acteurs du tourisme montagne et cols alpins ?",
