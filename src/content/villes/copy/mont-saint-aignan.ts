...
export const MONT_SAINT_AIGNAN_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Mont-Saint-Aignan : diagnostic adapté aux TPE et PME du plateau nord rouennais (services aux étudiants, commerces, laboratoires, artisans). Audit Flash 590 € HT, ROI quantifié sous 5 jours ouvrés.",
      en: "Audit IA à Mont-Saint-Aignan : diagnostic adapté aux TPE et PME du plateau nord rouennais (services aux étudiants, commerces, laboratoires, artisans). Audit Flash 590 € HT, ROI quantifié sous 5 jours ouvrés.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "L'Intervention Essentielle débute à 590 € HT et l'Audit Flash à 590 € HT. Les frais de déplacement depuis Paris (1h25 en train via gare Rouen Rive-Droite) sont facturés en sus de manière transparente. Tarifs publics détaillés sur notre site.",
    },
    {
