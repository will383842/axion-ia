...
// Toul (54, Meurthe-et-Moselle) — cathédrale gothique, vignoble Côtes de Toul AOC.
...
export const TOUL_COPY: VilleCopy = {
  ...
  pitchEn:
    "Toul (54), commune de Meurthe-et-Moselle, est une cité épiscopale historique avec sa cathédrale gothique Saint-Étienne et le vignoble des Côtes de Toul AOC. Tissu TPE viticulteurs, PME agroalimentaires, artisans BTP, commerces et services. Axion-IA accompagne tout le tissu professionnel local du Toulois.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Toul (54). Nous accompagnons tous types d'activités : TPE viticulteurs Côtes de Toul, PME agroalimentaires, artisans BTP, commerçants centre historique, professions libérales et acteurs du tourisme patrimonial.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Toul (54). Nous accompagnons tous types d'activités : TPE viticulteurs Côtes de Toul, PME agroalimentaires, artisans BTP, commerçants centre historique, professions libérales et acteurs du tourisme patrimonial.",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Toul : formats adaptés au domaine viticole, exploitation agroalimentaire, atelier artisan, commerce. Vos équipes repartent autonomes sur outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Toul : classification photos parcelles viticoles, automatisation traçabilité AOC, agents conversationnels vente directe, prédiction récoltes. Tous secteurs Toulois.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Toul et dans le Toulois ?",
      a: "Oui, Axion-IA intervient à Toul et tout le Toulois (Domgermain, Foug, Écrouves, Gondreville). Consultants depuis Nancy (25 min A31) ou Metz (50 min).",
    },
    {
