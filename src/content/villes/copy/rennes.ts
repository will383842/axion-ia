...
export const RENNES_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA opérationnel à Rennes : nous identifions vos cas d'usage réels dans le numérique (Atalante), l'agroalimentaire (Valorial, SPACE) ou l'industrie (Stellantis, Safran) et chiffrons le ROI. 4 niveaux du Sur place au Stratégique ETI selon votre taille.",
    ...
    sitesWeb: {
      ...
      en: "Custom web platforms and SaaS AI for Rennes SMEs/mid-caps — premium showcase site for French Tech Atalante scale-ups, interactive customer space for digital/agri-food, business dashboard connected to your CRM/ERP or industrial MES (La Janais, Valorial). Senior experts, Axion-IA design system, European hosting.",
    },
  },
  ...
  services: {
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Rennes des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 24-48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Rennes, itérations à distance.",
        whyHere: [
          "Projets web & SaaS rennais : 1er pôle public IA hors Île-de-France (IRISA, Inria), héritage numérique & telecom (Orange Innovation), agroalimentaire (Valorial), industrie, scale-ups French Tech Rennes Saint-Malo.",
          ...
          "Écosystème IA dense (IRISA, Inria, Rennes Atalante) : plateformes IA-native, RAG, agents — on parle le langage technique de la recherche rennaise, hébergement UE souverain.",
        ],
        methodology: [
          {
            step: "Cadrage à Rennes",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une application avec UX/UI et IA intégrée, pour scale-ups et PME rennaises.",
          },
          {
            sizeLabel: "ETI",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Rennes — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Vous travaillez avec l'écosystème deeptech/IA rennais ?",
            a: "Oui : plateformes IA-native, RAG, agents, recherche sémantique pour spin-offs et scale-ups issues d'IRISA, Inria et Rennes Atalante. On parle le langage technique de la recherche. Hébergement UE souverain, RGPD strict.",
          },
          {
        ...
        guarantees:
          "Devis ferme en forfait fixe (à partir de 24-48 h selon la complexité) : pas de dérive horaire cachée. Mise en ligne sans downtime quand on augmente l'existant. Web Vitals et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD : propriété totale, aucun abonnement imposé, transférable à tout prestataire de la région rennaise ou repris en interne.",
      },
      en: {
        hero: "In Rennes, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 24-48 h depending on project complexity, EU hosting, code and data yours. On-site Rennes kick-off, remote iterations.",
        whyHere: [
          "Rennes web & SaaS projects: France's leading public AI hub outside Île-de-France (IRISA, Inria), digital & telecom heritage (Orange Innovation), agri-food (Valorial), industry, French Tech Rennes Saint-Malo scale-ups.",
          ...
          "Dense AI ecosystem (IRISA, Inria, Rennes Atalante): AI-native platforms, RAG, agents — we speak the technical language of Rennes research, sovereign EU hosting.",
        ],
        methodology: [
          {
            step: "Scoping in Rennes",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Design or rebuild of a site or app with UX/UI and built-in AI, for Rennes scale-ups and SMEs.",
          },
          {
            sizeLabel: "Mid-cap",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Rennes — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Do you work with the Rennes deeptech/AI ecosystem?",
            a: "Yes: AI-native platforms, RAG, agents, semantic search for spin-offs and scale-ups from IRISA, Inria and Rennes Atalante. We speak the technical language of research. Sovereign EU hosting, strict GDPR.",
          },
          {
