...
export const OYONNAX_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Oyonnax : diagnostic 4 heures pensé pour la plasturgie et la sous-traitance industrielle du Haut-Bugey. Cas d'usage typiques : contrôle qualité visuel sur ligne d'injection, prédiction de pannes presse, automatisation des devis sur cahier des charges client. Audit Flash dès {{price:audit-flash|flat}}.",
