...
// Baud (56, Morbihan) — Centre Morbihan, Vénus de Quinipily, bourg.
...
export const BAUD_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Baud est un bourg dynamique du centre Morbihan, à mi-chemin entre Lorient et Pontivy. La commune vit de l'agroalimentaire, de l'artisanat, du commerce de proximité et de l'agriculture. Le tourisme patrimonial (Vénus de Quinipily, chapelles) complète un tissu économique ancré dans les filières locales bretonnes.",
  distancesFr:
    "Lorient à 30 min par D24. Pontivy à 25 min. Gare de Lorient à 35 min (TGV Paris 3h30). Vannes à 50 min. Aéroport Lorient-Bretagne-Sud à 40 min.",
  distancesEn:
    "Lorient à 30 min par D24. Pontivy à 25 min. Gare de Lorient à 35 min (TGV Paris 3h30). Vannes à 50 min. Aéroport Lorient-Bretagne-Sud à 40 min.",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Baud : formats adaptés au commerce de proximité, à l'atelier artisanal ou au bureau PME. Vos équipes repartent autonomes sur les outils IA métier adaptés à votre activité.",
    },
    implementation: {
      fr: "Implémentation IA à Baud : automatisation gestion stocks et commandes, agents conversationnels relation client, classification produits agroalimentaires, chatbots réservation et prise de RDV. Adapté tissu économique centre Morbihan.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Baud et dans le centre Morbihan ?",
      a: "Oui, Axion-IA intervient à Baud et dans tout le centre Morbihan (Locminé, Guémené-sur-Scorff, Bubry, Camors). Couverture Lorient (30 min), Pontivy (25 min) et Vannes (50 min).",
    },
    {
      q: "Travaillez-vous avec les PME agroalimentaires de Baud ?",
    ...
    },
    {
      ...
      a: "Nos consultants se déplacent dans vos locaux à Baud ou interviennent en visio. Lorient est à 30 min, Pontivy à 25 min. Pour les missions multi-jours, hébergement local possible. Frais de déplacement transparents en sus du forfait.",
    },
  ],
};
