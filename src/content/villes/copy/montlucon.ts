...
export const MONTLUCON_COPY: VilleCopy = {
  pitchFr:
    "Montluçon, dans l'Allier, est la principale ville du bassin du même nom, forgée par une longue tradition de métallurgie et de pneumatique, avec la présence historique de Dunlop. Aujourd'hui en reconversion, son économie s'appuie sur la sous-traitance industrielle, la mécanique, le commerce et les services. Axion-IA, cabinet d'architectes IA seniors, accompagne en priorité les TPE puis les PME de ce territoire pour automatiser leurs tâches répétitives et gagner en compétitivité, avec un ROI mesurable.",
  pitchEn:
    "Montluçon, dans l'Allier, est la principale ville du bassin du même nom, forgée par une longue tradition de métallurgie et de pneumatique, avec la présence historique de Dunlop. Aujourd'hui en reconversion, son économie s'appuie sur la sous-traitance industrielle, la mécanique, le commerce et les services. Axion-IA, cabinet d'architectes IA seniors, accompagne en priorité les TPE puis les PME de ce territoire pour automatiser leurs tâches répétitives et gagner en compétitivité, avec un ROI mesurable.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Montluçon (03, Allier). Nous accompagnons en priorité les TPE puis les PME du bassin montluçonnais : sous-traitants métallurgie et mécanique héritiers de la tradition Dunlop, ateliers, commerces et services. Audit des processus, automatisation des devis et relances, agents conversationnels, formation des équipes sur site. Les ETI restent un public marginal pour nous. Tarifs publics, ROI documenté.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Montluçon (03, Allier). Nous accompagnons en priorité les TPE puis les PME du bassin montluçonnais : sous-traitants métallurgie et mécanique héritiers de la tradition Dunlop, ateliers, commerces et services. Audit des processus, automatisation des devis et relances, agents conversationnels, formation des équipes sur site. Les ETI restent un public marginal pour nous. Tarifs publics, ROI documenté.",
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Oui. Nos architectes IA se déplacent à Montluçon et dans tout le bassin pour réaliser audits, interventions et implémentations dans vos locaux, généralement sous cinq jours ouvrés après validation, malgré l'éloignement des grandes métropoles.",
    },
    {
