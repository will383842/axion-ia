...
export const BOBIGNY_COPY: VilleCopy = {
  pitchFr:
    "Bobigny (93), préfecture de la Seine-Saint-Denis, est le cœur administratif et judiciaire du département, avec sa préfecture, son tribunal et ses grands équipements desservis par le tramway et le métro. Autour de ce pôle tertiaire et institutionnel gravitent de nombreuses TPE et PME : services aux entreprises, BTP, commerce, santé et transport. Axion-IA, cabinet d'architectes IA seniors, y accompagne en priorité les TPE puis les PME pour automatiser les tâches administratives et fiabiliser la relation client, avec des solutions concrètes et un retour sur investissement mesurable.",
  pitchEn:
    "Bobigny (93), préfecture de la Seine-Saint-Denis, est le cœur administratif et judiciaire du département, avec sa préfecture, son tribunal et ses grands équipements desservis par le tramway et le métro. Autour de ce pôle tertiaire et institutionnel gravitent de nombreuses TPE et PME : services aux entreprises, BTP, commerce, santé et transport. Axion-IA, cabinet d'architectes IA seniors, y accompagne en priorité les TPE puis les PME pour automatiser les tâches administratives et fiabiliser la relation client, avec des solutions concrètes et un retour sur investissement mesurable.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Bobigny (93, Seine-Saint-Denis) et dans le nord-est francilien. Nous accompagnons en priorité les TPE de services, de commerce et du BTP, puis les PME de services aux entreprises et de santé qui gravitent autour du pôle administratif et judiciaire. Notre méthode : un audit ciblé des tâches répétitives, des automatisations utiles déployées sur vos outils, et la formation de vos équipes. Les grandes ETI restent une part marginale de notre clientèle.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Bobigny (93, Seine-Saint-Denis) et dans le nord-est francilien. Nous accompagnons en priorité les TPE de services, de commerce et du BTP, puis les PME de services aux entreprises et de santé qui gravitent autour du pôle administratif et judiciaire. Notre méthode : un audit ciblé des tâches répétitives, des automatisations utiles déployées sur vos outils, et la formation de vos équipes. Les grandes ETI restent une part marginale de notre clientèle.",
