...
export const SULLY_SUR_LOIRE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Sully-sur-Loire (45), commune des bords de Loire en Loiret, est célèbre pour son château de Sully (patrimoine mondial UNESCO Val de Loire). Bourg rural de l'est-Loiret, entre Sologne et Beauce. Tissu TPE artisans, commerçants, PME agricoles, tourisme patrimonial Loire. Axion-IA opère sur l'ensemble des activités professionnelles locales.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Sully-sur-Loire (45). Nous accompagnons tous types d'activités : acteurs du tourisme patrimonial (château de Sully UNESCO), TPE artisans et commerçants du bourg, PME agricoles est-Loiret, indépendants, professions libérales et services aux entreprises du Sullias.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Sully-sur-Loire (45). Nous accompagnons tous types d'activités : acteurs du tourisme patrimonial (château de Sully UNESCO), TPE artisans et commerçants du bourg, PME agricoles est-Loiret, indépendants, professions libérales et services aux entreprises du Sullias.",
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Sully-sur-Loire : sessions dans votre site touristique, exploitation, commerce ou en visio. Dirigeants TPE/PME, artisans, agriculteurs, commerçants et gérants du Sullias et est-Loiret.",
      en: "Coaching 1-to-1 à Sully-sur-Loire : sessions dans votre site touristique, exploitation, commerce ou en visio. Dirigeants TPE/PME, artisans, agriculteurs, commerçants et gérants du Sullias et est-Loiret.",
    },
  },
  faqGeolocalisee: [
    {
