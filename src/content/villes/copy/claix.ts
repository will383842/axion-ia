...
export const CLAIX_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Claix : sessions dans votre cabinet, atelier, commerce ou en visio. Médecins, avocats, artisans BTP haut de gamme, commerçants, gérants TPE/PME claixois souhaitant intégrer l'IA.",
      en: "Coaching 1-to-1 à Claix : sessions dans votre cabinet, atelier, commerce ou en visio. Médecins, avocats, artisans BTP haut de gamme, commerçants, gérants TPE/PME claixois souhaitant intégrer l'IA.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les TPE artisans BTP à Claix (BTP haut de gamme, second œuvre, paysagistes) sur des cas IA pratiques : automatisation devis chantier, agents IA prise de RDV, classification photos chantier, gestion stocks et planning. Audit Flash 490 € HT adapté.",
    },
    {
      q: "Quels services pour les acteurs du tourisme Vercors ?",
      a: "Pour les acteurs du tourisme et loisirs montagne Vercors (stations Lans-en-Vercors, Villard-de-Lans à proximité de Claix), nous proposons audit Flash 490 € HT, intervention 1 journée formation, coaching 1-to-1. Cas IA : agents conversationnels multilingues, automatisation réservations, classification feedback.",
    },
    {
