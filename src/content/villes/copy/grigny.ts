...
export const GRIGNY_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit sur place IA à Grigny dès {{price:audit-flash|flat}} — 4 heures pour identifier 3 à 5 automatisations prioritaires dans le commerce, le transport ou la construction.",
