...
export const BREST_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    sitesWeb: {
      ...
      en: "Custom web platforms and SaaS AI for Brittany SMEs/mid-caps — premium showcase site for maritime defence, marine sciences and marine renewables (Naval Group, IFREMER, Pôle Mer), interactive customer space at Technopôle Brest-Iroise, business dashboard connected to your CRM/ERP or embedded systems. Senior experts, Axion-IA design system, European hosting.",
    },
  },
  ...
  services: {
        ...
        faq: [
          {
            ...
            a: "La durée varie selon le niveau retenu : un Audit sur place se déroule sur une journée, un Audit Stratégique ETI s'étale sur plusieurs semaines. Le rythme est calé avec vous dès le brief de cadrage initial.",
          },
          {
      ...
      fr: {
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Le format collectif (1 journée) pour le groupe entier ou Équipes pour focaliser sur un département (bureau d'études, commercial, administration, opérations).",
          },
          {
            sizeLabel: "ETI",
      ...
      en: {
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Group format for the whole group or Teams to focus on one department (engineering office, sales, administration, operations).",
          },
          {
            sizeLabel: "Mid-cap",
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Brest des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 24-48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Brest, itérations à distance.",
        whyHere: [
          "Projets web & SaaS brestois : défense & économie marine (Naval Group, Thales Underwater, IFREMER), ingénierie numérique (IMT Atlantique, ENIB, Lab-STICC), Marine nationale, PME de la Bretagne Ouest.",
          ...
          "Secteur défense & marine : confidentialité contractuelle stricte, hébergement UE souverain, plateformes data et RAG — adapté à l'écosystème naval et scientifique brestois.",
        ],
        methodology: [
          {
            step: "Cadrage à Brest",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une application avec UX/UI et IA intégrée, pour scale-ups, sous-traitants et PME brestoises.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Plateforme métier, technique ou portail sécurisé sur mesure, IA intégrée, branchée sur votre SI (PLM, ERP, datalake), hébergement souverain.",
          },
          {
            sizeLabel: "Grande entreprise",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Brest — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Vous gérez les exigences de confidentialité du secteur défense & marine ?",
            a: "Oui : confidentialité contractuelle stricte, hébergement UE souverain, code et données livrés dans votre infrastructure, jamais de transit hors UE. Un cadre adapté à l'écosystème naval et marine brestois (Naval Group, Thales Underwater, IFREMER).",
          },
          {
        ...
        guarantees:
          "Devis ferme en forfait fixe (à partir de 24-48 h selon la complexité) : pas de dérive horaire cachée. Mise en ligne sans downtime quand on augmente l'existant. Web Vitals et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD : propriété totale, aucun abonnement imposé, transférable à tout prestataire de la région brestoise ou repris en interne.",
      },
      en: {
        hero: "In Brest, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 24-48 h depending on project complexity, EU hosting, code and data yours. On-site Brest kick-off, remote iterations.",
        whyHere: [
          "Brest web & SaaS projects: defence & marine economy (Naval Group, Thales Underwater, IFREMER), digital engineering (IMT Atlantique, ENIB, Lab-STICC), French Navy, western Brittany SMEs.",
          ...
          "Defence & marine sector: strict contractual confidentiality, sovereign EU hosting, data platforms and RAG — fit for the Brest naval and scientific ecosystem.",
        ],
        methodology: [
          {
            step: "Scoping in Brest",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Design or rebuild of a site or app with UX/UI and built-in AI, for scale-ups, subcontractors and Brest SMEs.",
          },
          {
            sizeLabel: "Mid-cap",
            price: "AI-native SaaS platform",
            detail:
              "Bespoke business, technical or secure portal platform, AI built in, wired into your IS (PLM, ERP, datalake), sovereign hosting.",
          },
          {
            sizeLabel: "Large enterprise",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Brest — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Do you handle defence & marine confidentiality requirements?",
            a: "Yes: strict contractual confidentiality, sovereign EU hosting, code and data delivered into your infrastructure, never any transit outside the EU. A framework fit for the Brest naval and marine ecosystem (Naval Group, Thales Underwater, IFREMER).",
          },
          {
