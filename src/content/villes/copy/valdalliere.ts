...
export const VALDALLIERE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Valdallière : diagnostic adapté aux exploitations agricoles bocage, PME agroalimentaires (laiteries), TPE artisans BTP et commerçants ruraux. ROI mesurable, audit sur place dès {{price:audit-flash|flat}}.",
      en: "Audit IA à Valdallière : diagnostic adapté aux exploitations agricoles bocage, PME agroalimentaires (laiteries), TPE artisans BTP et commerçants ruraux. ROI mesurable, audit sur place dès {{price:audit-flash|flat}}.",
    },
    interventions: {
    ...
    implementation: {
      ...
      en: "Implémentation IA à Valdallière : gestion troupeaux bovin, prédiction production laitière, automatisation traçabilité, agents conversationnels vente directe. Adapté TPE/PME bocage.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Valdallière : sessions dans votre exploitation, laiterie, atelier ou en visio. Agriculteurs, dirigeants agroalimentaires, artisans BTP, gérants TPE/PME bocage.",
      en: "Coaching 1-to-1 à Valdallière : sessions dans votre exploitation, laiterie, atelier ou en visio. Agriculteurs, dirigeants agroalimentaires, artisans BTP, gérants TPE/PME bocage.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    },
    {
      ...
      a: "Pour les TPE artisans BTP et commerçants à Valdallière, audit sur place {{price:audit-flash|flat}}, intervention 1 journée formation, coaching 1-to-1. Cas typiques : automatisation devis, agents IA prise de RDV, gestion stocks.",
    },
    {
