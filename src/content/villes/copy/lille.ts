...
export const LILLE_COPY: VilleCopy = {
  ...
  services: {
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Lille des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Lille, itérations à distance.",
        whyHere: [
        ...
        faq: [
          ...
          },
          {
            ...
            a: "Oui. Après le cadrage, on remet un devis ferme en forfait fixe. Le délai de remise dépend de la complexité — à partir de 48 h pour un projet simple, davantage pour une plateforme e-commerce étendue. Pas de régie, pas de dérive horaire cachée.",
          },
          {
      ...
      en: {
        ...
        faq: [
          ...
          },
          {
            ...
            a: "Yes. After scoping, we deliver a firm quote on a fixed package. Turnaround depends on complexity — from 48 h for a simple project, more for an extended e-commerce platform. No time-and-materials, no hidden hourly drift.",
          },
          {
