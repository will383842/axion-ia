...
// Mions (69, Rhône) — banlieue SE Lyon, Métropole de Lyon, zones d'activités + péri-urbain.
...
export const MIONS_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Mions : formats adaptés au bureau tertiaire, entrepôt logistique, cabinet, commerce. Vos équipes repartent autonomes sur outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Mions : optimisation supply chain, agents conversationnels B2B, automatisation workflow tertiaire, classification documents. Métropole Lyon SE.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Mions et SE lyonnais ?",
      a: "Oui, Axion-IA intervient à Mions et tout le SE lyonnais (Corbas limitrophe, Saint-Priest, Vénissieux, Chassieu). Couverture Métropole de Lyon. Consultants depuis Lyon (20 min).",
    },
    {
      q: "Travaillez-vous avec les opérateurs logistiques ?",
      a: "Oui, nous accompagnons les opérateurs logistiques aire Lyon-Saint-Exupéry sur leurs cas IA : optimisation tournées, automatisation supply chain, agents IA service client B2B.",
    },
    {
