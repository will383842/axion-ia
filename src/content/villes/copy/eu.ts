...
export const EU_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Pour les acteurs du tourisme, nous proposons : automatisation reservations, agents conversationnels multilingues, gestion avis clients IA, billetterie augmentee. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
