...
// Corte (2B, Haute-Corse) — Cœur Corse, université, citadelle, sous-préfecture.
...
export const CORTE_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Corte est la capitale historique de la Corse et siège de l'Université de Corse Pasquale Paoli (environ 4 700 étudiants). Sous-préfecture de Haute-Corse, la ville domine le centre montagneux de l'île. L'économie repose sur les services universitaires, le tourisme culturel et de montagne (citadelle, gorges de la Restonica, vallée du Tavignano), le commerce de proximité, l'artisanat et les services publics.",
  distancesFr:
    "Bastia à 1h10 via T20. Ajaccio à 1h15 via T20. Aéroport Bastia-Poretta à 1h20. Aéroport Ajaccio à 1h25. Gare de Corte (ligne CFC Bastia–Ajaccio). Porto-Vecchio à 2h.",
  distancesEn:
    "Bastia à 1h10 via T20. Ajaccio à 1h15 via T20. Aéroport Bastia-Poretta à 1h20. Aéroport Ajaccio à 1h25. Gare de Corte (ligne CFC Bastia–Ajaccio). Porto-Vecchio à 2h.",
  topSectorsNaf: [
    "Enseignement supérieur & recherche",
    "Tourisme culturel & montagne",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Corte : formations pratiques pour équipes tourisme, commerçants, artisans et professions libérales du centre Corse. Vos collaborateurs repartent autonomes sur les outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Corte : agents conversationnels accueil touristique, automatisation gestion locative saisonnière, outils pédagogiques universitaires, gestion documentaire professions libérales. Adapté au tissu centre Corse.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Corte et dans le centre Corse ?",
      a: "Oui, Axion-IA intervient à Corte et dans tout le centre Corse (Venaco, Vivario, Ghisoni, Aléria). Couverture Bastia à 1h10 et Ajaccio à 1h15 par la T20.",
    },
    {
      q: "Accompagnez-vous les structures liées à l'Université de Corse ?",
    ...
    },
    {
      ...
      a: "Pour les acteurs touristiques de Corte (hébergeurs, restaurateurs, guides), nous proposons : agents IA réservation et accueil multilingue, automatisation planning saisonnier, chatbot visiteurs citadelle et Restonica. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
      q: "Comment se déroule une mission Axion-IA à Corte ?",
      a: "Après un premier échange gratuit, nous planifions l'intervention sous 5 jours. Nos consultants se déplacent depuis Bastia (1h10) ou Ajaccio (1h15). Intervention sur site ou en visio. Livrable actionnable et suivi post-mission de 30 jours inclus.",
    },
  ],
};
