...
// Marnaz (74, Haute-Savoie) — vallée de l'Arve, capitale mondiale du décolletage et de la micromécanique.
...
export const MARNAZ_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Marnaz : formats adaptés à l'atelier d'usinage, ligne de production ou bureau d'études. Vos équipes repartent autonomes sur outils IA configurés métier.",
    },
    implementation: {
      fr: "Implémentation IA à Marnaz : contrôle qualité par vision pièces usinées, prédiction maintenance tours CNC, optimisation gammes d'usinage, automatisation devis sous-traitance. Tissu décolletage vallée de l'Arve.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Marnaz et dans la vallée de l'Arve ?",
    ...
    },
    {
      ...
      a: "L'audit sur place IA à Marnaz démarre à {{price:audit-flash|flat}}. Ce diagnostic couvre l'analyse de vos processus d'usinage et sous-traitance, l'identification des cas d'usage IA prioritaires et un plan d'action chiffré avec ROI estimé.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants viennent directement dans votre atelier ou bureau d'études à Marnaz. Formats demi-journée ou journée complète, avec configuration d'outils IA adaptés à votre métier d'usinage et sous-traitance.",
    },
  ],
};
