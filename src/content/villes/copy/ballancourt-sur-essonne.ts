...
// Ballancourt-sur-Essonne (91, Essonne) — vallée Essonne, résidentielle semi-rurale.

import type { VilleCopy } from "./types";

export const BALLANCOURT_SUR_ESSONNE_COPY: VilleCopy = {
  pitchFr:
    "Ballancourt-sur-Essonne (91), commune résidentielle semi-rurale de la vallée de l'Essonne. Tissu TPE artisanat, commerces de proximité, PME services, professions libérales, agriculture locale. Axion-IA y intervient pour tous types d'activités.",
  pitchEn:
    "Ballancourt-sur-Essonne (91), commune résidentielle semi-rurale de la vallée de l'Essonne. Tissu TPE artisanat, commerces de proximité, PME services, professions libérales, agriculture locale. Axion-IA y intervient pour tous types d'activités.",
  directAnswerFr:
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Ballancourt-sur-Essonne : diagnostic adapté aux TPE artisanat, commerces de proximité, PME services, professions libérales, exploitants agricoles. ROI chiffré, audit Flash 490 € HT.",
      en: "Audit IA à Ballancourt-sur-Essonne : diagnostic adapté aux TPE artisanat, commerces de proximité, PME services, professions libérales, exploitants agricoles. ROI chiffré, audit Flash 490 € HT.",
    },
    interventions: {
      fr: "Interventions IA sur site à Ballancourt-sur-Essonne : formats adaptés atelier artisan, commerce, cabinet libéral, siège PME, exploitation agricole. Vos équipes repartent autonomes.",
      en: "Interventions IA sur site à Ballancourt-sur-Essonne : formats adaptés atelier artisan, commerce, cabinet libéral, siège PME, exploitation agricole. Vos équipes repartent autonomes.",
    },
    implementation: {
      fr: "Implémentation IA à Ballancourt-sur-Essonne : automatisation devis et facturation artisans, CRM augmenté PME, gestion stocks commerce, planning professions libérales.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Ballancourt-sur-Essonne ?",
      a: "Oui, Axion-IA intervient à Ballancourt-sur-Essonne et toute la vallée de l'Essonne (Mennecy à 10 min, Corbeil-Essonnes à 15 min, Évry-Courcouronnes à 20 min, Paris à 45 min).",
    },
    {
    ...
    {
      q: "Quel est le tarif d'un audit IA à Ballancourt ?",
    ...
    },
    {
      ...
      a: "Oui, nous couvrons Ballancourt-sur-Essonne, Mennecy, La Ferté-Alais, Corbeil-Essonnes et toute la vallée de l'Essonne. Frais de déplacement facturés à part, tarifs publics.",
    },
  ],
};
