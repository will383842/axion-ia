...
export const COULAINES_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Coulaines : diagnostic adapté aux TPE artisans, PME de services, commerçants et professions libérales du nord de l'agglomération mancelle. ROI chiffré, Audit Flash 490 € HT.",
