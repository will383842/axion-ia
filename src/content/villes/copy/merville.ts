...
// Merville (59, Nord) — commune flamande sur les bords de la Lys, plaine de la Lys, agriculture (maraîchage, élevage), aérodrome Merville-Calonne, entre Béthune et Hazebrouck.
...
export const MERVILLE_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Merville : formats adaptés à l'exploitation agricole, l'unité agroalimentaire, le commerce, l'atelier artisan. Vos équipes repartent autonomes sur les outils IA usage quotidien.",
    },
    implementation: {
      fr: "Implémentation IA à Merville : agriculture de précision, prédiction rendements maraîchers, classification qualité produits agroalimentaire, automatisation devis BTP, agents IA service client.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Merville et plaine de la Lys ?",
      a: "Oui, Axion-IA intervient à Merville et toute la plaine de la Lys (Estaires, Laventie, Hazebrouck, Bailleul). Nos consultants viennent de Lille (35 min A25), Béthune (15 min) ou en visio selon vos contraintes.",
    },
    {
    ...
    },
    {
      ...
      a: "Pour les TPE artisans BTP et commerçants à Merville, audit Flash 490 € HT, intervention 1 journée formation, coaching 1-to-1. Cas typiques : automatisation devis, agents IA prise de RDV, classification photos chantiers, gestion stocks, marketing local.",
    },
    {
