...
export const ARCUEIL_COPY: VilleCopy = {
  pitchFr:
    "Axion-IA, cabinet d'architectes IA seniors, accompagne les TPE et PME d'Arcueil, commune tertiaire du sud parisien dans la Métropole du Grand Paris. Sièges sociaux, éditeurs logiciels, services aux entreprises, commerce et BTP : nous transformons l'IA en gains concrets, sans jargon ni dépendance technique.",
  pitchEn:
    "Axion-IA, cabinet d'architectes IA seniors, accompagne les TPE et PME d'Arcueil, commune tertiaire du sud parisien dans la Métropole du Grand Paris. Sièges sociaux, éditeurs logiciels, services aux entreprises, commerce et BTP : nous transformons l'IA en gains concrets, sans jargon ni dépendance technique.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Arcueil auprès des TPE et PME en priorité, des PME ensuite. Nous ciblons le tertiaire dense du Val-de-Marne sud : éditeurs logiciels, services aux entreprises, sièges, commerce et BTP. Audit Flash sur mesure avec ROI chiffré, puis interventions sur site, vos équipes restant autonomes.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Arcueil auprès des TPE et PME en priorité, des PME ensuite. Nous ciblons le tertiaire dense du Val-de-Marne sud : éditeurs logiciels, services aux entreprises, sièges, commerce et BTP. Audit Flash sur mesure avec ROI chiffré, puis interventions sur site, vos équipes restant autonomes.",
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Arcueil pour éditeurs logiciels, agences et services aux entreprises : nous cartographions vos process (production, support, administratif, commercial) et chiffrons un ROI réaliste. Audit Flash sur mesure dès {{price:audit-flash|flat}}.",
      en: "Audit IA à Arcueil pour éditeurs logiciels, agences et services aux entreprises : nous cartographions vos process (production, support, administratif, commercial) et chiffrons un ROI réaliste. Audit Flash sur mesure dès {{price:audit-flash|flat}}.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Copilotes métiers, automatisation du support et de l'administratif, génération de contenu et qualification commerciale. Chaque piste est chiffrée en ROI dans l'Audit Flash avant toute implémentation.",
    },
    {
