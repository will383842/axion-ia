...
export const ARCUEIL_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Arcueil pour éditeurs logiciels, agences et services aux entreprises : nous cartographions vos process (production, support, administratif, commercial) et chiffrons un ROI réaliste. Audit Flash sur mesure dès 490 € HT.",
      en: "Audit IA à Arcueil pour éditeurs logiciels, agences et services aux entreprises : nous cartographions vos process (production, support, administratif, commercial) et chiffrons un ROI réaliste. Audit Flash sur mesure dès 490 € HT.",
    },
    interventions: {
