...
export const PERPIGNAN_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    sitesWeb: {
      ...
      en: "Custom web platforms and SaaS AI for Catalan SMEs and mid-caps — bilingual FR/ES showcase site for Saint-Charles International traders and Roussillon wine estates, B2B client portal for Tecnosud-DERBI renewables players, business dashboard connected to your CRM/ERP/TMS. Senior experts, Axion-IA design system, European hosting.",
    },
  },
  ...
  services: {
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Perpignan des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Perpignan, itérations à distance.",
        whyHere: [
