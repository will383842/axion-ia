...
// Neuville-de-Poitou (86, Vienne) — Nord Poitiers, Grand Poitiers.
...
export const NEUVILLE_DE_POITOU_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Neuville-de-Poitou et nord Poitou ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons médecins, avocats, experts-comptables et autres professions libérales à Neuville-de-Poitou sur leurs cas IA : automatisation secrétariat, classification documents, synthèse dossiers, agents conversationnels patients/clients.",
    },
    {
      q: "Quels services pour les commerçants neuvillois ?",
      a: "Pour les commerçants de Neuville-de-Poitou, audit sur place {{price:audit-flash|flat}}, intervention 1 journée formation, coaching 1-to-1. Cas typiques : gestion stocks IA, agents IA prise de RDV, automatisation comptabilité, fidélisation client augmentée.",
    },
    {
      q: "Travaillez-vous avec les entreprises proches du Futuroscope ?",
      a: "Oui, Neuville-de-Poitou est à 10 min du Futuroscope. Nous accompagnons PME tech, prestataires tourisme, sous-traitants du parc et entreprises de la zone Futuroscope sur leurs projets d'intelligence artificielle.",
    },
  ],
};
