...
export const PIBRAC_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Pibrac : diagnostic adapté aux TPE de services, PME tertiaires et professions libérales de l'ouest Toulouse. Audit Flash 490 € HT.",
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, sessions 1-to-1 pour dirigeants TPE et PME à Pibrac. Format flexible : locaux, visio. À partir de 990 € HT.",
    },
  ],
};
