...
export const AIZENAY_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Audit Flash 490 € HT, interventions sur site, coaching 1-to-1, implémentation IA. Cas artisans BTP : automatisation devis, gestion chantiers, planification équipes, facturation, relation client.",
    },
    {
