...
// Fonsorbes (31, Haute-Garonne) — Ouest Toulouse.
...
export const FONSORBES_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Fonsorbes : diagnostic adapté aux TPE artisans BTP, PME de services et professions libérales de l'ouest Toulouse. Audit Flash {{price:audit-flash|flat}}.",
      en: "Audit IA à Fonsorbes : diagnostic adapté aux TPE artisans BTP, PME de services et professions libérales de l'ouest Toulouse. Audit Flash {{price:audit-flash|flat}}.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Fonsorbes ?",
      a: "Oui, Axion-IA intervient à Fonsorbes et dans toute la couronne ouest de Toulouse (Plaisance-du-Touch, Saint-Lys, Léguevin). Nos consultants se déplacent en 25 min depuis Toulouse.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants se déplacent à Fonsorbes depuis Toulouse (25 min D632). Intervention 1 journée minimum, atelier pratique dans vos locaux. Équipes autonomes en fin de session.",
    },
    {
      q: "L'IA est-elle utile pour un artisan BTP à Fonsorbes ?",
      a: "Oui, l'IA aide les artisans BTP à automatiser devis, planning chantiers, relances clients, classification factures. Gains de temps concrets dès la première semaine d'utilisation.",
    },
  ],
};
