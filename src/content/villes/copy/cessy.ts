...
// Cessy (01, Ain) — pays de Gex, frontière suisse, péri-urbain Genève.

import type { VilleCopy } from "./types";

export const CESSY_COPY: VilleCopy = {
  pitchFr:
    "Cessy (01), commune du pays de Gex dans l'Ain, est positionnée à proximité de la frontière suisse et de Genève. Tissu économie frontalière, PME tertiaires, TPE artisans BTP, commerces. Axion-IA accompagne entreprises et indépendants gessiennes.",
  pitchEn:
    "Cessy (01), commune du pays de Gex dans l'Ain, est positionnée à proximité de la frontière suisse et de Genève. Tissu économie frontalière, PME tertiaires, TPE artisans BTP, commerces. Axion-IA accompagne entreprises et indépendants gessiennes.",
  directAnswerFr:
  ...
  ecosystemFr:
    "Cessy est dans le pays de Gex, proximité frontière suisse/Genève. Économie frontalière dynamique, PME tertiaires, TPE artisanat BTP, commerces.",
  ecosystemEn:
    "Cessy est dans le pays de Gex, proximité frontière suisse/Genève. Économie frontalière dynamique, PME tertiaires, TPE artisanat BTP, commerces.",
  distancesFr:
    "Genève centre à 15 min. Gex à 5 min. Ferney-Voltaire à 10 min. Aéroport Genève-Cointrin à 20 min. Lyon centre à 1h30.",
  distancesEn:
    "Genève centre à 15 min. Gex à 5 min. Ferney-Voltaire à 10 min. Aéroport Genève-Cointrin à 20 min. Lyon centre à 1h30.",
  topSectorsNaf: [
  ...
  servicesContext: {
    ...
    implementation: {
      ...
      en: "Implémentation IA à Cessy : agents conversationnels multilingue FR/EN/DE, automatisation workflow transfrontalier, classification documents. Pays de Gex.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Cessy : sessions dans votre bureau, commerce ou en visio. Dirigeants frontaliers, tertiaires, artisans, gérants TPE/PME cessyens.",
      en: "Coaching 1-to-1 à Cessy : sessions dans votre bureau, commerce ou en visio. Dirigeants frontaliers, tertiaires, artisans, gérants TPE/PME cessyens.",
    },
  },
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Cessy et pays de Gex ?",
      a: "Oui, Axion-IA intervient à Cessy et tout le pays de Gex (Gex à 5 min, Ferney-Voltaire, Saint-Genis-Pouilly, Divonne). Genève à 15 min.",
    },
    {
      q: "Travaillez-vous avec l'économie frontalière ?",
      a: "Oui, agents conversationnels multilingue FR/EN/DE, automatisation workflow transfrontalier, classification documents.",
    },
    {
