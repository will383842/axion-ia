...
// La Hague (50, Manche) — commune nouvelle du Cotentin nord, usine de retraitement, littoral sauvage.
...
export const LA_HAGUE_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à La Hague : formats adaptés à l'exploitation agricole, l'atelier industriel, le commerce rural, le prestataire touristique. Vos équipes repartent autonomes sur les outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à La Hague : automatisation contrôle qualité industriel, gestion traçabilité agricole, agents IA accueil touristique, prédiction maintenance sous-traitance nucléaire, CRM commerces ruraux.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à La Hague et dans le Cotentin ?",
      a: "Oui, Axion-IA intervient à La Hague et dans tout le Cotentin (Cherbourg, Valognes, Bricquebec). Nos consultants se déplacent depuis Cherbourg (20 min) ou Caen (1 h 30), ou en visio.",
    },
    {
      q: "Accompagnez-vous les PME sous-traitantes du secteur nucléaire ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les prestataires tourisme de nature de La Hague (gîtes, randonnées, activités côtières) : agents IA réservation, optimisation planning saisonnier, CRM fidélisation, automatisation accueil visiteurs.",
    },
    {
