...
export const CASTRES_COPY: VilleCopy = {
  pitchFr:
    "Castres (81), deuxième ville du Tarn, abrite le siège mondial du groupe Pierre Fabre, pilier de l'industrie pharmaceutique et cosmétique, dans une tradition textile et un tissu solide de TPE et PME locales. Axion-IA, cabinet d'experts IA seniors, accompagne en priorité les TPE puis les PME castraises pour automatiser leurs processus métier et déployer une IA souveraine, sobre et réellement utile au quotidien.",
  pitchEn:
    "Castres (81), deuxième ville du Tarn, abrite le siège mondial du groupe Pierre Fabre, pilier de l'industrie pharmaceutique et cosmétique, dans une tradition textile et un tissu solide de TPE et PME locales. Axion-IA, cabinet d'experts IA seniors, accompagne en priorité les TPE puis les PME castraises pour automatiser leurs processus métier et déployer une IA souveraine, sobre et réellement utile au quotidien.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Castres (81, Tarn). Nous accompagnons en priorité les TPE, puis les PME du territoire — sous-traitants et fournisseurs de la filière pharmaceutique et cosmétique gravitant autour de Pierre Fabre, artisans, commerçants, cabinets de services et PME textile ou agroalimentaires. Audit, interventions sur site, implémentation et coaching un-à-un : nous concevons des automatisations concrètes et conformes RGPD, avec un transfert d'autonomie à vos équipes. Les ETI restent un complément marginal de notre activité.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Castres (81, Tarn). Nous accompagnons en priorité les TPE, puis les PME du territoire — sous-traitants et fournisseurs de la filière pharmaceutique et cosmétique gravitant autour de Pierre Fabre, artisans, commerçants, cabinets de services et PME textile ou agroalimentaires. Audit, interventions sur site, implémentation et coaching un-à-un : nous concevons des automatisations concrètes et conformes RGPD, avec un transfert d'autonomie à vos équipes. Les ETI restent un complément marginal de notre activité.",
