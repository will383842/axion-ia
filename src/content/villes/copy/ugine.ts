...
// Ugine (73, Savoie) — vallée d'Arly entre Albertville et Annecy, industrie métallurgique (aciers spéciaux historique).
...
export const UGINE_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Ugine et dans la vallée d'Arly ?",
      a: "Oui, Axion-IA intervient à Ugine et dans toute la vallée d'Arly (Albertville, Flumet, Megève, Mercury, Grignon). Couverture étendue bassin Albertville-Annecy incluant les communes industrielles et touristiques.",
    },
    {
      q: "Travaillez-vous avec les industriels métallurgie et aciers spéciaux ?",
      a: "Oui, nous accompagnons les industriels métallurgie et aciers spéciaux à Ugine sur leurs cas IA : prédiction maintenance fours et équipements lourds, contrôle qualité par vision artificielle, optimisation chaînes de production, traçabilité lots, classification documentation technique.",
    },
    {
      q: "Accompagnez-vous les entreprises de mécanique industrielle ?",
    ...
    },
    {
      ...
      a: "Pour les TPE artisans et commerçants à Ugine, audit Flash 490 € HT, intervention 1 journée formation, coaching 1-to-1. Cas typiques : automatisation devis, agents IA prise de RDV, gestion stocks, facturation automatisée.",
    },
    {
      q: "Comment se déroule une mission à Ugine ?",
      a: "Nos consultants se déplacent à Ugine (10 min depuis Albertville, 35 min depuis Annecy). Interventions en usine, atelier ou locaux commerciaux. Formats demi-journée ou journée complète. Visio possible pour les sessions coaching.",
    },
  ],
};
