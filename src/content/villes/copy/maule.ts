...
// Maule (78, Yvelines) — vallée Mauldre, bourg rural ouest Yvelines.

import type { VilleCopy } from "./types";

export const MAULE_COPY: VilleCopy = {
  pitchFr:
    "Maule (78), bourg rural de la vallée de la Mauldre, dans l'ouest des Yvelines. Tissu de TPE artisans, PME agricoles et de services, commerces de centre-bourg, professions libérales et activités liées à la viticulture et au patrimoine local. Axion-IA y intervient pour tous types d'activités de la vallée de la Mauldre.",
  pitchEn:
    "Maule (78), bourg rural de la vallée de la Mauldre, dans l'ouest des Yvelines. Tissu de TPE artisans, PME agricoles et de services, commerces de centre-bourg, professions libérales et activités liées à la viticulture et au patrimoine local. Axion-IA y intervient pour tous types d'activités de la vallée de la Mauldre.",
  directAnswerFr:
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Maule : diagnostic adapté aux TPE artisans, PME agricoles et de services, commerces et professions libérales de la vallée de la Mauldre. ROI chiffré, Audit Flash 490 € HT.",
      en: "Audit IA à Maule : diagnostic adapté aux TPE artisans, PME agricoles et de services, commerces et professions libérales de la vallée de la Mauldre. ROI chiffré, Audit Flash 490 € HT.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Maule ?",
    ...
    },
    {
      ...
      a: "Oui, nos interventions IA sur site à Maule sont adaptées aux PME de services et entreprises locales. Vos équipes repartent autonomes sur les outils IA configurés pour leur métier.",
    },
    {
