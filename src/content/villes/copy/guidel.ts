...
// Guidel (56, Morbihan) — agglo Lorient, littoral, plages de Guidel-Plages.
...
export const GUIDEL_COPY: VilleCopy = {
  ...
  distancesEn:
    "Lorient centre à 20 min. Gare SNCF de Lorient (TGV Paris-Quimper) à 25 min. Paris-Montparnasse à 3 h en TGV direct. Aéroport Lorient Bretagne Sud à 15 min. Quimperlé à 20 min. Voie express RN 165 à 5 min.",
  topSectorsNaf: [
    "Tourisme balnéaire et hôtellerie-restauration",
    "Commerce de proximité",
    "Artisanat et BTP",
    "Nautisme et services littoraux",
    "Agriculture et services",
  ],
  servicesContext: {
    audit: {
      fr: "Audit IA à Guidel : diagnostic adapté aux TPE artisans, PME tourisme balnéaire et hôtellerie-restauration de Guidel-Plages, commerces, BTP, nautisme, agriculteurs. ROI chiffré, Audit Flash {{price:audit-flash|flat}}.",
      en: "Audit IA à Guidel : diagnostic adapté aux TPE artisans, PME tourisme balnéaire et hôtellerie-restauration de Guidel-Plages, commerces, BTP, nautisme, agriculteurs. ROI chiffré, Audit Flash {{price:audit-flash|flat}}.",
    },
    interventions: {
      ...
      en: "Interventions IA sur site à Guidel : formats adaptés hôtel-restaurant de plage, boutique de proximité, chantier BTP, exploitation agricole. Équipes formées à l'autonomie sur les outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Guidel : e-réservation hôtellerie balnéaire, CRM tourisme, yield management saisonnier, gestion stocks commerces, devis et planning BTP, traçabilité agricole.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Guidel et sur Lorient Agglomération ?",
    ...
    },
    {
      ...
      a: "L'Audit Flash démarre à {{price:audit-flash|flat}}. Tarifs publics consultables en ligne, adaptés aux TPE artisans et PME tourisme balnéaire de Guidel-Plages.",
    },
    {
      q: "Travaillez-vous avec les hôtels et restaurants de Guidel-Plages ?",
      a: "Oui, e-réservation, yield management saisonnier, marketing local, CRM clients, fidélisation, gestion avis Google, automatisation réseaux sociaux pour hôtels et restaurants littoraux.",
    },
    {
      q: "Accompagnez-vous les artisans BTP et acteurs du nautisme ?",
      a: "Oui, gestion devis, planning chantiers, suivi marges, maintenance prédictive, optimisation supply chain, e-commerce pour artisans BTP et professionnels du nautisme de Guidel.",
    },
    {
