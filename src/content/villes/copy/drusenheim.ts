...
// Drusenheim (67, Bas-Rhin) — Bords du Rhin, frontalier Allemagne, industrie pétrochimique et logistique.
...
export const DRUSENHEIM_COPY: VilleCopy = {
  ...
  pitchEn:
    "Drusenheim (67), commune de 5 388 habitants sur les bords du Rhin frontalier avec l'Allemagne, est un pôle industriel et logistique du nord-est Alsace. Plateforme industrielle pétrochimique et chimique. Tissu industrie chimique/pétrochimique, PME sous-traitants industriels, TPE artisans, logistique fluviale, commerces. Axion-IA y travaille avec les organisations du territoire.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Drusenheim (67). Nous accompagnons tous types d'activités : TPE/PME industries pétrochimique et chimique, sous-traitants industriels, logistique fluviale (port rhénan), artisans, commerçants et services aux entreprises transfrontaliers (Allemagne).",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Drusenheim (67). Nous accompagnons tous types d'activités : TPE/PME industries pétrochimique et chimique, sous-traitants industriels, logistique fluviale (port rhénan), artisans, commerçants et services aux entreprises transfrontaliers (Allemagne).",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Drusenheim et bords du Rhin ?",
      a: "Oui, Axion-IA intervient à Drusenheim et tout le nord-est Alsace rhénan (Gambsheim, Bischwiller, Soufflenheim, Roeschwoog). Consultants depuis Strasbourg (30 min) ou gare TER Drusenheim.",
    },
    {
      q: "Accompagnez-vous les industries chimique et pétrochimique ?",
      a: "Oui, maintenance prédictive équipements, classification incidents HSE, traçabilité production, agents conversationnels multilingue (DE/FR/EN), automatisation conformité réglementaire et reporting.",
    },
    {
      q: "Travaillez-vous avec les acteurs logistique fluviale ?",
