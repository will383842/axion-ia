...
// Melesse (35, Ille-et-Vilaine) — Nord Rennes, résidentielle.
...
export const MELESSE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Melesse (35), commune résidentielle au nord de Rennes en Ille-et-Vilaine, bénéficie de la dynamique de Rennes Métropole. Tissu TPE artisans, PME services, commerces de proximité, professions libérales et entreprises tertiaires. Axion-IA y travaille avec les organisations du territoire du nord rennais.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Melesse (35). Nous accompagnons TPE artisans, PME de services, commerçants, professions libérales et entreprises tertiaires du nord rennais. Audit sur place sur mesure, interventions sur site et coaching dirigeants.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Melesse (35). Nous accompagnons TPE artisans, PME de services, commerçants, professions libérales et entreprises tertiaires du nord rennais. Audit sur place sur mesure, interventions sur site et coaching dirigeants.",
  ...
  ecosystemEn:
    "Melesse est intégrée à Rennes Métropole (~460 000 hab) et profite de la dynamique économique rennaise (numérique, cybersécurité, agroalimentaire). Commune résidentielle attractive avec tissu TPE artisans, PME de services aux entreprises, commerces de proximité et professions libérales. Proximité immédiate de la zone nord de Rennes (La Chapelle-des-Fougeretz, Pacé, Betton).",
  distancesFr:
    "Rennes centre à 15 min (N137). Gare TGV Rennes à 20 min (Paris en 1h27). Aéroport Rennes-Saint-Jacques à 25 min. Betton à 5 min, Pacé à 10 min, Saint-Grégoire à 10 min.",
  distancesEn:
    "Rennes centre à 15 min (N137). Gare TGV Rennes à 20 min (Paris en 1h27). Aéroport Rennes-Saint-Jacques à 25 min. Betton à 5 min, Pacé à 10 min, Saint-Grégoire à 10 min.",
  topSectorsNaf: [
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Melesse : formations adaptées TPE/PME, ateliers pratiques outils IA métier. Vos équipes repartent autonomes, formats demi-journée ou journée complète.",
    },
    implementation: {
      fr: "Implémentation IA à Melesse : automatisation devis artisans, agents conversationnels commerce, classification documents professions libérales, optimisation planning PME services nord rennais.",
      en: "Implémentation IA à Melesse : automatisation devis artisans, agents conversationnels commerce, classification documents professions libérales, optimisation planning PME services nord rennais.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Melesse : sessions en visio ou dans vos locaux nord Rennes. Dirigeants TPE artisans, gérants PME services, professions libérales souhaitant intégrer l'IA au quotidien.",
      en: "Coaching 1-to-1 à Melesse : sessions en visio ou dans vos locaux nord Rennes. Dirigeants TPE artisans, gérants PME services, professions libérales souhaitant intégrer l'IA au quotidien.",
    },
  },
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Melesse et dans le nord rennais ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les TPE artisans BTP, commerçants et indépendants de Melesse. Cas typiques : automatisation devis, agents IA prise de rendez-vous, gestion stocks, classification photos chantiers.",
    },
    {
