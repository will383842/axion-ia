...
// Mézidon Vallée d'Auge (14, Calvados) — Commune nouvelle, Pays d'Auge, nœud ferroviaire.
...
export const MEZIDON_VALLEE_D_AUGE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Mézidon Vallée d'Auge : diagnostic adapté aux PME agroalimentaires Pays d'Auge (fromages AOP, cidreries), exploitations agricoles, TPE artisans et commerçants. ROI chiffré, audit Flash 490 € HT.",
      en: "Audit IA à Mézidon Vallée d'Auge : diagnostic adapté aux PME agroalimentaires Pays d'Auge (fromages AOP, cidreries), exploitations agricoles, TPE artisans et commerçants. ROI chiffré, audit Flash 490 € HT.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Mézidon Vallée d'Auge et dans le Pays d'Auge ?",
      a: "Oui, Axion-IA intervient à Mézidon Vallée d'Auge et tout le Pays d'Auge (Saint-Pierre-en-Auge, Livarot, Pont-l'Évêque, Lisieux). Consultants depuis Caen (30 min N13) ou via gare SNCF Mézidon.",
    },
    {
      q: "Accompagnez-vous les fromageries et cidreries AOP du Pays d'Auge ?",
      a: "Oui, nous accompagnons les PME agroalimentaires du Pays d'Auge sur leurs cas IA : traçabilité AOP (Camembert, Pont-l'Évêque, Livarot), prédiction qualité affinage, automatisation supply chain, gestion stocks saisonniers.",
    },
    {
    ...
    {
      q: "Quel est le tarif d'un audit IA à Mézidon Vallée d'Auge ?",
