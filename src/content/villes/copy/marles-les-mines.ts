...
// Marles-les-Mines (62, Pas-de-Calais) — Bassin minier, 5 411 hab.
...
export const MARLES_LES_MINES_COPY: VilleCopy = {
  ...
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient a Marles-les-Mines (62). Nous accompagnons les TPE, PME et ETI du bassin minier bethunois : artisans, commercants, prestataires de services et petits industriels. Audit sur place a partir de {{price:audit-flash|flat}}.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient a Marles-les-Mines (62). Nous accompagnons les TPE, PME et ETI du bassin minier bethunois : artisans, commercants, prestataires de services et petits industriels. Audit sur place a partir de {{price:audit-flash|flat}}.",
  ecosystemFr:
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site a Marles-les-Mines : formations adaptees aux ateliers artisanaux, commerces, cabinets de sante et bureaux PME. Equipes autonomes sur outils IA.",
    },
    implementation: {
      fr: "Implementation IA a Marles-les-Mines : automatisation gestion artisanale, agents conversationnels commerce, CRM augmentes pour PME du bassin minier.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il a Marles-les-Mines et dans le bassin minier ?",
    ...
    },
    {
      ...
      a: "Oui, toutes nos interventions a Marles-les-Mines sont conformes au RGPD. Protection des donnees de votre entreprise et de vos clients garantie contractuellement.",
    },
  ],
};
