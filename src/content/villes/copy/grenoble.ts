...
export const GRENOBLE_COPY: VilleCopy = {
  ...
  directAnswerFr:
    "Axion-IA est un cabinet IA opérationnel qui intervient à Grenoble (38) sur site, couvrant la ville et le bassin grenoblois (Meylan, Échirolles, Saint-Martin-d'Hères, Inovallée). Nous accompagnons les TPE tech et les spin-offs CEA/CNRS, les PME industrielles et de services, les ETI deep-tech (Soitec, Poma, Petzl et leurs sous-traitants) ainsi que les grands groupes (STMicroelectronics, Schneider Electric, Atos) sur leurs chantiers IA opérationnels — diagnostic chiffré, démos sur vos vraies données, plan d'action béton. Aucun lock-in technologique, vos équipes gardent la main.",
  directAnswerEn:
    "Axion-IA is an operational AI consultancy that intervenes in Grenoble (38) on site, covering the city and the Grenoble basin (Meylan, Échirolles, Saint-Martin-d'Hères, Inovallée). We support deep-tech micro-businesses and CEA/CNRS spin-offs, industrial and services SMEs, deep-tech mid-caps (Soitec, Poma, Petzl and their supply chains) plus large groups (STMicroelectronics, Schneider Electric, Atos) on their operational AI initiatives — costed diagnosis, demos on your real data, concrete action plan. No tech lock-in, your teams stay in control.",
