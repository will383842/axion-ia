...
export const BINIC_ETABLES_SUR_MER_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'audit Flash démarre à 490 € HT, accessible aux TPE. Pour les PME hôtelières et touristiques, les audits Stratégiques et implémentations sont dimensionnés selon vos effectifs et cas d'usage. Tarifs publics, transparents, sans engagement longue durée.",
    },
    {
