...
// Coublevie (38, Isère) — Pays voironnais, banlieue résidentielle Voiron, Chartreuse périphérique.

import type { VilleCopy } from "./types";

export const COUBLEVIE_COPY: VilleCopy = {
  pitchFr:
  ...
  ecosystemEn:
    "Coublevie est intégrée à la communauté d'agglomération du Pays voironnais (~93 000 hab), positionnée en banlieue résidentielle de Voiron. Position pied du massif de la Chartreuse. Tissu péri-urbain : PME tertiaires, TPE artisanat BTP, commerces de proximité, professions libérales installées, agriculture résiduelle.",
  distancesFr:
    "Voiron centre à 5 min. Gare Voiron à 10 min (TER Grenoble-Lyon). Grenoble centre à 30 min A48. Lyon centre à 1h A48. Aéroport Lyon-Saint-Exupéry à 1h. Chartreuse stations 30 min.",
  distancesEn:
    "Voiron centre à 5 min. Gare Voiron à 10 min (TER Grenoble-Lyon). Grenoble centre à 30 min A48. Lyon centre à 1h A48. Aéroport Lyon-Saint-Exupéry à 1h. Chartreuse stations 30 min.",
  topSectorsNaf: [
    "PME tertiaires Pays voironnais",
    "TPE artisanat BTP",
    "Professions libérales (santé, juridique)",
    "Commerce de proximité",
    "Agriculture résiduelle Chartreuse périphérique",
  ],
  servicesContext: {
    audit: {
    ...
    implementation: {
      ...
      en: "Implémentation IA à Coublevie : agents conversationnels client/patient, automatisation devis BTP, classification dossiers, CRM augmentés. Tissu péri-urbain Voironnais.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Coublevie : sessions dans votre cabinet, atelier, commerce ou en visio. Médecins, avocats, artisans, gérants TPE/PME coublevitaines souhaitant intégrer l'IA.",
      en: "Coaching 1-to-1 à Coublevie : sessions dans votre cabinet, atelier, commerce ou en visio. Médecins, avocats, artisans, gérants TPE/PME coublevitaines souhaitant intégrer l'IA.",
    },
  },
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Coublevie et Pays voironnais ?",
      a: "Oui, Axion-IA intervient à Coublevie et tout le Pays voironnais (Voiron, La Buisse, Moirans, Tullins, Rives). Nos consultants viennent de Lyon (1h A48) ou Grenoble (30 min A48).",
    },
    {
      q: "Accompagnez-vous les professions libérales du Voironnais ?",
      a: "Oui, nous accompagnons les professions libérales à Coublevie (médecins, avocats, expert-comptables) sur des cas IA respectueux du secret professionnel : agents conversationnels patients/clients, automatisation gestion RDV, classification dossiers. RGPD strict.",
    },
    {
      q: "Travaillez-vous avec les TPE artisans coublevitains ?",
      a: "Oui, nous accompagnons les TPE artisans BTP à Coublevie sur des cas IA pratiques : automatisation devis chantier, agents IA prise de RDV, classification photos chantier, gestion stocks. Audit Flash 490 € HT adapté.",
    },
    {
      q: "Quels services pour les PME tertiaires et commerces ?",
      a: "Pour les PME tertiaires et commerces à Coublevie, audit Flash 490 € HT, intervention 1 journée formation, coaching 1-to-1. Cas typiques : agents IA fidélité client, automatisation workflow, classification documents.",
    },
    {
