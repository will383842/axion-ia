...
// Divatte-sur-Loire (44, Loire-Atlantique) — Commune nouvelle, vignoble.
...
export const DIVATTE_SUR_LOIRE_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Divatte-sur-Loire et vignoble nantais ?",
      a: "Oui, Axion-IA intervient à Divatte-sur-Loire et tout le vignoble nantais est (Vallet, Le Loroux-Bottereau, La Chapelle-Heulin). Consultants depuis Nantes (25 min). Couverture complète Loire-Atlantique est.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants se déplacent directement dans votre domaine, exploitation ou bureau à Divatte-sur-Loire. Depuis Nantes, 25 min de trajet. Formats demi-journée ou journée complète.",
    },
  ],
};
