...
export const BAGNOLET_COPY: VilleCopy = {
  pitchFr:
    "Axion-IA, cabinet d'experts IA seniors, accompagne les TPE et PME de Bagnolet, commune de Seine-Saint-Denis aux portes est de Paris, reliée par la ligne 3 et le périphérique (porte de Bagnolet). Services aux entreprises, industries créatives, commerce, BTP et logistique urbaine : nous transformons l'IA en gains concrets, sans jargon ni dépendance technique.",
  pitchEn:
    "Axion-IA, cabinet d'experts IA seniors, accompagne les TPE et PME de Bagnolet, commune de Seine-Saint-Denis aux portes est de Paris, reliée par la ligne 3 et le périphérique (porte de Bagnolet). Services aux entreprises, industries créatives, commerce, BTP et logistique urbaine : nous transformons l'IA en gains concrets, sans jargon ni dépendance technique.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Bagnolet auprès des TPE et PME en priorité, des PME ensuite. Nous ciblons le tissu urbain de l'est parisien : services aux entreprises, industries créatives et audiovisuel, commerce, BTP et logistique urbaine. Audit sur place sur mesure avec ROI chiffré, puis interventions sur site, vos équipes restant autonomes.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Bagnolet auprès des TPE et PME en priorité, des PME ensuite. Nous ciblons le tissu urbain de l'est parisien : services aux entreprises, industries créatives et audiovisuel, commerce, BTP et logistique urbaine. Audit sur place sur mesure avec ROI chiffré, puis interventions sur site, vos équipes restant autonomes.",
