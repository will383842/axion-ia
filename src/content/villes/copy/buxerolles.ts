...
// Buxerolles (86, Vienne) — Agglo Poitiers nord, commune résidentielle périurbaine.
...
export const BUXEROLLES_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Buxerolles : formats adaptés aux cabinets libéraux, commerces, PME tertiaires ou associations. Vos équipes administratives et terrain repartent autonomes sur outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Buxerolles : agents conversationnels patients/clients, automatisation gestion RDV cabinets, classification dossiers, CRM augmenté PME tertiaires. Agglo Grand Poitiers nord.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Buxerolles et Grand Poitiers ?",
      a: "Oui, Axion-IA intervient à Buxerolles et toute l'agglomération Grand Poitiers (Poitiers centre à 10 min, Saint-Benoît, Migné-Auxances, Vouneuil-sous-Biard, Chasseneuil-du-Poitou). Consultants depuis Paris (TGV 1h40 gare Poitiers).",
    },
    {
      q: "Accompagnez-vous les professions libérales à Buxerolles ?",
      a: "Oui, nous accompagnons les professions libérales à Buxerolles (médecins, avocats, experts-comptables, kinés) sur leurs cas IA : agents conversationnels patients/clients, automatisation gestion RDV, classification dossiers, dictée IA rapports. Audit sur place {{price:audit-flash|flat}} adapté.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants viennent de Paris en TGV direct (1h40 gare Poitiers, puis 10 min Buxerolles). Pour les multi-jours, hébergement Poitiers centre. Frais de déplacement (TGV, repas, hébergement) facturés à part du forfait, tarifs publics.",
    },
  ],
};
