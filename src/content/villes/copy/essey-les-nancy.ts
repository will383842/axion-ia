...
// Essey-lès-Nancy (54, Meurthe-et-Moselle) — Est Nancy, centre commercial Saint-Sébastien.
...
export const ESSEY_LES_NANCY_COPY: VilleCopy = {
  ...
  pitchEn:
    "Essey-lès-Nancy (54), commune de Meurthe-et-Moselle à l'est de Nancy, est intégrée à la Métropole du Grand Nancy avec un pôle commercial structurant (zone Saint-Sébastien) et un tissu tertiaire dynamique. TPE et PME tertiaires, commerces de zone et de proximité, services aux entreprises, artisanat BTP, professions libérales. Axion-IA y conduit ses missions auprès des entreprises locales.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Essey-lès-Nancy (54). Nous accompagnons TPE et PME : commerçants de la zone Saint-Sébastien, sociétés tertiaires de l'est nancéien, artisans BTP, services aux entreprises, professions libérales. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Essey-lès-Nancy (54). Nous accompagnons TPE et PME : commerçants de la zone Saint-Sébastien, sociétés tertiaires de l'est nancéien, artisans BTP, services aux entreprises, professions libérales. Audit sur place sur mesure.",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Essey-lès-Nancy : formats adaptés au commerce de zone, bureau tertiaire, atelier BTP, cabinet libéral. Vos équipes repartent autonomes sur les outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Essey-lès-Nancy : agents conversationnels retail zone Saint-Sébastien, automatisation workflow tertiaire, CRM augmenté, devis intelligents BTP, gestion documentaire professions libérales.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Essey-lès-Nancy et zone Saint-Sébastien ?",
      a: "Oui, Axion-IA intervient à Essey-lès-Nancy et toute la Métropole du Grand Nancy, y compris la zone commerciale Saint-Sébastien. Consultants depuis Metz (50 min) ou Paris (1 h 30 via TGV).",
    },
    {
