...
export const HAZEBROUCK_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'Audit Flash démarre à {{price:intervention-4h|flat}} pour une TPE. Pour les PME services ou structures de santé, audit approfondi entre 1 900 et {{price:audit-cible-avance}}. Tarifs publics consultables.",
    },
    {
