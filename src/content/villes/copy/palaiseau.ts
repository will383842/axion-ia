...
export const PALAISEAU_COPY: VilleCopy = {
  ...
  pitchEn:
    "Palaiseau, sous-préfecture de l'Essonne de 37 471 habitants située à environ 18 km au sud-ouest de Paris, est un pôle scientifique et technologique majeur du cluster Paris-Saclay. La commune accueille l'École polytechnique, Télécom Paris, l'ENSTA Paris ainsi que des centres de recherche d'Onera, du CEA et de Danone. Axion-IA y accompagne en priorité les TPE et PME locales — startups deeptech, cabinets, sous-traitants industriels — dans l'intégration concrète de l'IA opérationnelle, en code custom et sans no-code.",
  directAnswerFr:
    "À Palaiseau, Axion-IA intervient sur site auprès des TPE et PME de l'écosystème Paris-Saclay, autour des grandes écoles (École polytechnique, Télécom Paris, ENSTA Paris) et des centres de recherche (Onera, CEA, Danone). Nos missions couvrent l'audit Flash 4 heures (à partir de 490 € HT), les interventions ponctuelles à partir de 590 € HT, l'implémentation clé en main et le coaching dirigeant — toujours en code custom Python/TypeScript, jamais en no-code. Williams se déplace depuis Paris via le RER B (Palaiseau, Palaiseau-Villebon, Lozère).",
  directAnswerEn:
    "À Palaiseau, Axion-IA intervient sur site auprès des TPE et PME de l'écosystème Paris-Saclay, autour des grandes écoles (École polytechnique, Télécom Paris, ENSTA Paris) et des centres de recherche (Onera, CEA, Danone). Nos missions couvrent l'audit Flash 4 heures (à partir de 490 € HT), les interventions ponctuelles à partir de 590 € HT, l'implémentation clé en main et le coaching dirigeant — toujours en code custom Python/TypeScript, jamais en no-code. Williams se déplace depuis Paris via le RER B (Palaiseau, Palaiseau-Villebon, Lozère).",
