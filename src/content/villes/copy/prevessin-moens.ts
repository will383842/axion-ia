...
// Prévessin-Moëns (01, Ain) — pays de Gex, frontière suisse, proximité CERN, économie frontalière.
...
export const PREVESSIN_MOENS_COPY: VilleCopy = {
  ...
  pitchEn:
    "Prévessin-Moëns (01), commune du pays de Gex dans l'Ain, est positionnée à la frontière suisse avec proximité immédiate du CERN (site principal Meyrin/Prévessin). Tissu économie frontalière dynamique, PME tertiaires et technologiques, TPE artisans BTP, commerces. Axion-IA opère pour entreprises et indépendants du secteur.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Prévessin-Moëns (01). Nous accompagnons tous types d'activités : PME technologiques (proximité CERN site Prévessin), économie frontalière Genève, TPE artisans BTP, commerçants et services aux entreprises pays de Gex.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Prévessin-Moëns (01). Nous accompagnons tous types d'activités : PME technologiques (proximité CERN site Prévessin), économie frontalière Genève, TPE artisans BTP, commerçants et services aux entreprises pays de Gex.",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Prévessin-Moëns : formats adaptés au bureau tech, commerce transfrontalier, atelier. Vos équipes repartent autonomes sur outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Prévessin-Moëns : agents conversationnels multilingue FR/EN/DE (économie frontalière CERN/Genève), automatisation workflow R&D, classification documents scientifiques.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Prévessin-Moëns et pays de Gex ?",
      a: "Oui, Axion-IA intervient à Prévessin-Moëns et tout le pays de Gex (Saint-Genis-Pouilly à 5 min, Ferney-Voltaire, Gex, Divonne). Genève à 15 min.",
    },
    {
      q: "Travaillez-vous avec les PME technologiques CERN ?",
      a: "Oui, agents conversationnels multilingue FR/EN/DE, automatisation workflow R&D, classification documents scientifiques, RAG sur bases documentaires.",
    },
    {
      q: "Accompagnez-vous l'économie frontalière ?",
