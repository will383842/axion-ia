...
export const ALBI_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Auditer un commerce, cabinet ou atelier d'Albi pour identifier les automatisations IA prioritaires — dès 490 € HT.",
      en: "Auditer un commerce, cabinet ou atelier d'Albi pour identifier les automatisations IA prioritaires — dès 490 € HT.",
    },
    interventions: {
    ...
    unAUn: {
      fr: "Accompagner en sessions individuelles les dirigeants de TPE/PME albigeoises pour une adoption IA progressive — dès 990 € HT.",
      en: "Accompagner en sessions individuelles les dirigeants de TPE/PME albigeoises pour une adoption IA progressive — dès 990 € HT.",
    },
  },
  faqGeolocalisee: [
    {
      q: "Quels sont les tarifs Axion-IA pour une intervention à Albi ?",
      a: "Nos audits flash débutent à 490 € HT et nos interventions essentielles à partir de 590 € HT. Les sessions 1-to-1 démarrent à 990 € HT. Tarifs publics consultables sur notre site.",
    },
    {
