...
export const CLERMONT_COPY: VilleCopy = {
  ...
  pitchEn:
    "Clermont (60), commune de 10 564 habitants dans l'Oise, est une sous-préfecture historique dominée par son donjon médiéval. Carrefour administratif et commercial du Clermontois, la ville concentre un tissu de TPE/PME services publics, commerce, artisanat, santé et services aux entreprises. Axion-IA y mène ses missions auprès des organisations locales.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Clermont (60). Nous accompagnons TPE et PME du Clermontois : commerçants, artisans, professionnels de santé, prestataires de services et acteurs du secteur public local. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Clermont (60). Nous accompagnons TPE et PME du Clermontois : commerçants, artisans, professionnels de santé, prestataires de services et acteurs du secteur public local. Audit sur place sur mesure.",
  ecosystemFr:
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Clermont : sessions dans votre commerce, cabinet, atelier ou en visio. Dirigeants TPE/PME du Clermontois souhaitant maîtriser l'IA appliquée à leur métier.",
      en: "Coaching 1-to-1 à Clermont : sessions dans votre commerce, cabinet, atelier ou en visio. Dirigeants TPE/PME du Clermontois souhaitant maîtriser l'IA appliquée à leur métier.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les TPE/PME commerce et artisanat du Clermontois. Cas IA typiques : gestion stocks automatisée, optimisation planning, facturation et comptabilité, marketing digital, OCR documents et analyse clientèle.",
    },
    {
