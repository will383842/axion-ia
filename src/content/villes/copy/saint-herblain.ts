...
export const SAINT_HERBLAIN_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit Flash 4 h à Saint-Herblain ({{price:audit-flash|flat}}) pour cartographier les automatisations IA prioritaires des TPE et PME du périphérique nantais et du pôle Atlantis.",
      en: "Audit Flash 4 h à Saint-Herblain ({{price:audit-flash|flat}}) pour cartographier les automatisations IA prioritaires des TPE et PME du périphérique nantais et du pôle Atlantis.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Audit Flash 4 h à {{price:audit-flash|flat}}, intervention sur site à {{price:intervention-4h|flat}}, implémentation à {{price:intervention-dirigeants|flat}}, accompagnement 1-to-1 à {{price:intervention-dirigeants|flat}}. Tarifs publics fixes, sans abonnement no-code additionnel.",
    },
    {
      q: "Quels délais pour intervenir à Saint-Herblain ?",
      a: "Déplacement sur site sous cinq jours ouvrés, Audit Flash livré en 4 heures, implémentations courantes (devis, factures, reporting) déployées en deux à trois semaines.",
    },
    {
