...
export const PLOUFRAGAN_COPY: VilleCopy = {
  ...
  pitchEn:
    "Ploufragan (22), commune de l'agglomération de Saint-Brieuc abritant le Zoopôle, pôle d'excellence agroalimentaire et vétérinaire des Côtes-d'Armor. Tissu de TPE et PME agroalimentaires, laboratoires, entreprises de services, artisans et professions libérales. Axion-IA opère pour toutes les structures économiques de la commune de l'agglo briochine.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Ploufragan (22). Nous accompagnons TPE et PME : entreprises agroalimentaires, laboratoires du Zoopôle, artisans, PME de services et professions libérales de l'agglomération de Saint-Brieuc. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Ploufragan (22). Nous accompagnons TPE et PME : entreprises agroalimentaires, laboratoires du Zoopôle, artisans, PME de services et professions libérales de l'agglomération de Saint-Brieuc. Audit sur place sur mesure.",
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'Audit sur place IA à Ploufragan démarre à {{price:audit-flash|flat}} pour 4 heures de diagnostic. Il couvre l'analyse de vos processus métier, l'identification des cas d'usage IA prioritaires et un plan d'action chiffré avec ROI estimé.",
    },
    {
