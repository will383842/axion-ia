...
// Verneuil d'Avre et d'Iton (27, Eure) — Commune nouvelle, patrimoine médiéval, Perche.
...
export const VERNEUIL_D_AVRE_ET_D_ITON_COPY: VilleCopy = {
  ...
  pitchEn:
    "Verneuil d'Avre et d'Iton (27), commune nouvelle de l'Eure aux confins du Perche et du Pays d'Ouche, riche patrimoine médiéval (tour de la Madeleine, maisons à pans de bois). Tissu TPE artisans, PME agriculture et élevage, commerces, services aux entreprises. Axion-IA couvre les activités professionnelles du bassin.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Verneuil d'Avre et d'Iton (27). Nous accompagnons tous types d'activités : TPE artisans, PME agriculture et élevage Perche-Ouche, commerces centre médiéval, professions libérales, indépendants et services aux entreprises du sud de l'Eure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Verneuil d'Avre et d'Iton (27). Nous accompagnons tous types d'activités : TPE artisans, PME agriculture et élevage Perche-Ouche, commerces centre médiéval, professions libérales, indépendants et services aux entreprises du sud de l'Eure.",
  ...
  ecosystemEn:
    "Verneuil d'Avre et d'Iton est une commune nouvelle de l'Eure issue de la fusion de Verneuil-sur-Avre et communes voisines, aux confins du Perche et du Pays d'Ouche. Riche patrimoine médiéval (tour de la Madeleine, église Notre-Dame, maisons à colombages). Économie portée par l'agriculture, l'élevage, l'artisanat, les commerces et les services.",
  distancesFr:
    "Gare Verneuil-sur-Avre (ligne Paris-Granville). Paris à 1h30 train. Évreux à 35 min. Dreux à 30 min. Chartres à 50 min. L'Aigle à 20 min.",
  distancesEn:
    "Gare Verneuil-sur-Avre (ligne Paris-Granville). Paris à 1h30 train. Évreux à 35 min. Dreux à 30 min. Chartres à 50 min. L'Aigle à 20 min.",
  topSectorsNaf: [
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Verneuil d'Avre et d'Iton : formats adaptés à l'exploitation agricole, l'atelier, le commerce, le cabinet. Vos équipes repartent autonomes sur outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Verneuil d'Avre et d'Iton : agriculture de précision Perche, traçabilité élevage, catalogage patrimoine, automatisation comptabilité. Commune nouvelle sud Eure.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Verneuil d'Avre et d'Iton et dans le sud de l'Eure ?",
      a: "Oui, Axion-IA intervient à Verneuil d'Avre et d'Iton et dans tout le sud de l'Eure (L'Aigle, Breteuil, Rugles, Conches-en-Ouche). Nos consultants se déplacent depuis Paris (1h30 train) ou Évreux (35 min).",
    },
    {
      q: "Travaillez-vous avec les exploitants agricoles et éleveurs du Perche ?",
      a: "Oui, nous accompagnons les exploitants agricoles et éleveurs du Perche normand sur leurs cas IA : agriculture de précision, prédiction rendements, surveillance troupeaux, traçabilité viande et lait, optimisation intrants.",
    },
    {
      q: "Accompagnez-vous les artisans de la rénovation du patrimoine bâti ?",
