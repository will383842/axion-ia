...
// Saint-Égrève (38, Isère) — nord-ouest Grenoble, massif Chartreuse, hôpital psychiatrique CHAI, label Ville internet 5@.
...
export const SAINT_EGREVE_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Saint-Égrève : formats adaptés à l'environnement médical (CHAI, cabinets), atelier artisan ou bureau PME. Vos équipes repartent avec outils IA configurés métier réel.",
    },
    implementation: {
      fr: "Implémentation IA à Saint-Égrève : agents conversationnels patients (santé), automatisation gestion RDV médicaux, classification dossiers, transcription consultations, CRM augmentés. RGPD-santé strict.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Égrève et nord-ouest grenoblois ?",
      a: "Oui, Axion-IA intervient à Saint-Égrève et tout le nord-ouest grenoblois (Fontaine, Sassenage, Le Fontanil-Cornillon, Voreppe). Couverture Grenoble-Alpes Métropole (« La Métro ») et accès via tramway E ou A48 vers Lyon.",
    },
    {
      q: "Travaillez-vous avec le Centre hospitalier Alpes-Isère (CHAI) ?",
    ...
    },
    {
      ...
      a: "Pour les PME tertiaires de l'agglomération Grenoble-Alpes Métropole, nous proposons les 5 services Axion-IA : audit IA (Sur place à Stratégique), interventions sur site, implémentation IA (agents, automatisations), coaching 1-to-1 dirigeants, et plateformes web/SaaS IA sur mesure.",
    },
    {
