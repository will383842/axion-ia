...
// Saint-Denis-lès-Bourg (01, Ain) — banlieue ouest de Bourg-en-Bresse, Bresse, périurbain volaille AOP & plasturgie.
...
export const SAINT_DENIS_LES_BOURG_COPY: VilleCopy = {
  ...
  distancesEn:
    "Bourg-en-Bresse centre à 5 min. Gare de Bourg-en-Bresse à 10 min (Paris en 2h env. via TGV Mâcon). Lyon centre à 1h par l'A40/A42. Aéroport Lyon-Saint-Exupéry à 50 min.",
  topSectorsNaf: [
    "Agriculture & élevage (filière volaille de Bresse AOP)",
    "Artisanat & BTP de proximité",
    "PME tertiaires & services aux entreprises (agglo burgienne)",
    "Sous-traitance agroalimentaire & plasturgie",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Saint-Denis-lès-Bourg : ateliers pratiques pour l'exploitation, le bureau, l'atelier ou le commerce. Vos collaborateurs sont autonomes ensuite.",
    },
    implementation: {
      fr: "Implémentation IA à Saint-Denis-lès-Bourg : traçabilité AOP, classification de photos d'élevage et de cultures, automatisation de workflow, agents conversationnels B2B et CRM augmentés en Bresse.",
    ...
    sitesWeb: {
      ...
      en: "Sites web augmentés à Saint-Denis-lès-Bourg : vitrines de producteurs AOP, portails de PME tertiaires et sites artisans enrichis d'IA — fiches produits, devis en ligne, qualification de leads.",
    },
  },
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Denis-lès-Bourg ?",
      a: "Oui, Axion-IA intervient à Saint-Denis-lès-Bourg et dans toute l'agglomération burgienne (Bourg-en-Bresse à 5 min, Viriat, Péronnas). Nos consultants viennent de Lyon (1h) ou animent les sessions en visio.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui. Pour les PME de services et sous-traitantes (agroalimentaire, plasturgie), nous mettons en place agents conversationnels B2B, automatisation de workflow, classification documentaire et CRM augmentés.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants viennent de Lyon (1h, A40/A42), la gare de Bourg est à 10 min (Paris 2h). L'intervention dure au moins une journée, sous forme d'atelier pratique dans vos locaux, pour rendre vos équipes autonomes.",
    },
    {
      q: "Axion-IA respecte-t-il le RGPD lors de ses interventions ?",
      a: "Oui, toutes nos interventions à Saint-Denis-lès-Bourg sont conformes au RGPD : minimisation des données, hébergement maîtrisé et absence de dépendance bloquante aux outils déployés.",
    },
  ],
};
