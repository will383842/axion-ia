...
// Le Mesnil-Esnard (76, Seine-Maritime) — Agglo Rouen est, residentielle, 8 177 hab.
...
export const LE_MESNIL_ESNARD_COPY: VilleCopy = {
  ...
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient au Mesnil-Esnard (76). Nous accompagnons les TPE, PME et professions liberales de l'agglo rouennaise est : medecins, avocats, commercants, artisans et prestataires de services. Audit Flash a partir de 490 EUR HT.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient au Mesnil-Esnard (76). Nous accompagnons les TPE, PME et professions liberales de l'agglo rouennaise est : medecins, avocats, commercants, artisans et prestataires de services. Audit Flash a partir de 490 EUR HT.",
  ecosystemFr:
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA au Mesnil-Esnard : diagnostic adapte aux professions liberales, TPE de services et commercants de l'agglo rouennaise est. ROI chiffre, audit Flash 490 EUR HT.",
      en: "Audit IA au Mesnil-Esnard : diagnostic adapte aux professions liberales, TPE de services et commercants de l'agglo rouennaise est. ROI chiffre, audit Flash 490 EUR HT.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il au Mesnil-Esnard et dans l'agglo de Rouen ?",
      a: "Oui, Axion-IA intervient au Mesnil-Esnard et dans toute la metropole rouennaise (Rouen, Bonsecours, Darnetal, Franqueville-Saint-Pierre). Consultants depuis Rouen (10 min) ou Paris (1h25).",
    },
    {
      q: "Quels services IA pour les professions liberales du Mesnil-Esnard ?",
    ...
    {
      q: "Quel est le tarif d'un audit IA au Mesnil-Esnard ?",
    ...
    },
    {
      ...
      a: "Oui, toutes nos interventions au Mesnil-Esnard sont conformes au RGPD. Protection des donnees de votre cabinet/entreprise et de vos clients/patients garantie contractuellement.",
    },
  ],
};
