...
// Le Rheu (35, Ille-et-Vilaine) — ouest Rennes, résidentielle.
...
export const LE_RHEU_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Le Rheu est une commune résidentielle à l'ouest immédiat de Rennes, intégrée à Rennes Métropole. En forte croissance démographique, elle accueille un tissu de PME tertiaires et services, TPE artisanat BTP dynamiques (construction pavillonnaire), commerces de proximité, professions libérales et agriculture résiduelle. Accès rocade ouest, proximité campus universitaire de Villejean et centre INRAE de Rennes.",
  distancesFr:
    "Rennes centre à 15 min. Gare de Rennes à 20 min (TGV Paris 1h25). Aéroport Rennes-Bretagne à 15 min. Rocade ouest de Rennes. Mordelles à 10 min. L'Hermitage à 5 min.",
  distancesEn:
    "Rennes centre à 15 min. Gare de Rennes à 20 min (TGV Paris 1h25). Aéroport Rennes-Bretagne à 15 min. Rocade ouest de Rennes. Mordelles à 10 min. L'Hermitage à 5 min.",
  topSectorsNaf: [
    "PME tertiaires & services aux entreprises",
    "TPE artisanat BTP & construction pavillonnaire",
    "Commerce de proximité",
    "Professions libérales (santé, conseil)",
    "Agriculture & agroalimentaire résiduel",
  ],
  servicesContext: {
    audit: {
      fr: "Audit IA au Rheu : diagnostic adapté aux PME tertiaires ouest rennais, TPE artisans BTP, commerçants et professions libérales. ROI chiffré, audit Flash 490 € HT.",
    ...
    implementation: {
      ...
      en: "Implémentation IA au Rheu : automatisation workflow tertiaire, agents conversationnels client, gestion devis BTP, CRM augmenté, outils IA professions libérales et gestion stocks commerce.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 au Rheu : sessions dans vos locaux, bureau ou en visio. Dirigeants TPE/PME ouest rennais souhaitant maîtriser l'IA dans leur activité tertiaire, artisanale ou commerciale.",
      en: "Coaching 1-to-1 au Rheu : sessions dans vos locaux, bureau ou en visio. Dirigeants TPE/PME ouest rennais souhaitant maîtriser l'IA dans leur activité tertiaire, artisanale ou commerciale.",
    },
  },
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il au Rheu ?",
      a: "Oui, Axion-IA intervient au Rheu et dans tout l'ouest de Rennes Métropole (Mordelles, L'Hermitage, Vezin-le-Coquet, Pacé). Nos consultants accèdent via rocade ouest (15 min depuis Rennes centre).",
    },
    {
      q: "Accompagnez-vous les PME tertiaires du Rheu ?",
      a: "Oui, nous accompagnons les PME tertiaires et services aux entreprises de l'ouest rennais sur leurs cas IA : automatisation workflow, agents conversationnels B2B, classification documents, CRM augmenté. Audit Flash 490 € HT pour démarrer.",
    },
    {
      q: "Quel est le tarif d'un audit IA au Rheu ?",
      a: "L'audit Flash Axion-IA démarre à 490 € HT pour 4 heures de diagnostic. Adapté aux TPE et PME de l'ouest rennais, il identifie les cas d'usage IA à fort ROI pour votre activité (tertiaire, BTP, commerce, professions libérales). Tarifs publics.",
    },
    {
      q: "Travaillez-vous avec les artisans BTP du Rheu ?",
      a: "Oui, nous accompagnons les TPE artisans BTP du Rheu et communes voisines sur leurs cas IA : automatisation devis, agents IA prise de RDV, classification photos chantier, suivi planning. Audit Flash 490 € HT.",
    },
    {
