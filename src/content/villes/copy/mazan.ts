...
export const MAZAN_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Mazan : diagnostic adapté aux TPE artisans, domaines viticoles AOC Ventoux, PME agroalimentaires et hébergements du Comtat. ROI chiffré, Audit Flash 490 € HT.",
    ...
    implementation: {
      ...
      en: "Implémentation IA à Mazan : traçabilité parcellaire AOC Ventoux, gestion vendanges et cave, automatisation devis artisans, fiches Google Business hébergements, gestion réservations oenotourisme. Adapté TPE/PME Comtat.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Mazan : sessions dans vos locaux ou en visio. Dirigeants TPE/PME viticulture, agriculture, agroalimentaire, hébergement et commerce du Comtat Venaissin.",
      en: "Coaching 1-to-1 à Mazan : sessions dans vos locaux ou en visio. Dirigeants TPE/PME viticulture, agriculture, agroalimentaire, hébergement et commerce du Comtat Venaissin.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    },
    {
      ...
      a: "Audit Flash 490 € HT, interventions sur site, coaching 1-to-1, implémentation IA. Cas viticulture AOC Ventoux : traçabilité parcellaire, gestion vendanges, optimisation cave, relation client B2B et oenotourisme, fiches Google Business.",
    },
    {
