...
export const JOUARS_PONTCHARTRAIN_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Jouars-Pontchartrain : diagnostic adapté aux TPE artisans, PME de services, commerces et professions libérales de la plaine de Versailles ouest. ROI chiffré, Audit Flash 490 € HT.",
      en: "Audit IA à Jouars-Pontchartrain : diagnostic adapté aux TPE artisans, PME de services, commerces et professions libérales de la plaine de Versailles ouest. ROI chiffré, Audit Flash 490 € HT.",
    },
    interventions: {
