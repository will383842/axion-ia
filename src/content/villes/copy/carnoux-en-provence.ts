...
// Carnoux-en-Provence (13, Bouches-du-Rhône) — est Marseille, commune résidentielle.
...
export const CARNOUX_EN_PROVENCE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Carnoux-en-Provence : diagnostic adapté aux professions libérales, TPE indépendants et commerçants de l'est marseillais. ROI chiffré, audit Flash {{price:audit-flash|flat}}.",
      en: "Audit IA à Carnoux-en-Provence : diagnostic adapté aux professions libérales, TPE indépendants et commerçants de l'est marseillais. ROI chiffré, audit Flash {{price:audit-flash|flat}}.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Carnoux-en-Provence ?",
    ...
    },
    {
      ...
      a: "L'audit Flash (4 heures, diagnostic + ROI chiffré) démarre à {{price:audit-flash|flat}}. Adapté aux professions libérales, TPE indépendants et commerçants carnousiens. Tarifs publics, sans engagement.",
    },
    {
      q: "Accompagnez-vous les professions libérales à Carnoux ?",
      a: "Oui, nous accompagnons avocats, médecins, consultants et professions libérales sur des cas IA concrets : rédaction assistée, automatisation gestion cabinet, classification dossiers, agents IA prise de RDV.",
    },
    {
      q: "Proposez-vous des sessions en visio pour les freelances ?",
      a: "Oui, nos interventions et coaching 1-to-1 sont disponibles en présentiel (vos locaux à Carnoux) ou en visio. Format flexible adapté aux indépendants et freelances en télétravail.",
    },
    {
