...
// Mulsanne (72, Sarthe) — Circuit 24h Le Mans, agglo.
...
export const MULSANNE_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Mulsanne fait partie de Le Mans Métropole (Sarthe). La célèbre ligne droite des Hunaudières traverse la commune (circuit des 24 Heures). Zones d'activités sud Le Mans, industries mécaniques, logistique, artisanat et commerces. Le Mans centre à 12 min.",
  distancesFr:
    "Le Mans centre à 12 min. Gare TGV Le Mans à 15 min. Paris à 55 min TGV depuis Le Mans. Tours à 1h A28. Autoroutes A11/A28 à 10 min.",
  distancesEn:
    "Le Mans centre à 12 min. Gare TGV Le Mans à 15 min. Paris à 55 min TGV depuis Le Mans. Tours à 1h A28. Autoroutes A11/A28 à 10 min.",
  topSectorsNaf: [
    "Industrie mécanique & automobile",
    "Logistique & entreposage sud Le Mans",
    "Artisanat & commerce de proximité",
    "Services aux entreprises agglo Le Mans",
    "Sport mécanique & événementiel",
  ],
  servicesContext: {
    audit: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Mulsanne et dans l'agglomération du Mans ?",
      a: "Oui, Axion-IA intervient à Mulsanne et dans toute l'agglomération du Mans. Le Mans centre est à 12 min. Déplacements sur site inclus dans le périmètre métropole.",
    },
    {
      q: "Quels services IA pour les PME industrielles de Mulsanne ?",
      a: "Audit sur place {{price:audit-flash|flat}}, interventions sur site, coaching 1-to-1, implémentation IA. Cas industrie : maintenance prédictive, contrôle qualité vision, automatisation logistique, optimisation chaîne production.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants sont accessibles depuis la gare TGV Le Mans (15 min de Mulsanne, Paris à 55 min TGV). Intervention sur site dans vos locaux industriels, entrepôts ou bureaux.",
    },
  ],
};
