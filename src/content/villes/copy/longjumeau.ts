...
// Longjumeau (91, Essonne) — vallée de l'Yvette, axe RN20, pôle santé et pharmacie, sud francilien.

import type { VilleCopy } from "./types";

export const LONGJUMEAU_COPY: VilleCopy = {
  pitchFr:
    "Longjumeau (91), dans l'Essonne, s'étire le long de l'historique RN20 dans la vallée de l'Yvette, à la croisée du sud francilien. La ville accueille un hôpital de référence, des laboratoires et grossistes pharmaceutiques, un commerce de proximité dense et des PME de services tournées vers le bassin d'emploi de Massy-Saclay. Axion-IA, cabinet d'architectes seniors en intelligence artificielle, y accompagne en priorité les TPE puis les PME pour automatiser l'administratif et fiabiliser la relation client, avec des solutions concrètes et un retour sur investissement mesurable.",
  pitchEn:
    "Longjumeau (91), dans l'Essonne, s'étire le long de l'historique RN20 dans la vallée de l'Yvette, à la croisée du sud francilien. La ville accueille un hôpital de référence, des laboratoires et grossistes pharmaceutiques, un commerce de proximité dense et des PME de services tournées vers le bassin d'emploi de Massy-Saclay. Axion-IA, cabinet d'architectes seniors en intelligence artificielle, y accompagne en priorité les TPE puis les PME pour automatiser l'administratif et fiabiliser la relation client, avec des solutions concrètes et un retour sur investissement mesurable.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Longjumeau (91, Essonne) et dans le sud francilien. Nous accompagnons en priorité les TPE et commerces de l'axe RN20, puis les PME de santé, de pharmacie et de services qui irriguent la vallée de l'Yvette. Notre méthode : un audit ciblé des tâches répétitives, des automatisations utiles déployées sur vos outils existants, et la formation de vos équipes. Les ETI restent une part marginale de notre clientèle.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Longjumeau (91, Essonne) et dans le sud francilien. Nous accompagnons en priorité les TPE et commerces de l'axe RN20, puis les PME de santé, de pharmacie et de services qui irriguent la vallée de l'Yvette. Notre méthode : un audit ciblé des tâches répétitives, des automatisations utiles déployées sur vos outils existants, et la formation de vos équipes. Les ETI restent une part marginale de notre clientèle.",
  seoHook: "santé, pharma & RN20",
  ecosystemFr:
    "Longjumeau s'inscrit dans la dynamique du sud francilien, entre Massy, Palaiseau et le plateau de Saclay. Son économie locale s'appuie sur un pôle santé marqué par l'hôpital et un tissu de laboratoires, répartiteurs et officines pharmaceutiques, complété par un commerce de détail le long de la RN20 et des PME de services et de logistique légère. Les TPE et petites PME y composent l'essentiel des employeurs, dirigées par des indépendants qui gèrent eux-mêmes facturation, prises de rendez-vous et relances clients.",
  ecosystemEn:
    "Longjumeau s'inscrit dans la dynamique du sud francilien, entre Massy, Palaiseau et le plateau de Saclay. Son économie locale s'appuie sur un pôle santé marqué par l'hôpital et un tissu de laboratoires, répartiteurs et officines pharmaceutiques, complété par un commerce de détail le long de la RN20 et des PME de services et de logistique légère. Les TPE et petites PME y composent l'essentiel des employeurs, dirigées par des indépendants qui gèrent eux-mêmes facturation, prises de rendez-vous et relances clients.",
  distancesFr:
    "Gare de Longjumeau (RER C) à proximité immédiate. Gare TGV de Massy à 10 km, aéroport de Paris-Orly à 15 km, plateau de Saclay à 15 min. Paris intra-muros à 20 km par la RN20 ou l'A6. Nos consultants se déplacent sur site depuis Paris, frais indiqués séparément.",
  distancesEn:
    "Gare de Longjumeau (RER C) à proximité immédiate. Gare TGV de Massy à 10 km, aéroport de Paris-Orly à 15 km, plateau de Saclay à 15 min. Paris intra-muros à 20 km par la RN20 ou l'A6. Nos consultants se déplacent sur site depuis Paris, frais indiqués séparément.",
  topSectorsNaf: [
    "Santé humaine et établissements hospitaliers",
    "Pharmacie, laboratoires et répartition",
    "Commerce de détail sur l'axe RN20",
    "Logistique légère et transport",
    "Services tertiaires aux entreprises",
  ],
  servicesContext: {
    audit: {
      fr: "Audit IA à Longjumeau : diagnostic sur site pour identifier les automatisations à fort retour dans une officine, un cabinet de santé ou une PME de services. Cartographie des tâches administratives et feuille de route chiffrée, dans le respect strict du RGPD pour les données de santé.",
      en: "Audit IA à Longjumeau : diagnostic sur site pour identifier les automatisations à fort retour dans une officine, un cabinet de santé ou une PME de services. Cartographie des tâches administratives et feuille de route chiffrée, dans le respect strict du RGPD pour les données de santé.",
    },
    interventions: {
      fr: "Interventions IA à Longjumeau : sessions opérationnelles adaptées au cabinet médical, à l'officine ou au bureau. Vos collaborateurs maîtrisent les outils déployés et gagnent en temps sur les tâches répétitives dès la première semaine.",
      en: "Interventions IA à Longjumeau : sessions opérationnelles adaptées au cabinet médical, à l'officine ou au bureau. Vos collaborateurs maîtrisent les outils déployés et gagnent en temps sur les tâches répétitives dès la première semaine.",
    },
    implementation: {
      fr: "Implémentation IA à Longjumeau : prise de rendez-vous intelligente pour le pôle santé, automatisation des relances et de la facturation, classification de documents pharmaceutiques, agents conversationnels patient ou client conformes RGPD.",
      en: "Implémentation IA à Longjumeau : prise de rendez-vous intelligente pour le pôle santé, automatisation des relances et de la facturation, classification de documents pharmaceutiques, agents conversationnels patient ou client conformes RGPD.",
    },
    unAUn: {
      fr: "Coaching un-à-un à Longjumeau : sessions individuelles avec le dirigeant, le pharmacien ou le professionnel de santé, sur site ou en visio. Pensé pour les TPE qui veulent un accompagnement sur mesure sans mobiliser d'équipe technique.",
      en: "Coaching un-à-un à Longjumeau : sessions individuelles avec le dirigeant, le pharmacien ou le professionnel de santé, sur site ou en visio. Pensé pour les TPE qui veulent un accompagnement sur mesure sans mobiliser d'équipe technique.",
    },
    sitesWeb: {
      fr: "Sites web augmentés à Longjumeau : site ou portail métier sur mesure dopé à l'IA pour santé, pharmacie et commerces de l'axe RN20 — prise de rendez-vous en ligne, réponses automatiques aux questions courantes, visibilité locale améliorée.",
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Oui. Nous couvrons Longjumeau et le sud francilien (Massy, Palaiseau, Chilly-Mazarin, Saclay). Nos consultants se déplacent sur site depuis Paris, à 20 km, ou interviennent en visio selon le format retenu avec vous.",
    },
    {
      q: "Accompagnez-vous les TPE et commerces de l'axe RN20 ?",
      a: "C'est notre priorité. Pour les commerçants et indépendants de Longjumeau, nous automatisons devis, relances et réservations, et nous formons le dirigeant à piloter ces outils sans dépendance à un prestataire.",
    },
    {
      q: "Travaillez-vous avec le pôle santé et pharmacie de Longjumeau ?",
      a: "Oui. Pour les officines, laboratoires et cabinets de santé, nous mettons en place prise de rendez-vous intelligente, classification de documents et agents conversationnels, toujours dans le respect strict du RGPD sur les données sensibles.",
    },
    {
      q: "Mes données patients ou clients restent-elles protégées ?",
      a: "Absolument. Toutes nos implémentations respectent le RGPD : minimisation des données, hébergement maîtrisé et traçabilité. C'est un point central de nos missions auprès des acteurs de santé du sud francilien.",
    },
    {
