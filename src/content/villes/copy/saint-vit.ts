...
export const SAINT_VIT_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Saint-Vit : formats adaptés à l'atelier industriel, entrepôt logistique, TPE artisan BTP ou exploitation agricole. Vos équipes repartent autonomes sur les outils IA métier.",
    },
    implementation: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Saint-Vit : sessions sur site ou en visio. Dirigeants PME industrielles, artisans, gérants TPE, commerçants et exploitants agricoles entre Besançon et Dole souhaitant maîtriser l'IA.",
      en: "Coaching 1-to-1 à Saint-Vit : sessions sur site ou en visio. Dirigeants PME industrielles, artisans, gérants TPE, commerçants et exploitants agricoles entre Besançon et Dole souhaitant maîtriser l'IA.",
    },
  },
  faqGeolocalisee: [
    {
