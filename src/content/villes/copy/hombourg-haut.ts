...
// Hombourg-Haut (57, Moselle) — Bassin houiller, basilique Saint-Étienne, frontalier Sarre.
...
export const HOMBOURG_HAUT_COPY: VilleCopy = {
  ...
  distancesEn:
    "Freyming-Merlebach à 5 min. Saint-Avold à 10 min. Forbach à 15 min. Sarrebruck (Allemagne) à 30 min. Metz à 50 min. Gare SNCF Hombourg-Haut (ligne Saint-Avold–Forbach). Autoroute A4 accès proche. Aéroport Sarrebruck-Ensheim à 35 min.",
  seoHook: "bassin houiller & patrimoine médiéval",
  topSectorsNaf: [
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Hombourg-Haut ?",
      a: "Oui, Axion-IA intervient à Hombourg-Haut et dans tout le Bassin houiller mosellan (Freyming-Merlebach, Saint-Avold, Forbach, Farebersviller). Consultants via gare SNCF Hombourg-Haut ou autoroute A4.",
    },
    {
      q: "Accompagnez-vous les entreprises transfrontalières vers la Sarre ?",
      a: "Oui, nombreux entrepreneurs frontaliers à Hombourg-Haut travaillant avec la Sarre : automatisation administrative transfrontalière, gestion bilingue FR/DE, conformité, outils collaboratifs. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
