...
export const BESANCON_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA opérationnel à Besançon : nous cartographions ce qui peut être automatisé dans votre entreprise et chiffrons le ROI. 4 niveaux du Sur place au Stratégique ETI selon votre taille, du cabinet bisontain à l'ETI microtechnique ou médicale de la technopôle TEMIS.",
    ...
    sitesWeb: {
      ...
      en: "Custom web platforms and SaaS AI for Besançon SMEs and mid-caps — premium showcase site for precision microtechnology players (PMT hub, ENSMM/FEMTO-ST) and TEMIS Santé medical devices, interactive customer space, business dashboard connected to your CRM/ERP/LIMS. Senior experts, Axion-IA design system, European hosting.",
    },
  },
  ...
  services: {
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Besançon des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 24-48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Besançon, itérations à distance.",
        whyHere: [
          "Projets web & SaaS bisontins : microtechniques de précision (FEMTO-ST, ENSMM, technopôle TEMIS), horlogerie & joaillerie (Yema, Maty), automobile (Stellantis Sochaux), PME franc-comtoises.",
          ...
          "Microtech & horlogerie de luxe : e-commerce premium, configurateur produit, plateformes data — on adapte la brique IA à votre exigence de précision. Hébergement UE souverain.",
        ],
        methodology: [
          {
            step: "Cadrage à Besançon",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une boutique avec UX/UI et IA intégrée, pour marques horlogères, industriels et PME bisontines.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Plateforme métier, industrielle ou e-commerce premium sur mesure, IA intégrée, branchée sur votre SI (PLM, ERP, PIM, datalake).",
          },
          {
            sizeLabel: "Grande entreprise",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Besançon — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous, particulièrement pour les marques horlogères premium.",
          },
          {
            q: "Vous gérez l'e-commerce premium et les configurateurs produit ?",
            a: "Oui : e-commerce premium multilingue, configurateur produit, recommandation, génération de fiches (Shopify, WooCommerce, PrestaShop). Un vrai levier pour l'horlogerie, la joaillerie et la microtech bisontines à l'export. Hébergement UE, RGPD strict.",
          },
          {
        ...
        guarantees:
          "Devis ferme en forfait fixe (à partir de 24-48 h selon la complexité) : pas de dérive horaire cachée. Mise en ligne sans downtime quand on augmente l'existant. Web Vitals et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD : propriété totale, aucun abonnement imposé, transférable à tout prestataire de la région bisontine ou repris en interne.",
      },
      en: {
        hero: "In Besançon, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 24-48 h depending on project complexity, EU hosting, code and data yours. On-site Besançon kick-off, remote iterations.",
        whyHere: [
          "Besançon web & SaaS projects: precision microtechnologies (FEMTO-ST, ENSMM, TEMIS technopole), watchmaking & jewellery (Yema, Maty), automotive (Stellantis Sochaux), Franche-Comté SMEs.",
          ...
          "Microtech & luxury watchmaking: premium e-commerce, product configurator, data platforms — we adapt the AI brick to your precision standards. Sovereign EU hosting.",
        ],
        methodology: [
          {
            step: "Scoping in Besançon",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Design or rebuild of a site or shop with UX/UI and built-in AI, for watch brands, manufacturers and Besançon SMEs.",
          },
          {
            sizeLabel: "Mid-cap",
            price: "AI-native SaaS platform",
            detail:
              "Bespoke business, industrial or premium e-commerce platform, AI built in, wired into your IS (PLM, ERP, PIM, datalake).",
          },
          {
            sizeLabel: "Large enterprise",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Besançon — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us, especially for premium watch brands.",
          },
          {
            q: "Do you handle premium e-commerce and product configurators?",
            a: "Yes: premium multilingual e-commerce, product configurator, recommendation, sheet generation (Shopify, WooCommerce, PrestaShop). A real lever for Besançon watchmaking, jewellery and microtech at export. EU hosting, strict GDPR.",
          },
          {
