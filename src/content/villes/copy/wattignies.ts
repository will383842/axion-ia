...
// Wattignies (59, Nord) — agglomération Lille sud, 15 525 hab.
...
export const WATTIGNIES_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Wattignies et dans la banlieue sud de Lille ?",
    ...
    },
    {
      ...
      a: "Nous accompagnons tous les secteurs B2B présents à Wattignies : services aux entreprises (comptabilité, conseil, IT), commerces de proximité, artisans du bâtiment, professions libérales (santé, juridique), prestataires B2B et sous-traitants de la métropole lilloise.",
    },
    {
