...
export const AIX_EN_PROVENCE_COPY: VilleCopy = {
  ...
  services: {
        ...
        faq: [
          {
            ...
            a: "Duration varies by tier: a Sur place audit runs over a day, a Mid-cap Strategic audit spans several weeks. The cadence is defined at the framing brief based on your schedule and organisation complexity.",
          },
          {
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Aix-en-Provence des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 24-48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Aix-en-Provence, itérations à distance.",
        whyHere: [
          "Projets web & SaaS aixois : deeptech & énergie (CEA Cadarache, ITER, STMicroelectronics Rousset), industrie (Airbus Helicopters), tourisme & culture, PME et ETI du bassin Aix-Marseille.",
          ...
          "Deeptech & industrie : portails techniques, RAG, plateformes data — ou tourisme & culture multilingue. On adapte la brique IA à votre secteur, hébergement UE souverain.",
        ],
        methodology: [
          {
            step: "Cadrage à Aix-en-Provence",
            detail:
        ...
        pricing: [
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une application avec UX/UI et IA intégrée, pour scale-ups, acteurs du tourisme et PME aixoises.",
          },
          {
            sizeLabel: "ETI",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Aix-en-Provence — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Vous travaillez avec l'écosystème deeptech & énergie ?",
            a: "Oui : portails techniques, RAG sur documentation, plateformes data et agents pour la deeptech et l'énergie (CEA Cadarache, ITER, STMicroelectronics). On parle le langage technique. Hébergement UE souverain, confidentialité contractuelle.",
          },
          {
        ...
        guarantees:
          "Devis ferme en forfait fixe (à partir de 24-48 h selon la complexité) : pas de dérive horaire cachée. Mise en ligne sans downtime quand on augmente l'existant. Web Vitals et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD : propriété totale, aucun abonnement imposé, transférable à tout prestataire de la région aixoise ou repris en interne.",
      },
      en: {
        hero: "In Aix-en-Provence, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 24-48 h depending on project complexity, EU hosting, code and data yours. On-site Aix-en-Provence kick-off, remote iterations.",
        whyHere: [
          "Aix-en-Provence web & SaaS projects: deeptech & energy (CEA Cadarache, ITER, STMicroelectronics Rousset), industry (Airbus Helicopters), tourism & culture, Aix-Marseille SMEs and mid-caps.",
          ...
          "Deeptech & industry: technical portals, RAG, data platforms — or multilingual tourism & culture. We adapt the AI brick to your sector, sovereign EU hosting.",
        ],
        methodology: [
          {
            step: "Scoping in Aix-en-Provence",
            detail:
        ...
        pricing: [
          {
            ...
            detail:
              "Design or rebuild of a site or app with UX/UI and built-in AI, for scale-ups, tourism players and Aix SMEs.",
          },
          {
            sizeLabel: "Mid-cap",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Aix-en-Provence — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Do you work with the deeptech & energy ecosystem?",
            a: "Yes: technical portals, RAG on documentation, data platforms and agents for deeptech and energy (CEA Cadarache, ITER, STMicroelectronics). We speak the technical language. Sovereign EU hosting, contractual confidentiality.",
          },
          {
