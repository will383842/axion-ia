...
// Héric (44, Loire-Atlantique) — Nord Nantes, résidentielle.
...
export const HERIC_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Héric : formats adaptés au chantier, à l'exploitation, au cabinet ou au commerce. Vos équipes repartent autonomes sur outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Héric : automatisation devis bâtiment, gestion planning chantiers, agents IA relation client, extraction données commerciales. Nord nantais.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Héric et nord Nantes ?",
      a: "Oui, Axion-IA intervient à Héric et tout le nord nantais (Grandchamp-des-Fontaines, Nort-sur-Erdre, Blain, Treillières). Consultants depuis Nantes centre (25 min). Couverture complète nord Loire-Atlantique.",
    },
    {
