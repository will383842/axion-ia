...
export const SAUMUR_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Pour les TPE et indépendants à Saumur (artisans, restaurateurs, professions libérales), audit Flash 490 € HT, intervention 1 journée formation pratique, coaching 1-to-1. Cas typiques : automatisation devis, agents IA pour vente directe, classification photos produits, gestion administrative.",
    },
    {
