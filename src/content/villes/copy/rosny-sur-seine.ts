...
// Rosny-sur-Seine (78, Yvelines) — bords de Seine, ouest Mantes-la-Jolie, château de Sully.
...
export const ROSNY_SUR_SEINE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Rosny-sur-Seine (78), commune des bords de Seine à l'ouest de Mantes-la-Jolie dans les Yvelines, accueille TPE artisans, PME industrielles et logistiques, commerces de proximité et professions libérales. Axion-IA répond aux besoins des activités professionnelles présentes du bassin mantois.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Rosny-sur-Seine (78). Nous accompagnons TPE et PME : artisans bords de Seine, PME industrielles et logistiques du bassin mantois, commerçants et professions libérales de ce pôle résidentiel historique près du château de Sully.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Rosny-sur-Seine (78). Nous accompagnons TPE et PME : artisans bords de Seine, PME industrielles et logistiques du bassin mantois, commerçants et professions libérales de ce pôle résidentiel historique près du château de Sully.",
  ...
  topSectorsNaf: [
    ...
    "Agriculture & exploitation maraîchère",
  ],
  servicesContext: {
    audit: {
    ...
    implementation: {
      ...
      en: "Implémentation IA à Rosny-sur-Seine : automatisation flux logistiques, gestion stocks PME industrielle, agents conversationnels artisans, CRM augmenté commerçants, planification tournées bords de Seine.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Rosny-sur-Seine : sessions chez vous ou en visio. Artisans, dirigeants PME industrielles, commerçants et professions libérales du bassin mantois souhaitant maîtriser l'IA dans leur pratique quotidienne.",
      en: "Coaching 1-to-1 à Rosny-sur-Seine : sessions chez vous ou en visio. Artisans, dirigeants PME industrielles, commerçants et professions libérales du bassin mantois souhaitant maîtriser l'IA dans leur pratique quotidienne.",
    },
  },
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Rosny-sur-Seine et dans le bassin mantois ?",
      a: "Oui, Axion-IA intervient à Rosny-sur-Seine et dans tout le bassin mantois (Mantes-la-Jolie à 5 min, Les Mureaux, Bonnières-sur-Seine). Nos consultants se déplacent via A13 ou Transilien J depuis Paris Saint-Lazare.",
    },
    {
      q: "Accompagnez-vous les PME industrielles de l'axe Seine ?",
