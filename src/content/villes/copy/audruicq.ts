...
// Audruicq (62, Pas-de-Calais) — Marais audomarois, 5 309 hab.
...
export const AUDRUICQ_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il a Audruicq et dans le marais audomarois ?",
      a: "Oui, Axion-IA intervient a Audruicq et dans tout l'Audomarois (Saint-Omer, Calais, Ardres). Consultants depuis Lille (1h10 TER) ou via Calais-Frethun (Eurostar 15 min).",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, toutes nos interventions a Audruicq sont conformes au RGPD. Protection des donnees de votre entreprise et de vos clients garantie contractuellement.",
    },
  ],
};
