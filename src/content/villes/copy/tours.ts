...
export const TOURS_COPY: VilleCopy = {
  ...
  services: {
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Tours des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 24-48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Tours, itérations à distance.",
        whyHere: [
          "Projets web & SaaS tourangeaux : industrie (STMicroelectronics, SKF, Michelin), smart energy (pôle S2E2), enseignement & recherche (30 000 étudiants), PME et ETI de Tours Métropole.",
          ...
          "Industrie & énergie : portails techniques, RAG, plateformes data et agents — un terrain naturel avec l'écosystème industriel tourangeau. Hébergement UE, RGPD strict.",
        ],
        methodology: [
          {
            step: "Cadrage à Tours",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une application avec UX/UI et IA intégrée, pour industriels, scale-ups et PME tourangelles.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Plateforme métier, industrielle ou portail technique sur mesure, IA intégrée, branchée sur votre SI (PLM, ERP, datalake).",
          },
          {
            sizeLabel: "Grande entreprise",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Tours — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Vous travaillez pour l'industrie et l'énergie ?",
            a: "Oui : portails techniques, RAG sur documentation, plateformes data, agents et automatisations branchés sur votre SI (PLM, ERP) — un terrain naturel à Tours avec STMicroelectronics, SKF et le pôle S2E2. Hébergement UE, RGPD strict.",
          },
          {
        ...
        guarantees:
          "Devis ferme en forfait fixe (à partir de 24-48 h selon la complexité) : pas de dérive horaire cachée. Mise en ligne sans downtime quand on augmente l'existant. Web Vitals et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD : propriété totale, aucun abonnement imposé, transférable à tout prestataire de la région tourangelle ou repris en interne.",
      },
      en: {
        hero: "In Tours, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 24-48 h depending on project complexity, EU hosting, code and data yours. On-site Tours kick-off, remote iterations.",
        whyHere: [
          "Tours web & SaaS projects: industry (STMicroelectronics, SKF, Michelin), smart energy (S2E2 cluster), education & research (30,000 students), Tours Métropole SMEs and mid-caps.",
          ...
          "Industry & energy: technical portals, RAG, data platforms and agents — a natural fit with the Tours industrial ecosystem. EU hosting, strict GDPR.",
        ],
        methodology: [
          {
            step: "Scoping in Tours",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Design or rebuild of a site or app with UX/UI and built-in AI, for manufacturers, scale-ups and Tours SMEs.",
          },
          {
            sizeLabel: "Mid-cap",
            price: "AI-native SaaS platform",
            detail:
              "Bespoke business, industrial or technical portal platform, AI built in, wired into your IS (PLM, ERP, datalake).",
          },
          {
            sizeLabel: "Large enterprise",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Tours — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Do you work for industry and energy?",
            a: "Yes: technical portals, RAG on documentation, data platforms, agents and automations wired to your IS (PLM, ERP) — a natural fit in Tours with STMicroelectronics, SKF and the S2E2 cluster. EU hosting, strict GDPR.",
          },
          {
