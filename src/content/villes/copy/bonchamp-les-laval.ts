...
export const BONCHAMP_LES_LAVAL_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Bonchamp-lès-Laval : diagnostic adapté aux TPE artisans, PME industrielles, agroalimentaires et prestataires B2B de l'est lavallois. ROI chiffré, Audit Flash 490 € HT.",
