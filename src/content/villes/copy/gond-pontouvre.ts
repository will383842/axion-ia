...
export const GOND_PONTOUVRE_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Gond-Pontouvre : formats adaptés au bureau, au commerce, à l'atelier ou au cabinet. Vos collaborateurs maîtrisent leurs outils IA après notre intervention.",
    },
    implementation: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'audit sur place IA à Gond-Pontouvre démarre à {{price:audit-flash|flat}}. Diagnostic complet de vos processus commerciaux, tertiaires ou artisanaux, identification des cas d'usage IA prioritaires, ROI chiffré et plan d'action concret.",
    },
    {
