...
export const PAU_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Pau : diagnostic pour TPE (cabinets libéraux, artisans, commerces béarnais), PME services et ETI sous-traitantes aéronautique/énergie. Audit Flash {{price:audit-flash|flat}}, ROI chiffré sous 7 jours.",
      en: "Audit IA à Pau : diagnostic pour TPE (cabinets libéraux, artisans, commerces béarnais), PME services et ETI sous-traitantes aéronautique/énergie. Audit Flash {{price:audit-flash|flat}}, ROI chiffré sous 7 jours.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Audit Flash {{price:audit-flash|flat}} (diagnostic et plan d'action sous 7 jours), Formation 4 h {{price:intervention-4h|flat}} (atelier sur site), Implémentation et Coaching 1-to-1 dès {{price:intervention-dirigeants|flat}}. Tarifs publics affichés, pas de devis opaque.",
    },
    {
