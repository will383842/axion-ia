...
export const MOYEUVRE_GRANDE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Moyeuvre-Grande : diagnostic adapté aux TPE/PME industrie, sous-traitants, artisans BTP, commerces et services de la Vallée de l'Orne. Audit Flash à 490 € HT, retour sur investissement chiffré.",
      en: "Audit IA à Moyeuvre-Grande : diagnostic adapté aux TPE/PME industrie, sous-traitants, artisans BTP, commerces et services de la Vallée de l'Orne. Audit Flash à 490 € HT, retour sur investissement chiffré.",
    },
    interventions: {
      ...
      en: "Interventions IA sur site à Moyeuvre-Grande : formats adaptés à l'atelier industriel, chantier, bureau, commerce. Vos équipes maîtrisent les outils déployés.",
    },
    implementation: {
