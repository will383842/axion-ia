...
export const LEERS_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Leers : sessions dans votre atelier, bureau, commerce ou en visio. Dirigeants TPE/PME du bassin roubaisien et transfrontaliers franco-belges souhaitant maîtriser l'IA dans leur activité.",
      en: "Coaching 1-to-1 à Leers : sessions dans votre atelier, bureau, commerce ou en visio. Dirigeants TPE/PME du bassin roubaisien et transfrontaliers franco-belges souhaitant maîtriser l'IA dans leur activité.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    },
    {
      ...
      a: "Nos consultants interviennent à Leers depuis Lille (20 min) ou Roubaix (5 min). Intervention sur site dans votre atelier textile, commerce, bureau ou en visio. Proximité frontière belge (Estaimpuis 3 min). Frais de déplacement facturés séparément du forfait, tarifs publics et transparents.",
    },
  ],
};
