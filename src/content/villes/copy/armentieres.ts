...
export const ARMENTIERES_COPY: VilleCopy = {
  ...
  topSectorsNaf: [
    ...
    "Logistique et transport fluvial (canal de la Lys)",
    "Services aux entreprises de la métropole lilloise",
    "Reconversion d'ateliers textiles (PME)",
  ],
  servicesContext: {
    audit: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Nos prestations à Armentières démarrent à 490 € HT pour un audit flash 4h et à 590 € HT pour une intervention sur site. La grille complète est publique sur axion-ia.com.",
    },
    {
    ...
    },
    {
      ...
      a: "Nous nous déplaçons depuis Armentières vers La Chapelle-d'Armentières, Houplines, Erquinghem-Lys, Nieppe et Comines-Warneton côté belge, ainsi que vers Lille et sa première couronne via l'A25.",
    },
    {
