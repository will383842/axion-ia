  ...
  faqGeolocalisee: [
    {
      ...
      a: "Nos prestations à Armentières démarrent à {{price:audit-flash|flat}} pour un audit sur place 4h et à {{price:intervention-4h|flat}} pour une intervention sur site. La grille complète est publique sur axion-ia.com.",
    },
    {
