...
// Hayange (57, Moselle) — Vallée de la Fensch, sidérurgie reconvertie, frontalier Luxembourg.
...
export const HAYANGE_COPY: VilleCopy = {
  ...
  distancesEn:
    "Thionville à 10 min. Metz à 30 min. Luxembourg-Ville à 35 min. Gare SNCF Hayange (ligne Metz–Luxembourg). Autoroute A30 accès direct. Aéroport Metz-Nancy-Lorraine à 40 min. Aéroport Luxembourg à 45 min.",
  seoHook: "sidérurgie reconvertie & frontaliers",
  topSectorsNaf: [
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Hayange : diagnostic adapté aux TPE/PME industrie, sous-traitants métallurgie, artisans BTP, commerces et services. ROI chiffré, audit Flash {{price:audit-flash|flat}}.",
      en: "Audit IA à Hayange : diagnostic adapté aux TPE/PME industrie, sous-traitants métallurgie, artisans BTP, commerces et services. ROI chiffré, audit Flash {{price:audit-flash|flat}}.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Hayange ?",
      a: "Oui, Axion-IA intervient à Hayange et dans toute la Vallée de la Fensch (Florange, Sérémange-Erzange, Algrange, Knutange). Consultants via gare SNCF Hayange ou autoroute A30. Luxembourg accessible en 35 min.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nombreux frontaliers et entrepreneurs hayangeois travaillant avec le Luxembourg : automatisation administrative transfrontalière, gestion multilingue, conformité, outils collaboratifs. Audit Flash {{price:audit-flash|flat}}.",
    },
    {
