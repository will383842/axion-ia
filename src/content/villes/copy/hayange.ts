...
export const HAYANGE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Hayange : diagnostic adapté aux TPE/PME industrie, sous-traitants métallurgie, artisans BTP, commerces et services. ROI chiffré, audit Flash 490 € HT.",
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, nombreux frontaliers et entrepreneurs hayangeois travaillant avec le Luxembourg : automatisation administrative transfrontalière, gestion multilingue, conformité, outils collaboratifs. Audit Flash 490 € HT.",
    },
    {
