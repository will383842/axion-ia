...
export const HAYANGE_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, nombreux frontaliers et entrepreneurs hayangeois travaillant avec le Luxembourg : automatisation administrative transfrontalière, gestion multilingue, conformité, outils collaboratifs. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
