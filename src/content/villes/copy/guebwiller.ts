...
export const GUEBWILLER_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, industriels, artisans et commerçants guebwillerois : traçabilité production, gestion commerciale, présence en ligne, automatisation administrative, devis et facturation. Audit Flash 490 € HT.",
    },
    {
