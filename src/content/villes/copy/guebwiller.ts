...
export const GUEBWILLER_COPY: VilleCopy = {
  ...
  pitchEn:
    "Guebwiller (68), sous-préfecture du Haut-Rhin de 11 243 habitants au pied du Grand Ballon, est célèbre pour ses quatre Grands Crus d'Alsace et structure la vallée du Florival. Tissu TPE/PME viticulture, tourisme patrimonial, industrie, commerces, services. Axion-IA y intervient pour tous types d'activités.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Guebwiller (68). Nous accompagnons tous types d'activités : TPE/PME viticulture Grand Cru et tourisme patrimonial, industrie, artisans, commerces et professions de services de la vallée du Florival.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Guebwiller (68). Nous accompagnons tous types d'activités : TPE/PME viticulture Grand Cru et tourisme patrimonial, industrie, artisans, commerces et professions de services de la vallée du Florival.",
  ecosystemFr:
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Guebwiller : sessions dans votre domaine, hébergement, atelier, commerce ou en visio. Viticulteurs Grand Cru, hôteliers, restaurateurs, industriels, artisans, commerçants TPE/PME du Florival.",
      en: "Coaching 1-to-1 à Guebwiller : sessions dans votre domaine, hébergement, atelier, commerce ou en visio. Viticulteurs Grand Cru, hôteliers, restaurateurs, industriels, artisans, commerçants TPE/PME du Florival.",
    },
  },
  faqGeolocalisee: [
    {
