...
export const EPAGNY_METZ_TESSY_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'Audit Flash Axion-IA démarre à 490 € HT, adapté aux TPE et PME d'Epagny Metz-Tessy. Diagnostic complet des opportunités IA dans votre activité (commerce, services, logistique), ROI chiffré et plan d'action concret sous 5 jours ouvrés.",
    },
    {
