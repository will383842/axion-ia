...
export const SAINT_FLOUR_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Saint-Flour : diagnostic adapté à l'administration, éleveurs Salers/Aubrac, agriculteurs Planèze, TPE artisans. ROI mesurable, audit Flash dès {{price:audit-flash|flat}}.",
      en: "Audit IA à Saint-Flour : diagnostic adapté à l'administration, éleveurs Salers/Aubrac, agriculteurs Planèze, TPE artisans. ROI mesurable, audit Flash dès {{price:audit-flash|flat}}.",
    },
    interventions: {
