...
export const COURBEVOIE_COPY: VilleCopy = {
  pitchFr:
    "Axion-IA, cabinet d'experts IA seniors, accompagne les TPE et PME de Courbevoie (92), au cœur du quartier d'affaires de La Défense. Au pied des tours qui abritent de grands sièges, un dense réseau de petites structures tertiaires — conseil, finance, services aux entreprises — fait vivre la ville. Nous y déployons une IA opérationnelle, sobre et conforme RGPD pour ces TPE et PME franciliennes.",
  pitchEn:
    "Axion-IA, cabinet d'experts IA seniors, accompagne les TPE et PME de Courbevoie (92), au cœur du quartier d'affaires de La Défense. Au pied des tours qui abritent de grands sièges, un dense réseau de petites structures tertiaires — conseil, finance, services aux entreprises — fait vivre la ville. Nous y déployons une IA opérationnelle, sobre et conforme RGPD pour ces TPE et PME franciliennes.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Courbevoie (92), dans le quartier d'affaires de La Défense. Nous accompagnons en priorité les TPE puis les PME du tertiaire : cabinets de conseil, services financiers, professions du droit, éditeurs et prestataires informatiques, sous-traitants des grands sièges. Audit sur place sur site, tarifs publics. Les ETI restent un cas marginal de notre clientèle.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Courbevoie (92), dans le quartier d'affaires de La Défense. Nous accompagnons en priorité les TPE puis les PME du tertiaire : cabinets de conseil, services financiers, professions du droit, éditeurs et prestataires informatiques, sous-traitants des grands sièges. Audit sur place sur site, tarifs publics. Les ETI restent un cas marginal de notre clientèle.",
