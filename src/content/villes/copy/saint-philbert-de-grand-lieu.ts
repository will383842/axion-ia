...
export const SAINT_PHILBERT_DE_GRAND_LIEU_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Saint-Philbert-de-Grand-Lieu : sessions dans votre exploitation, atelier, commerce ou en visio. Maraîchers, dirigeants PME agroalimentaires, artisans BTP, acteurs tourisme nature, gérants TPE.",
      en: "Coaching 1-to-1 à Saint-Philbert-de-Grand-Lieu : sessions dans votre exploitation, atelier, commerce ou en visio. Maraîchers, dirigeants PME agroalimentaires, artisans BTP, acteurs tourisme nature, gérants TPE.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    },
    {
      ...
      a: "Pour les TPE artisans BTP et commerçants à Saint-Philbert-de-Grand-Lieu, audit Flash 490 € HT, intervention 1 journée formation, coaching 1-to-1. Cas typiques : automatisation devis, gestion stocks, agents IA prise de commandes.",
    },
    {
