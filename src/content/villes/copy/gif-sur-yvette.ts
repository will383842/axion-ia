...
// Gif-sur-Yvette (91, Essonne) — plateau de Saclay, CNRS, CEA, université Paris-Saclay, écosystème deeptech et recherche.

import type { VilleCopy } from "./types";

export const GIF_SUR_YVETTE_COPY: VilleCopy = {
  pitchFr:
    "À Gif-sur-Yvette, au cœur du plateau de Saclay, Axion-IA accompagne les TPE et PME de la deeptech, de la recherche, des services scientifiques et des startups. Notre cabinet d'experts IA seniors aide les dirigeants à automatiser leur administratif et à structurer leurs opérations, sans complexité inutile.",
  pitchEn:
    "À Gif-sur-Yvette, au cœur du plateau de Saclay, Axion-IA accompagne les TPE et PME de la deeptech, de la recherche, des services scientifiques et des startups. Notre cabinet d'experts IA seniors aide les dirigeants à automatiser leur administratif et à structurer leurs opérations, sans complexité inutile.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui se déplace à Gif-sur-Yvette pour accompagner les TPE et PME locales. Située sur le plateau de Saclay, la commune accueille le CNRS, le CEA et fait partie de l'université Paris-Saclay, un écosystème deeptech parmi les plus denses d'Europe. Auprès des startups, spin-offs, laboratoires et prestataires de services scientifiques, nous réalisons des audits, déployons des automatisations concrètes et formons les dirigeants. La priorité va aux très petites entreprises et PME ; les ETI restent marginales.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui se déplace à Gif-sur-Yvette pour accompagner les TPE et PME locales. Située sur le plateau de Saclay, la commune accueille le CNRS, le CEA et fait partie de l'université Paris-Saclay, un écosystème deeptech parmi les plus denses d'Europe. Auprès des startups, spin-offs, laboratoires et prestataires de services scientifiques, nous réalisons des audits, déployons des automatisations concrètes et formons les dirigeants. La priorité va aux très petites entreprises et PME ; les ETI restent marginales.",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Nos interventions à Gif-sur-Yvette automatisent les tâches répétitives des jeunes PME deeptech : reporting, gestion administrative, suivi des financements et relation client, sans bouleverser vos outils existants.",
    },
    implementation: {
      fr: "L'implémentation à Gif-sur-Yvette déploie des solutions IA durables pour les startups et acteurs de la recherche, avec une attention forte à la confidentialité des travaux scientifiques et à la conformité RGPD des données traitées.",
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Oui, nos consultants se rendent directement dans vos locaux à Gif-sur-Yvette et sur le plateau de Saclay. La première rencontre se fait sur site afin de comprendre votre activité scientifique ou technologique avant toute recommandation.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui. Nous n'intervenons pas sur votre cœur scientifique, mais sur les fonctions support : reporting, administratif, gestion de projet et relation partenaires. L'IA libère du temps pour que vos équipes restent concentrées sur la recherche et l'innovation.",
    },
    {
    ...
    {
      q: "Comment garantissez-vous la conformité RGPD à Gif-sur-Yvette ?",
      a: "La conformité RGPD est intégrée dès l'audit puis à chaque étape de l'implémentation. Nous documentons les traitements, protégeons la confidentialité de vos travaux et privilégions un hébergement conforme à la réglementation européenne.",
    },
  ],
};
