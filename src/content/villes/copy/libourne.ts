...
export const LIBOURNE_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Le tissu économique libournais s'organise autour des AOC viticoles voisines (Saint-Émilion, Pomerol, Fronsac), du port historique sur la Dordogne, du centre hospitalier Robert-Boulin et de la garnison militaire (régiments et école de santé des armées). Le secrétariat du Père Noël, basé à Libourne depuis 1962, gère chaque année les courriers adressés à La Poste. Le réseau de bus Calibus, gratuit depuis 2010, structure la mobilité urbaine.",
  distancesFr:
    "La gare de Libourne, sur la ligne Paris-Bordeaux, est au centre-ville. Bordeaux est à environ 31 km via la RN89 / A89. L'aéroport de Bordeaux-Mérignac est à environ 45 km. Arcachon est à environ 98 km.",
  distancesEn:
    "La gare de Libourne, sur la ligne Paris-Bordeaux, est au centre-ville. Bordeaux est à environ 31 km via la RN89 / A89. L'aéroport de Bordeaux-Mérignac est à environ 45 km. Arcachon est à environ 98 km.",
  topSectorsNaf: [
    "Viticulture et culture de la vigne",
    "Commerce de détail",
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Accompagnement individuel dirigeant TPE/PME à Libourne : cadrage stratégique IA, feuille de route, arbitrages make-or-buy. Format intensif sur site. À partir de 990 € HT — détail sur la sous-page /un-a-un.",
      en: "Accompagnement individuel dirigeant TPE/PME à Libourne : cadrage stratégique IA, feuille de route, arbitrages make-or-buy. Format intensif sur site. À partir de 990 € HT — détail sur la sous-page /un-a-un.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    },
    {
      ...
      a: "Une intervention collective démarre à 590 € HT pour une équipe de 5 à 20 personnes. Un accompagnement dirigeant 1-to-1 démarre à 990 € HT. L'audit complet est cadré sur mesure selon le périmètre. Tarifs publics consultables sur axion-ia.fr.",
    },
    {
    ...
    },
    {
      ...
      a: "Axion-IA travaille exclusivement avec des architectures conformes RGPD : hébergement sur serveurs européens, aucune donnée transmise à des modèles tiers sans accord explicite. Pour les structures de santé du centre hospitalier Robert-Boulin ou les domaines viticoles traitant des données clients, nous appliquons les exigences sectorielles dès l'audit.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui. Pour les domaines de Saint-Émilion, Pomerol ou Fronsac, nous travaillons sur des cas d'usage concrets : automatisation de la relance acheteurs, génération assistée de fiches techniques multilingues, classification d'avis clients, traitement de mails commerciaux. Toujours en code custom RGPD, sans no-code.",
    },
  ],
};
