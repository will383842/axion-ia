...
// Mauguio (34, Hérault) — Agglo Montpellier est, Méjean, 16 522 hab.
...
export const MAUGUIO_COPY: VilleCopy = {
  ...
  pitchEn:
    "Mauguio (34), commune de 16 522 habitants dans l'agglomération de Montpellier est, entre plaine viticole et étang du Méjean. Son économie repose sur un tissu de TPE et PME de l'aéronautique (proximité aéroport), du commerce, de la viticulture, de la restauration, du tertiaire et du tourisme littoral (Carnon). Axion-IA opère pour toutes les structures économiques de la commune.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Mauguio (34). Nous accompagnons TPE et PME de l'agglo Montpellier est : entreprises de la zone aéroport, viticulteurs, commerçants, prestataires de services et professionnels du tourisme littoral Carnon. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Mauguio (34). Nous accompagnons TPE et PME de l'agglo Montpellier est : entreprises de la zone aéroport, viticulteurs, commerçants, prestataires de services et professionnels du tourisme littoral Carnon. Audit sur place sur mesure.",
  ecosystemFr:
  ...
  ecosystemEn:
    "Mauguio est une commune de l'agglo Montpellier est, entre plaine viticole et littoral méditerranéen (station balnéaire de Carnon). Son économie s'appuie sur la zone d'activité aéroportuaire (proximité aéroport Montpellier-Méditerranée), la viticulture, le commerce, la restauration, les services aux entreprises, les professions libérales et le tourisme littoral. Étang du Méjean (réserve naturelle).",
  distancesFr:
    "Montpellier centre à 15 min. Aéroport Montpellier-Méditerranée à 5 min. Nîmes à 40 min via A9. Sète à 30 min via A9. Gare TGV Montpellier-Saint-Roch à 20 min.",
  distancesEn:
    "Montpellier centre à 15 min. Aéroport Montpellier-Méditerranée à 5 min. Nîmes à 40 min via A9. Sète à 30 min via A9. Gare TGV Montpellier-Saint-Roch à 20 min.",
  seoHook: "aéronautique, viticulture & littoral",
  topSectorsNaf: [
    "Aéronautique & zone aéroport",
    "Viticulture & agroalimentaire",
    "Commerce & restauration",
    "Services aux entreprises & tertiaire",
    "Tourisme littoral & hébergement (Carnon)",
  ],
  servicesContext: {
    audit: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Mauguio : formats adaptés à l'entreprise aéroportuaire, au domaine viticole, au commerce ou au bureau tertiaire. Vos équipes repartent autonomes sur les outils IA configurés métier.",
    },
    implementation: {
      fr: "Implémentation IA à Mauguio : automatisation traçabilité viticole, gestion stocks, CRM clients, optimisation plannings saisonniers, facturation OCR et analyse flux touristiques Carnon.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Mauguio près de Montpellier ?",
    ...
    },
    {
      ...
      a: "Nous accompagnons les viticulteurs de Mauguio et de la plaine héraultaise. Cas IA typiques : traçabilité parcelles, gestion stocks cave, prévision vendanges, CRM clients caveau, automatisation facturation et déclarations récolte.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants interviennent sur site à Mauguio et dans l'agglo Montpellier est. Déplacement direct dans votre entreprise. Aéroport Montpellier-Méditerranée à 5 min, gare TGV Montpellier à 20 min.",
    },
  ],
};
