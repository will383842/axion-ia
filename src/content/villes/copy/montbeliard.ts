...
export const MONTBELIARD_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      fr: "Intervenir sur site dans le pays de Montbéliard pour automatiser devis, suivi qualité et gestion de production des PME et ETI industrielles, sans bouleverser les équipes.",
      en: "Intervenir sur site dans le pays de Montbéliard pour automatiser devis, suivi qualité et gestion de production des PME et ETI industrielles, sans bouleverser les équipes.",
    },
    implementation: {
    ...
    unAUn: {
      fr: "Accompagner en un-à-un les dirigeants de PME et ETI montbéliardaises pour comprendre l'IA, arbitrer les bons cas d'usage et garder la main sur leur stratégie d'automatisation.",
      en: "Accompagner en un-à-un les dirigeants de PME et ETI montbéliardaises pour comprendre l'IA, arbitrer les bons cas d'usage et garder la main sur leur stratégie d'automatisation.",
    },
    sitesWeb: {
  ...
  faqGeolocalisee: [
    ...
    {
      q: "L'IA est-elle accessible à une PME industrielle de Montbéliard ?",
      a: "C'est notre priorité. Nous concevons des automatisations sobres, pensées pour les PME fournisseuses de grands donneurs d'ordre, qui font gagner du temps sans coûts récurrents disproportionnés.",
    },
    {
