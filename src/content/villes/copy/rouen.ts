...
export const ROUEN_COPY: VilleCopy = {
  ...
  services: {
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Rouen des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 24-48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Rouen, itérations à distance.",
        whyHere: [
          "Projets web & SaaS rouennais : logistique & portuaire (HAROPA Seine, 1er port céréalier européen), industrie (Renault Cléon, Safran Nacelles, pharma Janssen, chimie Lubrizol), numérique (French Tech Normandie), PME de la Métropole Seine.",
          ...
          "Logistique, industrie & pharma : plateformes métier, tracking, RAG et agents — un terrain naturel à Rouen avec HAROPA et le tissu industriel normand. Hébergement UE, RGPD strict.",
        ],
        methodology: [
          {
            step: "Cadrage à Rouen",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une application avec UX/UI et IA intégrée, pour industriels, scale-ups et PME rouennaises.",
          },
          {
            sizeLabel: "ETI",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Rouen — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Vous gérez la logistique et l'industrie à grande échelle ?",
            a: "Oui : portails de suivi, automatisations métier, RAG sur documentation, agents branchés sur vos outils (TMS, ERP) — un terrain naturel à Rouen avec HAROPA Seine et le tissu industriel normand. Hébergement UE, RGPD strict.",
          },
          {
        ...
        guarantees:
          "Devis ferme en forfait fixe (à partir de 24-48 h selon la complexité) : pas de dérive horaire cachée. Mise en ligne sans downtime quand on augmente l'existant. Web Vitals et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD : propriété totale, aucun abonnement imposé, transférable à tout prestataire de la région rouennaise ou repris en interne.",
      },
      en: {
        hero: "In Rouen, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 24-48 h depending on project complexity, EU hosting, code and data yours. On-site Rouen kick-off, remote iterations.",
        whyHere: [
          "Rouen web & SaaS projects: logistics & port (HAROPA Seine, Europe's leading cereal port), industry (Renault Cléon, Safran Nacelles, Janssen pharma, Lubrizol chemistry), digital (French Tech Normandie), Seine Métropole SMEs.",
          ...
          "Logistics, industry & pharma: business platforms, tracking, RAG and agents — a natural fit in Rouen with HAROPA and the Normandy industrial fabric. EU hosting, strict GDPR.",
        ],
        methodology: [
          {
            step: "Scoping in Rouen",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Design or rebuild of a site or app with UX/UI and built-in AI, for manufacturers, scale-ups and Rouen SMEs.",
          },
          {
            sizeLabel: "Mid-cap",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Rouen — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Do you handle logistics and industry at scale?",
            a: "Yes: tracking portals, business automations, RAG on documentation, agents wired to your tools (TMS, ERP) — a natural fit in Rouen with HAROPA Seine and the Normandy industrial fabric. EU hosting, strict GDPR.",
          },
          {
