...
// Vernouillet (78, Yvelines) — bords de Seine, agglo Poissy/Les Mureaux.
...
export const VERNOUILLET_78_COPY: VilleCopy = {
  ...
  topSectorsNaf: [
    ...
    "Logistique & transport (axe Seine)",
    "Professions libérales & santé",
    "BTP & rénovation",
  ],
  servicesContext: {
    audit: {
      fr: "Audit IA à Vernouillet : diagnostic adapté aux TPE artisans, PME de services, commerces et professions libérales de l'agglomération Seine & Vexin. ROI chiffré, Audit Flash 490 € HT.",
      en: "Audit IA à Vernouillet : diagnostic adapté aux TPE artisans, PME de services, commerces et professions libérales de l'agglomération Seine & Vexin. ROI chiffré, Audit Flash 490 € HT.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Vernouillet dans les Yvelines ?",
      a: "Oui, Axion-IA intervient à Vernouillet et dans toute l'agglomération Seine & Vexin (Verneuil-sur-Seine, Triel-sur-Seine, Les Mureaux, Poissy, Médan). Nos consultants se déplacent sur site ou en visio.",
    },
    {
      q: "Quel est le tarif d'un audit IA à Vernouillet ?",
      a: "L'Audit Flash IA à Vernouillet démarre à 490 € HT pour 4 heures de diagnostic. Il couvre l'analyse de vos processus métier, l'identification des cas d'usage IA prioritaires et un plan d'action chiffré avec ROI estimé.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nos interventions IA sur site à Vernouillet sont adaptées aux PME de services et logistique. Vos équipes repartent autonomes sur les outils IA configurés pour leur métier, avec support post-intervention.",
    },
    {
