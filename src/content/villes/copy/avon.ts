...
// Avon (77, Seine-et-Marne) — jumelle de Fontainebleau, résidentielle, forêt domaniale, gare Fontainebleau-Avon.
...
export const AVON_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Avon : formats adaptés au cabinet médical, au commerce ou à l'entreprise de services. Vos équipes repartent autonomes sur les outils IA configurés pour leur métier.",
    },
    implementation: {
      fr: "Implémentation IA à Avon : automatisation prise de rendez-vous santé, agents conversationnels clients, gestion documentaire professions libérales, optimisation services à la personne. Adapté tissu résidentiel Fontainebleau-Avon.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Avon et dans le bassin Fontainebleau ?",
      a: "Oui, Axion-IA intervient à Avon et dans tout le bassin Fontainebleau (Fontainebleau, Vulaines-sur-Seine, Samois-sur-Seine, Héricy, Thomery). Nos consultants se déplacent sur site ou en visio.",
    },
    {
      q: "Quel est le prix d'un audit IA à Avon ?",
      a: "L'Audit sur place IA à Avon démarre à {{price:audit-flash|flat}}. Ce diagnostic couvre l'analyse de vos processus métier, l'identification des cas d'usage IA prioritaires et un plan d'action chiffré avec ROI estimé.",
    },
    {
