...
// Issoudun (36, Indre) — Sous-préfecture, tour Blanche, Balzac, 11 159 hab.
...
export const ISSOUDUN_COPY: VilleCopy = {
  ...
  pitchEn:
    "Issoudun (36), sous-préfecture de l'Indre au coeur du Berry, est une ville historique marquée par sa tour Blanche et l'oeuvre de Balzac. TPE artisans, PME industrielles et agroalimentaires, commerçants, professions libérales, indépendants et acteurs des services publics composent son tissu économique. Axion-IA accompagne entreprises et indépendants du bassin issoldunois.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Issoudun (36), sous-préfecture de l'Indre. Nous accompagnons tous types d'activités : TPE artisans, PME industrielles et agroalimentaires, commerçants, professions libérales, indépendants et services publics du Berry.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Issoudun (36), sous-préfecture de l'Indre. Nous accompagnons tous types d'activités : TPE artisans, PME industrielles et agroalimentaires, commerçants, professions libérales, indépendants et services publics du Berry.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Issoudun et dans le Berry ?",
      a: "Oui, Axion-IA intervient à Issoudun et dans tout le Berry (Châteauroux, Bourges, Vierzon, Le Blanc, La Châtre). Couverture également Tours à 1h30, Limoges à 2h et Paris à 2h30.",
    },
    {
      q: "Travaillez-vous avec les PME industrielles et aéronautiques d'Issoudun ?",
    ...
    },
    {
      ...
      a: "Pour les PME agroalimentaires et le négoce agricole du Berry, nous proposons des implémentations IA adaptées : traçabilité automatisée, contrôle qualité par vision, agents conversationnels gestion fournisseurs, optimisation logistique et planification saisonnière.",
    },
    {
