...
// Pecquencourt (59, Nord) — Bassin minier, 6 092 hab.
...
export const PECQUENCOURT_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Pecquencourt est située dans le bassin minier Nord-Pas-de-Calais (UNESCO), limitrophe de Douai et Sin-le-Noble, intégrée à la Communauté d'Agglomération du Douaisis. Tissu TPE artisans BTP et rénovation du patrimoine minier, PME industrie et sous-traitance, commerces de proximité, services aux entreprises. Reconversion économique post-minière avec développement de zones d'activités et éco-quartiers.",
  distancesFr:
    "Douai centre à 10 min. Sin-le-Noble à 5 min. Gare TGV Douai à 12 min (Paris en 1h05, Lille en 20 min). Lille à 35 min via A21. Valenciennes à 30 min. Aéroport Lille-Lesquin à 40 min.",
  distancesEn:
    "Douai centre à 10 min. Sin-le-Noble à 5 min. Gare TGV Douai à 12 min (Paris en 1h05, Lille en 20 min). Lille à 35 min via A21. Valenciennes à 30 min. Aéroport Lille-Lesquin à 40 min.",
  topSectorsNaf: [
  ...
  servicesContext: {
    ...
    implementation: {
      ...
      en: "Implémentation IA à Pecquencourt : automatisation devis BTP, contrôle qualité industriel par vision, optimisation planification sous-traitance, agents conversationnels commerce de proximité.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Pecquencourt : sessions sur site ou en visio pour dirigeants TPE artisans, gérants PME industrie et sous-traitance du bassin douaisien souhaitant intégrer l'IA.",
      en: "Coaching 1-to-1 à Pecquencourt : sessions sur site ou en visio pour dirigeants TPE artisans, gérants PME industrie et sous-traitance du bassin douaisien souhaitant intégrer l'IA.",
    },
  },
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Pecquencourt et dans l'agglomération de Douai ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les TPE artisans BTP de Pecquencourt et du bassin minier. Cas typiques IA : automatisation devis et factures, classification photos chantiers, agents IA prise de RDV, gestion stocks matériaux, planification tournées.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants interviennent depuis Douai (10 min) ou Lille (35 min via A21). Pecquencourt étant intégrée à l'agglomération douaisienne, déplacements sans surcoût hébergement. Sessions sur site ou en visio selon vos préférences.",
    },
  ],
};
