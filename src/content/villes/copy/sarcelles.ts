...
export const SARCELLES_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      fr: "Intervention Essentielle dès {{price:intervention-4h|flat}} à Sarcelles pour automatiser devis, relances clients et suivi administratif — code custom, pas de no-code.",
      en: "Intervention Essentielle dès {{price:intervention-4h|flat}} à Sarcelles pour automatiser devis, relances clients et suivi administratif — code custom, pas de no-code.",
    },
    implementation: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "À Sarcelles, l'Audit Flash 4 h démarre à {{price:audit-flash|flat}} et l'Intervention Essentielle à {{price:intervention-4h|flat}}. Les implémentations et sessions 1-to-1 commencent à {{price:intervention-dirigeants|flat}}. Tous nos tarifs sont publics et sans engagement.",
    },
    {
