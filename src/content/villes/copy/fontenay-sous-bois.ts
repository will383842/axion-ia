...
export const FONTENAY_SOUS_BOIS_COPY: VilleCopy = {
  pitchFr:
    "Axion-IA, cabinet d'experts IA seniors, accompagne les TPE et PME de Fontenay-sous-Bois (94), en lisière du bois de Vincennes. Ville résidentielle et tertiaire de l'est parisien, elle accueille des sièges et un dense réseau de petites structures de services, de conseil et de commerce. Nous y déployons une IA opérationnelle, sobre et conforme RGPD pour ces entreprises val-de-marnaises.",
  pitchEn:
    "Axion-IA, cabinet d'experts IA seniors, accompagne les TPE et PME de Fontenay-sous-Bois (94), en lisière du bois de Vincennes. Ville résidentielle et tertiaire de l'est parisien, elle accueille des sièges et un dense réseau de petites structures de services, de conseil et de commerce. Nous y déployons une IA opérationnelle, sobre et conforme RGPD pour ces entreprises val-de-marnaises.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Fontenay-sous-Bois (94), dans le Val-de-Marne. Nous accompagnons en priorité les TPE puis les PME : prestataires de services aux entreprises, éditeurs et sociétés informatiques, professions libérales, commerces et sous-traitants des sièges locaux. Audit sur place sur site, tarifs publics. Les ETI restent un cas marginal de notre clientèle.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Fontenay-sous-Bois (94), dans le Val-de-Marne. Nous accompagnons en priorité les TPE puis les PME : prestataires de services aux entreprises, éditeurs et sociétés informatiques, professions libérales, commerces et sous-traitants des sièges locaux. Audit sur place sur site, tarifs publics. Les ETI restent un cas marginal de notre clientèle.",
