...
// Fuveau (13, Bouches-du-Rhône) — ancien bassin minier reconverti, est d'Aix, pied de la Sainte-Victoire.
...
export const FUVEAU_COPY: VilleCopy = {
  ...
  pitchEn:
    "Fuveau (13), commune de l'est aixois au pied de la Sainte-Victoire, est un ancien bassin minier reconverti vers le résidentiel, le tertiaire et les zones d'activités. TPE artisans, professions libérales, PME tertiaires, commerces et viticulteurs AOC Côtes-de-Provence. Axion-IA opère pour toutes les structures économiques de la commune.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Fuveau (13). Nous accompagnons TPE artisans, professions libérales, PME tertiaires, viticulteurs AOC et commerces du bassin minier reconverti de l'est aixois. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Fuveau (13). Nous accompagnons TPE artisans, professions libérales, PME tertiaires, viticulteurs AOC et commerces du bassin minier reconverti de l'est aixois. Audit sur place sur mesure.",
  ...
  ecosystemEn:
    "Fuveau est à l'est d'Aix-en-Provence, au pied de la Sainte-Victoire. Ancien bassin minier (charbon, fermeture années 2000) reconverti vers le résidentiel haut de gamme, le tertiaire et des zones d'activités (ZA Saint-Estève, parc d'activités). Viticulture AOC Côtes-de-Provence Sainte-Victoire, PME tertiaires, artisanat BTP, professions libérales travaillant à Aix ou Marseille.",
  distancesFr:
    "Aix-en-Provence à 20 min. Marseille à 35 min via A52. Gare TGV Aix à 30 min. Aéroport Marseille-Provence à 35 min. Gardanne à 15 min. Trets à 10 min. Accès A52 et A8.",
  distancesEn:
    "Aix-en-Provence à 20 min. Marseille à 35 min via A52. Gare TGV Aix à 30 min. Aéroport Marseille-Provence à 35 min. Gardanne à 15 min. Trets à 10 min. Accès A52 et A8.",
  topSectorsNaf: [
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Fuveau : ateliers pour domaines viticoles, cabinets libéraux, équipes PME tertiaires et artisans. Outils IA configurés métier réel.",
    },
    implementation: {
      fr: "Implémentation IA à Fuveau : gestion parcellaire viticole, automatisation cabinet libéral, CRM augmentés, agents conversationnels caveau, marketing digital local. RGPD strict.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Fuveau et dans le pays de la Sainte-Victoire ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les domaines viticoles AOC sur des cas IA : gestion parcellaire prédictive, traçabilité vendanges, marketing vente directe, agents IA caveau, optimisation œnotourisme.",
    },
    {
      q: "Travaillez-vous avec les PME tertiaires des parcs d'activités ?",
      a: "Oui, nous intervenons auprès des PME tertiaires sur automatisation back-office, CRM intelligents, gestion commerciale, agents IA support client, automatisation reporting et tableaux de bord.",
    },
    {
