...
export const SAINTE_ADRESSE_COPY: VilleCopy = {
  ...
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient a Sainte-Adresse (76). Nous accompagnons les TPE, PME et professions liberales du Nice havrais : medecins, avocats, commercants, acteurs du tourisme et prestataires de services. Audit Flash a partir de 490 EUR HT.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient a Sainte-Adresse (76). Nous accompagnons les TPE, PME et professions liberales du Nice havrais : medecins, avocats, commercants, acteurs du tourisme et prestataires de services. Audit Flash a partir de 490 EUR HT.",
  ecosystemFr:
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA a Sainte-Adresse : diagnostic adapte aux professions liberales, TPE de services et acteurs du tourisme du Nice havrais. ROI chiffre, audit Flash 490 EUR HT.",
      en: "Audit IA a Sainte-Adresse : diagnostic adapte aux professions liberales, TPE de services et acteurs du tourisme du Nice havrais. ROI chiffre, audit Flash 490 EUR HT.",
    },
    interventions: {
