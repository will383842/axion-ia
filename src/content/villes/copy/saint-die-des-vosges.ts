...
// Saint-Dié-des-Vosges (88, Vosges) — Sous-préfecture, FIG, baptême de l'Amérique 1507, 19 251 hab.
...
export const SAINT_DIE_DES_VOSGES_COPY: VilleCopy = {
  ...
  pitchEn:
    "Saint-Dié-des-Vosges (88), sous-préfecture des Vosges, 19 251 habitants, est un pôle industriel et culturel du massif vosgien. Berceau du baptême de l'Amérique (1507), siège du Festival International de Géographie (FIG), la ville concentre un tissu de TPE/PME textile, bois, papeterie, mécanique, commerce et services. Axion-IA opère sur l'ensemble des activités professionnelles locales.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Saint-Dié-des-Vosges (88). Nous accompagnons TPE et PME du massif vosgien : industriels textile, bois, papeterie, mécaniciens, commerçants et prestataires de services. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Saint-Dié-des-Vosges (88). Nous accompagnons TPE et PME du massif vosgien : industriels textile, bois, papeterie, mécaniciens, commerçants et prestataires de services. Audit sur place sur mesure.",
  ecosystemFr:
  ...
  ecosystemEn:
    "Saint-Dié-des-Vosges est la sous-préfecture des Vosges et un pôle économique structurant du massif vosgien. Son tissu industriel historique (textile, bois, papeterie, mécanique) se diversifie vers le numérique et les services. Le Festival International de Géographie (FIG) et le patrimoine cartographique (baptême de l'Amérique, 1507) soutiennent un tourisme culturel. Bassin d'emploi articulé autour de la vallée de la Meurthe, relié à Strasbourg, Nancy et Colmar.",
  distancesFr:
    "Strasbourg à 1h15 via tunnel Maurice-Lemaire (A35/N59). Nancy à 1h20 via N59/A33. Colmar à 50 min via tunnel de Sainte-Marie-aux-Mines. Gare SNCF Saint-Dié (TER Strasbourg, Nancy). Pas de gare TGV directe, correspondance Strasbourg ou Nancy.",
  distancesEn:
    "Strasbourg à 1h15 via tunnel Maurice-Lemaire (A35/N59). Nancy à 1h20 via N59/A33. Colmar à 50 min via tunnel de Sainte-Marie-aux-Mines. Gare SNCF Saint-Dié (TER Strasbourg, Nancy). Pas de gare TGV directe, correspondance Strasbourg ou Nancy.",
  seoHook: "textile, bois & industrie vosgienne",
  topSectorsNaf: [
    "Textile & habillement",
    "Bois, papeterie & ameublement",
    "Mécanique & sous-traitance industrielle",
    "Commerce de proximité & restauration",
    "Services aux entreprises & tourisme culturel",
  ],
  servicesContext: {
    audit: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Dié-des-Vosges ?",
      a: "Oui, Axion-IA intervient à Saint-Dié-des-Vosges et dans la vallée de la Meurthe (Raon-l'Étape, Senones, Fraize, Gérardmer). Consultants accessibles via gare SNCF Saint-Dié (TER Strasbourg/Nancy). Strasbourg à 1h15, Nancy à 1h20.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, commerçants et artisans déodatiens : gestion stocks, relation client, automatisation comptabilité, présence en ligne, agents conversationnels. Approche adaptée au tissu économique du centre-ville et des zones d'activités périphériques.",
    },
    {
