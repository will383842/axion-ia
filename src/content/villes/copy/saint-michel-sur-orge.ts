...
export const SAINT_MICHEL_SUR_ORGE_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Le tissu économique de Saint-Michel-sur-Orge est dominé par les services (40,4 % de l'emploi), le commerce (21,9 %) et la construction (9,9 %). Les actifs se répartissent entre employés (29,9 %), professions intermédiaires (27,9 %), ouvriers (19,3 %), cadres (17,5 %) et artisans-commerçants (5,3 %). Le revenu médian par foyer s'élevait à 34 972 € en 2010. La ville investit dans le sport de haut niveau (handball Nationale 1 féminine, basket, tennis), ce qui structure également l'activité associative et événementielle locale.",
  distancesFr:
    "Saint-Michel-sur-Orge se trouve à 24 km au sud-ouest de Paris. La gare de Saint-Michel-sur-Orge est desservie par le RER C. La gare TGV de Massy est à environ 15 km, l'aéroport de Paris-Orly à environ 20 km. Accès routier via la RN20 et la francilienne (N104).",
  distancesEn:
    "Saint-Michel-sur-Orge se trouve à 24 km au sud-ouest de Paris. La gare de Saint-Michel-sur-Orge est desservie par le RER C. La gare TGV de Massy est à environ 15 km, l'aéroport de Paris-Orly à environ 20 km. Accès routier via la RN20 et la francilienne (N104).",
  topSectorsNaf: [
  ...
  servicesContext: {
    audit: {
      fr: "Réaliser un audit IA à Saint-Michel-sur-Orge — adapté aux PME et ETI des services, commerces et BTP — Audit sur place dès {{price:audit-flash|flat}}.",
      en: "Réaliser un audit IA à Saint-Michel-sur-Orge — adapté aux PME et ETI des services, commerces et BTP — Audit sur place dès {{price:audit-flash|flat}}.",
    },
    interventions: {
    ...
    unAUn: {
      fr: "Accompagner en 1-to-1 les dirigeants de PME et ETI à Saint-Michel-sur-Orge — sessions personnalisées — à partir de {{price:intervention-dirigeants|flat}}.",
      en: "Accompagner en 1-to-1 les dirigeants de PME et ETI à Saint-Michel-sur-Orge — sessions personnalisées — à partir de {{price:intervention-dirigeants|flat}}.",
    },
  },
  services: {
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Saint-Michel-sur-Orge des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure et mobile-first, e-commerce multi-CMS (WordPress, Shopify, WooCommerce, PrestaShop, Magento), chatbot RAG multilingue ancré sur vos contenus, recherche sémantique, agents et automatisations. Pensé pour une ville essonnienne de 21 776 habitants où le tissu repose à 40,4 % sur les services, 21,9 % sur le commerce de détail et 9,9 % sur la construction — un terrain de PME et ETI du centre-ville, de l'artisanat du BTP et du transport, le long des 2 km de berges de l'Orge. Population jeune (39,7 % de moins de 30 ans) et écosystème sportif structurant (handball Nationale 1 féminine, basket, tennis). Devis à partir de 24-48 h selon la complexité, hébergement UE, code et données à vous. Kick-off en présentiel à Saint-Michel-sur-Orge, itérations à distance.",
        whyHere: [
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, notre équipe se déplace sur site sous 5 jours ouvrés après validation de la mission. Accès via le RER C (gare de Saint-Michel-sur-Orge), la RN20 ou la francilienne N104.",
    },
    {
      q: "Axion-IA couvre-t-il les communes voisines de Saint-Michel-sur-Orge ?",
      a: "Oui, nous intervenons également à Longpont-sur-Orge, Sainte-Geneviève-des-Bois, Brétigny-sur-Orge et Le Plessis-Pâté, ainsi que plus largement sur l'agglomération Cœur d'Essonne et le sud de l'Essonne.",
    },
    {
      q: "Vos solutions IA sont-elles conformes RGPD à Saint-Michel-sur-Orge ?",
      a: "Oui, toutes nos solutions respectent strictement le RGPD : hébergement en Union européenne, code source livré au client, registre des traitements à jour et traçabilité complète des accès aux données.",
    },
    {
      q: "Quels secteurs locaux bénéficient le plus de l'IA à Saint-Michel-sur-Orge ?",
      a: "Les services aux entreprises (40,4 % de l'emploi local), le commerce de détail (21,9 %) et les artisans du BTP (9,9 %) bénéficient particulièrement de l'automatisation des devis, plannings et relances. Les sociétés de transport et l'écosystème sportif/événementiel local sont aussi concernés.",
    },
    {
      q: "Proposez-vous des formations IA pour les équipes à Saint-Michel-sur-Orge ?",
      a: "Oui, nous proposons des sessions 1-to-1 pour dirigeants à partir de {{price:intervention-dirigeants|flat}} et des formations collectives sur site adaptées aux équipes opérationnelles des PME et ETI michelloises.",
    },
  ],
};
