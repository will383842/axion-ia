...
export const ANN_ULLIN_COPY: VilleCopy = {
  ...
  pitchEn:
    "Annœullin (59), commune du Nord en agglomération Lille sud, est issue du bassin minier reconverti. Tissu mixte : TPE artisans BTP, PME industrielles reconverties, commerces de proximité, professions libérales, services péri-urbains. Axion-IA opère pour toutes les structures économiques de la commune.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Annœullin (59). Nous accompagnons tous types d'activités : TPE artisans BTP, PME industrielles reconverties, commerçants de proximité, professions libérales, indépendants et services aux entreprises du sud lillois.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Annœullin (59). Nous accompagnons tous types d'activités : TPE artisans BTP, PME industrielles reconverties, commerçants de proximité, professions libérales, indépendants et services aux entreprises du sud lillois.",
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Pour les commerçants et professions libérales à Annœullin, audit sur place {{price:audit-flash|flat}}, intervention 1 journée formation, coaching 1-to-1. Cas typiques : agents conversationnels, automatisation RDV, fidélisation.",
    },
    {
