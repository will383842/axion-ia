...
// Quimperlé (29, Finistère) — Confluence Ellé/Isole, abbaye Sainte-Croix, industrie papetière.
...
export const QUIMPERLE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Quimperlé (29), cité finistérienne au confluent de l'Ellé et de l'Isole, est connue pour son abbaye Sainte-Croix et son héritage papetier industriel. Tissu TPE artisans, PME agroalimentaires et papetières, commerces centre-ville, services et tourisme. Axion-IA collabore avec toutes les structures locales du Pays de Quimperlé et du sud Finistère.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Quimperlé (29). Nous accompagnons tous types d'activités : TPE artisans et commerçants centre-ville, PME agroalimentaires et papetières, indépendants, professions libérales, acteurs du tourisme et services aux entreprises du Pays de Quimperlé et du sud Finistère.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Quimperlé (29). Nous accompagnons tous types d'activités : TPE artisans et commerçants centre-ville, PME agroalimentaires et papetières, indépendants, professions libérales, acteurs du tourisme et services aux entreprises du Pays de Quimperlé et du sud Finistère.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Quimperlé et dans le sud Finistère ?",
      a: "Oui, Axion-IA intervient à Quimperlé et tout le Pays de Quimperlé (Moëlan-sur-Mer, Riec-sur-Bélon, Clohars-Carnoët, Bannalec, Scaër). Nos consultants viennent via TGV gare de Quimperlé ou depuis Lorient (20 min N165).",
    },
    {
      q: "Travaillez-vous avec les PME agroalimentaires bretonnes du sud Finistère ?",
      a: "Oui, nous accompagnons les PME agroalimentaires du Pays de Quimperlé sur leurs cas IA : contrôle qualité par vision, traçabilité automatisée, prédiction demande, optimisation chaîne de production et agents conversationnels B2B.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les acteurs du tourisme (hôtels, restaurants, sites patrimoniaux, offices de tourisme) sur leurs cas IA : chatbot réservation multilingue, pricing dynamique, gestion avis clients, automatisation communication saisonnière.",
    },
    {
