...
export const LES_PAVILLONS_SOUS_BOIS_COPY: VilleCopy = {
  ...
  pitchEn:
    "Les Pavillons-sous-Bois (93), commune de 25 804 habitants (2023) située à 10 km au nord-est de Paris en Seine-Saint-Denis. Tissu de TPE commerçants et artisans (commerce 33,5 %, construction 17 %), PME services. Zone d'activité La Poudrette (55+ entreprises). Desserte tramway T4 (deux arrêts) et canal de l'Ourcq. Axion-IA accompagne TPE, PME et professions libérales locales sur leurs projets IA.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient aux Pavillons-sous-Bois (93). Nous accompagnons en priorité les TPE (commerces de proximité, artisans BTP, professions libérales) puis les PME (zone d'activité La Poudrette, services aux entreprises), avec des cas d'usage IA concrets (devis, relation client, automatisation), des tarifs publics dès 490 € HT et des consultants qui se déplacent en tramway T4 ou voiture depuis Paris.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient aux Pavillons-sous-Bois (93). Nous accompagnons en priorité les TPE (commerces de proximité, artisans BTP, professions libérales) puis les PME (zone d'activité La Poudrette, services aux entreprises), avec des cas d'usage IA concrets (devis, relation client, automatisation), des tarifs publics dès 490 € HT et des consultants qui se déplacent en tramway T4 ou voiture depuis Paris.",
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA aux Pavillons-sous-Bois : diagnostic 2 jours pour TPE commerçants, artisans BTP, professions libérales et PME de la zone La Poudrette. Cartographie des processus, identification des cas d'usage IA prioritaires, ROI chiffré. Audit Flash dès 490 € HT.",
      en: "Audit IA aux Pavillons-sous-Bois : diagnostic 2 jours pour TPE commerçants, artisans BTP, professions libérales et PME de la zone La Poudrette. Cartographie des processus, identification des cas d'usage IA prioritaires, ROI chiffré. Audit Flash dès 490 € HT.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'Audit Flash démarre à 490 € HT (diagnostic 2 jours). L'Intervention Essentielle démarre à 590 € HT. Le coaching 1-to-1 démarre à 990 € HT. Tarifs publics affichés, pas de devis opaque, pas de frais cachés.",
    },
    {
