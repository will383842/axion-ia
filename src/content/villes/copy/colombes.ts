...
export const COLOMBES_COPY: VilleCopy = {
  ...
  distancesEn:
    "Colombes est à environ 10 km au nord-ouest du centre de Paris. Quatre gares Transilien desservent la ville : Colombes et Le Stade sur la ligne J, La Garenne-Colombes et Les Vallées sur la ligne L. Les tramways T1 et T2 complètent la desserte. L'aéroport Paris-Charles-de-Gaulle est à environ 30 km par l'A86 puis l'A1, l'aéroport d'Orly à environ 25 km via l'A86.",
  topSectorsNaf: [
    "Programmation informatique & ESN",
    "Commerce de détail centre-ville",
    "Bâtiment & artisans",
    "Services aux entreprises (cabinets, agences)",
    "Industrie & R&D (héritage aéronautique)",
  ],
  servicesContext: {
    audit: {
    ...
    interventions: {
      ...
      en: "Interventions sur site à Colombes pour automatiser des cas concrets : extraction et classement de PDF, enrichissement CRM, génération de devis depuis Excel, relances clients par email, exports comptables vers Sage ou EBP. Code Python/TypeScript versionné et documenté, livré à votre équipe.",
    },
    implementation: {
      fr: "Implémentation à Colombes de briques IA durables : connecteurs entre vos outils existants (compta, CRM, messagerie), agents internes pour le support et la qualification, pipelines de reporting hebdo. Architecture pensée pour rester maintenable par votre équipe ou un prestataire tiers.",
  ...
  services: {
    sitesWeb: {
        ...
        methodology: [
          {
            ...
            detail:
              "Un brief de cadrage confidentiel pour comprendre votre activité, vos outils (CRM, ERP, compta, PIM e-commerce) et vos objectifs. Particulièrement utile pour les directions métier des sièges colombiens et les PME des parcs Kléber et Fossés-Jean qui partent de systèmes hétérogènes.",
          },
          {
            step: "Kick-off à Colombes",
            detail:
              "Première venue sur site à Colombes — secteur Charles-de-Gaulle / Portes de la Défense au sud ou parcs d'activité au nord — pour observer vos parcours réels (clients, commandes, support) et cadrer l'architecture du site ou de la plateforme SaaS avec vos équipes.",
          },
          {
            step: "Design UX/UI et maquettes",
            detail:
              "Conception de l'interface (desktop et mobile) et des parcours : pages, tunnel e-commerce multi-CMS, espace client ou SaaS métier. Maquettes validées avant la moindre ligne de code, pour éviter les allers-retours coûteux.",
          },
          {
            step: "Développement IA-native",
            detail:
              "Développement en code custom : front, back, intégrations (paiement, CRM, ERP), plus les briques IA utiles — chatbot RAG sur vos contenus, recherche sémantique, génération assistée. Code versionné, documenté, propriété du client, sans dépendance à Axion-IA.",
          },
          {
            step: "Mise en ligne et transfert",
            detail:
              "Déploiement sur hébergement Union européenne conforme RGPD, recette avec vos équipes, transfert de propriété complet du code et de la documentation. Vous pouvez reprendre la main en interne ou avec tout prestataire, sans verrou éditeur.",
          },
        ],
        pricing: [
          {
          ...
          },
          {
            ...
            detail:
              "Pour les PME des parcs Kléber, Equilibre et du parc technologique des Fossés-Jean : site métier ou e-commerce multi-CMS, espace client, intégration CRM/compta et chatbot RAG sur vos contenus.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Pour les ETI et établissements adossés à La Défense (énergie, agroalimentaire, services) : application SaaS métier, portail multi-utilisateurs, recherche sémantique, agents internes, intégrations ERP — architecture pensée pour durer.",
          },
          {
            sizeLabel: "Grande entreprise",
            price: "Programme plateforme & gouvernance",
            detail:
              "Pour les directions des grands comptes colombiens (Arkema, UCB Pharma, Shell, Oracle, Tetra Pak, PepsiCo, Biogaran) : conception de plateformes IA avec exigences de conformité pharma/données, souveraineté et hébergement UE, et transfert aux équipes internes.",
          },
        ],
        faq: [
          {
          ...
          },
          {
            ...
            a: "Oui. Le pôle santé colombien — UCB Pharma en immunologie/neurologie, Biogaran sur les génériques — impose des exigences de conformité et de souveraineté des données. Nous les intégrons dès l'architecture : hébergement Union européenne par défaut, minimisation des données, journalisation et clauses de confidentialité, plutôt que de les ajouter après coup.",
          },
          {
            q: "Travaillez-vous l'e-commerce et le multi-CMS, ou seulement du sur-mesure ?",
            a: "Les deux. Nous concevons des boutiques e-commerce sur les principaux CMS du marché comme du développement full-custom, selon ce qui sert votre activité. Pour une PME des parcs d'activité du nord de Colombes, un socle CMS bien intégré à votre compta et votre CRM est souvent le bon choix ; pour une plateforme SaaS métier, on part sur du code custom.",
          },
          {
            q: "Le code et la plateforme restent-ils notre propriété après la mission ?",
            a: "Oui, intégralement. Le code est versionné, documenté et vous appartient. Vous pouvez le reprendre en interne ou le confier à tout prestataire du nord des Hauts-de-Seine — il n'y a aucun verrou éditeur ni dépendance contractuelle à Axion-IA. L'hébergement reste en Union européenne et conforme RGPD.",
          },
          {
      ...
      en: {
        ...
        whyHere: [
          "Colombes concentrates establishments of large groups drawn by the immediate proximity of La Défense: specialty chemicals (Arkema, historically at 420 rue d'Estienne d'Orves), immunology/neurology biopharma (UCB Pharma), energy (Shell, with Engie next door in La Garenne-Colombes) and food (PepsiCo, Tetra Pak) — all business units that need robust portals and internal SaaS tools.",
          "The real fabric of Colombes is mostly SMEs and micro-businesses: 94% of companies have fewer than 10 employees, spread across the Charles-de-Gaulle sector in the south (Portes de la Défense, Perspective Défense, West Plaza) and in the north across the Kléber park, the Equilibre programme, the Fossés-Jean technology park and the Prairie industrial zone. We build sites and e-commerce for them that do not require an in-house IT department.",
          "The Colombes pharmaceutical and health cluster (UCB Pharma, generics maker Biogaran) imposes data compliance and sovereignty constraints: we handle these from the architecture stage — EU hosting, logging, data minimisation — rather than bolting them on afterwards.",
          "Colombes is a living Olympic venue: the Yves-du-Manoir stadium, host of the 1924 Games and the Paris 2024 field hockey events, now houses the national training centre of the French Hockey Federation. Clubs, federations and event operators in northern Hauts-de-Seine have concrete needs for ticketing, registration and member areas that we know how to build.",
        ],
        methodology: [
          {
            step: "Remote scoping",
            detail:
              "A confidential scoping brief to understand your business, your tools (CRM, ERP, accounting, e-commerce PIM) and your goals. Especially useful for the business units of Colombes headquarters and the SMEs of the Kléber and Fossés-Jean parks starting from heterogeneous systems.",
          },
          {
            step: "Kick-off in Colombes",
            detail:
              "First on-site visit in Colombes — Charles-de-Gaulle / Portes de la Défense sector in the south or the northern business parks — to observe your real journeys (customers, orders, support) and frame the architecture of the site or SaaS platform with your teams.",
          },
          {
            step: "UX/UI design and mockups",
            detail:
              "Designing the interface (desktop and mobile) and the journeys: pages, multi-CMS e-commerce funnel, customer or line-of-business SaaS area. Mockups validated before a single line of code, to avoid costly back-and-forth.",
          },
          {
            step: "AI-native development",
            detail:
              "Custom-code development: front end, back end, integrations (payment, CRM, ERP), plus the useful AI building blocks — RAG chatbot on your content, semantic search, assisted generation. Versioned, documented code, owned by the client, with no dependency on Axion-IA.",
          },
          {
            step: "Go-live and handover",
            detail:
              "Deployment on European Union hosting compliant with GDPR, acceptance testing with your teams, full transfer of ownership of the code and documentation. You can take over in-house or with any provider, with no vendor lock-in.",
          },
        ],
        pricing: [
          {
          ...
          },
          {
            ...
            detail:
              "For SMEs in the Kléber and Equilibre parks and the Fossés-Jean technology park: line-of-business site or multi-CMS e-commerce, customer area, CRM/accounting integration and RAG chatbot on your content.",
          },
          {
            sizeLabel: "ETI",
            price: "AI-native SaaS platform",
            detail:
              "For mid-caps and establishments backing onto La Défense (energy, food, services): line-of-business SaaS application, multi-user portal, semantic search, internal agents, ERP integrations — architecture built to last.",
          },
          {
            sizeLabel: "Grande entreprise",
            price: "Platform and governance programme",
            detail:
              "For the leadership of the Colombes large accounts (Arkema, UCB Pharma, Shell, Oracle, Tetra Pak, PepsiCo, Biogaran): designing AI platforms with pharma/data compliance requirements, sovereignty and EU hosting, and handover to internal teams.",
          },
        ],
        faq: [
          {
            q: "What types of Colombes businesses do you design sites and SaaS platforms for?",
            a: "The full spectrum: micro-businesses and shops in the town centre and around the Yves-du-Manoir stadium, SMEs in the Kléber and Equilibre parks and the Fossés-Jean technology park, and the business units of the tertiary establishments in the Charles-de-Gaulle / Portes de la Défense sector (Arkema, UCB Pharma, Shell, Oracle, Tetra Pak, PepsiCo, Biogaran). We focus on the nature of the need — showcase, e-commerce, customer area or line-of-business SaaS — not the size.",
          },
          {
            q: "Do you handle the compliance constraints of the Colombes pharma and health players?",
            a: "Yes. The Colombes health cluster — UCB Pharma in immunology/neurology, Biogaran in generics — imposes data compliance and sovereignty requirements. We build them into the architecture from the start: European Union hosting by default, data minimisation, logging and confidentiality clauses, rather than adding them afterwards.",
          },
          {
            q: "Do you do e-commerce and multi-CMS, or only fully custom builds?",
            a: "Both. We design e-commerce stores on the main market CMSs as well as full-custom development, depending on what serves your business. For an SME in the northern Colombes business parks, a CMS foundation well integrated with your accounting and CRM is often the right choice; for a line-of-business SaaS platform, we go with custom code.",
          },
          {
            q: "Do the code and platform remain our property after the project?",
            a: "Yes, entirely. The code is versioned, documented and yours. You can take it over in-house or hand it to any provider in northern Hauts-de-Seine — there is no vendor lock-in and no contractual dependency on Axion-IA. Hosting stays in the European Union and GDPR-compliant.",
          },
          {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Nous nous déplaçons sur site à Colombes pour les phases d'observation et de mise en route — environ 10 km depuis Paris via T1, T2, Transilien J ou L. Le suivi régulier et les itérations peuvent ensuite se faire en visio si vous le préférez.",
    },
    {
      q: "Intervenez-vous aussi dans les communes proches de Colombes ?",
      a: "Oui : nous intervenons à Asnières-sur-Seine, Gennevilliers, Nanterre, Bois-Colombes, La Garenne-Colombes ainsi qu'à Argenteuil et Bezons (Val-d'Oise), toutes limitrophes de Colombes.",
    },
    {
    ...
    },
    {
      ...
      a: "Toutes nos missions à Colombes intègrent un volet RGPD : minimisation des données collectées, hébergement UE par défaut, registre des traitements, et clauses de confidentialité dans chaque devis. Le code livré reste votre propriété et peut être audité.",
    },
    {
