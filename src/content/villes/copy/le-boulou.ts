...
// Le Boulou (66, Pyrénées-Orientales) — Station thermale, frontalier Espagne, A9.
...
export const LE_BOULOU_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il au Boulou et dans le Vallespir frontalier ?",
      a: "Oui, Axion-IA intervient au Boulou et tout le Vallespir frontalier (Céret à 10 min, Le Perthus à 10 min, Maureillas, Saint-Jean-Pla-de-Corts). Nos consultants viennent de Perpignan (25 min).",
    },
    {
      q: "Travaillez-vous avec les PME transport et logistique transfrontalière ?",
      a: "Oui, nous accompagnons les PME transport et logistique transfrontalière du Boulou (axe A9 France-Espagne) : optimisation tournées, automatisation douane, agents IA bilingues FR/ES, suivi flotte.",
    },
    {
      q: "Accompagnez-vous les professionnels du thermalisme ?",
