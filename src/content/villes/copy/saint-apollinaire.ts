...
// Saint-Apollinaire (21, Côte-d'Or) — nord-est Dijon, zones d'activités et logistique.
...
export const SAINT_APOLLINAIRE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Saint-Apollinaire (21), commune de Côte-d'Or au nord-est immédiat de Dijon, est marquée par ses zones d'activités économiques (Cap Nord) et son positionnement logistique. Tissu PME logistique, commerce, TPE artisans, services aux entreprises, résidentiel périurbain dijonnais. Axion-IA y déploie son expertise pour toutes les organisations.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Saint-Apollinaire (21). Nous accompagnons TPE et PME : PME logistique et distribution Cap Nord, commerces, TPE artisans, services aux entreprises et résidentiel périurbain dijonnais. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Saint-Apollinaire (21). Nous accompagnons TPE et PME : PME logistique et distribution Cap Nord, commerces, TPE artisans, services aux entreprises et résidentiel périurbain dijonnais. Audit sur place sur mesure.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Apollinaire et agglo dijonnaise ?",
      a: "Oui, Axion-IA intervient à Saint-Apollinaire et toute la métropole dijonnaise (Quetigny, Chenôve, Talant, Fontaine-lès-Dijon). Consultants depuis Dijon (10 min).",
    },
    {
      q: "Travaillez-vous avec les PME logistique Cap Nord ?",
      a: "Oui, optimisation supply chain IA, prévision demande, automatisation préparation commandes, routage tournées et traçabilité.",
    },
    {
      q: "Accompagnez-vous les commerces de gros ?",
