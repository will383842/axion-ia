...
// Saint-Jacques-de-la-Lande (35, Ille-et-Vilaine) — aéroport Rennes, sud Rennes Métropole.

import type { VilleCopy } from "./types";

export const SAINT_JACQUES_DE_LA_LANDE_COPY: VilleCopy = {
  pitchFr:
  ...
  ecosystemEn:
    "Saint-Jacques-de-la-Lande est la commune d'accueil de l'aéroport Rennes-Bretagne, porte aérienne de la Bretagne. Zone économique aéroportuaire (logistique, fret, services voyageurs), complétée par un tissu TPE/PME de services, commerces et activités tertiaires. Développement urbain rapide avec l'arrivée du métro ligne B, quartier de la Courrouze.",
  distancesFr:
    "Aéroport Rennes-Bretagne sur la commune. Métro ligne B station La Courrouze (directe centre Rennes 10 min). Gare Rennes TGV à 10 min. Rocade sud Rennes immédiate. Paris TGV 1h25 depuis Rennes.",
  distancesEn:
    "Aéroport Rennes-Bretagne sur la commune. Métro ligne B station La Courrouze (directe centre Rennes 10 min). Gare Rennes TGV à 10 min. Rocade sud Rennes immédiate. Paris TGV 1h25 depuis Rennes.",
  topSectorsNaf: [
    "Logistique aéroportuaire et fret",
    "Services aux entreprises",
    "Commerce et distribution",
    "TPE artisanat et BTP",
    "Activités tertiaires métropolitaines",
  ],
  servicesContext: {
    audit: {
    ...
    implementation: {
      ...
      en: "Implémentation IA à Saint-Jacques-de-la-Lande : optimisation logistique aéroportuaire, automatisation facturation, agents conversationnels service client, prédiction flux voyageurs. Sud Rennes Métropole.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Saint-Jacques-de-la-Lande : sessions dans vos bureaux, zone aéroportuaire ou en visio. Dirigeants logistiques, gérants TPE/PME, commerçants du sud Rennes Métropole.",
      en: "Coaching 1-to-1 à Saint-Jacques-de-la-Lande : sessions dans vos bureaux, zone aéroportuaire ou en visio. Dirigeants logistiques, gérants TPE/PME, commerçants du sud Rennes Métropole.",
    },
  },
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Jacques-de-la-Lande ?",
      a: "Oui, Axion-IA intervient à Saint-Jacques-de-la-Lande et tout le sud de Rennes Métropole (Bruz, Chartres-de-Bretagne, Noyal-Châtillon-sur-Seiche). Nos consultants se déplacent directement dans vos locaux, zone aéroportuaire comprise.",
    },
    {
      q: "Travaillez-vous avec les entreprises de la zone aéroportuaire ?",
      a: "Oui, nous accompagnons les TPE et PME de la zone aéroportuaire Rennes-Bretagne sur leurs cas IA : optimisation logistique fret, prédiction flux voyageurs, automatisation traitement bagages, agents IA service client multilingue.",
    },
    {
      q: "Accompagnez-vous les entreprises de services du sud Rennes ?",
      a: "Oui, nous accompagnons les entreprises de services, cabinets conseil, professions libérales et sociétés tertiaires du sud Rennes Métropole sur leurs cas IA : automatisation admin, RAG documentaire, agents conversationnels, outils productivité.",
    },
    {
      q: "Quels services pour les TPE et commerçants jacquolandins ?",
      a: "Pour les TPE, artisans et commerçants à Saint-Jacques-de-la-Lande, audit Flash 490 € HT, intervention 1 journée formation, coaching 1-to-1. Cas typiques : automatisation devis, agents IA prise de RDV, gestion stocks.",
    },
    {
