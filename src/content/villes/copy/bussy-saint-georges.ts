...
export const BUSSY_SAINT_GEORGES_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit Flash 4h sur site à Bussy-Saint-Georges pour les TPE et PME du parc Gustave-Eiffel ou du centre-ville — {{price:intervention-4h|flat}}.",
      en: "Audit Flash 4h sur site à Bussy-Saint-Georges pour les TPE et PME du parc Gustave-Eiffel ou du centre-ville — {{price:intervention-4h|flat}}.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Nos tarifs publics démarrent à {{price:intervention-4h|flat}} pour un Audit Flash de 4 heures à Bussy-Saint-Georges. Les interventions et implémentations suivantes sont facturées sur devis selon le périmètre validé après l'audit.",
    },
    {
