    ...
    sitesWeb: {
      fr: {
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une application avec UX/UI et IA intégrée, pour studios, scale-ups et PME montreuilloises.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Plateforme métier, interactive ou portail client sur mesure, IA intégrée, branchée sur votre SI (CRM, ERP, datalake).",
          },
          {
            sizeLabel: "Grande entreprise",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Montreuil — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous, particulièrement pour les studios créatifs.",
          },
          {
            q: "Vous travaillez pour le gaming, le créatif et la finance ?",
            a: "Oui : plateformes interactives, portails, recherche sémantique, RAG et agents pour studios (Ubisoft), créatifs du Bas-Montreuil et grands comptes finance (AFD, BNP Paribas Personal Finance). Hébergement UE, RGPD strict.",
          },
          {
      ...
      en: {
        ...
        whyHere: [
          ...
          "Gaming, creative & finance: interactive platforms, portals, data and agents — we adapt the AI brick to your sector, from studio to large digital department. EU hosting, strict GDPR.",
        ],
        methodology: [
          {
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Design or rebuild of a site or app with UX/UI and built-in AI, for studios, scale-ups and Montreuil SMEs.",
          },
          {
            sizeLabel: "Mid-cap",
            price: "AI-native SaaS platform",
            detail:
              "Bespoke business, interactive or customer portal platform, AI built in, wired into your IS (CRM, ERP, datalake).",
          },
          {
            sizeLabel: "Large enterprise",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Montreuil — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us, especially for creative studios.",
          },
          {
            q: "Do you work for gaming, creative and finance?",
            a: "Yes: interactive platforms, portals, semantic search, RAG and agents for studios (Ubisoft), Bas-Montreuil creatives and finance large accounts (AFD, BNP Paribas Personal Finance). EU hosting, strict GDPR.",
          },
          {
