...
export const LONS_LE_SAUNIER_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les TPE artisans BTP et commerçants de Lons-le-Saunier sur des cas IA pratiques : automatisation devis, agents IA prise de rendez-vous, gestion stocks, optimisation planning. Audit Flash 490 € HT adapté aux petites structures.",
    },
    {
