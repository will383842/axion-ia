...
// Lons-le-Saunier (39, Jura) — Préfecture du Jura, thermes, Vache qui rit, Rouget de Lisle.
...
export const LONS_LE_SAUNIER_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Lons-le-Saunier : diagnostic adapté aux TPE artisans, PME agroalimentaires et fromagères du Jura, commerçants, acteurs du thermalisme et collectivités. ROI mesurable, audit Flash dès {{price:audit-flash|flat}} accessible.",
      en: "Audit IA à Lons-le-Saunier : diagnostic adapté aux TPE artisans, PME agroalimentaires et fromagères du Jura, commerçants, acteurs du thermalisme et collectivités. ROI mesurable, audit Flash dès {{price:audit-flash|flat}} accessible.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Lons-le-Saunier et dans le Jura ?",
      a: "Oui, Axion-IA intervient à Lons-le-Saunier et dans tout le département du Jura (Champagnole, Poligny, Arbois, Saint-Claude, Dole). Couverture également Besançon à 1h10, Bourg-en-Bresse à 1h et Lyon à 1h40.",
    },
    {
      q: "Travaillez-vous avec les entreprises agroalimentaires et fromagères du Jura ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les TPE artisans BTP et commerçants de Lons-le-Saunier sur des cas IA pratiques : automatisation devis, agents IA prise de rendez-vous, gestion stocks, optimisation planning. Audit Flash {{price:audit-flash|flat}} adapté aux petites structures.",
    },
    {
      q: "Quels services pour le thermalisme et le tourisme jurassien ?",
      a: "Pour les acteurs du thermalisme et du tourisme jurassien, nous proposons des implémentations IA adaptées : agents conversationnels réservation et accueil, automatisation planning soins, gestion avis en ligne, chatbots information touristique reculées et vignoble du Jura.",
    },
    {
