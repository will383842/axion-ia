...
// Saint-Astier (24, Dordogne) — Vallée Isle, ciment, abbaye.
...
export const SAINT_ASTIER_COPY: VilleCopy = {
  ...
  pitchEn:
    "Saint-Astier (24), bourg de la vallée de l'Isle en Dordogne, connu pour sa cimenterie historique et son abbatiale romane. Tissu TPE/PME commerce, artisanat, industrie ciment, agroalimentaire et services. Axion-IA y déploie son expertise pour toutes les organisations.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Saint-Astier (24). Nous accompagnons TPE/PME du commerce, de l'artisanat, de l'industrie, de l'agroalimentaire périgourdin et des services en vallée de l'Isle. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Saint-Astier (24). Nous accompagnons TPE/PME du commerce, de l'artisanat, de l'industrie, de l'agroalimentaire périgourdin et des services en vallée de l'Isle. Audit sur place sur mesure.",
  ecosystemFr:
  ...
  ecosystemEn:
    "Saint-Astier est un bourg historique de la vallée de l'Isle, entre Périgueux et Mussidan. Connu pour sa cimenterie (chaux hydraulique naturelle, référence BTP/restauration patrimoine) et son abbatiale romane. Économie : commerce de proximité, artisanat, industrie ciment et matériaux, agroalimentaire (élevage, cultures), BTP et services.",
  distancesFr:
    "Périgueux à 20 min. Mussidan à 15 min. Bordeaux à 1h30 A89. Bergerac à 40 min. Gare SNCF Saint-Astier ligne Bordeaux–Périgueux. Aéroport Bergerac-Dordogne-Périgord à 45 min.",
  distancesEn:
    "Périgueux à 20 min. Mussidan à 15 min. Bordeaux à 1h30 A89. Bergerac à 40 min. Gare SNCF Saint-Astier ligne Bordeaux–Périgueux. Aéroport Bergerac-Dordogne-Périgord à 45 min.",
  seoHook: "ciment, artisanat & vallée de l'Isle",
  topSectorsNaf: [
    "Industrie ciment & matériaux",
    "Commerce de détail & artisanat",
    "Agroalimentaire & élevage",
    "BTP & restauration patrimoine",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Saint-Astier : formations pratiques pour commerçants, artisans, équipes industrie et exploitants agricoles de la vallée de l'Isle.",
    },
    implementation: {
      fr: "Implémentation IA à Saint-Astier : optimisation production ciment, gestion stock commerce, traçabilité agroalimentaire, automatisation devis BTP, outils métier.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Astier ?",
    ...
    },
    {
      ...
      a: "Oui, cas IA industrie ciment : optimisation process production, maintenance prédictive, contrôle qualité automatisé, planification expéditions et reporting automatisé.",
    },
    {
      q: "Quel délai pour démarrer une mission IA à Saint-Astier ?",
      a: "Intervention sous 5 jours ouvrés. Périgueux à 20 min, Bordeaux à 1h30 A89. Déplacements sur site ou sessions en visio selon vos préférences.",
    },
    {
