...
export const PIGNAN_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, audits IA adaptés aux domaines viticoles AOC : optimisation gestion parcelles, automatisation relation client caveau, classification avis, prédiction vendanges. Audit sur place {{price:audit-flash|flat}}, restitution sous 7 jours.",
    },
    {
      q: "Quels services pour les artisans BTP à Pignan ?",
      a: "Pour les artisans BTP (13,7 % des établissements pignanais) : Audit sur place {{price:audit-flash|flat}}, Formation 4 h {{price:intervention-4h|flat}}, coaching 1-to-1 dès {{price:intervention-dirigeants|flat}}. Cas typiques : devis automatisés, classification photos chantier, planification interventions, agents IA réponse client.",
    },
    {
      q: "Accompagnez-vous les commerces de proximité ?",
      a: "Oui, pour les commerces et activités d'hôtellerie de Pignan (17,9 % des établissements) : Audit sur place {{price:audit-flash|flat}}, coaching rapide. Cas typiques : chatbot client, gestion stocks, automatisation commandes fournisseurs, marketing digital local.",
    },
    {
