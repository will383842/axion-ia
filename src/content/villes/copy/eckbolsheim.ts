...
// Eckbolsheim (67, Bas-Rhin) — agglo Strasbourg ouest, hippodrome.
...
export const ECKBOLSHEIM_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Eckbolsheim est une commune de l'agglomération strasbourgeoise située à l'ouest de Strasbourg, marquée par l'hippodrome de Strasbourg et un tissu de services, commerces et artisans. Bassin de vie intégré à l'Eurométropole, accès direct au centre de Strasbourg en quelques minutes.",
  distancesFr:
    "Strasbourg centre à 10 min. Gare TGV de Strasbourg à 12 min. Aéroport Strasbourg-Entzheim à 10 min. Autoroute A35 accès à 5 min. Colmar à 1h. Allemagne (Kehl) à 20 min.",
  distancesEn:
    "Strasbourg centre à 10 min. Gare TGV de Strasbourg à 12 min. Aéroport Strasbourg-Entzheim à 10 min. Autoroute A35 accès à 5 min. Colmar à 1h. Allemagne (Kehl) à 20 min.",
  seoHook: "services, commerces & artisans",
  topSectorsNaf: [
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Eckbolsheim ?",
      a: "Oui, Axion-IA intervient à Eckbolsheim et dans l'agglomération strasbourgeoise (Strasbourg, Schiltigheim, Lingolsheim, Wolfisheim). Consultants via A35 ou tram strasbourgeois. Bassin de vie intégré à l'Eurométropole.",
    },
    {
      q: "Travaillez-vous avec les commerces et artisans d'Eckbolsheim ?",
