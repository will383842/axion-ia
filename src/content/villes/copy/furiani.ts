...
export const FURIANI_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Furiani : sessions dans votre commerce, structure, exploitation ou en visio. Dirigeants TPE/PME furianais, gérants structures sportives et touristiques.",
      en: "Coaching 1-to-1 à Furiani : sessions dans votre commerce, structure, exploitation ou en visio. Dirigeants TPE/PME furianais, gérants structures sportives et touristiques.",
    },
  },
  faqGeolocalisee: [
    {
