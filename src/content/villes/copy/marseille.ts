...
export const MARSEILLE_COPY: VilleCopy = {
  ...
  services: {
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Marseille des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Marseille, itérations à distance.",
        whyHere: [
          "Projets web & SaaS marseillais : opérateurs maritimes & logistiques du Grand Port (filiales CMA CGM), deeptech Château-Gombert (photonique, défense), biotech Luminy, services Euroméditerranée.",
          ...
          "Plateformes logistiques & portuaires : tracking, automatisations métier et agents branchés sur vos outils — hébergement UE, RGPD strict.",
        ],
        methodology: [
          {
            step: "Cadrage à Marseille",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une application avec UX/UI et IA intégrée, pour PME et scale-ups marseillaises.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Plateforme métier ou portail client sur mesure pour la logistique, le maritime et l'industrie, IA intégrée, branchée sur votre SI (TMS, ERP, datalake).",
          },
          {
            sizeLabel: "Grande entreprise",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Marseille — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Vous gérez les plateformes logistiques et portuaires ?",
            a: "Oui : portails de suivi, automatisations métier, agents branchés sur vos outils (TMS, ERP, douane), recherche sémantique documentaire. Un terrain naturel à Marseille avec le Grand Port et l'écosystème CMA CGM. Hébergement UE, RGPD strict.",
          },
          {
          ...
          },
          {
            ...
            a: "Oui. Après le cadrage, on remet un devis ferme en forfait fixe. Le délai de remise dépend de la complexité — à partir de 48 h pour un projet simple, davantage pour une plateforme logistique étendue. Pas de régie, pas de dérive horaire cachée.",
          },
          {
        ...
        guarantees:
          "Devis ferme en forfait fixe (à partir de 48 h selon la complexité) : pas de dérive horaire cachée. Mise en ligne sans downtime quand on augmente l'existant. Web Vitals et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD : propriété totale, aucun abonnement imposé, transférable à tout prestataire de la région marseillaise ou repris en interne.",
      },
      en: {
        hero: "In Marseille, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 48 h depending on project complexity, EU hosting, code and data yours. On-site Marseille kick-off, remote iterations.",
        whyHere: [
          "Marseille web & SaaS projects: maritime & logistics operators of the Grand Port (CMA CGM subsidiaries), Château-Gombert deeptech (photonics, defence), Luminy biotech, Euroméditerranée services.",
          ...
          "Logistics & port platforms: tracking, business automations and agents wired to your tools — EU hosting, strict GDPR.",
        ],
        methodology: [
          {
            step: "Scoping in Marseille",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Design or rebuild of a site or app with UX/UI and built-in AI, for Marseille SMEs and scale-ups.",
          },
          {
            sizeLabel: "Mid-cap",
            price: "AI-native SaaS platform",
            detail:
              "Bespoke business platform or customer portal for logistics, maritime and industry, AI built in, wired into your IS (TMS, ERP, datalake).",
          },
          {
            sizeLabel: "Large enterprise",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Marseille — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Do you handle logistics and port platforms?",
            a: "Yes: tracking portals, business automations, agents wired to your tools (TMS, ERP, customs), semantic document search. A natural fit in Marseille with the Grand Port and the CMA CGM ecosystem. EU hosting, strict GDPR.",
          },
          {
          ...
          },
          {
            ...
            a: "Yes. After scoping, we deliver a firm quote on a fixed package. Turnaround depends on complexity — from 48 h for a simple project, more for an extended logistics platform. No time-and-materials, no hidden hourly drift.",
          },
          {
