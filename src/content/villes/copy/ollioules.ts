...
export const OLLIOULES_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Audit sur place {{price:audit-flash|flat}}, interventions sur site, coaching 1-to-1, implémentation IA. Cas horticulture : optimisation production sous serre, prévision rendements, automatisation traçabilité, gestion commerciale B2B et marché aux fleurs.",
    },
    {
