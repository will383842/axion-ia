...
// Tain-l'Hermitage (26, Drôme) — viticulture AOC Hermitage, Crozes-Hermitage, Saint-Joseph, oenotourisme prestige.
...
export const TAIN_L_HERMITAGE_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Tain-l'Hermitage : formats adaptés au domaine viticole, négoce en vins, atelier agroalimentaire. Vos équipes repartent autonomes sur outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Tain-l'Hermitage : prédiction vendanges grands crus, classification photos cépages, traçabilité AOC export, agents conversationnels oenotourisme multilingue, scoring sommellerie.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Tain-l'Hermitage et vallée du Rhône ?",
      a: "Oui, Axion-IA intervient à Tain-l'Hermitage et toute la vallée du Rhône septentrionale (Tournon-sur-Rhône rive opposée Ardèche, Mercurol-Veaunes, Erôme). Couverture grands crus AOC. Consultants depuis Lyon (1h A7) ou Valence (25 min).",
    },
    {
      q: "Travaillez-vous avec les viticulteurs AOC Hermitage / Crozes-Hermitage ?",
      a: "Oui, nous accompagnons les viticulteurs AOC Hermitage, Crozes-Hermitage et Saint-Joseph (vallée du Rhône septentrionale) sur leurs cas IA : prédiction vendanges grands crus, classification photos cépages, traçabilité AOC export, agents conversationnels oenotourisme multilingue prestige.",
    },
    {
      q: "Accompagnez-vous les négociants et PME agroalimentaires ?",
