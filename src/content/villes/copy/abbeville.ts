...
// Abbeville (80, Somme) — capitale du Ponthieu, agroalimentaire, serrurerie et métallurgie historiques, porte d'entrée du tourisme de la baie de Somme.
...
export const ABBEVILLE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Abbeville : diagnostic adapté aux PME agroalimentaires, aux ateliers de serrurerie et de métallurgie, à l'hôtellerie-restauration et aux artisans. Nous identifions les usages prioritaires et chiffrons le ROI avant tout engagement.",
      en: "Audit IA à Abbeville : diagnostic adapté aux PME agroalimentaires, aux ateliers de serrurerie et de métallurgie, à l'hôtellerie-restauration et aux artisans. Nous identifions les usages prioritaires et chiffrons le ROI avant tout engagement.",
    },
    interventions: {
      fr: "Interventions IA sur site à Abbeville : sessions en atelier, en cuisine ou au bureau. Vos équipes deviennent autonomes sur les devis, le suivi de production et la gestion des réservations.",
      en: "Interventions IA sur site à Abbeville : sessions en atelier, en cuisine ou au bureau. Vos équipes deviennent autonomes sur les devis, le suivi de production et la gestion des réservations.",
    },
    implementation: {
      fr: "Implémentation IA à Abbeville : automatisation des devis et de la planification industrielle, gestion des réservations touristiques, traçabilité agroalimentaire et reporting pour PME et artisans.",
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, c'est un de nos terrains privilégiés. Pour l'agroalimentaire et les ateliers de serrurerie et de métallurgie, nous automatisons devis, planification, traçabilité et reporting, sur des outils simples à prendre en main.",
    },
    {
      q: "Accompagnez-vous l'hôtellerie et la restauration de la baie de Somme ?",
      a: "Oui, pour les hôtels et restaurants liés au tourisme de la baie de Somme, nous mettons en place gestion des réservations, réponses automatiques, optimisation de l'occupation saisonnière et fidélisation client.",
    },
    {
