...
export const BAILLEUL_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Bailleul : diagnostic adapté aux TPE artisans, PME agroalimentaire et brasserie, commerçants et professions libérales de la Flandre française. Audit Flash 490 € HT, ROI chiffré sous 10 jours.",
      en: "Audit IA à Bailleul : diagnostic adapté aux TPE artisans, PME agroalimentaire et brasserie, commerçants et professions libérales de la Flandre française. Audit Flash 490 € HT, ROI chiffré sous 10 jours.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Nous proposons audit Flash 4h (490 € HT), interventions sur site demi-journée ou journée, coaching dirigeant 1-to-1 et implémentation clé en main. Formats adaptés aux contraintes des TPE artisans et commerçants flamands.",
    },
    {
