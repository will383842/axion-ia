...
export const SCIONZIER_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'Audit Flash Axion-IA démarre à 490 € HT, adapté aux TPE et PME de Scionzier. Diagnostic complet des opportunités IA dans votre activité (décolletage, artisanat, commerce), ROI chiffré et plan d'action concret sous 5 jours ouvrés.",
    },
    {
