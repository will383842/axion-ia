...
// Plessé (44, Loire-Atlantique) — Nord Loire-Atlantique, rural, forêt du Gâvre, agriculture & élevage.
...
export const PLESSE_COPY: VilleCopy = {
  ...
  topSectorsNaf: [
    ...
    "Artisanat BTP & filière bois",
    "Commerce de proximité",
    "Agroalimentaire & transformation",
    "Services de santé & professions libérales",
  ],
  servicesContext: {
    audit: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Plessé : formations et ateliers pratiques adaptés aux exploitants agricoles, artisans BTP et commerçants. Vos équipes repartent autonomes sur les outils IA du quotidien.",
    },
    implementation: {
      fr: "Implémentation IA à Plessé : automatisation gestion troupeau et traçabilité, agents IA devis chantier BTP, outils prédiction stocks commerçants, digitalisation PME agroalimentaires pays de Redon.",
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les artisans BTP et menuisiers de Plessé sur des cas IA pratiques : automatisation devis chantier, planification équipes, gestion stocks matériaux, agents IA prise de rendez-vous clients.",
    },
    {
