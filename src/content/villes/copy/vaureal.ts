...
// Vauréal (95, Val-d'Oise) — ville nouvelle Cergy-Pontoise, résidentielle, 16 079 hab.
...
export const VAUREAL_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Vauréal : formats adaptés au commerce, cabinet ou atelier. Vos équipes repartent autonomes sur les outils IA configurés pour leur métier.",
    },
    implementation: {
      fr: "Implémentation IA à Vauréal : automatisation devis artisans, agents conversationnels pour commerces, gestion relation client PME, digitalisation cabinets libéraux. Bassin Cergy-Pontoise.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Vauréal dans le Val-d'Oise ?",
      a: "Oui, Axion-IA intervient à Vauréal et dans toute l'agglomération Cergy-Pontoise (Cergy, Jouy-le-Moutier, Pontoise, Osny, Saint-Ouen-l'Aumône). Nos consultants se déplacent sur site ou en visio.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nos interventions IA sur site à Vauréal et Cergy-Pontoise sont adaptées aux PME de services et commerces. Formats demi-journée ou journée complète, vos équipes repartent autonomes sur les outils IA configurés.",
    },
    {
