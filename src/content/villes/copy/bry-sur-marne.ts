...
// Bry-sur-Marne (94, Val-de-Marne) — RER A, studios INA/cinéma, bords de Marne.
...
export const BRY_SUR_MARNE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Bry-sur-Marne : diagnostic adapté aux TPE audiovisuels, PME de services numériques, commerçants et professions libérales de l'est Val-de-Marne. ROI chiffré, Audit Flash {{price:audit-flash|flat}}.",
      en: "Audit IA à Bry-sur-Marne : diagnostic adapté aux TPE audiovisuels, PME de services numériques, commerçants et professions libérales de l'est Val-de-Marne. ROI chiffré, Audit Flash {{price:audit-flash|flat}}.",
    },
    interventions: {
      ...
      en: "Interventions IA sur site à Bry-sur-Marne : formats adaptés au studio, agence, commerce ou cabinet. Vos équipes repartent autonomes sur les outils IA configurés pour leur métier.",
    },
    implementation: {
      fr: "Implémentation IA à Bry-sur-Marne : automatisation post-production audiovisuelle, agents conversationnels PME numériques, gestion relation client commerces, digitalisation cabinets. Écosystème studios et créatifs.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Bry-sur-Marne dans le Val-de-Marne ?",
      a: "Oui, Axion-IA intervient à Bry-sur-Marne et dans tout l'est du Val-de-Marne (Villiers-sur-Marne, Noisy-le-Grand, Champigny, Chennevières, Le Perreux). Nos consultants se déplacent sur site ou en visio, RER A direct.",
    },
    {
      q: "Quel est le prix d'un audit IA à Bry-sur-Marne ?",
      a: "L'Audit Flash IA à Bry-sur-Marne démarre à {{price:audit-flash|flat}}. Ce diagnostic couvre l'analyse de vos processus métier, l'identification des cas d'usage IA prioritaires et un plan d'action chiffré avec ROI estimé.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nos interventions IA sur site à Bry-sur-Marne sont adaptées aux PME numériques et commerces. Formats demi-journée ou journée complète, vos équipes repartent autonomes sur les outils IA configurés métier.",
    },
    {
