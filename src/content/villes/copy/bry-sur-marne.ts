...
export const BRY_SUR_MARNE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Bry-sur-Marne : diagnostic adapté aux TPE audiovisuels, PME de services numériques, commerçants et professions libérales de l'est Val-de-Marne. ROI chiffré, Audit Flash 490 € HT.",
      en: "Audit IA à Bry-sur-Marne : diagnostic adapté aux TPE audiovisuels, PME de services numériques, commerçants et professions libérales de l'est Val-de-Marne. ROI chiffré, Audit Flash 490 € HT.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'Audit Flash IA à Bry-sur-Marne démarre à 490 € HT. Ce diagnostic couvre l'analyse de vos processus métier, l'identification des cas d'usage IA prioritaires et un plan d'action chiffré avec ROI estimé.",
    },
    {
