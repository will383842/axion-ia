  ...
  faqGeolocalisee: [
    {
      ...
      a: "L'Audit sur place à Saint-Cyr-l'École démarre à {{price:audit-flash|flat}} pour 4 heures sur site, livrable PDF inclus. Les interventions ciblées et accompagnements 1-à-1 démarrent également à {{price:intervention-4h|flat}}. Tarifs publics, sans devis caché.",
    },
    {
      q: "Quels délais pour une intervention Axion-IA à Saint-Cyr-l'École ?",
      a: "Williams se déplace à Saint-Cyr-l'École sous 5 à 10 jours ouvrés après validation. La gare Transilien (lignes N, U, RER C) et le tramway T13 facilitent des interventions express depuis Paris.",
    },
    {
