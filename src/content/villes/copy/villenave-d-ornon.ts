...
const DIRECT_ANSWER_FR =
  "Axion-IA intervient à Villenave-d'Ornon pour les TPE et PME girondines : viticulteurs des Graves et Pessac-Léognan, artisans BTP et sous-traitants de Bordeaux Métropole, commerçants de la zone d'activités (9,8 % du territoire communal), professions libérales et acteurs de la filière vigne-vin gravitant autour de l'ISVV. William se déplace via la gare TGV Bordeaux-Saint-Jean (8 km, tram C direct) pour cadrer le besoin sur place, livrer du code custom et former l'équipe. Audit Flash {{price:audit-flash|flat}}, Intervention Essentielle {{price:intervention-4h|flat}}, 1-à-1 {{price:intervention-dirigeants|flat}}.";
...
const VILLE_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Audit Flash bookable sous 5 à 10 jours ouvrés selon disponibilités. Intervention Essentielle livrée en 2 à 4 semaines selon complexité. Pour les propriétés en période de vendanges, calendrier adapté aux contraintes du chai.",
    },
    {
