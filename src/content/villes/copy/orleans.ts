...
export const ORLEANS_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    sitesWeb: {
      ...
      en: "Custom web platforms and SaaS AI for Orléans and Loiret SMEs/mid-caps — premium showcase site for Cosmetic Valley players (R&D Ormes) and pharma CDMOs (Saint-Jean-de-Braye, Gidy), customer space for BRGM, INRAE and Le LAB'O incubatees, business dashboard connected to your LIMS, CRM or ERP. Senior experts, Axion-IA design system, European hosting.",
    },
  },
  ...
  services: {
    audit: {
      fr: {
        hero: "L'audit IA Axion-IA cartographie ce qui peut être automatisé dans votre entreprise orléanaise et chiffre le retour sur investissement à 12-24 mois. Quatre niveaux du Sur place au Stratégique ETI couvrent toutes les tailles, des PME du centre-ville aux ETI cosmétiques et pharmaceutiques de l'agglomération, en passant par les directions IA des groupes implantés à Ormes et Saint-Jean-de-Braye.",
        whyHere: [
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Orléans des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 24-48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Orléans, itérations à distance.",
        whyHere: [
          "Projets web & SaaS orléanais : cosmétique (Cosmetic Valley, 1er pôle mondial, Shiseido R&D), pharmaceutique (Servier, Famar), machinisme agricole (John Deere France), géosciences (BRGM), PME du Loiret.",
          ...
          "Cosmétique & pharma : e-commerce premium, recommandation, fiches conformes, data RGPD/santé — un terrain naturel à Orléans avec la Cosmetic Valley. Hébergement UE strict.",
        ],
        methodology: [
          {
            step: "Cadrage à Orléans",
            detail:
        ...
        pricing: [
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une boutique avec UX/UI et IA intégrée, pour marques cosmétiques, scale-ups et PME orléanaises.",
          },
          {
            sizeLabel: "ETI",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Orléans — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Vous gérez l'e-commerce cosmétique et pharma ?",
            a: "Oui : e-commerce premium, recommandation, génération de fiches conformes, traduction multilingue (Shopify, WooCommerce, PrestaShop). Un vrai levier pour la Cosmetic Valley et le pharma à l'export, conforme HCU et AI Act. Hébergement UE, RGPD strict, données santé sécurisées.",
          },
          {
        ...
        guarantees:
          "Devis ferme en forfait fixe (à partir de 24-48 h selon la complexité) : pas de dérive horaire cachée. Mise en ligne sans downtime quand on augmente l'existant. Web Vitals et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD : propriété totale, aucun abonnement imposé, transférable à tout prestataire de la région orléanaise ou repris en interne.",
      },
      en: {
        hero: "In Orléans, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 24-48 h depending on project complexity, EU hosting, code and data yours. On-site Orléans kick-off, remote iterations.",
        whyHere: [
          "Orléans web & SaaS projects: cosmetics (Cosmetic Valley, world's leading cluster, Shiseido R&D), pharma (Servier, Famar), agri-machinery (John Deere France), geosciences (BRGM), Loiret SMEs.",
          ...
          "Cosmetics & pharma: premium e-commerce, recommendation, compliant sheets, GDPR/health data — a natural fit in Orléans with Cosmetic Valley. Strict EU hosting.",
        ],
        methodology: [
          {
            step: "Scoping in Orléans",
            detail:
        ...
        pricing: [
          {
            ...
            detail:
              "Design or rebuild of a site or shop with UX/UI and built-in AI, for cosmetics brands, scale-ups and Orléans SMEs.",
          },
          {
            sizeLabel: "Mid-cap",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Orléans — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Do you handle cosmetics and pharma e-commerce?",
            a: "Yes: premium e-commerce, recommendation, compliant sheet generation, multilingual translation (Shopify, WooCommerce, PrestaShop). A real lever for Cosmetic Valley and pharma at export, HCU and AI Act compliant. EU hosting, strict GDPR, secured health data.",
          },
          {
