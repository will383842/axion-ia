...
// Passy (74, Haute-Savoie) — vallée de l'Arve face Mont-Blanc, plateau d'Assy (sanatoriums historiques, église art moderne), voisine Sallanches.
...
export const PASSY_COPY: VilleCopy = {
  ...
  pitchEn:
    "Passy (74), commune de la vallée de l'Arve en Haute-Savoie, est implantée face au Mont-Blanc avec son célèbre plateau d'Assy (sanatoriums historiques, église d'art moderne classée). Tissu tourisme montagne Mont-Blanc, hôtellerie et hébergement, patrimoine culturel, TPE artisanat, commerces de proximité. Axion-IA collabore avec toutes les structures locales.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Passy (74). Nous accompagnons TPE et PME : acteurs tourisme montagne Mont-Blanc, hébergeurs et hôteliers de la vallée de l'Arve, artisans du bâtiment, commerçants, acteurs patrimoine culturel plateau d'Assy.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Passy (74). Nous accompagnons TPE et PME : acteurs tourisme montagne Mont-Blanc, hébergeurs et hôteliers de la vallée de l'Arve, artisans du bâtiment, commerçants, acteurs patrimoine culturel plateau d'Assy.",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Passy : formats adaptés hébergements, hôtels, commerces, ateliers artisans. Vos équipes repartent autonomes sur les outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Passy : agents conversationnels multilingues pour touristes Mont-Blanc, automatisation réservations hébergement, classification avis clients saisonniers.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Passy et vallée de l'Arve ?",
