...
// Darnetal (76, Seine-Maritime) — Vallee Robec, agglo Rouen est, 9 566 hab.
...
export const DARNETAL_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site a Darnetal : formations adaptees aux commerces, cabinets, bureaux tertiaires et ateliers artisanaux. Equipes autonomes sur outils IA.",
    },
    implementation: {
      fr: "Implementation IA a Darnetal : automatisation administrative, agents conversationnels clients, CRM augmentes pour PME tertiaires et commercants de l'agglo rouennaise.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il a Darnetal et dans l'agglo de Rouen ?",
      a: "Oui, Axion-IA intervient a Darnetal et dans toute la metropole rouennaise (Rouen, Bonsecours, Le Mesnil-Esnard, Franqueville-Saint-Pierre). Consultants depuis Rouen (10 min) ou Paris (1h25).",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons avocats, experts-comptables, medecins et autres professions liberales de Darnetal : automatisation documents, IA redaction, gestion agenda intelligente.",
    },
    {
      q: "Vos interventions respectent-elles le RGPD a Darnetal ?",
      a: "Oui, toutes nos interventions a Darnetal sont conformes au RGPD. Protection des donnees de votre entreprise et de vos clients garantie contractuellement.",
    },
  ],
};
