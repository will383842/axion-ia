...
export const LYON_COPY: VilleCopy = {
  ...
  services: {
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Lyon des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 24-48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Lyon, itérations à distance.",
        whyHere: [
          "Projets web & SaaS lyonnais : ETI industrielles de la vallée de la Chimie, biotech/santé Gerland (Lyonbiopôle), scale-ups de Part-Dieu et Confluence (H7), banque/assurance.",
          ...
          "Données sensibles santé/biotech : hébergement UE strict, chaîne IA souveraine RGPD — un vrai atout pour Gerland et la French Tech One.",
        ],
        methodology: [
          {
            step: "Cadrage à Lyon",
        ...
        pricing: [
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une application avec UX/UI et IA intégrée, pour scale-ups et PME lyonnaises.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Plateforme métier ou portail client sur mesure pour l'industrie et la santé, IA intégrée, branchée sur votre SI (CRM, ERP, datalake).",
          },
          {
            sizeLabel: "Grande entreprise",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Lyon — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Mes données santé/biotech restent-elles en Europe ?",
            a: "Oui, et c'est un point clé pour l'écosystème Gerland/Lyonbiopôle : toute la chaîne IA est hébergeable en UE (Hetzner Frankfurt), conforme RGPD, sans transit hors UE sans DPA. Vous gardez la propriété complète de vos données et modèles.",
          },
          {
      ...
      en: {
        hero: "In Lyon, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 24-48 h depending on project complexity, EU hosting, code and data yours. On-site Lyon kick-off, remote iterations.",
        whyHere: [
          "Lyon web & SaaS projects: industrial mid-caps of the Vallée de la Chimie, Gerland health/biotech (Lyonbiopôle), Part-Dieu and Confluence scale-ups (H7), banking/insurance.",
          ...
          "Sensitive health/biotech data: strict EU hosting, GDPR-sovereign AI chain — a real asset for Gerland and French Tech One.",
        ],
        methodology: [
          {
            step: "Scoping in Lyon",
            detail:
        ...
        pricing: [
          {
            ...
            detail:
              "Design or rebuild of a site or app with UX/UI and built-in AI, for Lyon scale-ups and SMEs.",
          },
          {
            sizeLabel: "Mid-cap",
            price: "AI-native SaaS platform",
            detail:
              "Bespoke business platform or customer portal for industry and health, AI built in, wired into your IS (CRM, ERP, datalake).",
          },
          {
            sizeLabel: "Large enterprise",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Lyon — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Does my health/biotech data stay in Europe?",
            a: "Yes, and it's key for the Gerland/Lyonbiopôle ecosystem: the whole AI chain can be hosted in the EU (Hetzner Frankfurt), GDPR-compliant, with no transit outside the EU without a DPA. You keep full ownership of your data and models.",
          },
          {
          ...
          },
          {
            ...
            a: "Yes. After scoping, we deliver a firm quote on a fixed package. Turnaround depends on complexity — from 24-48 h for a simple project, more for an extended industrial business platform. No time-and-materials, no hidden hourly drift.",
          },
          {
