...
export const LE_PLESSIS_ROBINSON_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Non. Axion-IA n'a pas d'agence au Plessis-Robinson : nos architectes IA se déplacent depuis Paris, avec des frais de transport transparents distincts du forfait.",
    },
  ],
};
