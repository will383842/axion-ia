      ...
      fr: {
        ...
        methodology: [
          ...
          },
          {
            ...
            detail:
              "Wireframes, design system et maquettes Figma à votre marque, pensés mobile-first et pour une lecture rapide des contenus techniques denses. Prototype cliquable testé avec vos commerciaux ou votre support avant toute ligne de code, pour valider l'ergonomie sur les cas d'usage du sud Saclay.",
          },
          {
            step: "Développement par sprints",
            detail:
              "Greffe IA sur l'existant ou build IA-native : portail produit, e-commerce B2B multi-CMS, chatbot RAG multilingue sur vos notices, recherche sémantique, agents de qualification. Démos hebdomadaires en visio depuis Courtaboeuf, avec priorisation continue selon vos retours d'équipe technique.",
          },
          {
            step: "Recette + mise en ligne",
            detail:
              "Tests d'acceptation menés avec vos référents métier, Web Vitals et SEO/AEO validés, accessibilité contrôlée, puis mise en production sans downtime — sans interrompre vos flux commerciaux ni votre support technique, y compris en pleine campagne ou clôture trimestrielle.",
          },
          {
            step: "Livraison + autonomie",
            detail:
              "Code source, bases et modèles livrés chez vous, hébergement UE possible aux Ulis ou ailleurs en Europe. Passation et documentation pour que vos équipes techniques et bureaux d'études pilotent l'outil en autonomie, sans verrou ni abonnement imposé par Axion-IA.",
          },
        ],
        pricing: [
          {
            ...
            detail:
              "Conception ou refonte d'un site produit, d'un portail technique ou d'une boutique B2B pour les sous-traitantes pharma, électronique, instrumentation et IT du sud Saclay : UX/UI mobile-first, documentation interactive, e-commerce multi-CMS et IA intégrée.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Plateforme métier ou portail client sur mesure pour les acteurs structurants du parc de Courtaboeuf — éditeurs de logiciels, fournisseurs d'instrumentation, groupes pharma — avec IA intégrée et branchement sur votre SI (CRM, ERP, PLM).",
          },
          {
            sizeLabel: "Grande entreprise",
            price: "Programme produit",
            detail:
              "Programmes pluriannuels pour les grands sièges pharma, électronique et logiciel du sud Saclay : refonte de plateformes, design system mutualisé, recherche sémantique sur la documentation R&D, équipe dédiée Axion-IA en mode produit.",
          },
        ],
        faq: [
          {
            q: "Faites-vous l'UX/UI et l'e-commerce, pas seulement l'IA ?",
            a: "Oui. On conçoit l'expérience complète — research, wireframes, design system, maquettes Figma, prototype cliquable, mobile-first — pour un site produit, un portail technique ou une boutique B2B, avec ou sans brique IA. E-commerce multi-CMS (WordPress, Shopify, WooCommerce, PrestaShop, Magento) ou code sur mesure : on s'adapte à votre stack, pas l'inverse.",
          },
          {
            q: "Mes données techniques et réglementaires restent-elles en Europe ?",
            a: "Oui. Toute la chaîne IA est hébergeable en UE, conforme RGPD et AI Act, sans transit hors UE sans DPA signé. Pour les filières pharma, dispositifs médicaux et électronique de Courtaboeuf, vos fiches, notices, données de traçabilité et données clients restent maîtrisées, sans verrou ni dépendance à un prestataire unique ni à un cloud extra-européen.",
          },
          {
          ...
          },
          {
            ...
            a: "Oui. Pour un éditeur de logiciels, un fournisseur d'instruments ou une sous-traitante pharma de Courtaboeuf, on déploie un chatbot RAG multilingue sur la documentation, une recherche sémantique sur le catalogue et des agents de qualification commerciale, greffés sur votre site existant ou un nouveau portail produit pensé pour des cycles B2B longs.",
          },
          {
            q: "Pouvez-vous construire une boutique B2B pour vendre instruments et pièces aux Ulis ?",
            a: "Oui. On conçoit des vitrines e-commerce B2B adaptées au commerce de gros technique du parc de Courtaboeuf : catalogues d'instruments et de pièces, tarifs par compte client, devis en ligne, commandes récurrentes et fiches produits enrichies. Le tout en multi-CMS ou sur mesure, avec recherche sémantique et chatbot pour guider l'acheteur dans une référence technique dense.",
          },
        ],
        guarantees:
