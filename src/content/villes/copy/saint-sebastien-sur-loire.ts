...
export const SAINT_SEBASTIEN_SUR_LOIRE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Saint-Sébastien-sur-Loire, ville de Loire-Atlantique (44) en banlieue sud de Nantes, mêle tissu résidentiel familial et TPE/PME locales (artisanat, commerces, services). Axion-IA y intervient pour les TPE, indépendants et PME tertiaires du bassin nantais sud Loire.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Saint-Sébastien-sur-Loire (44). Nous accompagnons les TPE artisanales, indépendants, PME tertiaires sébastiennaises (cabinets, commerces, services aux entreprises) et structures du bassin sud Nantes sur leurs cas IA opérationnels.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Saint-Sébastien-sur-Loire (44). Nous accompagnons les TPE artisanales, indépendants, PME tertiaires sébastiennaises (cabinets, commerces, services aux entreprises) et structures du bassin sud Nantes sur leurs cas IA opérationnels.",
  ecosystemFr:
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Saint-Sébastien : diagnostic adapté aux TPE artisanales et PME tertiaires sud-Nantes. ROI chiffré pragmatique, audit Flash 490 € HT accessible aux petites structures et indépendants.",
      en: "Audit IA à Saint-Sébastien : diagnostic adapté aux TPE artisanales et PME tertiaires sud-Nantes. ROI chiffré pragmatique, audit Flash 490 € HT accessible aux petites structures et indépendants.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les TPE artisanales et indépendants à Saint-Sébastien sur des cas IA accessibles : automatisation devis/factures, agents IA pour relation client, planification interventions. Audit Flash 490 € HT adapté aux artisans et petits commerces.",
    },
    {
