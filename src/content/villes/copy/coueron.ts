...
export const COUERON_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Accompagnement un-à-un à Couëron pour dirigeants de TPE/PME : monter en compétence sur l'IA générative, choisir les bons outils, éviter les pièges no-code. Format 1h30 à 990 € HT, sur site ou Loire-Atlantique.",
      en: "Accompagnement un-à-un à Couëron pour dirigeants de TPE/PME : monter en compétence sur l'IA générative, choisir les bons outils, éviter les pièges no-code. Format 1h30 à 990 € HT, sur site ou Loire-Atlantique.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    },
    {
      ...
      a: "Oui. Sessions un-à-un à Couëron à partir de 990 € HT (1h30), sur site ou en visio. Cible : dirigeants de TPE/PME souhaitant cadrer leur feuille de route IA sans dépendance no-code.",
    },
  ],
};
