...
// Gex (01, Ain) — chef-lieu pays de Gex, frontière suisse, sous-préfecture Ain, Jura/Mont-Blanc panorama.
...
export const GEX_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Gex : diagnostic adapté aux PME tertiaires pays de Gex, administration, frontaliers Genève, acteurs tourisme Jura, TPE artisans. Audit Flash à {{price:audit-flash|flat}}, retour sur investissement chiffré.",
      en: "Audit IA à Gex : diagnostic adapté aux PME tertiaires pays de Gex, administration, frontaliers Genève, acteurs tourisme Jura, TPE artisans. Audit Flash à {{price:audit-flash|flat}}, retour sur investissement chiffré.",
    },
    interventions: {
      ...
      en: "Interventions IA sur site à Gex : formats adaptés à l'administration, bureau tertiaire, station tourisme, commerce. Vos équipes repartent autonomes sur outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Gex : agents conversationnels multilingue FR/EN/DE (frontaliers Genève), automatisation flux administratifs, agents touristes Jura, classification documents.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Gex et pays de Gex ?",
      a: "Oui, Axion-IA intervient à Gex et tout le pays de Gex (Ferney-Voltaire, Saint-Genis-Pouilly, Divonne-les-Bains, Prévessin-Moëns). Genève à 20 min. Consultants depuis Lyon (1h30) ou Genève (20 min).",
    },
    {
      q: "Travaillez-vous avec l'économie frontalière Genève ?",
      a: "Oui, agents conversationnels multilingue FR/EN/DE, automatisation workflow transfrontalier, classification documents multi-juridiction.",
    },
    {
      q: "Accompagnez-vous les acteurs tourisme Jura ?",
    ...
    },
    {
      ...
      a: "Nos consultants viennent de Lyon (1h30) ou Genève (20 min). Frais de déplacement facturés à part du forfait, tarifs publics.",
    },
  ],
};
