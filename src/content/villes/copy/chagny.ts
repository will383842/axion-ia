...
// Chagny (71, Saône-et-Loire) — Côte chalonnaise, vignoble Bourgogne, canal du Centre, 5 350 hab.
...
export const CHAGNY_COPY: VilleCopy = {
  ...
  pitchEn:
    "Chagny (71), commune au carrefour de la Côte chalonnaise et du canal du Centre en Saône-et-Loire, est un pôle viticole et gastronomique bourguignon. Tissu de TPE/PME viticulture, restauration, commerce, artisanat et services. Axion-IA opère sur l'ensemble des activités professionnelles locales.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Chagny (71). Nous accompagnons TPE et PME : viticulteurs, restaurateurs, commerçants de centre-ville, artisans et prestataires de services de la Côte chalonnaise en Bourgogne. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Chagny (71). Nous accompagnons TPE et PME : viticulteurs, restaurateurs, commerçants de centre-ville, artisans et prestataires de services de la Côte chalonnaise en Bourgogne. Audit sur place sur mesure.",
  ...
  ecosystemEn:
    "Chagny est situé au pied de la Côte chalonnaise, au croisement des vignobles de Bourgogne et du canal du Centre. La ville est connue pour sa gastronomie (Maison Lameloise, 3 étoiles Michelin) et son tissu viticole. L'économie locale repose sur la viticulture, la restauration, le commerce de proximité, l'artisanat BTP et les services. Proximité de Beaune (15 min) et Chalon-sur-Saône (15 min).",
  distancesFr:
    "Gare SNCF Chagny (TER Dijon-Lyon). Beaune à 15 min. Chalon-sur-Saône à 15 min. Gare TGV Le Creusot-Montchanin à 30 min (Paris à 1h20). Dijon à 50 min. Lyon à 1h30 via A6.",
  distancesEn:
    "Gare SNCF Chagny (TER Dijon-Lyon). Beaune à 15 min. Chalon-sur-Saône à 15 min. Gare TGV Le Creusot-Montchanin à 30 min (Paris à 1h20). Dijon à 50 min. Lyon à 1h30 via A6.",
  topSectorsNaf: [
    "Viticulture & négoce viticole",
    "Restauration & gastronomie",
    "Commerce de proximité & artisanat",
    "Hébergement & tourisme viticole",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Chagny et en Côte chalonnaise ?",
      a: "Oui, Axion-IA intervient à Chagny et sur toute la Côte chalonnaise (Beaune, Chalon-sur-Saône, Mercurey, Rully, Givry). Gare TGV Le Creusot-Montchanin à 30 min, Paris à 1h20 en TGV.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les domaines viticoles et maisons de négoce de la Côte chalonnaise. Cas IA typiques : gestion parcellaire, traçabilité vendanges, automatisation relation client B2B, analyse données commerciales export.",
    },
    {
      q: "L'IA peut-elle aider les restaurateurs de Chagny ?",
      a: "Oui, Chagny étant un pôle gastronomique reconnu, nous accompagnons les restaurateurs sur des cas concrets : prévision réservations, gestion approvisionnements, yield management, chatbot accueil client et optimisation planning.",
    },
    {
