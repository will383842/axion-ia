...
export const CROSNE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Crosne (91), commune résidentielle de l'est de l'Essonne aux bords de l'Yerres et de la Seine, accueille un tissu de TPE artisans, commerces de proximité, professions libérales et PME de services. Axion-IA y intervient pour tous types d'activités de l'est essonnien.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Crosne (91). Nous accompagnons tous types d'activités : TPE artisans, commerçants de proximité des bords de l'Yerres, professions libérales, indépendants, PME tertiaires et services de l'est Essonne. Audit Flash sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Crosne (91). Nous accompagnons tous types d'activités : TPE artisans, commerçants de proximité des bords de l'Yerres, professions libérales, indépendants, PME tertiaires et services de l'est Essonne. Audit Flash sur mesure.",
