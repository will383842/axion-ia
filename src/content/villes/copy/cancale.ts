...
// Cancale (35, Ille-et-Vilaine) — Côte d'Émeraude, huîtres plates, port de pêche.
...
export const CANCALE_COPY: VilleCopy = {
  ...
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Cancale (35). Nous accompagnons tous types d'activités : TPE et PME ostréicoles, pêcheurs, restaurateurs, hôteliers, commerçants et artisans de la Côte d'Émeraude. Audit sur place sur mesure, démarrage sous 5 jours.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Cancale (35). Nous accompagnons tous types d'activités : TPE et PME ostréicoles, pêcheurs, restaurateurs, hôteliers, commerçants et artisans de la Côte d'Émeraude. Audit sur place sur mesure, démarrage sous 5 jours.",
  ecosystemFr:
  ...
  ecosystemEn:
    "Cancale est l'une des places fortes de l'ostréiculture française, célèbre pour ses huîtres plates sauvages issues de bancs naturels et ses huîtres creuses d'élevage. La commune combine activité maritime (pêche, ostréiculture, conchyliculture), tourisme balnéaire et gastronomique (restaurants étoilés, hôtellerie, créperies), commerce, artisanat et services aux résidents de la Côte d'Émeraude.",
  distancesFr:
    "Saint-Malo à 20 min. Dinard à 30 min. Mont-Saint-Michel à 45 min. Rennes à 1h via N137. Gare de Saint-Malo à 25 min (TGV Paris 2h10). Aéroport Dinard-Pleurtuit-Saint-Malo à 35 min.",
  distancesEn:
    "Saint-Malo à 20 min. Dinard à 30 min. Mont-Saint-Michel à 45 min. Rennes à 1h via N137. Gare de Saint-Malo à 25 min (TGV Paris 2h10). Aéroport Dinard-Pleurtuit-Saint-Malo à 35 min.",
  topSectorsNaf: [
    "Ostréiculture, conchyliculture & pêche",
    "Hôtellerie, restauration & gastronomie",
    "Tourisme balnéaire & loisirs nautiques",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Cancale et sur la Côte d'Émeraude ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les exploitations ostréicoles et conchylicoles cancalaises sur leurs cas IA : traçabilité produits, prévisions météo et marées, automatisation administrative, gestion bancs naturels, vente directe en ligne et conformité sanitaire.",
    },
    {
      q: "Quels services IA pour les restaurateurs et hôteliers de Cancale ?",
      a: "Pour les restaurateurs et hôteliers cancalais, nous proposons : Audit sur place {{price:audit-flash|flat}}, formation IA 1 journée, coaching 1-to-1. Cas typiques : agents IA réservation, gestion yield management, automatisation menus, fidélisation clients, présence en ligne et traduction multilingue.",
    },
    {
      q: "Comment se déroule une mission Axion-IA à Cancale ?",
      a: "Après un premier échange gratuit, nous planifions l'intervention sous 5 jours. Nos consultants interviennent sur site à Cancale ou en visio. Chaque mission inclut un livrable actionnable, un plan IA chiffré et un suivi post-mission de 30 jours.",
    },
  ],
};
