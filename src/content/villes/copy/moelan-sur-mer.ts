...
export const MOELAN_SUR_MER_COPY: VilleCopy = {
  ...
  pitchEn:
    "Moëlan-sur-Mer (29), commune littorale du sud Finistère entre les rias du Belon et de l'Aven, est mondialement connue pour ses huîtres plates Belon. TPE ostréicoles, PME touristiques, artisans, commerces de bourg, professions libérales et exploitants agricoles composent son tissu économique. Axion-IA opère pour entreprises et indépendants du secteur des rias du Belon et de l'Aven.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Moëlan-sur-Mer (29). Nous accompagnons tous types d'activités : TPE ostréicoles des rias du Belon et de l'Aven, PME touristiques, artisans, commerçants de bourg, professions libérales, exploitants agricoles et indépendants du secteur.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Moëlan-sur-Mer (29). Nous accompagnons tous types d'activités : TPE ostréicoles des rias du Belon et de l'Aven, PME touristiques, artisans, commerçants de bourg, professions libérales, exploitants agricoles et indépendants du secteur.",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Moëlan-sur-Mer : formats adaptés aux exploitations ostréicoles, hébergeurs touristiques, TPE artisans ou commerces de bourg. Vos équipes repartent autonomes sur les outils IA métier.",
    },
    implementation: {
