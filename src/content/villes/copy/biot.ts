...
export const BIOT_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Biot : diagnostic adapté aux TPE artisans d'art (verrerie, céramique), startups tech Sophia Antipolis et PME R&D du bassin Antibes-Valbonne. Audit Flash à 490 € HT, retour sur investissement chiffré accessible aux petites structures.",
      en: "Audit IA à Biot : diagnostic adapté aux TPE artisans d'art (verrerie, céramique), startups tech Sophia Antipolis et PME R&D du bassin Antibes-Valbonne. Audit Flash à 490 € HT, retour sur investissement chiffré accessible aux petites structures.",
    },
    interventions: {
