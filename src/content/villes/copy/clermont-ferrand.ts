...
export const CLERMONT_FERRAND_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA opérationnel à Clermont-Ferrand : nous identifions les workflows automatisables dans votre structure clermontoise et chiffrons le ROI — industrie, agroalimentaire, services ou recherche. 4 niveaux du Sur place au Stratégique ETI selon votre taille.",
  ...
  services: {
        ...
        faq: [
          {
            ...
            a: "Duration varies by tier: a Sur place audit runs over a day, a Mid-cap Strategic audit spans several days or weeks. We agree on the cadence at the framing brief.",
          },
          {
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Clermont-Ferrand des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 24-48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Clermont-Ferrand, itérations à distance.",
        whyHere: [
          "Projets web & SaaS clermontois : industrie (siège mondial Michelin), agroalimentaire & semences (Limagrain, 4e semencier mondial), aéronautique, sous-traitance, PME et ETI auvergnates.",
          ...
          "Industrie & agro à l'échelle : plateformes métier, RAG sur documentation, traçabilité et agents — un terrain naturel avec Michelin et Limagrain. Hébergement UE, RGPD strict.",
        ],
        methodology: [
          {
            step: "Cadrage à Clermont-Ferrand",
            detail:
        ...
        pricing: [
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une application avec UX/UI et IA intégrée, pour industriels, scale-ups et PME clermontoises.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Plateforme métier, industrielle ou agritech sur mesure, IA intégrée, branchée sur votre SI (PLM, ERP, datalake).",
          },
          {
            sizeLabel: "Grande entreprise",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Clermont-Ferrand — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Vous travaillez pour l'industrie et l'agro à grande échelle ?",
            a: "Oui : plateformes métier, RAG sur documentation technique, traçabilité, agents et automatisations branchés sur votre SI (PLM, ERP) — un terrain naturel à Clermont avec Michelin et Limagrain. Hébergement UE, RGPD strict.",
          },
          {
        ...
        guarantees:
          "Devis ferme en forfait fixe (à partir de 24-48 h selon la complexité) : pas de dérive horaire cachée. Mise en ligne sans downtime quand on augmente l'existant. Web Vitals et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD : propriété totale, aucun abonnement imposé, transférable à tout prestataire de la région clermontoise ou repris en interne.",
      },
      en: {
        hero: "In Clermont-Ferrand, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 24-48 h depending on project complexity, EU hosting, code and data yours. On-site Clermont-Ferrand kick-off, remote iterations.",
        whyHere: [
          "Clermont-Ferrand web & SaaS projects: industry (Michelin world HQ), agri-food & seeds (Limagrain, world's 4th seed company), aeronautics, subcontracting, Auvergne SMEs and mid-caps.",
          ...
          "Industry & agri at scale: business platforms, RAG on documentation, traceability and agents — a natural fit with Michelin and Limagrain. EU hosting, strict GDPR.",
        ],
        methodology: [
          {
            step: "Scoping in Clermont-Ferrand",
            detail:
        ...
        pricing: [
          {
            ...
            detail:
              "Design or rebuild of a site or app with UX/UI and built-in AI, for manufacturers, scale-ups and Clermont SMEs.",
          },
          {
            sizeLabel: "Mid-cap",
            price: "AI-native SaaS platform",
            detail:
              "Bespoke business, industrial or agritech platform, AI built in, wired into your IS (PLM, ERP, datalake).",
          },
          {
            sizeLabel: "Large enterprise",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Clermont-Ferrand — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Do you work for industry and agri at scale?",
            a: "Yes: business platforms, RAG on technical documentation, traceability, agents and automations wired to your IS (PLM, ERP) — a natural fit in Clermont with Michelin and Limagrain. EU hosting, strict GDPR.",
          },
          {
