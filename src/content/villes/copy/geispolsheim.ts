...
// Geispolsheim (67, Bas-Rhin) — Sud Strasbourg, vergers cerises, sucrerie historique.
...
export const GEISPOLSHEIM_COPY: VilleCopy = {
  ...
  distancesEn:
    "Strasbourg centre à 15 min. Illkirch-Graffenstaden à 5 min. Aéroport Strasbourg-Entzheim à 10 min. Tramway CTS extension proche. Autoroute A35 accès direct. Gare TER Geispolsheim (ligne Strasbourg–Sélestat).",
  seoHook: "agroalimentaire & arboriculture",
  topSectorsNaf: [
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Geispolsheim ?",
      a: "Oui, Axion-IA intervient à Geispolsheim et dans toute la zone sud de l'eurométropole strasbourgeoise (Illkirch-Graffenstaden, Ostwald, Fegersheim, Lipsheim). Consultants via gare TER ou autoroute A35. Strasbourg centre à 15 min.",
    },
    {
