...
export const NANCY_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    sitesWeb: {
      ...
      en: "Custom web platforms and SaaS AI for Nancy SMEs, mid-caps and organisations — premium showcase site for industry, health and research, business portal for Brabois Technopole and Artem campus, dashboard connected to your CRM/ERP. Senior experts, Axion-IA design system, European hosting.",
    },
  },
  ...
  services: {
    audit: {
      fr: {
        hero: "L'audit IA Axion-IA cartographie ce qui peut être automatisé dans votre organisation nancéienne et chiffre le retour sur investissement à 12-24 mois. Quatre niveaux du Sur place au Stratégique ETI couvrent toutes les tailles, des PME du centre-ville aux ETI industrielles du bassin lorrain et aux directions des organisations de santé du Technopôle Brabois.",
        whyHere: [
    ...
    sitesWeb: {
      fr: {
        ...
        whyHere: [
          ...
          "Santé & data sensible : plateformes santé, RAG, agents — hébergement UE strict, HDS sur demande, conforme RGPD. Un atout pour l'écosystème Brabois.",
        ],
        methodology: [
          {
        ...
        pricing: [
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une application avec UX/UI et IA intégrée, pour scale-ups, acteurs santé et PME nancéiennes.",
          },
          {
            sizeLabel: "ETI",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Nancy — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Vous gérez les données santé sensibles ?",
            a: "Oui : plateformes santé, RAG, agents et portails avec hébergement UE strict, HDS sur demande, conforme RGPD — vos données sensibles ne sortent pas de votre périmètre. Un atout pour l'écosystème santé du Technopôle Brabois et du CHRU.",
          },
          {
      ...
      en: {
        ...
        whyHere: [
          ...
          "Health & sensitive data: health platforms, RAG, agents — strict EU hosting, HDS on request, GDPR-compliant. An asset for the Brabois ecosystem.",
        ],
        methodology: [
          {
        ...
        pricing: [
          {
            ...
            detail:
              "Design or rebuild of a site or app with UX/UI and built-in AI, for scale-ups, health players and Nancy SMEs.",
          },
          {
            sizeLabel: "Mid-cap",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Nancy — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Do you handle sensitive health data?",
            a: "Yes: health platforms, RAG, agents and portals with strict EU hosting, HDS on request, GDPR-compliant — your sensitive data stays within your perimeter. An asset for the Brabois technopole and university hospital health ecosystem.",
          },
          {
