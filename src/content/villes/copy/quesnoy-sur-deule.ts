...
// Quesnoy-sur-Deûle (59, Nord) — Agglo Lille nord, bords Deûle, 6 805 hab.
...
export const QUESNOY_SUR_DEULE_COPY: VilleCopy = {
  ...
  topSectorsNaf: [
    ...
    "BTP et second œuvre résidentiel",
  ],
  servicesContext: {
    audit: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Quesnoy-sur-Deûle : formats adaptés au bureau, commerce, entrepôt logistique. Vos équipes repartent autonomes sur les outils IA du quotidien.",
    },
    implementation: {
      fr: "Implémentation IA à Quesnoy-sur-Deûle : automatisation gestion transport fluvial, agents IA service client, optimisation stocks commerce, outils planification BTP, digitalisation professions libérales.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Quesnoy-sur-Deûle ?",
      a: "Oui, Axion-IA intervient à Quesnoy-sur-Deûle et dans tout le nord de la métropole lilloise (Wambrechies, Marquette-lez-Lille, Deûlémont, Verlinghem). Nos consultants viennent de Lille centre (15 min) ou en visio selon vos contraintes.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les PME transport et logistique fluviale de Quesnoy-sur-Deûle : optimisation tournées, traçabilité expéditions, automatisation planning, gestion documentaire, agents IA relation client B2B.",
    },
    {
