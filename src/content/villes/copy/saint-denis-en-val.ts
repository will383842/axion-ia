...
// Saint-Denis-en-Val (45, Loiret) — agglo Orléans sud, Val de Loire.
...
export const SAINT_DENIS_EN_VAL_COPY: VilleCopy = {
  ...
  topSectorsNaf: [
    ...
    "Maraîchage & horticulture Val de Loire",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Denis-en-Val et agglo Orléans ?",
      a: "Oui, Axion-IA intervient à Saint-Denis-en-Val et dans toute l'agglomération Orléans Métropole (Olivet, Saint-Jean-de-Braye, Fleury-les-Aubrais, Saran). Couverture nationale, déplacement sur site inclus dans le forfait mission.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les PME de services aux entreprises de l'agglo Orléans sud (conseil, informatique, comptabilité, RH). Cas IA : automatisation reporting, CRM augmentés, classification documents, agents conversationnels internes. ROI chiffré contractuel.",
    },
    {
