...
export const NIMES_COPY: VilleCopy = {
  ...
  services: {
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Nîmes des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 24-48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Nîmes, itérations à distance.",
        whyHere: [
          "Projets web & SaaS nîmois : agroalimentaire (Royal Canin), gestion de l'eau & environnement (BRL Groupe), santé (CHU Carémeau), commerce & BTP, technopôle Georges Besse, PME gardoises.",
          ...
          "Agro, santé & services : plateformes métier, RAG, e-commerce et agents — on adapte la brique IA à votre secteur. Hébergement UE, RGPD strict, HDS santé sur demande.",
        ],
        methodology: [
          {
            step: "Cadrage à Nîmes",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une application avec UX/UI et IA intégrée, pour scale-ups, commerces et PME gardoises.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Plateforme métier, santé ou portail client sur mesure, IA intégrée, branchée sur votre SI (CRM, ERP, datalake), hébergement HDS sur demande.",
          },
          {
            sizeLabel: "Grande entreprise",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Nîmes — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Vous travaillez pour la santé et l'agroalimentaire ?",
            a: "Oui : plateformes data, RAG, agents et portails pour la santé (CHU Carémeau) et l'agroalimentaire (Royal Canin). Hébergement UE, RGPD strict, HDS (santé) sur demande — vos données sensibles ne sortent pas de votre périmètre.",
          },
          {
        ...
        guarantees:
          "Devis ferme en forfait fixe (à partir de 24-48 h selon la complexité) : pas de dérive horaire cachée. Mise en ligne sans downtime quand on augmente l'existant. Web Vitals et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD : propriété totale, aucun abonnement imposé, transférable à tout prestataire de la région nîmoise ou repris en interne.",
      },
      en: {
        hero: "In Nîmes, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 24-48 h depending on project complexity, EU hosting, code and data yours. On-site Nîmes kick-off, remote iterations.",
        whyHere: [
          "Nîmes web & SaaS projects: agri-food (Royal Canin), water & environment management (BRL Groupe), health (Carémeau university hospital), retail & construction, Georges Besse technopole, Gard SMEs.",
          ...
          "Agri-food, health & services: business platforms, RAG, e-commerce and agents — we adapt the AI brick to your sector. EU hosting, strict GDPR, HDS health on request.",
        ],
        methodology: [
          {
            step: "Scoping in Nîmes",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Design or rebuild of a site or app with UX/UI and built-in AI, for scale-ups, retailers and Gard SMEs.",
          },
          {
            sizeLabel: "Mid-cap",
            price: "AI-native SaaS platform",
            detail:
              "Bespoke business, health or customer portal platform, AI built in, wired into your IS (CRM, ERP, datalake), HDS hosting on request.",
          },
          {
            sizeLabel: "Large enterprise",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Nîmes — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Do you work for health and agri-food?",
            a: "Yes: data platforms, RAG, agents and portals for health (Carémeau hospital) and agri-food (Royal Canin). EU hosting, strict GDPR, HDS (health) on request — your sensitive data stays within your perimeter.",
          },
          {
