...
export const VERNON_COPY: VilleCopy = {
  pitchFr:
    "Axion-IA, cabinet d'experts IA seniors, accompagne les TPE et PME de Vernon (27), dans l'Eure. Ville du site ArianeGroup, où sont conçus les moteurs des fusées Ariane, Vernon mêle high-tech spatial, industrie, commerce et un tourisme tiré par Giverny et les jardins de Monet. Nous y déployons une IA concrète au service des petites structures de la vallée de la Seine.",
  pitchEn:
    "Axion-IA, cabinet d'experts IA seniors, accompagne les TPE et PME de Vernon (27), dans l'Eure. Ville du site ArianeGroup, où sont conçus les moteurs des fusées Ariane, Vernon mêle high-tech spatial, industrie, commerce et un tourisme tiré par Giverny et les jardins de Monet. Nous y déployons une IA concrète au service des petites structures de la vallée de la Seine.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Vernon (27), dans l'Eure. Nous accompagnons en priorité les TPE puis les PME : sous-traitants industriels et techniques de l'écosystème ArianeGroup, commerces, structures touristiques de Giverny, artisans et professions libérales. Audit sur place sur site, tarifs publics. Les ETI restent un cas marginal de notre clientèle.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Vernon (27), dans l'Eure. Nous accompagnons en priorité les TPE puis les PME : sous-traitants industriels et techniques de l'écosystème ArianeGroup, commerces, structures touristiques de Giverny, artisans et professions libérales. Audit sur place sur site, tarifs publics. Les ETI restent un cas marginal de notre clientèle.",
