...
// Chauvigny (86, Vienne) — Cité médiévale aux 5 châteaux, bords de la Vienne, carrières de pierre.
...
export const CHAUVIGNY_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Chauvigny : diagnostic adapté aux TPE artisans pierre/BTP, PME carriers, acteurs tourisme patrimonial, commerçants et professions libérales du Chauvinois. Audit Flash à {{price:audit-flash|flat}}, retour sur investissement chiffré accessible.",
      en: "Audit IA à Chauvigny : diagnostic adapté aux TPE artisans pierre/BTP, PME carriers, acteurs tourisme patrimonial, commerçants et professions libérales du Chauvinois. Audit Flash à {{price:audit-flash|flat}}, retour sur investissement chiffré accessible.",
    },
    interventions: {
      ...
      en: "Interventions IA sur site à Chauvigny : formats adaptés aux ateliers de taille de pierre, exploitations carrières, sites touristiques ou commerces. Vos équipes terrain et back-office repartent autonomes sur outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Chauvigny : agents conversationnels visiteurs multilingue, classification photos patrimoine, optimisation flux carrières, automatisation devis BTP/pierre, CRM augmenté artisans. Est Vienne.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Chauvigny et vallée de la Vienne ?",
      a: "Oui, Axion-IA intervient à Chauvigny et toute la vallée de la Vienne est (Saint-Savin-sur-Gartempe à 15 min, Lussac-les-Châteaux, Civaux). Consultants depuis Poitiers (25 min) ou Paris (TGV 1h40 + 25 min).",
    },
    {
      q: "Travaillez-vous avec les carriers et artisans pierre de Chauvigny ?",
      a: "Oui, nous accompagnons les carriers et artisans de la pierre de Chauvigny sur leurs cas IA opérationnels : optimisation flux extraction, classification blocs par qualité (vision IA), automatisation devis pierre de taille, gestion stocks carrières. ROI chiffré contractuel.",
    },
    {
      q: "Accompagnez-vous les acteurs tourisme patrimonial ?",
    ...
    },
    {
      ...
      a: "Pour les TPE artisans BTP et commerçants à Chauvigny, audit Flash {{price:audit-flash|flat}}, intervention 1 journée formation pratique, coaching 1-to-1. Cas typiques : automatisation devis, gestion stocks, agents IA prise de RDV, classification photos chantiers.",
    },
    {
