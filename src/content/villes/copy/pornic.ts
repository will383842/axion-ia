...
// Pornic (44, Loire-Atlantique) — Station balnéaire, port, Côte de Jade.
...
export const PORNIC_COPY: VilleCopy = {
  ...
  pitchEn:
    "Pornic (44), station balnéaire et port de la Côte de Jade, près de 19 000 habitants. Économie touristique, thalassothérapie, commerce de centre-ville, artisanat, pêche et ostréiculture. Tissu TPE commerçants, PME hôtelières et touristiques, professions libérales. Axion-IA accompagne entreprises et indépendants du bassin pornicais.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Pornic (44), station balnéaire de la Côte de Jade. Nous accompagnons TPE commerçants, PME hôtelières et touristiques, artisans et professions libérales du littoral sud-Loire. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Pornic (44), station balnéaire de la Côte de Jade. Nous accompagnons TPE commerçants, PME hôtelières et touristiques, artisans et professions libérales du littoral sud-Loire. Audit sur place sur mesure.",
  ...
  ecosystemEn:
    "Pornic (18 745 hab) est une station balnéaire réputée de la Côte de Jade, en Loire-Atlantique. Port de plaisance et de pêche, thalassothérapie, commerces touristiques, artisanat, ostréiculture et agriculture périurbaine. Proximité Nantes (50 min), Saint-Nazaire (35 min). Destination touristique majeure du littoral atlantique sud-Loire.",
  distancesFr:
    "Nantes à 50 min. Saint-Nazaire à 35 min. La Baule à 45 min. Gare SNCF Pornic (TER Nantes-Pornic). Aéroport Nantes-Atlantique à 45 min.",
  distancesEn:
    "Nantes à 50 min. Saint-Nazaire à 35 min. La Baule à 45 min. Gare SNCF Pornic (TER Nantes-Pornic). Aéroport Nantes-Atlantique à 45 min.",
  topSectorsNaf: [
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Pornic : formats adaptés à l'hôtellerie-restauration, commerce touristique, thalasso et artisanat littoral. Vos équipes repartent autonomes sur outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Pornic : revenue management hôtelier, réservation en ligne augmentée, CRM clients tourisme, automatisation facturation et agents conversationnels pour les PME de la Côte de Jade.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Pornic ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons hôteliers, restaurateurs et centres de thalasso : revenue management IA, réservation en ligne optimisée, gestion avis clients, chatbot multilingue et automatisation administrative.",
    },
    {
