...
// Vierzon (18, Cher) — grand carrefour ferroviaire du Centre, héritage du machinisme agricole (Société Française historique), porcelaine, industrie en reconversion.
...
export const VIERZON_COPY: VilleCopy = {
  ...
  pitchEn:
    "À Vierzon (18), carrefour ferroviaire majeur du Centre-Val de Loire et ancienne capitale du machinisme agricole, Axion-IA accompagne les TPE et PME de l'industrie en reconversion, de la logistique et des services. PME mécaniques et métallurgiques héritières du tracteur et de la porcelaine, transporteurs profitant de l'étoile ferroviaire, artisans, commerces et professions libérales : nous concevons des usages IA concrets pour gagner en productivité sans complexité.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Vierzon (Cher) auprès des TPE et PME, en priorité les très petites entreprises, puis les PME. Nous accompagnons les PME industrielles et mécaniques issues de l'histoire du machinisme agricole, les acteurs de la logistique adossés au carrefour ferroviaire, les artisans et les commerces locaux. Tout commence par un audit qui chiffre le retour sur investissement avant tout engagement.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Vierzon (Cher) auprès des TPE et PME, en priorité les très petites entreprises, puis les PME. Nous accompagnons les PME industrielles et mécaniques issues de l'histoire du machinisme agricole, les acteurs de la logistique adossés au carrefour ferroviaire, les artisans et les commerces locaux. Tout commence par un audit qui chiffre le retour sur investissement avant tout engagement.",
  ...
  distancesEn:
    "Vierzon est un nœud ferroviaire majeur : Paris-Austerlitz en 1 h 40, Bourges en 20 minutes, Tours en 50 minutes, Châteauroux en 35 minutes. L'autoroute A71 traverse la ville et l'aéroport de Châteauroux-Centre est à 60 km.",
  topSectorsNaf: [
    "Mécanique et fabrication de produits métalliques",
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Vierzon : diagnostic adapté aux PME mécaniques et métallurgiques, aux acteurs logistiques et aux artisans. Nous identifions les usages prioritaires et chiffrons le ROI avant tout engagement.",
      en: "Audit IA à Vierzon : diagnostic adapté aux PME mécaniques et métallurgiques, aux acteurs logistiques et aux artisans. Nous identifions les usages prioritaires et chiffrons le ROI avant tout engagement.",
    },
    interventions: {
      fr: "Interventions IA sur site à Vierzon : sessions en atelier, en entrepôt ou au bureau. Vos équipes deviennent autonomes sur les devis, le suivi de production et la gestion documentaire.",
      en: "Interventions IA sur site à Vierzon : sessions en atelier, en entrepôt ou au bureau. Vos équipes deviennent autonomes sur les devis, le suivi de production et la gestion documentaire.",
    },
    implementation: {
      fr: "Implémentation IA à Vierzon : automatisation des devis industriels, planification de production et de maintenance, optimisation des tournées logistiques et reporting pour PME mécaniques et transporteurs.",
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, c'est un de nos terrains privilégiés à Vierzon, héritière du machinisme agricole. Nous automatisons les devis, la planification de production et de maintenance et la gestion documentaire, sur des outils simples à prendre en main.",
    },
    {
      q: "Accompagnez-vous les acteurs de la logistique et du transport ?",
      a: "Oui, la position de carrefour ferroviaire de Vierzon attire les transporteurs. Nous optimisons les tournées, automatisons le suivi des expéditions et structurons le reporting pour piloter l'activité au quotidien.",
    },
    {
