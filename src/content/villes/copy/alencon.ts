  ...
  faqGeolocalisee: [
    {
      ...
      a: "Oui. William se déplace sur site à Alençon depuis Paris en train via la gare du Mans (environ 2 h), puis l'A28 ou un transfert local. Le délai standard de déplacement est de 5 jours ouvrés après validation de la prestation, avec confirmation écrite des horaires d'intervention sur site dans la préfecture de l'Orne.",
    },
    {
