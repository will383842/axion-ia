...
export const PORT_JEROME_SUR_SEINE_COPY: VilleCopy = {
  ...
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient a Port-Jerome-sur-Seine (76). Nous accompagnons les TPE, PME et sous-traitants du pole petrochimique : maintenance industrielle, services, artisans, commercants et professions liberales. Audit Flash a partir de {{price:audit-flash|flat}}.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient a Port-Jerome-sur-Seine (76). Nous accompagnons les TPE, PME et sous-traitants du pole petrochimique : maintenance industrielle, services, artisans, commercants et professions liberales. Audit Flash a partir de {{price:audit-flash|flat}}.",
  ecosystemFr:
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA a Port-Jerome-sur-Seine : diagnostic adapte aux TPE sous-traitantes, PME industrielles et prestataires de maintenance du pole petrochimique. ROI chiffre, audit Flash {{price:audit-flash|flat}}.",
      en: "Audit IA a Port-Jerome-sur-Seine : diagnostic adapte aux TPE sous-traitantes, PME industrielles et prestataires de maintenance du pole petrochimique. ROI chiffre, audit Flash {{price:audit-flash|flat}}.",
    },
    interventions: {
