...
// Courdimanche (95, Val-d'Oise) — agglo Cergy-Pontoise, 30 km NO Paris.
...
export const COURDIMANCHE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Courdimanche (95), commune de l'agglomération de Cergy-Pontoise à 30 km au nord-ouest de Paris. Tissu TPE artisans et prestataires, PME tertiaire et logistique, commerces, professions libérales et structures de l'économie sociale. Axion-IA y travaille avec les organisations du territoire du pôle cergypontain.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Courdimanche (95). Nous accompagnons tous types d'activités : TPE artisans et prestataires, PME tertiaire et logistique, commerces de proximité, professions libérales et structures de l'agglomération de Cergy-Pontoise. Audit Flash sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Courdimanche (95). Nous accompagnons tous types d'activités : TPE artisans et prestataires, PME tertiaire et logistique, commerces de proximité, professions libérales et structures de l'agglomération de Cergy-Pontoise. Audit Flash sur mesure.",
  ...
  topSectorsNaf: [
    ...
    "Économie sociale & associatif",
  ],
  servicesContext: {
    audit: {
      fr: "Audit IA à Courdimanche : diagnostic adapté aux TPE artisans, PME tertiaire et logistique, commerces et professions libérales de l'agglomération Cergy-Pontoise. ROI chiffré, Audit Flash 490 € HT.",
      en: "Audit IA à Courdimanche : diagnostic adapté aux TPE artisans, PME tertiaire et logistique, commerces et professions libérales de l'agglomération Cergy-Pontoise. ROI chiffré, Audit Flash 490 € HT.",
    },
    interventions: {
      ...
      en: "Interventions IA sur site à Courdimanche : formats adaptés au bureau tertiaire, au commerce ou à l'entrepôt. Vos équipes repartent autonomes sur les outils IA configurés pour leur métier.",
    },
    implementation: {
      fr: "Implémentation IA à Courdimanche : automatisation flux administratifs, optimisation logistique, agents conversationnels, CRM intelligent. Solutions adaptées au tissu PME du pôle Cergy-Pontoise.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Courdimanche dans le Val-d'Oise ?",
      a: "Oui, Axion-IA intervient à Courdimanche et dans toute l'agglomération de Cergy-Pontoise (Cergy, Pontoise, Vauréal, Menucourt, Boisemont). Nos consultants se déplacent sur site ou en visio.",
    },
    {
      q: "Quel est le prix d'un audit IA à Courdimanche ?",
      a: "L'Audit Flash IA à Courdimanche démarre à 490 € HT. Ce diagnostic couvre l'analyse de vos processus métier, l'identification des cas d'usage IA prioritaires et un plan d'action chiffré avec ROI estimé.",
    },
    {
      q: "Accompagnez-vous les PME tertiaire du pôle Cergy-Pontoise ?",
