...
export const DIJON_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    sitesWeb: {
      ...
      en: "Custom web platforms and SaaS AI for Dijon and Burgundy SMEs/mid-caps — premium showcase site for AOP wine estates and agri-food players (URGO, Amora, Vitagora), customer space for practices and training providers, business dashboard connected to your CRM/ERP. Senior experts, Axion-IA design system, European hosting.",
    },
  },
  ...
  services: {
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Dijon des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 24-48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Dijon, itérations à distance.",
        whyHere: [
          "Projets web & SaaS dijonnais : agroalimentaire & foodtech (Cité Internationale de la Gastronomie et du Vin), sièges industriels (URGO, Amora), French Tech labellisée, PME et ETI du bassin bourguignon.",
          ...
          "Foodtech, vin & gastronomie : e-commerce, recommandation, fiches générées, traçabilité et storytelling de marque — l'ADN du bassin dijonnais à l'export.",
        ],
        methodology: [
          {
            step: "Cadrage à Dijon",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une boutique avec UX/UI et IA intégrée, pour producteurs, domaines et PME dijonnaises.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS / e-commerce IA-native",
            detail:
              "Plateforme e-commerce, métier ou portail client à l'export, IA intégrée, branchée sur votre SI (CRM, ERP, PIM, datalake).",
          },
          {
            sizeLabel: "Grande entreprise",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Dijon — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Vous gérez l'e-commerce agroalimentaire et l'export ?",
            a: "Oui : e-commerce, recommandation, génération de fiches, traçabilité et traduction multilingue (Shopify, WooCommerce, PrestaShop). Un vrai levier pour la foodtech, le vin et la gastronomie dijonnaise à l'international, conforme HCU et AI Act. Hébergement UE, RGPD strict.",
          },
          {
        ...
        guarantees:
          "Devis ferme en forfait fixe (à partir de 24-48 h selon la complexité) : pas de dérive horaire cachée. Mise en ligne sans downtime quand on augmente l'existant. Web Vitals et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD : propriété totale, aucun abonnement imposé, transférable à tout prestataire de la région dijonnaise ou repris en interne.",
      },
      en: {
        hero: "In Dijon, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 24-48 h depending on project complexity, EU hosting, code and data yours. On-site Dijon kick-off, remote iterations.",
        whyHere: [
          "Dijon web & SaaS projects: agri-food & foodtech (International City of Gastronomy and Wine), industrial HQs (URGO, Amora), labelled French Tech, Burgundy SMEs and mid-caps.",
          ...
          "Foodtech, wine & gastronomy: e-commerce, recommendation, generated sheets, traceability and brand storytelling — the DNA of the Dijon area at export.",
        ],
        methodology: [
          {
            step: "Scoping in Dijon",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Design or rebuild of a site or shop with UX/UI and built-in AI, for producers, estates and Dijon SMEs.",
          },
          {
            sizeLabel: "Mid-cap",
            price: "AI-native SaaS / e-commerce platform",
            detail:
              "E-commerce, business or export customer portal platform, AI built in, wired into your IS (CRM, ERP, PIM, datalake).",
          },
          {
            sizeLabel: "Large enterprise",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Dijon — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Do you handle agri-food e-commerce and export?",
            a: "Yes: e-commerce, recommendation, sheet generation, traceability and multilingual translation (Shopify, WooCommerce, PrestaShop). A real lever for Dijon foodtech, wine and gastronomy internationally, HCU and AI Act compliant. EU hosting, strict GDPR.",
          },
          {
