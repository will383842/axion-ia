...
// Montoir-de-Bretagne (44, Loire-Atlantique) — Port industriel Saint-Nazaire.
...
export const MONTOIR_DE_BRETAGNE_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Montoir-de-Bretagne : formats adaptés à l'atelier industriel, au bureau logistique ou à l'entrepôt portuaire. Vos équipes repartent autonomes sur outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Montoir-de-Bretagne : automatisation workflow logistique portuaire, maintenance prédictive industrielle, agents IA gestion sous-traitance, extraction données transport.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Montoir-de-Bretagne et bassin nazairien ?",
      a: "Oui, Axion-IA intervient à Montoir-de-Bretagne et toute l'agglomération nazairienne (Saint-Nazaire, Donges, Trignac, Pornichet). Consultants depuis Nantes (55 min). Couverture complète du bassin industriel et portuaire.",
    },
    {
