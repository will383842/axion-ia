...
// Valleiry (74, Haute-Savoie) — Grand Genève frontalier.
...
export const VALLEIRY_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Valleiry : diagnostic adapté aux PME de services transfrontaliers, artisans BTP, commerces et professions libérales du Genevois français. Audit sur place {{price:audit-flash|flat}} avec ROI quantifié.",
      en: "Audit IA à Valleiry : diagnostic adapté aux PME de services transfrontaliers, artisans BTP, commerces et professions libérales du Genevois français. Audit sur place {{price:audit-flash|flat}} avec ROI quantifié.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Valleiry et dans le Grand Genève ?",
      a: "Oui, Axion-IA intervient à Valleiry et dans tout le Grand Genève côté français (Saint-Julien-en-Genevois à 10 min, Viry, Collonges, Archamps). Nos consultants couvrent le bassin transfrontalier depuis Genève (20 min) ou Annecy.",
    },
    {
      q: "Accompagnez-vous les entreprises transfrontalières à Valleiry ?",
