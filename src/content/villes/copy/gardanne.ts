...
export const GARDANNE_COPY: VilleCopy = {
  ...
  distancesEn:
    "Gardanne dispose de sa gare SNCF (liaisons Marseille et Aix-en-Provence). L'aéroport Marseille-Provence est à 25 minutes en voiture, la gare TGV d'Aix-en-Provence à 20 minutes. Les autoroutes A51, A8, A52 et A50 desservent le bassin minier.",
  topSectorsNaf: [
    "Métallurgie & production d'alumine",
    "Production d'électricité (biomasse)",
    "Microélectronique & R&D",
      ...
      fr: {
        ...
        methodology: [
          ...
          },
          {
            ...
            detail:
              "Wireframes, design system et maquettes Figma à votre marque ; prototype cliquable testé avant tout développement, pensé mobile-first pour vos clients comme pour vos équipes terrain, ateliers et bureaux d'études du bassin de Gardanne. On valide l'ergonomie avant d'écrire la moindre ligne de code.",
          },
          {
            step: "Développement par sprints",
            detail:
              "Greffe IA sur l'existant ou build IA-native : configurateur de devis, e-commerce multi-CMS, chatbot RAG multilingue, recherche sémantique, agents connectés à vos ERP/CRM/MES. Démos hebdomadaires en visio, code versionné et accessible, ajustements continus jusqu'au comportement attendu.",
          },
          {
            step: "Recette + mise en ligne",
            detail:
              "Tests d'acceptation, Web Vitals (LCP, INP, CLS) et SEO/AEO validés, accessibilité contrôlée. Mise en production sans downtime — y compris en pleine activité de production industrielle d'Alteo, de saison commerciale du centre-ville ou de campagne des artisans BTP des ZA.",
          },
          {
            step: "Livraison + autonomie",
            detail:
              "Code source, bases de données et modèles livrés chez vous (hébergement UE possible), documentation et passation incluses. Vos équipes pilotent l'outil en autonomie, sans verrou ni abonnement imposé, et peuvent le confier à tout prestataire régional ou le reprendre en interne.",
          },
        ],
        pricing: [
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une boutique avec UX/UI et IA intégrée pour la sous-traitance industrielle, les bureaux d'études et les services tertiaires métropolitains : catalogue, devis en ligne, paiement, multilingue, sur WordPress, Shopify, WooCommerce, PrestaShop, Magento ou code sur mesure.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Plateforme métier ou portail fournisseurs sur mesure pour les acteurs structurants du bassin (industrie de l'alumine, énergie biomasse, microélectronique), IA intégrée, recherche sémantique sur documentation technique, branchée sur votre SI (ERP, CRM, MES).",
          },
          {
            sizeLabel: "Grande entreprise",
            price: "Programme produit",
            detail:
              "Programmes pluriannuels pour les grands employeurs industriels et énergétiques régionaux du type Alteo ou Gazel Énergie : refonte de plateformes, design system, agents et automatisations, équipe dédiée Axion-IA en mode produit avec roadmap partagée.",
          },
        ],
        faq: [
          {
            q: "Faites-vous l'UX/UI et l'e-commerce, pas seulement l'IA ?",
            a: "Oui, on fait tout. On conçoit l'expérience complète — research, wireframes, design system, maquettes Figma, prototype cliquable, intégration mobile-first — pour un site vitrine, une boutique e-commerce ou une plateforme métier, avec ou sans brique IA. E-commerce multi-CMS (WordPress, Shopify, WooCommerce, PrestaShop, Magento) ou code sur mesure, au choix selon votre existant et votre équipe.",
          },
          {
            q: "Mes données industrielles et techniques restent-elles en Europe ?",
            a: "Oui. Toute la chaîne IA est hébergeable en UE, conforme RGPD et AI Act, sans transit hors UE sans DPA signé. Pour la sous-traitance d'Alteo, les bureaux d'études microélectronique du campus Georges Charpak ou les fournisseurs de la centrale biomasse, vous gardez la propriété complète de vos plans, fichiers de caractérisation et modèles, sans verrou.",
          },
          {
            q: "Pouvez-vous connecter l'outil à notre ERP de production ?",
            a: "Oui. On intègre configurateurs de devis, portails fournisseurs et agents directement sur votre ERP, CRM ou MES existant via API. Idéal pour la sous-traitance industrielle du bassin minier reconverti qui veut automatiser devis, commandes, suivi et relances sans changer de système, en gardant la traçabilité de chaque pièce et de chaque ordre de fabrication.",
          },
          {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Les interventions IA à Gardanne démarrent à {{price:intervention-4h|flat}}. L'Audit sur place débute à {{price:audit-flash|flat}} et l'implémentation à {{price:impl-poc|entry}}. Tarifs publics, pas de devis surprise.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous intervenons dans toute la Métropole d'Aix-Marseille-Provence, notamment Aix-en-Provence (15 km), Marseille (25 km), Bouc-Bel-Air, Mimet, Meyreuil et Simiane-Collongue.",
    },
    {
      q: "Comment garantissez-vous la conformité RGPD à Gardanne ?",
      a: "Données hébergées en UE, registre des traitements fourni, clause DPA signée avant tout démarrage. Notre approche code custom permet un contrôle fin des flux, exigeant pour les sous-traitants industriels.",
    },
    {
