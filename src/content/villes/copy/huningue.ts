...
export const HUNINGUE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Huningue (68), commune de 7 487 habitants en Haut-Rhin, est située au carrefour des trois frontières (France, Allemagne, Suisse) aux portes de Bâle. Port rhénan, industries chimiques et pharmaceutiques, tissu TPE/PME logistique transfrontalière, commerce, services et artisanat. Axion-IA répond aux besoins de toutes les entreprises.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Huningue (68). Nous accompagnons TPE et PME du bassin des trois frontières : logisticiens, industriels chimie/pharma, commerçants, artisans et prestataires de services. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Huningue (68). Nous accompagnons TPE et PME du bassin des trois frontières : logisticiens, industriels chimie/pharma, commerçants, artisans et prestataires de services. Audit sur place sur mesure.",
  ecosystemFr:
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Huningue : sessions dans votre usine, entrepôt, agence, commerce ou en visio. Dirigeants TPE/PME du bassin trinational Bâle souhaitant maîtriser l'IA appliquée à leur métier.",
      en: "Coaching 1-to-1 à Huningue : sessions dans votre usine, entrepôt, agence, commerce ou en visio. Dirigeants TPE/PME du bassin trinational Bâle souhaitant maîtriser l'IA appliquée à leur métier.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les TPE/PME et sous-traitants du secteur chimie/pharma du bassin bâlois. Cas IA typiques : contrôle qualité automatisé, conformité réglementaire, OCR documents, gestion traçabilité, agents conversationnels trilingues FR/DE/EN pour clients internationaux.",
    },
    {
