...
// Amnéville (57, Moselle) — pôle thermal et touristique mosellan (Amnéville-les-Thermes), casino, zoo, Walygator, entre Metz et Thionville.
...
export const AMNEVILLE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Amnéville : diagnostic adapté aux TPE hôtels/restaurants pôle thermal, PME loisirs et tourisme, commerces, artisans. Audit Flash à 490 € HT, retour sur investissement chiffré.",
      en: "Audit IA à Amnéville : diagnostic adapté aux TPE hôtels/restaurants pôle thermal, PME loisirs et tourisme, commerces, artisans. Audit Flash à 490 € HT, retour sur investissement chiffré.",
    },
    interventions: {
      ...
      en: "Interventions IA sur site à Amnéville : formats adaptés à l'hôtel, restaurant, parc de loisirs, commerce. Vos équipes repartent autonomes sur les outils IA usage quotidien.",
    },
    implementation: {
      fr: "Implémentation IA à Amnéville : agents conversationnels multilingues réservation thermes/hôtel, prédiction affluence parcs loisirs, recommandation visiteurs, automatisation devis BTP.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Amnéville et sillon mosellan ?",
      a: "Oui, Axion-IA intervient à Amnéville et tout le sillon mosellan (Metz, Thionville, Hagondange, Talange, Rombas). Nos consultants viennent de Metz (20 min A31), Luxembourg (50 min) ou en visio selon vos contraintes.",
    },
    {
    ...
    },
    {
      ...
      a: "Pour les TPE artisans BTP et commerçants à Amnéville, audit Flash 490 € HT, intervention 1 journée formation, coaching 1-to-1. Cas typiques : automatisation devis, agents IA prise de RDV, classification photos chantiers, gestion stocks.",
    },
    {
      q: "Comment se passe une mission depuis Metz ou Luxembourg ?",
      a: "Nos consultants viennent de Metz (20 min A31), Nancy (50 min) ou Luxembourg-Ville (50 min). Pour les multi-jours, hébergement local possible (offre hôtelière dense pôle thermal). Frais de déplacement facturés à part du forfait, tarifs publics.",
    },
  ],
};
