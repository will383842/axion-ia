...
// Quint-Fonsegrives (31, Haute-Garonne) — Est Toulouse, résidentielle.
...
export const QUINT_FONSEGRIVES_COPY: VilleCopy = {
  ...
  pitchEn:
    "Quint-Fonsegrives (31), commune résidentielle prisée de l'est de Toulouse, plus de 6 100 habitants. Tissu TPE de services, PME tertiaires, professions libérales, commerces de proximité. Axion-IA y travaille avec les organisations du territoire de la couronne est de Toulouse.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Quint-Fonsegrives (31). Nous accompagnons TPE de services, PME tertiaires, professions libérales et commerçants de l'est Toulouse. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Quint-Fonsegrives (31). Nous accompagnons TPE de services, PME tertiaires, professions libérales et commerçants de l'est Toulouse. Audit sur place sur mesure.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Quint-Fonsegrives ?",
      a: "Oui, Axion-IA intervient à Quint-Fonsegrives et dans toute la couronne est de Toulouse (Balma, Saint-Orens, L'Union). Nos consultants se déplacent en 12 min depuis Toulouse.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants se déplacent à Quint-Fonsegrives depuis Toulouse (12 min D2). Intervention 1 journée minimum, atelier pratique.",
    },
    {
