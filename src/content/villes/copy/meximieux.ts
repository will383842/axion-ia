...
// Meximieux (01, Ain) — plaine de l'Ain, Côtière est, péri-urbain Lyon NE.

import type { VilleCopy } from "./types";

export const MEXIMIEUX_COPY: VilleCopy = {
  pitchFr:
    "Meximieux (01), commune de la plaine de l'Ain dans l'Ain, est positionnée sur la Côtière est de Lyon. Tissu PME tertiaires et industrielles (plaine de l'Ain), TPE artisans BTP, commerces, agriculture. Axion-IA y intervient pour tous types d'activités de la plaine de l'Ain.",
  pitchEn:
    "Meximieux (01), commune de la plaine de l'Ain dans l'Ain, est positionnée sur la Côtière est de Lyon. Tissu PME tertiaires et industrielles (plaine de l'Ain), TPE artisans BTP, commerces, agriculture. Axion-IA y intervient pour tous types d'activités de la plaine de l'Ain.",
  directAnswerFr:
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Meximieux : diagnostic adapté aux PME tertiaires/industrielles plaine de l'Ain, agriculteurs, TPE artisans. ROI chiffré, audit Flash 490 € HT.",
      en: "Audit IA à Meximieux : diagnostic adapté aux PME tertiaires/industrielles plaine de l'Ain, agriculteurs, TPE artisans. ROI chiffré, audit Flash 490 € HT.",
    },
    interventions: {
      ...
      en: "Interventions IA sur site à Meximieux : formats adaptés au bureau, atelier, exploitation agricole, commerce. Vos équipes repartent autonomes sur outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Meximieux : agents conversationnels B2B, prédiction maintenance, classification photos cultures, automatisation workflow. Plaine de l'Ain.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Meximieux et plaine de l'Ain ?",
      a: "Oui, Axion-IA intervient à Meximieux et toute la plaine de l'Ain (Miribel à 20 min, Ambérieu à 15 min, Pérouges). Consultants depuis Lyon (40 min).",
    },
    {
