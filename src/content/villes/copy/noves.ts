...
// Noves (13, Bouches-du-Rhône) — Petite Crau, agriculture, axe A7.
...
export const NOVES_COPY: VilleCopy = {
  ...
  pitchEn:
    "Noves (13), commune de la Petite Crau dans les Bouches-du-Rhône au sud d'Avignon, conjugue agriculture maraîchère, vergers, viticulture AOC et tissu de TPE artisans, PME services et commerces. Accès direct A7 vers Lyon et Marseille. Axion-IA accompagne entreprises et indépendants de la Petite Crau.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Noves (13). Nous accompagnons TPE artisans, exploitations agricoles, viticulteurs, PME de services et commerçants de la Petite Crau. Audit sur place sur mesure, sans engagement.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Noves (13). Nous accompagnons TPE artisans, exploitations agricoles, viticulteurs, PME de services et commerçants de la Petite Crau. Audit sur place sur mesure, sans engagement.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Noves et dans la Petite Crau ?",
      a: "Oui, Axion-IA intervient à Noves et dans toute la Petite Crau (Châteaurenard à 10 min, Cavaillon à 15 min, Saint-Rémy, Avignon). Couverture complète Vallée du Rhône sud via A7.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les exploitations agricoles et maraîchères de la Petite Crau : gestion irrigation prédictive, optimisation rendements, traçabilité récoltes, négoce digitalisé, marketing direct.",
    },
    {
      q: "Travaillez-vous avec les viticulteurs AOC de Noves ?",
      a: "Oui, nous accompagnons les domaines viticoles AOC : gestion parcellaire, traçabilité vendanges, marketing vente directe caveau, agents IA réservation, optimisation stocks. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
