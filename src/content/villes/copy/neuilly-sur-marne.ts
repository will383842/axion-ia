...
export const NEUILLY_SUR_MARNE_COPY: VilleCopy = {
  pitchFr:
    "Axion-IA accompagne les PME et ETI de Neuilly-sur-Marne (93330, Seine-Saint-Denis, 39 800 habitants en 2023), commune située à 13,1 km à l'est de Paris en bordure de Marne. Avec 2 221 établissements actifs dont 1 546 dans le commerce, le transport et les services, 324 dans la construction et 100 dans l'industrie, et la présence des hôpitaux psychiatriques de Ville-Évrard et Maison Blanche comme employeurs majeurs, la ville offre un terrain riche pour automatiser les processus métier des PME locales en code custom.",
  pitchEn:
    "Axion-IA accompagne les PME et ETI de Neuilly-sur-Marne (93330, Seine-Saint-Denis, 39 800 habitants en 2023), commune située à 13,1 km à l'est de Paris en bordure de Marne. Avec 2 221 établissements actifs dont 1 546 dans le commerce, le transport et les services, 324 dans la construction et 100 dans l'industrie, et la présence des hôpitaux psychiatriques de Ville-Évrard et Maison Blanche comme employeurs majeurs, la ville offre un terrain riche pour automatiser les processus métier des PME locales en code custom.",
  directAnswerFr:
    "À Neuilly-sur-Marne (Seine-Saint-Denis, 93330), Axion-IA déploie des automatisations IA sur mesure pour les PME et ETI locales — commerces, services aux entreprises, construction, transport et structures médico-sociales liées à l'écosystème des hôpitaux Ville-Évrard et Maison Blanche. Williams se déplace sur site depuis Paris via les RER A (Neuilly-Plaisance), B (Vert-Galant), E (Chénay-Gagny) ou par l'A4/A86, pour un Audit sur place dès {{price:audit-flash|flat}}, une Formation 4 h dès {{price:intervention-4h|flat}}, ou un accompagnement un-à-un dès {{price:intervention-dirigeants|flat}}. Code custom uniquement.",
  directAnswerEn:
    "À Neuilly-sur-Marne (Seine-Saint-Denis, 93330), Axion-IA déploie des automatisations IA sur mesure pour les PME et ETI locales — commerces, services aux entreprises, construction, transport et structures médico-sociales liées à l'écosystème des hôpitaux Ville-Évrard et Maison Blanche. Williams se déplace sur site depuis Paris via les RER A (Neuilly-Plaisance), B (Vert-Galant), E (Chénay-Gagny) ou par l'A4/A86, pour un Audit sur place dès {{price:audit-flash|flat}}, une Formation 4 h dès {{price:intervention-4h|flat}}, ou un accompagnement un-à-un dès {{price:intervention-dirigeants|flat}}. Code custom uniquement.",
  ...
  servicesContext: {
    ...
    interventions: {
      fr: "Intervention en groupe à Neuilly-sur-Marne dès {{price:intervention-4h|flat}} — Williams se déplace sur site via le RER A, B ou E pour automatiser un workflow (relances, planning, reporting).",
      en: "Intervention en groupe à Neuilly-sur-Marne dès {{price:intervention-4h|flat}} — Williams se déplace sur site via le RER A, B ou E pour automatiser un workflow (relances, planning, reporting).",
    },
    implementation: {
      fr: "Implémentation IA en code custom à Neuilly-sur-Marne dès {{price:impl-poc|entry}} — développement sur mesure et conformité RGPD pour les PME et ETI du Nord-Est parisien.",
      en: "Implémentation IA en code custom à Neuilly-sur-Marne dès {{price:impl-poc|entry}} — développement sur mesure et conformité RGPD pour les PME et ETI du Nord-Est parisien.",
    },
    unAUn: {
      fr: "Accompagnement un-à-un dirigeant à Neuilly-sur-Marne dès {{price:intervention-dirigeants|flat}} — sessions stratégiques pour piloter l'intégration de l'IA dans votre PME ou ETI.",
      en: "Accompagnement un-à-un dirigeant à Neuilly-sur-Marne dès {{price:intervention-dirigeants|flat}} — sessions stratégiques pour piloter l'intégration de l'IA dans votre PME ou ETI.",
    },
  },
  services: {
    sitesWeb: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "À Neuilly-sur-Marne, nous accompagnons en priorité les PME et ETI du commerce, des services aux entreprises, de la construction, du transport, et les structures médico-sociales ou paramédicales liées à l'écosystème Ville-Évrard / Maison Blanche.",
    },
    {
