...
export const NEUILLY_SUR_MARNE_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    implementation: {
      ...
      en: "Implémentation IA en code custom à Neuilly-sur-Marne dès {{price:impl-poc|entry}} — développement sur mesure et conformité RGPD pour les TPE et PME du Nord-Est parisien.",
    },
    unAUn: {
      fr: "Accompagnement un-à-un dirigeant à Neuilly-sur-Marne dès {{price:intervention-dirigeants|flat}} — sessions stratégiques pour piloter l'intégration de l'IA dans votre TPE ou PME.",
