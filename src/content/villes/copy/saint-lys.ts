...
// Saint-Lys (31, Haute-Garonne) — Ouest Toulouse.
...
export const SAINT_LYS_COPY: VilleCopy = {
  ...
  pitchEn:
    "Saint-Lys (31), commune de l'ouest toulousain avec près de 10 000 habitants. Tissu TPE artisans BTP, PME de services, commerces de centre-bourg, professions libérales, activités agricoles. Axion-IA répond aux besoins des activités professionnelles présentes de la couronne ouest de Toulouse.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Saint-Lys (31). Nous accompagnons TPE artisans, PME de services, professions libérales et commerçants de l'ouest Toulouse. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Saint-Lys (31). Nous accompagnons TPE artisans, PME de services, professions libérales et commerçants de l'ouest Toulouse. Audit sur place sur mesure.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Lys ?",
      a: "Oui, Axion-IA intervient à Saint-Lys et dans tout l'ouest de Toulouse (Fonsorbes, Léguevin, Muret). Nos consultants se déplacent en 30 min depuis Toulouse.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants se déplacent à Saint-Lys depuis Toulouse (30 min RN124). Intervention 1 journée minimum, atelier pratique dans vos locaux.",
    },
    {
      q: "L'IA peut-elle aider les artisans BTP de Saint-Lys ?",
      a: "Oui, l'IA automatise devis, planning chantiers, relances clients, classification factures. Gains de temps concrets dès la première semaine d'utilisation.",
    },
  ],
};
