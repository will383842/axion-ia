...
export const LISSES_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les TPE artisans BTP et commerçants de Lisses. Cas typiques : automatisation devis chantier, agents IA prise de RDV, classification photos, gestion planning. Audit Flash 490 € HT adapté aux petites structures.",
    },
    {
