...
// Saint-Martin-Boulogne (62, Pas-de-Calais) — agglo Boulogne-sur-Mer, services et commerces.
...
export const SAINT_MARTIN_BOULOGNE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Saint-Martin-Boulogne (62), commune de l'agglomération boulonnaise dans le Pas-de-Calais, concentre un tissu de TPE commerciales, PME de services, professions libérales et activités tertiaires péri-urbaines. Axion-IA opère pour toutes les structures économiques de la commune du Boulonnais.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Saint-Martin-Boulogne (62). Nous accompagnons TPE commerçantes, PME de services, professions libérales, artisans et entreprises tertiaires de l'agglomération boulonnaise. Audit sur place sur mesure, intervention sur site ou en visio.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Saint-Martin-Boulogne (62). Nous accompagnons TPE commerçantes, PME de services, professions libérales, artisans et entreprises tertiaires de l'agglomération boulonnaise. Audit sur place sur mesure, intervention sur site ou en visio.",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Saint-Martin-Boulogne : formations pratiques adaptées au commerce, cabinet ou bureau. Vos équipes repartent autonomes sur outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Saint-Martin-Boulogne : automatisation gestion stocks, agents conversationnels clients, classification documents, CRM intelligent. Tissu tertiaire boulonnais.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Martin-Boulogne ?",
      a: "Oui, Axion-IA intervient à Saint-Martin-Boulogne et dans toute l'agglomération boulonnaise (Boulogne-sur-Mer, Outreau, Le Portel, Wimereux). Nos consultants se déplacent sur site ou en visio.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les commerces de Saint-Martin-Boulogne sur des cas IA concrets : automatisation gestion stocks, agents IA prise de RDV, analyse données clients, CRM intelligent.",
    },
    {
