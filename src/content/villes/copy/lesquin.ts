...
export const LESQUIN_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Lesquin : sessions dans vos locaux (entrepôt, bureau, hôtel) ou en visio. Dirigeants TPE/PME du pôle aéroportuaire lillois souhaitant maîtriser l'IA dans leur activité logistique ou transport.",
      en: "Coaching 1-to-1 à Lesquin : sessions dans vos locaux (entrepôt, bureau, hôtel) ou en visio. Dirigeants TPE/PME du pôle aéroportuaire lillois souhaitant maîtriser l'IA dans leur activité logistique ou transport.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    {
      q: "Accompagnez-vous les TPE et PME de la logistique et du transport ?",
