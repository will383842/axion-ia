...
// Coudekerque-Branche (59, Nord) — agglomération de Dunkerque, industrie portuaire et sidérurgie proche, Hauts-de-France.

import type { VilleCopy } from "./types";

export const COUDEKERQUE_BRANCHE_COPY: VilleCopy = {
  pitchFr:
    "Coudekerque-Branche (59), commune accolée à Dunkerque dans le Nord, vit dans l'orbite du grand port industriel et de la sidérurgie du littoral des Hauts-de-France. Autour des grands sites tournent une multitude de TPE et PME : sous-traitance industrielle, maintenance, logistique portuaire, transport, BTP et commerces de proximité. Axion-IA, cabinet d'experts IA seniors, accompagne en priorité ces TPE puis ces PME pour automatiser les tâches répétitives et fiabiliser leurs opérations, avec des solutions concrètes et un retour sur investissement mesurable.",
  pitchEn:
    "Coudekerque-Branche (59), commune accolée à Dunkerque dans le Nord, vit dans l'orbite du grand port industriel et de la sidérurgie du littoral des Hauts-de-France. Autour des grands sites tournent une multitude de TPE et PME : sous-traitance industrielle, maintenance, logistique portuaire, transport, BTP et commerces de proximité. Axion-IA, cabinet d'experts IA seniors, accompagne en priorité ces TPE puis ces PME pour automatiser les tâches répétitives et fiabiliser leurs opérations, avec des solutions concrètes et un retour sur investissement mesurable.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Coudekerque-Branche (59, Nord) et dans toute l'agglomération de Dunkerque. Nous accompagnons en priorité les TPE de maintenance, transport et commerce, puis les PME de sous-traitance industrielle et de logistique gravitant autour du port et de la sidérurgie. Notre méthode : un audit ciblé des irritants, des automatisations utiles déployées sur vos outils, et la formation de vos équipes. Les grandes ETI restent une part marginale de notre clientèle.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Coudekerque-Branche (59, Nord) et dans toute l'agglomération de Dunkerque. Nous accompagnons en priorité les TPE de maintenance, transport et commerce, puis les PME de sous-traitance industrielle et de logistique gravitant autour du port et de la sidérurgie. Notre méthode : un audit ciblé des irritants, des automatisations utiles déployées sur vos outils, et la formation de vos équipes. Les grandes ETI restent une part marginale de notre clientèle.",
  ...
  distancesEn:
    "Dunkerque centre à 5 min, port et zones industrielles à 10 min. Gare de Dunkerque à 3 km, Lille et sa gare TGV à 1h, Calais à 45 min. Bruxelles à 1h30. Nos consultants se déplacent sur site depuis Lille, frais indiqués séparément, ou interviennent en visio selon le format.",
  topSectorsNaf: [
    "Sous-traitance industrielle et maintenance (port, sidérurgie)",
    "Logistique portuaire et entreposage",
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Coudekerque-Branche : diagnostic sur site pour identifier les automatisations à fort retour dans une PME de maintenance, de logistique ou de transport. Cartographie des tâches chronophages et feuille de route priorisée et chiffrée.",
      en: "Audit IA à Coudekerque-Branche : diagnostic sur site pour identifier les automatisations à fort retour dans une PME de maintenance, de logistique ou de transport. Cartographie des tâches chronophages et feuille de route priorisée et chiffrée.",
    },
    interventions: {
      fr: "Interventions IA à Coudekerque-Branche : sessions opérationnelles adaptées à l'atelier, à l'entrepôt ou au bureau. Vos équipes maîtrisent les outils déployés et gagnent du temps sur la saisie et la planification dès la première semaine.",
      en: "Interventions IA à Coudekerque-Branche : sessions opérationnelles adaptées à l'atelier, à l'entrepôt ou au bureau. Vos équipes maîtrisent les outils déployés et gagnent du temps sur la saisie et la planification dès la première semaine.",
    },
    implementation: {
      fr: "Implémentation IA à Coudekerque-Branche : optimisation des tournées et plannings transport, classification de documents techniques et de bons de livraison, maintenance prédictive en atelier, agents conversationnels B2B intégrés à vos logiciels.",
  ...
  faqGeolocalisee: [
    ...
    {
      q: "Travaillez-vous avec les PME de sous-traitance industrielle et de logistique ?",
      a: "Oui. Pour la maintenance, la sous-traitance liée au port et la logistique, nous mettons en place classification de documents, maintenance prédictive et optimisation de tournées intégrées à vos outils existants.",
    },
    {
