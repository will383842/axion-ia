...
// Le Chambon-Feugerolles (42, Loire) — vallée Ondaine, héritage industriel métallurgique/petite mécanique, Saint-Étienne Métropole.
...
export const LE_CHAMBON_FEUGEROLLES_COPY: VilleCopy = {
  ...
  pitchEn:
    "Le Chambon-Feugerolles (42), commune de la vallée de l'Ondaine dans la Loire, est intégrée à Saint-Étienne Métropole. Héritage industriel important (métallurgie, petite mécanique fine). Tissu PME industrielles diversifiées, TPE artisans BTP, commerces. Axion-IA répond aux besoins de toutes les entreprises vallée Ondaine.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient au Chambon-Feugerolles (42). Nous accompagnons tous types d'activités : PME industrielles vallée Ondaine (héritage métallurgique/petite mécanique), TPE artisans BTP, commerçants, indépendants, professions libérales et services aux entreprises de Saint-Étienne Métropole.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient au Chambon-Feugerolles (42). Nous accompagnons tous types d'activités : PME industrielles vallée Ondaine (héritage métallurgique/petite mécanique), TPE artisans BTP, commerçants, indépendants, professions libérales et services aux entreprises de Saint-Étienne Métropole.",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site au Chambon-Feugerolles : formats adaptés à l'atelier industriel (mécanique de précision), commerce, bureau. Vos équipes repartent autonomes sur outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA au Chambon-Feugerolles : prédiction maintenance industrielle, contrôle qualité par vision (mécanique de précision), agents conversationnels B2B. Vallée Ondaine.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il au Chambon-Feugerolles et vallée Ondaine ?",
      a: "Oui, Axion-IA intervient au Chambon-Feugerolles et toute la vallée de l'Ondaine (Firminy limitrophe à 5 min, Unieux, Fraisses). Couverture Saint-Étienne Métropole. Consultants depuis Lyon (1h) ou Saint-Étienne (15 min).",
    },
    {
      q: "Travaillez-vous avec les PME industrielles métallurgie/mécanique ?",
    ...
    },
    {
      ...
      a: "Nos consultants viennent de Lyon (1h) ou Saint-Étienne (15 min). Pour les multi-jours, hébergement local possible. Frais de déplacement facturés à part du forfait, tarifs publics.",
    },
  ],
};
