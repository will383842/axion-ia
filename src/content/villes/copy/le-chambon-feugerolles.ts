...
export const LE_CHAMBON_FEUGEROLLES_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Pour les indépendants et professions libérales au Chambon-Feugerolles, audit Flash 490 € HT, intervention 1 journée formation, coaching 1-to-1. Cas typiques : agents IA prise de RDV, classification documents, CRM augmentés.",
    },
    {
