...
// Sainte-Livrade-sur-Lot (47, Lot-et-Garonne) — Vallée Lot, 6 541 hab.
...
export const SAINTE_LIVRADE_SUR_LOT_COPY: VilleCopy = {
  ...
  pitchEn:
    "Sainte-Livrade-sur-Lot (47), commune de 6 541 habitants dans le Lot-et-Garonne, est un bourg dynamique de la vallée du Lot, entre Villeneuve-sur-Lot et Agen. Son économie repose sur un tissu de TPE agricoles et maraîchères, PME agroalimentaires, commerces de proximité, artisans BTP et services. Axion-IA couvre les activités professionnelles du bassin.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Sainte-Livrade-sur-Lot (47). Nous accompagnons TPE et PME de la vallée du Lot : exploitations agricoles et maraîchères, entreprises agroalimentaires, commerçants, artisans et professions libérales du bassin livradais. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Sainte-Livrade-sur-Lot (47). Nous accompagnons TPE et PME de la vallée du Lot : exploitations agricoles et maraîchères, entreprises agroalimentaires, commerçants, artisans et professions libérales du bassin livradais. Audit sur place sur mesure.",
  ecosystemFr:
  ...
  ecosystemEn:
    "Sainte-Livrade-sur-Lot est un bourg de la vallée du Lot, entre Villeneuve-sur-Lot (10 min) et Agen (25 min). Son économie s'appuie sur les filières agricoles (maraîchage, arboriculture, pruneaux d'Agen), l'agroalimentaire, le commerce de proximité, l'artisanat BTP et les services. La commune bénéficie de la plaine alluviale fertile du Lot, moteur de l'activité agricole locale.",
  distancesFr:
    "Villeneuve-sur-Lot à 10 min. Agen à 25 min via D911. Bordeaux à 1h30 via A62. Gare SNCF la plus proche : Agen (TGV Paris-Agen). Aéroport Agen-La Garenne à 30 min.",
  distancesEn:
    "Villeneuve-sur-Lot à 10 min. Agen à 25 min via D911. Bordeaux à 1h30 via A62. Gare SNCF la plus proche : Agen (TGV Paris-Agen). Aéroport Agen-La Garenne à 30 min.",
  seoHook: "agriculture, agroalimentaire & vallée du Lot",
  topSectorsNaf: [
    "Agriculture, maraîchage & arboriculture",
    "Agroalimentaire & transformation fruits",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Sainte-Livrade-sur-Lot : formats adaptés à l'exploitation agricole, l'entreprise agroalimentaire, le commerce ou l'atelier. Vos équipes repartent autonomes.",
    },
    implementation: {
      fr: "Implémentation IA à Sainte-Livrade-sur-Lot : traçabilité parcellaire, prédiction récoltes, automatisation tri et conditionnement fruits, gestion stocks, OCR facturation.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Sainte-Livrade-sur-Lot ?",
    ...
    },
    {
      ...
      a: "Nos consultants interviennent sur site à Sainte-Livrade-sur-Lot et dans la vallée du Lot. Déplacement direct sur votre exploitation ou entreprise. Accès via Agen (25 min D911), aéroport Agen-La Garenne à 30 min.",
    },
  ],
};
