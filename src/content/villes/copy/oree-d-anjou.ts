...
// Orée d'Anjou (49, Maine-et-Loire) — Commune nouvelle, vignoble Anjou, bords Loire, face à Nantes.
...
export const OREE_D_ANJOU_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Orée d'Anjou est une commune nouvelle aux confins du Maine-et-Loire et de la Loire-Atlantique, face à Ancenis. L'économie locale s'appuie sur la viticulture (coteaux-d'ancenis, muscadet), le tissu industriel et logistique hérité de la vallée de la Loire, l'artisanat BTP, les commerces et les services. Patrimoine remarquable avec le belvédère de Champtoceaux et la maison natale de Joachim du Bellay à Liré.",
  distancesFr:
    "Ancenis à 5 min (pont de Loire). Nantes centre à 35 min via A11. Angers centre à 50 min. Gare d'Ancenis (TER Nantes–Angers) à 5 min. Cholet à 50 min. Aéroport Nantes Atlantique à 40 min.",
  distancesEn:
    "Ancenis à 5 min (pont de Loire). Nantes centre à 35 min via A11. Angers centre à 50 min. Gare d'Ancenis (TER Nantes–Angers) à 5 min. Cholet à 50 min. Aéroport Nantes Atlantique à 40 min.",
  topSectorsNaf: [
    "Viticulture coteaux-d'ancenis & muscadet",
    "Industrie & logistique val de Loire",
    "Artisanat BTP & construction",
    "Commerce de proximité & tourisme patrimoine",
    "Services aux entreprises Ancenis–Nantes",
  ],
  servicesContext: {
    audit: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Orée d'Anjou : formations viticulteurs, ateliers PME industrielles, sessions artisans BTP et commerçants. Vos équipes repartent autonomes sur les outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Orée d'Anjou : traçabilité viticole, automatisation logistique val de Loire, prédiction maintenance industrielle, agents IA commerciaux et digitalisation PME Ancenis.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Orée d'Anjou et dans le val de Loire ?",
      a: "Oui, Axion-IA intervient à Orée d'Anjou et dans tout le val de Loire entre Ancenis et Nantes (Mauges-sur-Loire, Montrevault-sur-Èvre, Le Loroux-Bottereau, Vallet). Nos consultants se déplacent depuis Nantes en 35 minutes.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les PME industrielles et logistiques du val de Loire sur tous les cas IA : prédiction maintenance, automatisation qualité, optimisation supply chain, agents IA service client B2B et gestion documentaire.",
    },
    {
