...
export const BOIS_COLOMBES_COPY: VilleCopy = {
  pitchFr:
    "Bois-Colombes (92), commune résidentielle et tertiaire des Hauts-de-Seine, abrite sièges sociaux, services financiers et numériques, professions libérales et commerces de proximité, à deux pas de La Défense. Axion-IA, cabinet d'experts IA seniors, accompagne en priorité les TPE et PME locales, les ETI en complément.",
  pitchEn:
    "Bois-Colombes (92), commune résidentielle et tertiaire des Hauts-de-Seine, abrite sièges sociaux, services financiers et numériques, professions libérales et commerces de proximité, à deux pas de La Défense. Axion-IA, cabinet d'experts IA seniors, accompagne en priorité les TPE et PME locales, les ETI en complément.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient sur site à Bois-Colombes et dans tout l'ouest francilien. Nous accompagnons en priorité les TPE et PME locales — cabinets de conseil et services financiers, agences numériques, professions libérales, commerces et services de proximité — puis les ETI et sièges en complément. Audit, intervention sur site, implémentation et coaching un-à-un, à tarifs publics.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient sur site à Bois-Colombes et dans tout l'ouest francilien. Nous accompagnons en priorité les TPE et PME locales — cabinets de conseil et services financiers, agences numériques, professions libérales, commerces et services de proximité — puis les ETI et sièges en complément. Audit, intervention sur site, implémentation et coaching un-à-un, à tarifs publics.",
