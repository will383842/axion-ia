...
// Ille-sur-Têt (66, Pyrénées-Orientales) — Orgues de calcaire, vallée Têt.
...
export const ILLE_SUR_TET_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Ille-sur-Têt et dans la vallée de la Têt ?",
      a: "Oui, Axion-IA intervient à Ille-sur-Têt et toute la vallée de la Têt (Prades à 15 min, Vinça, Millas, Néfiach). Nos consultants viennent de Perpignan (25 min).",
    },
    {
      q: "Travaillez-vous avec les arboriculteurs et producteurs de fruits ?",
      a: "Oui, nous accompagnons les arboriculteurs de la vallée de la Têt (pêches, abricots, cerises) : tri qualité par vision, prédiction récoltes, traçabilité parcellaire, vente directe e-commerce.",
    },
    {
      q: "Accompagnez-vous les acteurs du tourisme nature ?",
