...
export const CUERS_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Audit sur place {{price:audit-flash|flat}}, interventions sur site, coaching 1-to-1, implémentation IA. Cas viticulture Côtes de Provence : traçabilité parcellaire, gestion vendanges, optimisation cave, relation client B2B export et œnotourisme.",
    },
    {
