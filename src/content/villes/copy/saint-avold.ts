...
// Saint-Avold (57, Moselle) — Bassin houiller reconverti, chimie/pétrochimie, sous-préfecture.
...
export const SAINT_AVOLD_COPY: VilleCopy = {
  ...
  distancesEn:
    "Metz à 45 min. Forbach à 20 min. Sarrebruck (Allemagne) à 35 min. Luxembourg à 1h15. Gare SNCF Saint-Avold (ligne Metz–Forbach). Autoroute A4 accès direct. Aéroport Metz-Nancy-Lorraine à 55 min.",
  seoHook: "chimie, pétrochimie & bassin houiller",
  topSectorsNaf: [
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Saint-Avold : formats adaptés à l'atelier industriel, plateforme chimique, entrepôt logistique, chantier, bureau. Vos équipes repartent autonomes.",
    },
    implementation: {
      fr: "Implémentation IA à Saint-Avold : maintenance prédictive industrielle, contrôle qualité chimie, traçabilité supply chain, automatisation devis BTP, agents conversationnels B2B.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Avold ?",
      a: "Oui, Axion-IA intervient à Saint-Avold et dans tout le bassin houiller mosellan (Carling, Folschviller, L'Hôpital, Forbach). Consultants via gare SNCF Saint-Avold ou autoroute A4. Sarrebruck accessible en 35 min.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, commerçants, artisans BTP et entreprises logistique de Saint-Avold : gestion stocks, devis automatisés, relation client, optimisation tournées, présence en ligne. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
