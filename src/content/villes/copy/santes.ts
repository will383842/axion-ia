...
export const SANTES_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    implementation: {
      ...
      en: "Implémentation IA à Santes : automatisation gestion documentaire cabinets libéraux, CRM augmenté prestataires B2B sud lillois, agents conversationnels prise de rendez-vous, optimisation flux logistiques canal de la Deûle, copilotes IA comptabilité-facturation TPE-PME.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Santes : sessions dans votre cabinet, bureau, commerce ou en visio. Dirigeants TPE/PME du sud de la métropole lilloise souhaitant maîtriser l'IA dans leur activité quotidienne.",
      en: "Coaching 1-to-1 à Santes : sessions dans votre cabinet, bureau, commerce ou en visio. Dirigeants TPE/PME du sud de la métropole lilloise souhaitant maîtriser l'IA dans leur activité quotidienne.",
    },
  },
  faqGeolocalisee: [
    {
