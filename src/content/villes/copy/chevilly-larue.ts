...
// Chevilly-Larue (94, Val-de-Marne) — sud Paris, MIN Rungis proche, zone d'activités.
...
export const CHEVILLY_LARUE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Chevilly-Larue : diagnostic adapté aux TPE artisans, PME logistique et agroalimentaire, commerçants et professions libérales du sud Val-de-Marne. ROI chiffré, Audit Flash 490 € HT.",
      en: "Audit IA à Chevilly-Larue : diagnostic adapté aux TPE artisans, PME logistique et agroalimentaire, commerçants et professions libérales du sud Val-de-Marne. ROI chiffré, Audit Flash 490 € HT.",
    },
    interventions: {
      ...
      en: "Interventions IA sur site à Chevilly-Larue : formats adaptés à l'entrepôt, au commerce ou au cabinet. Vos équipes repartent autonomes sur les outils IA configurés pour leur métier.",
    },
    implementation: {
      fr: "Implémentation IA à Chevilly-Larue : optimisation chaîne logistique, prédiction stocks agroalimentaire, automatisation devis artisans, agents conversationnels client. Proximité MIN Rungis et Orly.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Chevilly-Larue dans le Val-de-Marne ?",
      a: "Oui, Axion-IA intervient à Chevilly-Larue et dans tout le sud du Val-de-Marne (Rungis, Thiais, L'Haÿ-les-Roses, Villejuif, Vitry-sur-Seine). Nos consultants se déplacent sur site ou en visio.",
    },
    {
      q: "Quel est le prix d'un audit IA à Chevilly-Larue ?",
      a: "L'Audit Flash IA à Chevilly-Larue démarre à 490 € HT. Ce diagnostic couvre l'analyse de vos processus métier, l'identification des cas d'usage IA prioritaires et un plan d'action chiffré avec ROI estimé.",
    },
    {
