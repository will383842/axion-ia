...
// Cuincy (59, Nord) — Agglomération de Douai, commune résidentielle.
...
export const CUINCY_COPY: VilleCopy = {
  ...
  pitchEn:
    "Cuincy (59), commune résidentielle de 6 467 habitants de l'agglomération de Douai dans le Nord, intégrée à la Communauté d'Agglomération du Douaisis. Tissu TPE artisans, PME de services, commerces de proximité, professions libérales et indépendants du bassin douaisien. Axion-IA y mène ses missions auprès des organisations locales du Douaisis.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Cuincy (59). Nous accompagnons TPE artisans, PME de services, commerçants, professions libérales et indépendants de l'agglomération de Douai. Audit Flash sur mesure, interventions sur site et coaching dirigeants.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Cuincy (59). Nous accompagnons TPE artisans, PME de services, commerçants, professions libérales et indépendants de l'agglomération de Douai. Audit Flash sur mesure, interventions sur site et coaching dirigeants.",
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Cuincy : diagnostic adapté aux TPE artisans, PME de services, commerçants et professions libérales de l'agglomération douaisienne. Audit Flash {{price:audit-flash|flat}}, ROI chiffré sous 10 jours.",
      en: "Audit IA à Cuincy : diagnostic adapté aux TPE artisans, PME de services, commerçants et professions libérales de l'agglomération douaisienne. Audit Flash {{price:audit-flash|flat}}, ROI chiffré sous 10 jours.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Cuincy et dans l'agglomération de Douai ?",
      a: "Oui, Axion-IA intervient à Cuincy et dans toute la Communauté d'Agglomération du Douaisis (Douai, Lambres-lez-Douai, Flers-en-Escrebieux, Sin-le-Noble). Nos consultants se déplacent depuis Lille en 35 min ou Douai en 8 min.",
    },
    {
      q: "Combien coûte un audit IA à Cuincy  ?",
      a: "L'Audit Flash IA démarre à {{price:audit-flash|flat}} pour une session de 4h. Idéal pour les TPE et PME de Cuincy souhaitant identifier rapidement leurs cas d'usage IA prioritaires avec ROI chiffré sous 10 jours.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants interviennent depuis Lille en 35 min ou directement de Douai en 8 min. Cuincy étant intégrée à l'agglomération douaisienne, déplacements sans surcoût hébergement. Sessions sur site ou en visio selon vos préférences.",
    },
  ],
};
