...
// Revel (31, Haute-Garonne) — Lauragais, ébénisterie/meuble d'art, lac Saint-Ferréol.
...
export const REVEL_COPY: VilleCopy = {
  ...
  pitchEn:
    "Revel (31), cité du Lauragais réputée pour l'ébénisterie et le meuble d'art, près de 10 000 habitants. Tissu TPE artisans d'art, PME du meuble et du bois, commerces de centre-ville, professions libérales, tourisme lac Saint-Ferréol. Axion-IA répond aux besoins des activités professionnelles présentes du Lauragais.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Revel (31). Nous accompagnons TPE artisans d'art, PME du meuble, commerçants, professions libérales et acteurs du tourisme du Lauragais. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Revel (31). Nous accompagnons TPE artisans d'art, PME du meuble, commerçants, professions libérales et acteurs du tourisme du Lauragais. Audit sur place sur mesure.",
  ...
  distancesEn:
    "Toulouse centre à 50 min (A61/D622). Castelnaudary à 25 min. Castres à 40 min. Lac Saint-Ferréol à 10 min.",
  topSectorsNaf: [
    "Ébénisterie & meuble d'art",
    "Artisanat d'art & métiers du bois",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Revel : formats adaptés à l'atelier d'ébénisterie, au commerce de la halle, à l'hébergement touristique. Vos équipes repartent autonomes.",
    },
    implementation: {
      fr: "Implémentation IA à Revel : automatisation devis ébénisterie, gestion commandes meuble d'art, agents conversationnels tourisme, classification documents pour artisans et PME du Lauragais.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Revel ?",
      a: "Oui, Axion-IA intervient à Revel et dans tout le Lauragais (Villefranche-de-Lauragais, Castelnaudary, Sorèze). Nos consultants se déplacent en 50 min depuis Toulouse.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, l'IA aide les artisans ébénistes à automatiser devis, suivi commandes, gestion planning atelier, relances clients et classification documents. Gains concrets dès les premières semaines.",
    },
    {
      q: "Comment se déroule une intervention IA à Revel ?",
      a: "Nos consultants se déplacent à Revel (50 min depuis Toulouse). Intervention 1 journée minimum, atelier pratique dans vos locaux. Équipes autonomes en fin de session.",
    },
  ],
};
