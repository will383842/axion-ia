...
export const AMIENS_COPY: VilleCopy = {
  ...
  services: {
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Amiens des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 24-48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Amiens, itérations à distance.",
        whyHere: [
          "Projets web & SaaS amiénois : industrie (Procter & Gamble, Valeo Embrayages — centre mondial des transmissions hybrides), tourisme (2 sites UNESCO), PME et ETI picardes.",
          ...
          "Industrie & FMCG : plateformes métier, RAG, traçabilité et agents — ou tourisme & culture. On adapte la brique IA à votre secteur, hébergement UE, RGPD strict.",
        ],
        methodology: [
          {
            step: "Cadrage à Amiens",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une application avec UX/UI et IA intégrée, pour industriels, acteurs du tourisme et PME amiénoises.",
          },
          {
            sizeLabel: "ETI",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Amiens — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Vous travaillez pour l'industrie et le FMCG ?",
            a: "Oui : plateformes métier, RAG sur documentation, traçabilité, agents et automatisations branchés sur votre SI (PLM, ERP) — un terrain naturel à Amiens avec Procter & Gamble et Valeo. Hébergement UE, RGPD strict.",
          },
          {
        ...
        guarantees:
          "Devis ferme en forfait fixe (à partir de 24-48 h selon la complexité) : pas de dérive horaire cachée. Mise en ligne sans downtime quand on augmente l'existant. Web Vitals et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD : propriété totale, aucun abonnement imposé, transférable à tout prestataire de la région amiénoise ou repris en interne.",
      },
      en: {
        hero: "In Amiens, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 24-48 h depending on project complexity, EU hosting, code and data yours. On-site Amiens kick-off, remote iterations.",
        whyHere: [
          "Amiens web & SaaS projects: industry (Procter & Gamble, Valeo Embrayages — world centre for hybrid transmissions), tourism (2 UNESCO sites), Picardy SMEs and mid-caps.",
          ...
          "Industry & FMCG: business platforms, RAG, traceability and agents — or tourism & culture. We adapt the AI brick to your sector, EU hosting, strict GDPR.",
        ],
        methodology: [
          {
            step: "Scoping in Amiens",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Design or rebuild of a site or app with UX/UI and built-in AI, for manufacturers, tourism players and Amiens SMEs.",
          },
          {
            sizeLabel: "Mid-cap",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Amiens — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Do you work for industry and FMCG?",
            a: "Yes: business platforms, RAG on documentation, traceability, agents and automations wired to your IS (PLM, ERP) — a natural fit in Amiens with Procter & Gamble and Valeo. EU hosting, strict GDPR.",
          },
          {
