...
// Fresnes-sur-Escaut (59, Nord) — vallee de l'Escaut, bassin minier UNESCO, 7 354 hab.
...
export const FRESNES_SUR_ESCAUT_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site a Fresnes-sur-Escaut : formations adaptees a l'atelier industriel, au commerce ou au bureau tertiaire. Equipes autonomes sur outils IA des la premiere journee.",
    },
    implementation: {
      fr: "Implementation IA a Fresnes-sur-Escaut : automatisation processus industriels, agents conversationnels client, predictif maintenance, CRM augmentes pour PME du Valenciennois.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il a Fresnes-sur-Escaut et dans le Valenciennois ?",
      a: "Oui, Axion-IA intervient a Fresnes-sur-Escaut et dans tout le Valenciennois (Valenciennes, Conde-sur-l'Escaut, Vieux-Conde, Anzin). Consultants depuis Lille (45 min TER) ou Paris (TGV Valenciennes 1h50).",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, toutes nos interventions a Fresnes-sur-Escaut sont conformes au RGPD. Protection des donnees de votre entreprise et de vos clients garantie contractuellement.",
    },
  ],
};
