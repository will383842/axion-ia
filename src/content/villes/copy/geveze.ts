...
export const GEVEZE_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Gévezé : sessions dans vos locaux ou en visio pour dirigeants TPE/PME gévezéens, artisans du bâtiment, commerçants et professions libérales.",
      en: "Coaching 1-to-1 à Gévezé : sessions dans vos locaux ou en visio pour dirigeants TPE/PME gévezéens, artisans du bâtiment, commerçants et professions libérales.",
    },
  },
  faqGeolocalisee: [
    {
