...
// Givet (08, Ardennes) — Pointe Ardennes, frontalier Belgique, fort Charlemont.
...
export const GIVET_COPY: VilleCopy = {
  ...
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Givet (08). Nous accompagnons tous types d'activités : TPE artisans, PME industrielles, commerçants transfrontaliers, acteurs touristiques fluviaux et professions libérales de la pointe ardennaise. Audit sur place sur mesure, démarrage sous 5 jours.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Givet (08). Nous accompagnons tous types d'activités : TPE artisans, PME industrielles, commerçants transfrontaliers, acteurs touristiques fluviaux et professions libérales de la pointe ardennaise. Audit sur place sur mesure, démarrage sous 5 jours.",
  ecosystemFr:
  ...
  ecosystemEn:
    "Givet (environ 6 400 habitants) est la commune la plus septentrionale des Ardennes, enclavée en Belgique sur 3 côtés. Le fort de Charlemont, citadelle Vauban édifiée par Charles Quint, domine la ville et la Meuse. L'économie locale repose sur l'industrie (papeterie, métallurgie, chimie), le commerce frontalier avec la Belgique (Dinant, Namur), le tourisme fluvial (port de plaisance Meuse), l'artisanat et les services aux frontaliers.",
  distancesFr:
    "Charleville-Mézières à 60 km via N51. Dinant (Belgique) à 22 km. Namur (Belgique) à 50 km. Reims à 1h45 via A34. Gare de Givet (ligne Givet-Charleville). Aéroport Charleroi (Belgique) à 1h.",
  distancesEn:
    "Charleville-Mézières à 60 km via N51. Dinant (Belgique) à 22 km. Namur (Belgique) à 50 km. Reims à 1h45 via A34. Gare de Givet (ligne Givet-Charleville). Aéroport Charleroi (Belgique) à 1h.",
  topSectorsNaf: [
    "Industrie papeterie, métallurgie & chimie",
    "Commerce frontalier franco-belge",
    "Tourisme fluvial & patrimoine Vauban",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Givet : formations pratiques pour équipes industrielles, commerçants frontaliers, tourisme fluvial et services de la pointe ardennaise. Vos collaborateurs repartent autonomes sur les outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Givet : maintenance prédictive industrie, agents conversationnels bilingues FR-NL pour clientèle belge, automatisation gestion port plaisance, gestion documentaire transfrontalière. Adapté au tissu frontalier ardennais.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Givet et à la pointe des Ardennes ?",
      a: "Oui, Axion-IA intervient à Givet et dans toute la pointe ardennaise (Fumay, Vireux-Wallerand, Aubrives, Chooz). Couverture Charleville-Mézières à 60 km par la N51 et Dinant (Belgique) à 22 km.",
    },
    {
      q: "Accompagnez-vous les commerces et entreprises transfrontaliers franco-belges ?",
      a: "Oui, nous accompagnons les commerces, PME et acteurs économiques transfrontaliers de Givet avec des solutions IA bilingues FR-NL : chatbots multilingues, gestion fiscale dual, optimisation logistique frontalière. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
    ...
    },
    {
      ...
      a: "Pour les industriels de Givet, nous proposons : maintenance prédictive lignes production, contrôle qualité visuel, optimisation flux logistique transfrontalier, gestion documentaire ICPE/Seveso. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
      q: "Comment se déroule une mission Axion-IA à Givet ?",
      a: "Après un premier échange gratuit, nous planifions l'intervention sous 5 jours. Nos consultants se déplacent depuis Charleville-Mézières (60 km) ou via Reims (1h45). Intervention sur site ou en visio. Livrable actionnable et suivi post-mission de 30 jours inclus.",
    },
  ],
};
