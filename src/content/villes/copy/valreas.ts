...
// Valréas (84, Vaucluse) — Enclave des Papes en Drôme, viticulture Côtes du Rhône, cartonnage.
...
export const VALREAS_COPY: VilleCopy = {
  ...
  pitchEn:
    "Valréas (84), capitale de l'Enclave des Papes en Drôme provençale, conjugue tradition industrielle (cartonnage), viticulture AOC Côtes du Rhône et tissu artisanal rural. TPE artisans et viticulteurs, PME cartonnage et agroalimentaires, professions libérales, commerces et tourisme oenologique. Axion-IA accompagne tout le tissu professionnel local.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Valréas (84). Nous accompagnons TPE artisans, viticulteurs AOC, PME cartonnage et agroalimentaires, commerces et professions libérales de l'Enclave des Papes. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Valréas (84). Nous accompagnons TPE artisans, viticulteurs AOC, PME cartonnage et agroalimentaires, commerces et professions libérales de l'Enclave des Papes. Audit sur place sur mesure.",
  ...
  servicesContext: {
    ...
    unAUn: {
      ...
      en: "Coaching 1-to-1 à Valréas : sessions pour dirigeants PME cartonnage, viticulteurs AOC, artisans et commerçants souhaitant maîtriser l'IA opérationnelle sans transformation lourde.",
    },
  },
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Valréas et dans l'Enclave des Papes ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les viticulteurs sur traçabilité parcellaire, prévision de récoltes, gestion cave, e-commerce direct producteur, marketing oenotouristique multilingue et conformité réglementaire.",
    },
    {
      q: "Travaillez-vous avec les PME cartonnage et industrielles ?",
      a: "Oui, nous intervenons dans le cartonnage et l'industrie sur prévision de demande, optimisation chaîne production, maintenance prédictive, gestion stocks et automatisation administrative.",
    },
    {
