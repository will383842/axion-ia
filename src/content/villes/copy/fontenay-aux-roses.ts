...
export const FONTENAY_AUX_ROSES_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Fontenay : formats adaptés à votre métier réel (atelier, commerce, cabinet, laboratoire). Vos équipes repartent avec outils IA configurés pour vos tâches concrètes.",
    },
    implementation: {
      fr: "Implémentation IA à Fontenay : agents conversationnels, automatisation devis BTP/devis honoraires libéraux, classification documents recherche, CRM augmentés, gestion RDV santé. Tous secteurs.",
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Oui, Axion-IA intervient à Fontenay-aux-Roses et tout le sud-ouest des Hauts-de-Seine (Châtenay-Malabry, Le Plessis-Robinson, Bourg-la-Reine, Sceaux, Bagneux). Couverture également plateau de Saclay (15 min) et Paris intra-muros (20 min RER B).",
    },
    {
      q: "Accompagnez-vous le CEA Fontenay-aux-Roses et structures de recherche ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les TPE artisans BTP à Fontenay (plombiers, électriciens, peintres, menuisiers) sur des cas IA pratiques : automatisation devis chantier, agents IA prise de RDV, classification photos chantier, gestion stocks et planning. Audit Flash 490 € HT adapté aux artisans.",
    },
    {
      q: "Quels services pour les professions libérales fontenaysiennes ?",
      a: "Pour les professions libérales à Fontenay (médecins, avocats, expertise-comptable, consultants), audit Flash 490 € HT, intervention 1 journée formation pratique, coaching 1-to-1. Cas IA : agents conversationnels patients/clients, automatisation gestion RDV, transcription consultations.",
    },
    {
      q: "Quels formats pour les commerces de proximité ?",
      a: "Pour les commerces de proximité à Fontenay (boulangeries, librairies, fleuristes, optique), nous proposons audit ciblé sur votre activité, intervention 1 journée formation IA pratique. Cas typiques : agents IA fidélité client, classification produits, automatisation devis, gestion stocks.",
    },
  ],
};
