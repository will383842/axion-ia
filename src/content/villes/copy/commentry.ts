...
export const COMMENTRY_COPY: VilleCopy = {
  pitchFr:
    "Commentry (03), commune du bassin de Montluçon dans l'Allier, a un héritage minier et industriel fort (ancien bassin houiller, métallurgie historique). Tissu PME industrielles diversifiées, TPE artisans BTP, commerces. Axion-IA y intervient pour tous types d'activités du Bourbonnais.",
  pitchEn:
    "Commentry (03), commune du bassin de Montluçon dans l'Allier, a un héritage minier et industriel fort (ancien bassin houiller, métallurgie historique). Tissu PME industrielles diversifiées, TPE artisans BTP, commerces. Axion-IA y intervient pour tous types d'activités du Bourbonnais.",
  directAnswerFr:
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Commentry : diagnostic adapté aux PME industrielles diversifiées bassin Montluçon, TPE artisans. ROI chiffré, audit Flash 490 € HT.",
      en: "Audit IA à Commentry : diagnostic adapté aux PME industrielles diversifiées bassin Montluçon, TPE artisans. ROI chiffré, audit Flash 490 € HT.",
    },
    interventions: {
      fr: "Interventions IA sur site à Commentry : formats adaptés à l'atelier industriel, commerce. Vos équipes repartent autonomes.",
      en: "Interventions IA sur site à Commentry : formats adaptés à l'atelier industriel, commerce. Vos équipes repartent autonomes.",
    },
    implementation: {
