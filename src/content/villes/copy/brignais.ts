...
// Brignais (69, Rhône) — banlieue SO Lyon, vallée du Garon, péri-urbain résidentiel.
...
export const BRIGNAIS_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Brignais : formats adaptés au bureau, cabinet professionnel, commerce. Vos équipes repartent autonomes sur outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Brignais : agents conversationnels patient/client, automatisation workflow tertiaire, classification dossiers, CRM augmentés. SO lyonnais.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Brignais et SO lyonnais ?",
      a: "Oui, Axion-IA intervient à Brignais et tout le SO lyonnais (Oullins à 10 min, Pierre-Bénite, Givors à 15 min, Chaponost). Consultants depuis Lyon (20 min).",
    },
    {
      q: "Accompagnez-vous les professions libérales brignairotes ?",
      a: "Oui, nous accompagnons les professions libérales à Brignais sur leurs cas IA respectueux du secret professionnel : agents conversationnels patients/clients, automatisation RDV, classification dossiers. RGPD strict.",
    },
    {
