...
export const BEDARRIDES_COPY: VilleCopy = {
  ...
  pitchEn:
    "Bédarrides (84), commune de la vallée de l'Ouvèze proche de Châteauneuf-du-Pape, compte près de 5 671 habitants. Vignoble AOC Châteauneuf-du-Pape et Côtes-du-Rhône, agriculture, tissu de TPE artisanales, domaines viticoles prestigieux, PME agroalimentaires et commerces de proximité. Axion-IA y intervient pour tous types d'activités.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Bédarrides (84). Nous accompagnons tous types d'activités : TPE artisans, domaines viticoles AOC Châteauneuf-du-Pape et Côtes-du-Rhône, PME agroalimentaires, commerces et services de la vallée de l'Ouvèze. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Bédarrides (84). Nous accompagnons tous types d'activités : TPE artisans, domaines viticoles AOC Châteauneuf-du-Pape et Côtes-du-Rhône, PME agroalimentaires, commerces et services de la vallée de l'Ouvèze. Audit sur place sur mesure.",
  ...
  servicesContext: {
    ...
    implementation: {
      ...
      en: "Implémentation IA à Bédarrides : traçabilité parcellaire AOC Châteauneuf-du-Pape, gestion vendanges et cave, relation client B2B export, oenotourisme, agents conversationnels multilingues, fiches Google Business. Adapté TPE/PME vallée Ouvèze.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Bédarrides : sessions dans vos locaux ou en visio. Dirigeants TPE/PME viticulture AOC, oenotourisme, hébergement, agroalimentaire et commerce de la vallée de l'Ouvèze.",
      en: "Coaching 1-to-1 à Bédarrides : sessions dans vos locaux ou en visio. Dirigeants TPE/PME viticulture AOC, oenotourisme, hébergement, agroalimentaire et commerce de la vallée de l'Ouvèze.",
    },
  },
  faqGeolocalisee: [
    {
