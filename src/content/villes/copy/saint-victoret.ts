...
// Saint-Victoret (13, Bouches-du-Rhône) — aéroport Marseille-Provence, zone aéroportuaire.
...
export const SAINT_VICTORET_COPY: VilleCopy = {
  ...
  pitchEn:
    "Saint-Victoret (13), commune riveraine de l'aéroport Marseille-Provence, bénéficie d'un tissu d'entreprises liées à l'aéroportuaire, à la logistique et aux services. TPE artisans, PME transport et logistique, prestataires aéroportuaires, commerçants. Axion-IA opère pour entreprises et indépendants du secteur.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Saint-Victoret (13). Nous accompagnons TPE artisans, PME de logistique aéroportuaire, prestataires de services, commerçants et entreprises de la zone Marseille-Provence. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Saint-Victoret (13). Nous accompagnons TPE artisans, PME de logistique aéroportuaire, prestataires de services, commerçants et entreprises de la zone Marseille-Provence. Audit sur place sur mesure.",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Saint-Victoret : ateliers pratiques pour équipes logistique, maintenance aéroportuaire et services aux entreprises. Outils IA configurés métier réel.",
    },
    implementation: {
      fr: "Implémentation IA à Saint-Victoret : optimisation flux fret, maintenance prédictive, automatisation documents transport, agents conversationnels clients, gestion planning équipes. RGPD strict.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Victoret et zone aéroportuaire ?",
      a: "Oui, Axion-IA intervient à Saint-Victoret et dans toute la zone aéroportuaire (Marignane, Vitrolles, Les Pennes-Mirabeau, Châteauneuf-les-Martigues). Aéroport Marseille-Provence à 5 min.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les entreprises liées à l'aéroport Marseille-Provence : handling, fret aérien, maintenance, catering, location véhicules, prestataires services. Cas IA adaptés à chaque métier.",
    },
    {
      q: "Proposez-vous des solutions IA pour la logistique fret ?",
      a: "Oui, nous implémentons des solutions IA pour le fret : optimisation planification chargements, traçabilité documentaire, maintenance prédictive équipements, automatisation déclarations douanières.",
    },
    {
