...
// Bures-sur-Yvette (91, Essonne) — vallée de Chevreuse, campus Paris-Saclay, résidentielle, 9 548 hab.
...
export const BURES_SUR_YVETTE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Bures-sur-Yvette (91), commune résidentielle de la vallée de Chevreuse aux portes du campus Paris-Saclay, accueille un tissu de TPE, professions libérales, commerces de proximité et PME liées à l'écosystème universitaire et scientifique. Axion-IA y travaille avec les organisations du territoire du sud-ouest essonnien.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Bures-sur-Yvette (91). Nous accompagnons tous types d'activités : TPE, professions libérales, commerçants de la vallée de Chevreuse, PME de services, indépendants et structures proches du campus Paris-Saclay. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Bures-sur-Yvette (91). Nous accompagnons tous types d'activités : TPE, professions libérales, commerçants de la vallée de Chevreuse, PME de services, indépendants et structures proches du campus Paris-Saclay. Audit sur place sur mesure.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Bures-sur-Yvette et vallée de Chevreuse ?",
      a: "Oui, Axion-IA intervient à Bures-sur-Yvette et toute la vallée de Chevreuse (Orsay, Gif-sur-Yvette, Les Ulis, Palaiseau). Nos consultants accèdent facilement via le RER B depuis Paris (45 min).",
    },
    {
      q: "Accompagnez-vous les professions libérales buressoises ?",
      a: "Oui, nous accompagnons les professions libérales à Bures-sur-Yvette sur des cas IA respectueux du secret professionnel : agents conversationnels patients/clients, automatisation gestion RDV, transcription consultations, classification dossiers. RGPD strict.",
    },
    {
