...
export const LA_GARENNE_COLOMBES_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Non. Axion-IA n'a pas d'agence à La Garenne-Colombes : nos architectes IA se déplacent depuis Paris, avec des frais de transport transparents distincts du forfait.",
    },
  ],
};
