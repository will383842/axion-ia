...
// Sommières (30, Gard) — bourg médiéval, Vidourle, Gard, patrimoine.
...
export const SOMMIERES_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Sommières et Vidourle gardois ?",
      a: "Oui, Axion-IA intervient à Sommières et tout le secteur Vidourle (Villevieille, Aspères, Calvisson, Salinelles). Couverture étendue entre Nîmes et Montpellier, Piémont cévenol et plaine gardoise.",
    },
    {
      q: "Travaillez-vous avec les domaines viticoles AOC Sommières ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les acteurs du tourisme patrimoine sommiérois (château, événements médiévaux, hébergements) : chatbot multilingue visiteurs, automatisation réservations, classification avis, marketing IA ciblé événementiel.",
    },
    {
      q: "Comment se passe une mission à Sommières ?",
      a: "Sommières est à 30 min de Nîmes et 30 min de Montpellier. Nos consultants interviennent sur site. Échangeur A9 Lunel à 15 min. Gare TGV Nîmes à 30 min voiture.",
    },
  ],
};
