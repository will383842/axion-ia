...
// Saint-Omer (62, Pas-de-Calais) — Sous-préfecture, cathédrale, marais audomarois.
...
export const SAINT_OMER_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Omer et dans l'Audomarois ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les PME agroalimentaires et maraîchères de l'Audomarois sur optimisation traçabilité, prédiction rendements, contrôle qualité par vision, automatisation documents réglementaires, classification photos produits. ROI chiffré contractuel.",
    },
    {
      q: "Accompagnez-vous les professionnels du tourisme et du patrimoine ?",
      a: "Oui, nous accompagnons les professionnels du tourisme à Saint-Omer (hôtels, restaurants, offices de tourisme, sites patrimoniaux) sur agents conversationnels multilingues, automatisation réservations, classification avis, optimisation tarification dynamique.",
    },
    {
