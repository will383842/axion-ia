...
// Pacé (35, Ille-et-Vilaine) — ouest Rennes, résidentielle dynamique.
...
export const PACE_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Pacé et ouest Rennes ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les professions libérales (avocats, experts-comptables, praticiens santé) de Pacé sur leurs cas IA : automatisation rédaction, RAG documentaire, agents IA prise de RDV, outils productivité bureautique.",
    },
    {
      q: "Quels services pour les PME de services de l'ouest Rennes ?",
      a: "Pour les PME de services à Pacé et ouest Rennes, audit complet processus IA, implémentation outils sur mesure (RAG, agents, automatisation), formation équipes. ROI chiffré dès l'audit sur place {{price:audit-flash|flat}}.",
    },
    {
