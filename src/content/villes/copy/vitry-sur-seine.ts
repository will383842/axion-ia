...
export const VITRY_SUR_SEINE_COPY: VilleCopy = {
  pitchFr:
    "Vitry-sur-Seine concentre des acteurs industriels et scientifiques de premier plan — dont le Centre de recherche Sanofi et l'IUT de Vitry-sur-Seine. Axion-IA intervient sur site pour aider les entreprises vitriotes à déployer l'IA dans leurs opérations, sans détour par des généralités.",
  pitchEn:
    "Vitry-sur-Seine concentre des acteurs industriels et scientifiques de premier plan — dont le Centre de recherche Sanofi et l'IUT de Vitry-sur-Seine. Axion-IA intervient sur site pour aider les entreprises vitriotes à déployer l'IA dans leurs opérations, sans détour par des généralités.",
  directAnswerFr:
  ...
  ecosystemEn:
    "L'économie vitriote s'articule autour de l'industrie pharmaceutique — avec le Centre de recherche Sanofi Vitry — et du numérique via le pôle Systematic Paris-Region. Les ZAC du Port à l'Anglais et Rouget de Lisle accueillent également des activités de construction et de commerce structurant le tissu local.",
  distancesFr:
    "Vitry-sur-Seine est accessible depuis la Gare de Lyon (12 km), l'Aéroport d'Orly (11 km) et desservie par 3 lignes métro/tram.",
  distancesEn:
    "Vitry-sur-Seine est accessible depuis la Gare de Lyon (12 km), l'Aéroport d'Orly (11 km) et desservie par 3 lignes métro/tram.",
  topSectorsNaf: [
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Vitry-sur-Seine : nous cartographions vos processus métier — notamment dans les secteurs R&D et santé présents sur la ville — pour identifier 3 chantiers IA prioritaires chiffrés. Détail complet sur la sous-page /audits.",
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Les structures liées à la R&D scientifique — secteur dominant à Vitry-sur-Seine — mobilisent souvent l'IA pour la veille documentaire, la synthèse de rapports et l'automatisation de processus qualité. Nous auditons ces usages sans présupposer de solution, en partant de vos contraintes réglementaires réelles.",
    },
    {
      q: "Comment Axion-IA traite-t-il la conformité RGPD lors d'une intervention à Vitry-sur-Seine ?",
