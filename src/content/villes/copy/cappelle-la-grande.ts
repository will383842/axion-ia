...
// Cappelle-la-Grande (59, Nord) — agglomération de Dunkerque, commune résidentielle.
...
export const CAPPELLE_LA_GRANDE_COPY: VilleCopy = {
  ...
  distancesEn:
    "Dunkerque centre à 10 min. Saint-Pol-sur-Mer à 8 min. Grande-Synthe à 10 min. Autoroute A16 accès à 5 min. Gare SNCF de Dunkerque à 12 min. Port de Dunkerque à 15 min. Calais à 35 min. Lille à 1 h 10.",
  seoHook: "services & sous-traitance industrielle",
  topSectorsNaf: [
    "Services aux entreprises et professions libérales",
    "Commerce de proximité et artisanat",
    "Sous-traitance industrielle et logistique portuaire",
    "Restauration et hôtellerie",
    "Construction et BTP local",
  ],
  servicesContext: {
    audit: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Cappelle-la-Grande ?",
    ...
    },
    {
      ...
      a: "Oui, artisans, restaurateurs et professions libérales cappellois : gestion stocks, prise de réservations, comptabilité, relation client, présence locale en ligne. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
