...
// Champigny-sur-Marne (94, Val-de-Marne) — grande ville des bords de Marne, héritage métallurgique et mécanique, guinguettes historiques, future desserte Grand Paris Express.

import type { VilleCopy } from "./types";

export const CHAMPIGNY_SUR_MARNE_COPY: VilleCopy = {
  pitchFr:
  ...
  ecosystemEn:
    "Champigny-sur-Marne, l'une des plus grandes villes du Val-de-Marne, s'est construite le long de la Marne et de ses guinguettes, avec un passé industriel fort dans la métallurgie, la mécanique et la transformation des métaux. Son tissu actuel mêle ateliers et petites industries, artisans du bâtiment, commerces de proximité et sociétés de services, à l'aube d'un désenclavement par le Grand Paris Express. Ces TPE et PME affrontent des tâches répétitives — devis, plannings, suivi qualité, relances — qui se prêtent bien à des automatisations ciblées et rentables qu'Axion-IA priorise, l'ETI restant marginale.",
  distancesFr:
    "Champigny-sur-Marne est desservie par le RER A (Champigny) et le RER E (Les Boullereaux-Champigny), à une vingtaine de minutes de Paris, et sera prochainement reliée à la ligne 15 du Grand Paris Express. L'A4 et l'A86 bordent la commune, la gare de Lyon est à une dizaine de kilomètres et l'aéroport de Paris-Orly à une vingtaine. Cette desserte permet à Axion-IA d'intervenir sur site sans logistique lourde.",
  distancesEn:
    "Champigny-sur-Marne est desservie par le RER A (Champigny) et le RER E (Les Boullereaux-Champigny), à une vingtaine de minutes de Paris, et sera prochainement reliée à la ligne 15 du Grand Paris Express. L'A4 et l'A86 bordent la commune, la gare de Lyon est à une dizaine de kilomètres et l'aéroport de Paris-Orly à une vingtaine. Cette desserte permet à Axion-IA d'intervenir sur site sans logistique lourde.",
  topSectorsNaf: [
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Champigny-sur-Marne : une journée pour cartographier les tâches répétitives d'un atelier, d'un artisan ou d'un commerce — chiffrage de devis, plannings, suivi qualité — et prioriser ce qui mérite réellement d'être automatisé.",
      en: "Audit IA à Champigny-sur-Marne : une journée pour cartographier les tâches répétitives d'un atelier, d'un artisan ou d'un commerce — chiffrage de devis, plannings, suivi qualité — et prioriser ce qui mérite réellement d'être automatisé.",
    },
    interventions: {
      fr: "Interventions à Champigny-sur-Marne : nous traitons un irritant précis d'une TPE ou PME locale — devis, relances fournisseurs, plannings de chantier — avec une automatisation sobre, livrée vite et tenable.",
      en: "Interventions à Champigny-sur-Marne : nous traitons un irritant précis d'une TPE ou PME locale — devis, relances fournisseurs, plannings de chantier — avec une automatisation sobre, livrée vite et tenable.",
    },
    implementation: {
      fr: "Implémentation à Champigny-sur-Marne : nous connectons l'IA aux outils déjà en place chez les artisans, industriels et commerces locaux — devis, ERP, gestion de planning — pour un déploiement documenté, sans dépendance imposée.",
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Oui. Notre priorité va aux TPE puis aux PME de Champigny-sur-Marne : ateliers, artisans du bâtiment, commerces et sociétés de services. Nous accompagnons les ETI plus à la marge. L'objectif est d'apporter des automatisations utiles, sans complexité inutile.",
    },
    {
      q: "L'IA est-elle utile aux ateliers et artisans de Champigny-sur-Marne ?",
      a: "Oui. Le tissu campinois, héritier de la métallurgie et de la mécanique, compte de nombreux ateliers et artisans dont les tâches — chiffrage de devis, plannings, suivi qualité — sont répétitives et se prêtent bien à des automatisations ciblées et rentables.",
    },
    {
    ...
    {
      q: "Comment garantissez-vous la conformité RGPD à Champigny-sur-Marne ?",
      a: "La conformité RGPD est intégrée dès le cadrage : minimisation des données, hébergement maîtrisé, traçabilité des traitements. Pour des ateliers, artisans et commerces gérant des données clients et fournisseurs, c'est une condition de départ non négociable.",
    },
  ],
};
