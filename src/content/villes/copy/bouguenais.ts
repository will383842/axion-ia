  ...
  faqGeolocalisee: [
    {
      ...
      a: "L'Audit Flash 4 h démarre à {{price:audit-flash|flat}}, l'Intervention Essentielle à {{price:intervention-4h|flat}} et l'implémentation sur mesure à {{price:impl-poc|entry}}. Tous nos tarifs publics sont consultables en ligne, sans frais cachés.",
    },
    {
