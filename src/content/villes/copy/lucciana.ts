...
export const LUCCIANA_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Lucciana : sessions dans votre exploitation, commerce, atelier ou en visio. Dirigeants TPE/PME lucciagiens, gérants tourisme patrimonial et balnéaire.",
      en: "Coaching 1-to-1 à Lucciana : sessions dans votre exploitation, commerce, atelier ou en visio. Dirigeants TPE/PME lucciagiens, gérants tourisme patrimonial et balnéaire.",
    },
  },
  faqGeolocalisee: [
    {
