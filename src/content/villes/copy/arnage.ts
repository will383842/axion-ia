...
// Arnage (72, Sarthe) — Agglo Le Mans, circuit 24h.
...
export const ARNAGE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Arnage (72), commune de l'agglomération du Mans en Sarthe, est mondialement connue pour la courbe d'Arnage du circuit des 24 Heures. Plus de 5 400 habitants, zones d'activités dynamiques, tissu de TPE artisanales, PME industrielles et commerces. Axion-IA opère pour toutes les structures économiques de la commune.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Arnage (72). Nous accompagnons tous types d'activités : TPE artisans et commerçants, PME industrielles agglo Le Mans, sous-traitants automobile et sport mécanique, professions libérales et services de proximité.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Arnage (72). Nous accompagnons tous types d'activités : TPE artisans et commerçants, PME industrielles agglo Le Mans, sous-traitants automobile et sport mécanique, professions libérales et services de proximité.",
  ...
  ecosystemEn:
    "Arnage fait partie de Le Mans Métropole (Sarthe). Le circuit des 24 Heures du Mans passe par la commune (virage d'Arnage). Zones d'activités à proximité du pôle économique sud Le Mans. Industries mécaniques, commerce, artisanat, services. Le Mans centre à 10 min.",
  distancesFr:
    "Le Mans centre à 10 min. Gare TGV Le Mans à 15 min. Paris à 55 min TGV depuis Le Mans. Tours à 1h A28. Autoroutes A11/A28 accessibles en 10 min.",
  distancesEn:
    "Le Mans centre à 10 min. Gare TGV Le Mans à 15 min. Paris à 55 min TGV depuis Le Mans. Tours à 1h A28. Autoroutes A11/A28 accessibles en 10 min.",
  topSectorsNaf: [
    "Industrie mécanique & automobile",
    "Sport mécanique & événementiel (24 Heures du Mans)",
    "Artisanat & commerce de proximité",
    "Services aux entreprises agglo Le Mans",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Arnage et dans l'agglomération du Mans ?",
      a: "Oui, Axion-IA intervient à Arnage et dans toute l'agglomération du Mans. Le Mans centre est à 10 min. Déplacements sur site inclus dans le périmètre métropole.",
    },
    {
      q: "Quels services IA pour les PME industrielles d'Arnage ?",
      a: "Audit sur place {{price:audit-flash|flat}}, interventions sur site, coaching 1-to-1, implémentation IA. Cas industrie : maintenance prédictive, contrôle qualité vision, automatisation logistique, optimisation chaîne de production.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants sont accessibles depuis la gare TGV Le Mans (15 min d'Arnage, Paris à 55 min TGV). Intervention sur site dans vos locaux industriels, ateliers ou bureaux.",
    },
  ],
};
