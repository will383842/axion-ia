...
export const LE_MENE_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Nos consultants se déplacent depuis Saint-Brieuc (40 min) ou Rennes (1h15). Gare TGV de Saint-Brieuc sur la ligne Paris-Brest, puis route vers Loudéac et Le Mené.",
    },
  ],
};
