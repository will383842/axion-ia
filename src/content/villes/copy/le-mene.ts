...
// Le Mené (22, Côtes-d'Armor) — Commune nouvelle centre Bretagne, agroalimentaire.
...
export const LE_MENE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Le Mené (22), commune nouvelle du centre Bretagne dans les Côtes-d'Armor, est un pôle agroalimentaire et agricole majeur du pays de Loudéac. TPE artisans, PME agroalimentaires, exploitants agricoles, commerces de bourg, coopératives et professions libérales composent son tissu économique. Axion-IA opère pour toutes les structures économiques de la commune du centre Bretagne.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient au Mené (22). Nous accompagnons tous types d'activités : TPE artisans, PME agroalimentaires et coopératives agricoles du centre Bretagne, commerçants de bourg, transporteurs, professions libérales et indépendants du pays de Loudéac.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient au Mené (22). Nous accompagnons tous types d'activités : TPE artisans, PME agroalimentaires et coopératives agricoles du centre Bretagne, commerçants de bourg, transporteurs, professions libérales et indépendants du pays de Loudéac.",
  ...
  ecosystemEn:
    "Le Mené est une commune nouvelle née en 2016 de la fusion de sept communes du centre Bretagne, dans le pays de Loudéac. L'économie locale repose sur l'agroalimentaire (porc, volaille, lait), l'agriculture intensive, les coopératives, l'artisanat BTP, le transport routier et le commerce de bourg. La commune est pionnière en énergies renouvelables (méthanisation, éolien).",
  distancesFr:
    "Loudéac à 20 min. Gare de Saint-Brieuc (TGV Paris 2h45) à 40 min. Gare de Rennes (TGV) à 1h15. Lamballe à 30 min. Pontivy à 35 min.",
  distancesEn:
    "Loudéac à 20 min. Gare de Saint-Brieuc (TGV Paris 2h45) à 40 min. Gare de Rennes (TGV) à 1h15. Lamballe à 30 min. Pontivy à 35 min.",
  topSectorsNaf: [
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site au Mené : formats adaptés à l'atelier agroalimentaire, la coopérative agricole ou le commerce de bourg. Vos équipes repartent autonomes sur les outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA au Mené : automatisation traçabilité agroalimentaire, agents IA gestion de troupeau, optimisation logistique coopérative, classification documents qualité. Adapté au tissu agricole et industriel centre Bretagne.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il au Mené et dans le centre Bretagne ?",
      a: "Oui, Axion-IA intervient au Mené et dans tout le pays de Loudéac (Loudéac, Merdrignac, Collinée, Plémet, Uzel). Saint-Brieuc à 40 min, Rennes à 1h15, Pontivy à 35 min.",
    },
    {
      q: "Travaillez-vous avec les PME agroalimentaires du secteur ?",
    ...
    },
    {
      ...
      a: "Nos consultants se déplacent depuis Saint-Brieuc (40 min) ou Rennes (1h15). Gare TGV de Saint-Brieuc sur la ligne Paris-Brest, puis route vers Loudéac et Le Mené. Frais de déplacement facturés à part du forfait journée, tarifs publics et transparents.",
    },
  ],
};
