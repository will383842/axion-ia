...
export const SAINT_SULPICE_LA_POINTE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Saint-Sulpice-la-Pointe (81), commune dynamique à la charnière Toulouse-Tarn avec près de 10 000 habitants. Tissu TPE artisans, PME sous-traitance aéronautique et industrie, commerces, services et professions libérales. Axion-IA répond aux besoins de toutes les entreprises du bassin saint-sulpicien.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Saint-Sulpice-la-Pointe (81). Nous accompagnons TPE artisans, PME aéronautique et industrielles, commerçants et professions libérales entre Toulouse et Tarn. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Saint-Sulpice-la-Pointe (81). Nous accompagnons TPE artisans, PME aéronautique et industrielles, commerçants et professions libérales entre Toulouse et Tarn. Audit sur place sur mesure.",
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Saint-Sulpice-la-Pointe : sessions dans vos locaux ou en visio. Dirigeants TPE, gérants PME aéro/industrie, commerçants et professions libérales du sud Tarn.",
      en: "Coaching 1-to-1 à Saint-Sulpice-la-Pointe : sessions dans vos locaux ou en visio. Dirigeants TPE, gérants PME aéro/industrie, commerçants et professions libérales du sud Tarn.",
    },
  },
  faqGeolocalisee: [
    {
