...
// Sarrebourg (57, Moselle) — sous-préfecture, vitraux Chagall, cristallerie, carrefour Metz–Nancy–Strasbourg.
...
export const SARREBOURG_COPY: VilleCopy = {
  ...
  pitchEn:
    "Sarrebourg (57), sous-préfecture de 12 170 habitants en Moselle, carrefour historique sur la Sarre entre Metz, Nancy et Strasbourg, est connue pour ses vitraux Chagall et son héritage cristallier (cristallerie Saint-Louis à proximité). Tissu TPE/PME industrie, cristallerie, commerces, services, tourisme culturel. Axion-IA y intervient pour tous types d'activités.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Sarrebourg (57). Nous accompagnons tous types d'activités : TPE/PME industrie et cristallerie, artisans verriers, commerces du centre, professions de services, administrations sous-préfectorales et acteurs du tourisme culturel sarrebourgeois.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Sarrebourg (57). Nous accompagnons tous types d'activités : TPE/PME industrie et cristallerie, artisans verriers, commerces du centre, professions de services, administrations sous-préfectorales et acteurs du tourisme culturel sarrebourgeois.",
  ecosystemFr:
  ...
  distancesEn:
    "Strasbourg à 50 min. Nancy à 1h. Metz à 1h. Gare SNCF Sarrebourg (TGV Paris à 2h, ligne Paris–Strasbourg). Autoroute A4 accès direct. Aéroport Strasbourg-Entzheim à 1h. Luxembourg à 1h45.",
  seoHook: "industrie, cristallerie & culture",
  topSectorsNaf: [
    "Industrie cristallerie et verrerie",
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Sarrebourg : diagnostic adapté aux TPE/PME industrie, cristallerie, artisans verriers, commerces, services. ROI chiffré, audit Flash 490 € HT.",
      en: "Audit IA à Sarrebourg : diagnostic adapté aux TPE/PME industrie, cristallerie, artisans verriers, commerces, services. ROI chiffré, audit Flash 490 € HT.",
    },
    interventions: {
      fr: "Interventions IA sur site à Sarrebourg : formats adaptés à l'atelier industriel, la cristallerie, le commerce, le bureau. Vos équipes repartent autonomes.",
      en: "Interventions IA sur site à Sarrebourg : formats adaptés à l'atelier industriel, la cristallerie, le commerce, le bureau. Vos équipes repartent autonomes.",
    },
    implementation: {
      fr: "Implémentation IA à Sarrebourg : contrôle qualité production verrière, traçabilité industrielle, agents conversationnels touristiques bilingues, workflow administratif, gestion commerciale.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Sarrebourg ?",
      a: "Oui, Axion-IA intervient à Sarrebourg et dans son arrondissement (Phalsbourg, Saverne à proximité). Consultants via gare SNCF Sarrebourg (TGV) ou A4. Position carrefour entre Metz, Nancy, Strasbourg.",
    },
    {
