...
export const SARREBOURG_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, commerçants du centre-ville et acteurs du tourisme culturel sarrebourgeois (vitraux Chagall, patrimoine) : gestion réservations, relation client, automatisation comptabilité, présence en ligne. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
