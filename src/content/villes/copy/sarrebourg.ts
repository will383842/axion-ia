...
export const SARREBOURG_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Sarrebourg : formats adaptés à l'atelier industriel, la cristallerie, le commerce, le bureau. Vos collaborateurs gèrent ensuite la stack en autonomie.",
    },
    implementation: {
