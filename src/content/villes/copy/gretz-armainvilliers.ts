...
// Gretz-Armainvilliers (77, Seine-et-Marne) — est Seine-et-Marne, résidentielle.
...
export const GRETZ_ARMAINVILLIERS_COPY: VilleCopy = {
  ...
  pitchEn:
    "Gretz-Armainvilliers (77), commune résidentielle de l'est de la Seine-et-Marne, entre forêt d'Armainvilliers et bassin de Brie. Tissu TPE artisans, PME de services, commerces de proximité, professions libérales et prestataires. Axion-IA y déploie son expertise pour toutes les organisations.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Gretz-Armainvilliers (77). Nous accompagnons TPE et PME : artisans du bâtiment, commerces de proximité, professions libérales, prestataires de services et entreprises de l'est seine-et-marnais. Audit Flash sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Gretz-Armainvilliers (77). Nous accompagnons TPE et PME : artisans du bâtiment, commerces de proximité, professions libérales, prestataires de services et entreprises de l'est seine-et-marnais. Audit Flash sur mesure.",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Gretz-Armainvilliers : formats adaptés au cabinet, commerce ou atelier artisan. Vos équipes repartent autonomes sur les outils IA configurés pour leur métier.",
    },
    implementation: {
      fr: "Implémentation IA à Gretz-Armainvilliers : automatisation devis artisans, gestion relation client PME, facturation automatisée, digitalisation cabinets professions libérales.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Gretz-Armainvilliers ?",
      a: "Oui, Axion-IA intervient à Gretz-Armainvilliers et dans tout l'est de la Seine-et-Marne (Tournan-en-Brie, Ozoir-la-Ferrière, Pontault-Combault, Roissy-en-Brie). Nos consultants se déplacent sur site ou en visio.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nos interventions IA sur site à Gretz-Armainvilliers sont adaptées aux PME de services et commerces. Formats demi-journée ou journée complète, vos équipes repartent autonomes sur les outils IA métier.",
    },
    {
