...
// Sarzeau (56, Morbihan) — Presqu'île Rhuys, Golfe Morbihan, tourisme.
...
export const SARZEAU_COPY: VilleCopy = {
  ...
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Sarzeau (56). Nous accompagnons tous types d'activités : TPE touristiques, PME de l'hébergement, restaurateurs, artisans, commerçants saisonniers et indépendants de la presqu'île de Rhuys. Audit sur place sur mesure, démarrage sous 5 jours.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Sarzeau (56). Nous accompagnons tous types d'activités : TPE touristiques, PME de l'hébergement, restaurateurs, artisans, commerçants saisonniers et indépendants de la presqu'île de Rhuys. Audit sur place sur mesure, démarrage sous 5 jours.",
  ecosystemFr:
  ...
  ecosystemEn:
    "Sarzeau est la commune principale de la presqu'île de Rhuys, entre le Golfe du Morbihan et l'océan Atlantique. L'économie locale est fortement saisonnière, tirée par le tourisme balnéaire (campings, hôtels, locations), la restauration, le nautisme, l'ostréiculture et l'artisanat d'art. Le château de Suscinio et les plages attirent plus de 500 000 visiteurs par an. En arrière-saison, les services de proximité et les professions libérales stabilisent l'activité.",
  distancesFr:
    "Vannes à 25 min par RD780. Gare de Vannes (TGV Paris 2 h 30) à 30 min. Auray à 40 min. Lorient à 1 h 10. Aéroport Lorient-Bretagne Sud à 1 h 15. Port-Navalo (navettes Golfe) à 10 min.",
  distancesEn:
    "Vannes à 25 min par RD780. Gare de Vannes (TGV Paris 2 h 30) à 30 min. Auray à 40 min. Lorient à 1 h 10. Aéroport Lorient-Bretagne Sud à 1 h 15. Port-Navalo (navettes Golfe) à 10 min.",
  topSectorsNaf: [
    "Tourisme balnéaire & hébergement",
    "Restauration & commerce saisonnier",
    "Nautisme & activités maritimes",
    "Artisanat d'art & BTP",
    "Professions libérales & services de proximité",
  ],
  servicesContext: {
    audit: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Sarzeau et sur la presqu'île de Rhuys ?",
      a: "Oui, Axion-IA intervient à Sarzeau et sur toute la presqu'île de Rhuys (Saint-Gildas-de-Rhuys, Arzon, Le Tour-du-Parc, Surzur). Nos consultants se déplacent depuis Vannes en 25 minutes.",
    },
    {
      q: "Accompagnez-vous les hébergeurs et restaurateurs à Sarzeau ?",
    ...
    },
    {
      ...
      a: "Absolument. L'IA optimise la gestion saisonnière : prévision de fréquentation, tarification dynamique, automatisation des plannings été/hiver, CRM fidélisation clients récurrents et marketing ciblé pré-saison. Idéal pour les activités de la presqu'île de Rhuys.",
    },
    {
      q: "Comment se déroule une mission Axion-IA à Sarzeau ?",
      a: "Après un premier échange gratuit, nous planifions l'intervention sous 5 jours. Nos consultants interviennent sur site à Sarzeau ou en visio. Chaque mission inclut un livrable actionnable, un plan IA chiffré et un suivi post-mission de 30 jours.",
    },
  ],
};
