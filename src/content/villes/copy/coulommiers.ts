...
// Coulommiers (77, Seine-et-Marne) — 16 374 hab, sous-préfecture, fromage Brie de Coulommiers.
...
export const COULOMMIERS_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Coulommiers, sous-préfecture de Seine-et-Marne, est un pôle structurant de l'est francilien. Tissu économique diversifié : filière agroalimentaire (Brie de Coulommiers), artisanat BTP, commerces de centre-ville, services aux entreprises, professions libérales de santé. Zone d'activités des Musiciens et parc Coutevroult à proximité.",
  distancesFr:
    "Paris Est à 1h10 en train (Transilien P). Meaux à 30 min. Melun à 45 min. Disneyland Paris / Marne-la-Vallée à 30 min en voiture. Accès RN34 et A4 à proximité.",
  distancesEn:
    "Paris Est à 1h10 en train (Transilien P). Meaux à 30 min. Melun à 45 min. Disneyland Paris / Marne-la-Vallée à 30 min en voiture. Accès RN34 et A4 à proximité.",
  topSectorsNaf: [
    "Agroalimentaire et filière Brie",
    "Commerce de détail et centre-ville",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Coulommiers et dans l'est Seine-et-Marne ?",
      a: "Oui, Axion-IA intervient à Coulommiers et dans tout l'est Seine-et-Marne (Rebais, La Ferté-sous-Jouarre, Crécy-la-Chapelle, Jouarre). Nos consultants se déplacent depuis Paris Est (1h10 en Transilien P).",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants interviennent à Coulommiers (1h10 depuis Paris Est en Transilien P, ou 1h en voiture via A4). Intervention dans vos locaux, atelier pratique avec vos équipes, livraison d'outils configurés.",
    },
  ],
};
