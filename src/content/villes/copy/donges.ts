...
// Donges (44, Loire-Atlantique) — Raffinerie, estuaire Loire.
...
export const DONGES_COPY: VilleCopy = {
  ...
  pitchEn:
    "Donges (44), commune de l'estuaire de la Loire en Loire-Atlantique, accueille la raffinerie TotalEnergies et un tissu de TPE artisans, PME industrielles, sous-traitants et commerces de proximité. Axion-IA y mène ses missions auprès des organisations locales du bassin estuarien.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Donges (44). Nous accompagnons les TPE artisans, PME industrielles et sous-traitantes, commerçants et prestataires de l'estuaire de la Loire sur leurs cas IA opérationnels. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Donges (44). Nous accompagnons les TPE artisans, PME industrielles et sous-traitantes, commerçants et prestataires de l'estuaire de la Loire sur leurs cas IA opérationnels. Audit sur place sur mesure.",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Donges : formats adaptés atelier, site industriel, bureau ou commerce. Vos équipes repartent autonomes sur outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Donges : automatisation maintenance prédictive, gestion qualité industrielle, agents conversationnels B2B, traçabilité et planification production PME.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Donges ?",
      a: "Oui, Axion-IA intervient à Donges et tout l'estuaire de la Loire (Montoir-de-Bretagne, Saint-Nazaire, Trignac, Savenay). Couverture complète Loire-Atlantique, gare TER Donges desservie.",
    },
    {
      q: "Accompagnez-vous les PME sous-traitantes industrielles ?",
    ...
    },
    {
      ...
      a: "Oui, l'IA apporte des gains concrets au secteur industriel : maintenance prédictive, planification production, gestion qualité, traçabilité réglementaire. Adapté aux PME et sous-traitants de l'estuaire de la Loire.",
    },
    {
