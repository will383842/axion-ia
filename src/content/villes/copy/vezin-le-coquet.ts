...
// Vezin-le-Coquet (35, Ille-et-Vilaine) — Ouest Rennes, résidentielle.
...
export const VEZIN_LE_COQUET_COPY: VilleCopy = {
  ...
  pitchEn:
    "Vezin-le-Coquet (35), commune résidentielle de l'ouest de Rennes Métropole, bénéficie d'une situation privilégiée aux portes de Rennes. Tissu de TPE/PME tertiaires et de services, artisans BTP portés par la dynamique immobilière, commerces de proximité, professions libérales et indépendants. Axion-IA opère pour toutes les structures économiques de la commune.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Vezin-le-Coquet (35). Nous accompagnons tous types d'activités : TPE et PME tertiaires de l'ouest de Rennes Métropole, artisans BTP, commerçants de proximité, professions libérales, indépendants et prestataires de services aux entreprises du bassin rennais ouest.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Vezin-le-Coquet (35). Nous accompagnons tous types d'activités : TPE et PME tertiaires de l'ouest de Rennes Métropole, artisans BTP, commerçants de proximité, professions libérales, indépendants et prestataires de services aux entreprises du bassin rennais ouest.",
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Vezin-le-Coquet : diagnostic adapté aux PME tertiaires de l'ouest Rennes Métropole, artisans BTP, professions libérales et commerçants de proximité. Audit sur place {{price:audit-flash|flat}} avec ROI quantifié.",
      en: "Audit IA à Vezin-le-Coquet : diagnostic adapté aux PME tertiaires de l'ouest Rennes Métropole, artisans BTP, professions libérales et commerçants de proximité. Audit sur place {{price:audit-flash|flat}} avec ROI quantifié.",
    },
    interventions: {
      ...
      en: "Interventions IA sur site à Vezin-le-Coquet : formats adaptés aux bureaux PME, cabinets libéraux, commerces et ateliers artisans. Vos équipes repartent autonomes sur les outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Vezin-le-Coquet : automatisation workflow tertiaire, agents conversationnels client, CRM augmenté, gestion planning professions libérales, outils IA artisans devis/facturation.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Vezin-le-Coquet ?",
      a: "Oui, Axion-IA intervient à Vezin-le-Coquet et dans tout l'ouest de Rennes Métropole (Le Rheu, Pacé, L'Hermitage, Mordelles). Nos consultants viennent de Rennes centre (10 min) ou interviennent en visio.",
    },
    {
      q: "Accompagnez-vous les PME tertiaires de l'ouest de Rennes ?",
      a: "Oui, nous accompagnons les PME tertiaires et services aux entreprises de l'ouest rennais sur leurs cas IA : automatisation CRM, agents conversationnels B2B, classification documents, optimisation relation client. Audit sur place {{price:audit-flash|flat}} pour démarrer.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les professions libérales (cabinets santé, conseil, expertise comptable) de Vezin-le-Coquet sur des cas IA ciblés : automatisation planning, classification dossiers, agents IA prise de RDV, optimisation parcours patient/client.",
    },
    {
