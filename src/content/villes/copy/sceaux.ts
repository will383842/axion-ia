...
export const SCEAUX_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit sur place 4h à Sceaux pour PME et ETI des Hauts-de-Seine — diagnostic des processus de cabinet (juridique, comptable, conseil), facturation, gestion clients et CRM. À partir de {{price:audit-flash|flat}}, livrable sous 5 jours.",
      en: "Audit sur place 4h à Sceaux pour PME et ETI des Hauts-de-Seine — diagnostic des processus de cabinet (juridique, comptable, conseil), facturation, gestion clients et CRM. À partir de {{price:audit-flash|flat}}, livrable sous 5 jours.",
    },
    interventions: {
    ...
    implementation: {
      ...
      en: "Implémentation IA code-first à Sceaux : intégration outils métier (logiciels juridiques, comptables, CRM), agents internes, automatisations pour cabinets et commerces. À partir de {{price:impl-poc|entry}}.",
    },
    unAUn: {
      fr: "Sessions un-à-un avec dirigeants de cabinets et PME scéens pour cadrer la feuille de route IA : priorisation, ROI, conformité RGPD (sensibilité forte sur données juridiques et fiscales). À partir de {{price:intervention-dirigeants|flat}}.",
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "PME et ETI des activités juridiques, comptables et conseil, des sièges sociaux, du commerce de proximité, de la restauration et de la formation. Nous travaillons aussi avec des indépendants et professions libérales scéennes.",
    },
    {
