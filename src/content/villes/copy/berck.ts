...
// Berck (62, Pas-de-Calais) — station balnéaire Côte d'Opale, hôpital maritime historique, tourisme et santé, plage.
...
export const BERCK_COPY: VilleCopy = {
  ...
  topSectorsNaf: [
    ...
    "Activités récréatives et sportives (plage, cerf-volant)",
  ],
  servicesContext: {
    audit: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Berck : formats adaptés à l'hôtel, au cabinet paramédical, au commerce, à l'établissement de rééducation. Vos équipes repartent autonomes sur les outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Berck : automatisation réservations tourisme, gestion planning soins, agents IA accueil patient, optimisation stocks saisonniers, CRM fidélisation clientèle balnéaire.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Berck et sur la Côte d'Opale ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les PME santé et rééducation de Berck sur leurs cas IA : gestion planning soins, agents IA accueil patient, automatisation dossiers médicaux, prédiction pics d'activité saisonniers.",
    },
    {
      q: "Quels services pour les commerçants et paramédicaux berckois ?",
      a: "Pour les commerçants et professions paramédicales à Berck, audit sur place {{price:audit-flash|flat}}, intervention 1 journée formation, coaching 1-to-1. Cas typiques : agents IA conversationnels, automatisation RDV, fidélisation client.",
    },
    {
