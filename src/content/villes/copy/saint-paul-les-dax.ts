...
// Saint-Paul-lès-Dax (40, Landes) — station thermale, agglomération Dax, quatrième commune des Landes.
...
export const SAINT_PAUL_LES_DAX_COPY: VilleCopy = {
  ...
  pitchEn:
    "Saint-Paul-lès-Dax (40), station thermale de l'agglomération dacquoise dans les Landes, est la quatrième commune du département. Thermalisme, bien-être, commerces zone Grand Dax, TPE santé/bien-être, PME services, artisans. Tissu économique complémentaire de Dax. Axion-IA y déploie son expertise pour toutes les organisations.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Saint-Paul-lès-Dax (40). Nous accompagnons TPE et PME du thermalisme et du bien-être, commerces de la zone Grand Dax, professions de santé, artisans BTP, hébergeurs et prestataires touristiques de l'agglomération dacquoise.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Saint-Paul-lès-Dax (40). Nous accompagnons TPE et PME du thermalisme et du bien-être, commerces de la zone Grand Dax, professions de santé, artisans BTP, hébergeurs et prestataires touristiques de l'agglomération dacquoise.",
  ...
  distancesEn:
    "Dax centre à 5 min. Bayonne à 45 min par A63. Bordeaux à 1h30 par A63. Pau à 1h par A64. Gare SNCF Dax (TGV Paris 4h). Aéroport Biarritz-Pays Basque à 50 min.",
  topSectorsNaf: [
    "Thermalisme & bien-être (établissements thermaux)",
    "Commerce de détail (zone Grand Dax)",
    "Santé & professions paramédicales",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Saint-Paul-lès-Dax : formations adaptées aux établissements thermaux, centres bien-être, commerces, professions de santé. Vos équipes repartent autonomes sur les outils IA configurés métier.",
    },
    implementation: {
      fr: "Implémentation IA à Saint-Paul-lès-Dax : automatisation réservations thermales, chatbot curistes multilingue, classification retours patients, prédiction affluence saisonnière, optimisation planning soins et gestion stocks commerces.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Paul-lès-Dax et dans le Grand Dax ?",
      a: "Oui, Axion-IA intervient à Saint-Paul-lès-Dax et toute l'agglomération du Grand Dax (Dax, Narrosse, Tercis-les-Bains, Yzosse). Couverture complète du bassin thermal et commercial dacquois.",
    },
    {
      q: "Proposez-vous des audits IA pour les établissements thermaux ?",
      a: "Oui, audit sur place {{price:audit-flash|flat}} adapté aux établissements thermaux et centres de bien-être. Diagnostic automatisation réservations curistes, gestion planning soins, chatbot multilingue, classification retours patients, optimisation parcours de soin.",
    },
    {
      q: "Accompagnez-vous les commerces de la zone Grand Dax ?",
      a: "Oui, nous accompagnons les commerces de la zone Grand Dax sur leurs cas IA : gestion stocks prédictive, automatisation commandes fournisseurs, chatbot service client, analyse données ventes, optimisation flux logistique.",
    },
    {
      q: "Quels services pour les professions de santé saint-pauloises ?",
      a: "Pour les professions de santé et paramédicales à Saint-Paul-lès-Dax, audit sur place {{price:audit-flash|flat}}, coaching 1-to-1 outils IA métier. Cas typiques : automatisation secrétariat, tri documents patients, aide rédaction comptes-rendus, gestion agenda.",
    },
    {
