...
// Beaugency (45, Loiret) — bords Loire, pont médiéval, cité historique.
...
export const BEAUGENCY_COPY: VilleCopy = {
  ...
  pitchEn:
    "Beaugency (45), cité médiévale en bords de Loire (pont roman classé, donjon du XIe siècle, abbatiale Notre-Dame), est un pôle touristique et patrimonial du Val de Loire entre Orléans et Blois. Tissu TPE commerçantes, artisans du bâtiment, PME viticoles et agro-alimentaires, professions libérales, hébergeurs tourisme. Axion-IA collabore avec toutes les structures locales.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Beaugency (45). Nous accompagnons tous types d'activités : TPE commerçants et artisans du centre historique, PME viticoles et agro-alimentaires du Val de Loire, professions libérales, hébergeurs et restaurateurs touristiques, associations patrimoniales. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Beaugency (45). Nous accompagnons tous types d'activités : TPE commerçants et artisans du centre historique, PME viticoles et agro-alimentaires du Val de Loire, professions libérales, hébergeurs et restaurateurs touristiques, associations patrimoniales. Audit sur place sur mesure.",
  ...
  ecosystemEn:
    "Beaugency est une cité historique en bords de Loire (8 024 hab.), entre Orléans (25 km) et Blois (35 km), au cœur du Val de Loire classé UNESCO. Tissu TPE commerçants du centre médiéval, artisans bâtiment restauration patrimoine, PME viticoles (AOC Orléans-Cléry), agro-alimentaires, hébergeurs et restaurateurs touristiques. La ville attire un tourisme patrimonial fort (pont médiéval, donjon, abbatiale).",
  distancesFr:
    "Gare de Beaugency (TER Orléans-Blois-Tours, 20 min Orléans, 25 min Blois). Aéroport Paris-Orly à 1h30. A10 vers Orléans (25 min) et Paris (1h30).",
  distancesEn:
    "Gare de Beaugency (TER Orléans-Blois-Tours, 20 min Orléans, 25 min Blois). Aéroport Paris-Orly à 1h30. A10 vers Orléans (25 min) et Paris (1h30).",
  topSectorsNaf: [
    "Commerce de détail & artisanat centre-ville",
    "Viticulture & agro-alimentaire Val de Loire",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Beaugency : formats adaptés au commerce de centre-ville, domaine viticole ou PME agro-alimentaire. Vos équipes terrain et back-office repartent autonomes sur outils IA configurés métier.",
    },
    implementation: {
      fr: "Implémentation IA à Beaugency : agents conversationnels multilingues tourisme, automatisation réservations hébergement, gestion stocks viticoles, CRM augmentés. Adapté aux TPE/PME et acteurs patrimoine Val de Loire.",
      en: "Implémentation IA à Beaugency : agents conversationnels multilingues tourisme, automatisation réservations hébergement, gestion stocks viticoles, CRM augmentés. Adapté aux TPE/PME et acteurs patrimoine Val de Loire.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Beaugency : sessions dans votre commerce, domaine viticole, hôtel ou cabinet. Commerçants, viticulteurs, hébergeurs et gérants TPE/PME balgentiennes souhaitant maîtriser l'IA au quotidien.",
      en: "Coaching 1-to-1 à Beaugency : sessions dans votre commerce, domaine viticole, hôtel ou cabinet. Commerçants, viticulteurs, hébergeurs et gérants TPE/PME balgentiennes souhaitant maîtriser l'IA au quotidien.",
    },
  },
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Beaugency et dans le Val de Loire ?",
      a: "Oui, Axion-IA intervient à Beaugency et dans tout le Val de Loire entre Orléans et Blois (Meung-sur-Loire, Mer, Cléry-Saint-André, Tavers). Couverture nationale, déplacement sur site inclus dans le forfait mission.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les PME viticoles et agro-alimentaires du Val de Loire autour de Beaugency. Cas IA : prédiction vendanges, gestion parcellaire, traçabilité production, CRM augmentés export, automatisation commandes et facturation. ROI chiffré contractuel.",
    },
    {
