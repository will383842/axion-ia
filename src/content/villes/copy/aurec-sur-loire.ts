...
export const AUREC_SUR_LOIRE_COPY: VilleCopy = {
  pitchFr:
    "Axion-IA, cabinet d'experts IA seniors, accompagne les TPE et PME d'Aurec-sur-Loire, commune du nord de la Haute-Loire nichée dans les gorges de la Loire, aux portes du bassin stéphanois. PME industrielles, sous-traitance mécanique, agriculture de montagne, artisans BTP et commerces : nous transformons l'IA en gains concrets, sans jargon ni dépendance technique.",
  pitchEn:
    "Axion-IA, cabinet d'experts IA seniors, accompagne les TPE et PME d'Aurec-sur-Loire, commune du nord de la Haute-Loire nichée dans les gorges de la Loire, aux portes du bassin stéphanois. PME industrielles, sous-traitance mécanique, agriculture de montagne, artisans BTP et commerces : nous transformons l'IA en gains concrets, sans jargon ni dépendance technique.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Aurec-sur-Loire auprès des TPE et PME en priorité, des PME ensuite. Nous ciblons les PME industrielles et sous-traitants du nord Haute-Loire, les agriculteurs de montagne, les artisans du BTP et les commerces. Audit sur place sur mesure avec ROI chiffré, puis interventions sur site, vos équipes restant autonomes.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Aurec-sur-Loire auprès des TPE et PME en priorité, des PME ensuite. Nous ciblons les PME industrielles et sous-traitants du nord Haute-Loire, les agriculteurs de montagne, les artisans du BTP et les commerces. Audit sur place sur mesure avec ROI chiffré, puis interventions sur site, vos équipes restant autonomes.",
