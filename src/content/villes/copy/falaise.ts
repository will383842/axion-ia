...
// Falaise (14, Calvados) — Château Guillaume le Conquérant, sous-préfecture, bocage.
...
export const FALAISE_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Falaise est une sous-préfecture du Calvados, célèbre comme ville natale de Guillaume le Conquérant (château XIIe siècle). Pôle économique entre bocage normand et plaine de Caen. Tissu PME industrielles (plasturgie, métallurgie), agroalimentaire, TPE artisans BTP, commerces centre-ville, tourisme patrimoine.",
  distancesFr:
    "Caen à 35 min N158. Argentan à 25 min. Gare SNCF Caen à 35 min (pas de gare à Falaise). Aéroport Caen-Carpiquet à 45 min.",
  distancesEn:
    "Caen à 35 min N158. Argentan à 25 min. Gare SNCF Caen à 35 min (pas de gare à Falaise). Aéroport Caen-Carpiquet à 45 min.",
  topSectorsNaf: [
    "Industrie (plasturgie, métallurgie)",
    "Agroalimentaire normand",
    "Tourisme patrimoine (château Guillaume le Conquérant)",
    "TPE artisanat BTP",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Falaise : formats adaptés à l'usine, atelier industriel, commerce, site touristique ou cabinet. Vos équipes repartent autonomes sur outils IA configurés métier.",
    },
    implementation: {
      fr: "Implémentation IA à Falaise : contrôle qualité par vision industrielle, prédiction maintenance, agents conversationnels tourisme patrimoine, automatisation processus. Adapté TPE/PME pays de Falaise.",
      en: "Implémentation IA à Falaise : contrôle qualité par vision industrielle, prédiction maintenance, agents conversationnels tourisme patrimoine, automatisation processus. Adapté TPE/PME pays de Falaise.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Falaise : sessions dans votre usine, atelier, commerce ou en visio. Dirigeants industriels, acteurs tourisme patrimoine, artisans BTP, gérants TPE/PME falaisiens.",
      en: "Coaching 1-to-1 à Falaise : sessions dans votre usine, atelier, commerce ou en visio. Dirigeants industriels, acteurs tourisme patrimoine, artisans BTP, gérants TPE/PME falaisiens.",
    },
  },
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Falaise et dans le pays de Falaise ?",
      a: "Oui, Axion-IA intervient à Falaise et tout le pays de Falaise (Potigny, Morteaux-Couliboeuf, Saint-Pierre-Canivet). Consultants depuis Caen (35 min N158).",
    },
    {
      q: "Accompagnez-vous les PME industrielles de Falaise ?",
      a: "Oui, nous accompagnons les PME industrielles de Falaise (plasturgie, métallurgie, mécanique) sur leurs cas IA : contrôle qualité par vision, prédiction maintenance équipements, automatisation production, classification documents techniques.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants viennent de Caen (35 min N158). Déplacement direct sur site (usine, atelier, commerce, cabinet). Pour les multi-jours, hébergement local possible. Frais de déplacement facturés à part du forfait.",
    },
  ],
};
