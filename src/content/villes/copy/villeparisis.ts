...
export const VILLEPARISIS_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      fr: "Interventions IA sur site à Villeparisis : ateliers adaptés TPE (commerce ZAC, artisan, restaurant) ou PME logistique. Vos équipes repartent autonomes. Intervention Essentielle dès {{price:intervention-4h|flat}}.",
      en: "Interventions IA sur site à Villeparisis : ateliers adaptés TPE (commerce ZAC, artisan, restaurant) ou PME logistique. Vos équipes repartent autonomes. Intervention Essentielle dès {{price:intervention-4h|flat}}.",
    },
    implementation: {
