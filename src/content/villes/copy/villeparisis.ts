...
export const VILLEPARISIS_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Villeparisis : diagnostic pour TPE (artisans BTP, commerces, restauration) et PME logistique/transport proches CDG. Audit Flash {{price:audit-flash|flat}}, ROI chiffré sous 7 jours.",
      en: "Audit IA à Villeparisis : diagnostic pour TPE (artisans BTP, commerces, restauration) et PME logistique/transport proches CDG. Audit Flash {{price:audit-flash|flat}}, ROI chiffré sous 7 jours.",
    },
    interventions: {
