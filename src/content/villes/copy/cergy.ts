...
export const CERGY_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "À Cergy, un Audit Flash sur site ({{price:audit-flash|flat}}, 4 h) permet à un dirigeant de TPE ou PME de cartographier les processus chronophages — facturation, gestion documentaire, support client — et de cadrer un plan d'automatisation chiffré.",
      en: "À Cergy, un Audit Flash sur site ({{price:audit-flash|flat}}, 4 h) permet à un dirigeant de TPE ou PME de cartographier les processus chronophages — facturation, gestion documentaire, support client — et de cadrer un plan d'automatisation chiffré.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Nos tarifs publics s'appliquent à Cergy comme partout en France : Audit Flash 4 h à {{price:audit-flash|flat}}, Intervention Essentielle à {{price:intervention-4h|flat}}, accompagnement un-à-un dès {{price:intervention-dirigeants|flat}}. Aucun forfait caché, devis envoyé sous 48 h.",
    },
    {
