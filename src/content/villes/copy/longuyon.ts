...
export const LONGUYON_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, commerçants et artisans de Longuyon : gestion stocks, relation client transfrontalière, automatisation comptabilité, présence en ligne. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
