...
// Longuyon (54, Meurthe-et-Moselle) — Pays Haut, frontière Belgique/Luxembourg, ferroviaire.
...
export const LONGUYON_COPY: VilleCopy = {
  ...
  distancesEn:
    "Luxembourg-ville à 45 min. Longwy à 20 min. Metz à 55 min. Gare SNCF Longuyon (axe Paris–Luxembourg). Autoroute A30 à 15 min. Belgique (Virton) à 25 min. Nancy à 1h30.",
  seoHook: "transfrontalier & nœud ferroviaire",
  topSectorsNaf: [
    "Transport et logistique transfrontaliers",
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Longuyon : diagnostic adapté aux TPE/PME commerces, artisans, transporteurs transfrontaliers, sous-traitants industriels et professions libérales. ROI chiffré, audit Flash {{price:audit-flash|flat}}.",
      en: "Audit IA à Longuyon : diagnostic adapté aux TPE/PME commerces, artisans, transporteurs transfrontaliers, sous-traitants industriels et professions libérales. ROI chiffré, audit Flash {{price:audit-flash|flat}}.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Longuyon ?",
      a: "Oui, Axion-IA intervient à Longuyon et dans le Pays Haut (Longwy, Villerupt, Mont-Saint-Martin) ainsi que vers la frontière luxembourgeoise et belge. Consultants via gare SNCF Longuyon ou autoroute A30.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, commerçants et artisans de Longuyon : gestion stocks, relation client transfrontalière, automatisation comptabilité, présence en ligne. Audit Flash {{price:audit-flash|flat}}.",
    },
    {
