...
// Sèvremont (85, Vendée) — Commune nouvelle, bocage vendéen.
...
export const SEVREMONT_COPY: VilleCopy = {
  ...
  pitchEn:
    "Sèvremont (85), commune nouvelle du bocage vendéen, compte plus de 6 300 habitants. Née de la fusion de quatre communes, entre Les Herbiers et Pouzauges. Tissu de TPE artisanales, PME industrielles et agroalimentaires, exploitations agricoles et commerces. Axion-IA opère pour entreprises et indépendants du secteur.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Sèvremont (85). Nous accompagnons tous types d'activités : TPE artisans et commerçants, PME industrielles du bocage, exploitations agricoles, professions libérales et services de proximité.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Sèvremont (85). Nous accompagnons tous types d'activités : TPE artisans et commerçants, PME industrielles du bocage, exploitations agricoles, professions libérales et services de proximité.",
  ...
  ecosystemEn:
    "Sèvremont est une commune nouvelle du haut bocage vendéen (fusion 2016 de La Flocellière, Saint-Michel-Mont-Mercure, La Pommeraie-sur-Sèvre et Le Boupère). Point culminant de la Vendée (Mont Mercure, 290 m). Industries, agriculture, artisanat. Les Herbiers à 15 min, Pouzauges à 10 min.",
  distancesFr:
    "Les Herbiers à 15 min. Pouzauges à 10 min. La Roche-sur-Yon à 45 min. Cholet à 35 min. Nantes à 1h10.",
  distancesEn:
    "Les Herbiers à 15 min. Pouzauges à 10 min. La Roche-sur-Yon à 45 min. Cholet à 35 min. Nantes à 1h10.",
  topSectorsNaf: [
    "Agriculture & élevage haut bocage",
    "PME industrielles & transformation",
    "Artisanat BTP & construction",
    "Commerce & services de proximité",
    "Tourisme vert & patrimoine (Mont Mercure)",
  ],
  servicesContext: {
    audit: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Sèvremont et dans le haut bocage vendéen ?",
      a: "Oui, Axion-IA intervient à Sèvremont et dans tout le haut bocage vendéen (Les Herbiers, Pouzauges, Mortagne-sur-Sèvre). Consultants accessibles depuis Les Herbiers (15 min) ou Cholet (35 min).",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants interviennent depuis Les Herbiers (15 min) ou Cholet (35 min). Déplacement sur site dans vos locaux professionnels, atelier ou exploitation agricole.",
    },
  ],
};
