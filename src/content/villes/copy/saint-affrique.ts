...
// Saint-Affrique (12, Aveyron) — Roquefort à proximité, sud Aveyron, vallée de la Sorgue.
...
export const SAINT_AFFRIQUE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Saint-Affrique (12), commune du sud Aveyron dans la vallée de la Sorgue, porte d'entrée du pays de Roquefort. Tissu TPE artisans, PME agroalimentaires (filière Roquefort, charcuterie), commerces de centre-ville, professions libérales, tourisme vert (Grands Causses). Axion-IA couvre les activités professionnelles du bassin.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Saint-Affrique (12). Nous accompagnons TPE artisans, PME agroalimentaires de la filière Roquefort, commerçants, professions libérales, acteurs du tourisme vert Grands Causses et services du sud Aveyron. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Saint-Affrique (12). Nous accompagnons TPE artisans, PME agroalimentaires de la filière Roquefort, commerçants, professions libérales, acteurs du tourisme vert Grands Causses et services du sud Aveyron. Audit sur place sur mesure.",
  ...
  ecosystemEn:
    "Saint-Affrique est le pôle urbain du sud Aveyron, dans la vallée de la Sorgue, à proximité immédiate de Roquefort-sur-Soulzon (caves Roquefort). Économie structurée autour de l'agroalimentaire (filière laitière Roquefort AOP, charcuterie, produits du terroir), de l'élevage ovin, du commerce de centre-ville, des professions libérales et du tourisme vert (Parc naturel régional des Grands Causses).",
  distancesFr:
    "Millau à 30 min (D999). Rodez à 1h15. Albi à 1h20. Montpellier à 1h40 (A75). Béziers à 1h30. Gare SNCF Saint-Affrique sur ligne Tournemire-Millau.",
  distancesEn:
    "Millau à 30 min (D999). Rodez à 1h15. Albi à 1h20. Montpellier à 1h40 (A75). Béziers à 1h30. Gare SNCF Saint-Affrique sur ligne Tournemire-Millau.",
  topSectorsNaf: [
    "Agroalimentaire & filière Roquefort AOP",
    "Élevage ovin & laitier",
    "Commerce de centre-ville",
    "Tourisme vert (Parc Grands Causses)",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Saint-Affrique : formats adaptés à l'atelier laitier, à l'exploitation agricole, au commerce ou au cabinet libéral. Vos équipes repartent autonomes sur les outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Saint-Affrique : traçabilité filière laitière Roquefort, automatisation qualité agroalimentaire, agents conversationnels tourisme vert Grands Causses, classification documents cabinets.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Affrique et sud Aveyron ?",
      a: "Oui, Axion-IA intervient à Saint-Affrique et dans tout le sud Aveyron (Roquefort-sur-Soulzon, Vabres-l'Abbaye, Belmont-sur-Rance, Camarès). Couverture jusqu'à Millau (30 min).",
    },
    {
      q: "Accompagnez-vous les PME de la filière Roquefort ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les professionnels du tourisme vert (gîtes, campings, guides nature) sur leurs cas IA : agents conversationnels réservation, gestion saisonnalité, classification avis clients, automatisation communication.",
    },
    {
