...
// Le Puy-Sainte-Réparade (13, Bouches-du-Rhône) — Durance, vignoble, nord d'Aix.
...
export const LE_PUY_SAINTE_REPARADE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Le Puy-Sainte-Réparade (13), commune viticole de la vallée de la Durance au nord d'Aix-en-Provence, conjugue domaines AOC Coteaux d'Aix prestigieux, agriculture, TPE artisans, PME tertiaires et professions libérales. Bassin résidentiel haut de gamme. Axion-IA accompagne tout le tissu professionnel local de la vallée de la Durance.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient au Puy-Sainte-Réparade (13). Nous accompagnons TPE artisans, viticulteurs AOC, PME tertiaires, exploitations agricoles et professions libérales de la vallée de la Durance. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient au Puy-Sainte-Réparade (13). Nous accompagnons TPE artisans, viticulteurs AOC, PME tertiaires, exploitations agricoles et professions libérales de la vallée de la Durance. Audit sur place sur mesure.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il au Puy-Sainte-Réparade et dans la vallée de la Durance ?",
      a: "Oui, Axion-IA intervient au Puy-Sainte-Réparade et dans toute la vallée de la Durance (Pertuis à 15 min, Aix à 20 min, Saint-Cannat, Rognes, Meyrargues). Couverture complète nord aixois.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les domaines viticoles AOC Coteaux d'Aix sur des cas IA premium : gestion parcellaire, traçabilité vendanges, agents IA œnotourisme et caveau, marketing vente directe, optimisation stocks et exports.",
    },
    {
