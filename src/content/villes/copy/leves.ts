...
// Lèves (28, Eure-et-Loir) — Agglo Chartres nord, résidentielle, 5 685 hab.
...
export const LEVES_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Lèves : diagnostic adapté aux TPE artisans, PME de services du bassin chartrain, commerçants, professions libérales et entreprises de l'agglomération de Chartres. Audit Flash 490 € HT avec ROI quantifié accessible.",
      en: "Audit IA à Lèves : diagnostic adapté aux TPE artisans, PME de services du bassin chartrain, commerçants, professions libérales et entreprises de l'agglomération de Chartres. Audit Flash 490 € HT avec ROI quantifié accessible.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Lèves et dans l'agglomération de Chartres ?",
      a: "Oui, Axion-IA intervient à Lèves et dans toute l'agglomération de Chartres Métropole (Chartres, Mainvilliers, Lucé, Luisant, Champhol). Couverture également Dreux à 35 min, Paris à 1h20 et Orléans à 1h15.",
    },
    {
      q: "Travaillez-vous avec les PME de services et négoce du bassin chartrain ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les TPE artisans BTP, commerçants et professions libérales de Lèves sur des cas IA pratiques : automatisation devis, agents IA prise de rendez-vous, gestion stocks, optimisation planning. Audit Flash 490 € HT adapté aux petites structures.",
    },
    {
      q: "Quels services IA pour les entreprises cosmétique et agroalimentaire du bassin chartrain ?",
      a: "Pour les entreprises cosmétique et agroalimentaire du bassin chartrain, nous proposons des implémentations IA adaptées : contrôle qualité par vision, automatisation traçabilité, agents conversationnels documentation réglementaire, optimisation chaîne logistique.",
    },
    {
