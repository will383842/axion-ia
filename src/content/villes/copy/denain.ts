...
export const DENAIN_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit Flash 4 h à Denain ({{price:audit-flash|flat}}) pour cartographier les tâches répétitives des TPE et PME logistiques, mécaniques ou commerciales du bassin de la Porte du Hainaut.",
      en: "Audit Flash 4 h à Denain ({{price:audit-flash|flat}}) pour cartographier les tâches répétitives des TPE et PME logistiques, mécaniques ou commerciales du bassin de la Porte du Hainaut.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Audit Flash 4 h à {{price:audit-flash|flat}}, intervention sur site à {{price:intervention-4h|flat}}, implémentation à {{price:intervention-dirigeants|flat}}, accompagnement 1-to-1 à {{price:intervention-dirigeants|flat}}. Tarifs publics fixes, sans abonnement ni licence no-code.",
    },
    {
