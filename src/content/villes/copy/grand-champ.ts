...
// Grand-Champ (56, Morbihan) — Arrière-pays vannetais, agriculture.
...
export const GRAND_CHAMP_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Grand-Champ est une commune rurale dynamique de l'arrière-pays vannetais, en croissance démographique grâce à sa proximité avec Vannes. L'économie locale repose sur l'agriculture (élevage laitier et porcin, cultures céréalières), l'agroalimentaire, l'artisanat du bâtiment et les commerces de proximité. Le cadre rural attire également des professions libérales et indépendants en télétravail.",
  distancesFr:
    "Vannes à 15 min par D767. Locminé à 20 min. Gare de Vannes à 18 min (TGV Paris 2h30). Auray à 25 min. Aéroport Lorient-Bretagne-Sud à 50 min.",
  distancesEn:
    "Vannes à 15 min par D767. Locminé à 20 min. Gare de Vannes à 18 min (TGV Paris 2h30). Auray à 25 min. Aéroport Lorient-Bretagne-Sud à 50 min.",
  seoHook: "agriculture & artisanat arrière-pays vannetais",
  topSectorsNaf: [
    "Agriculture & élevage",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Grand-Champ : formats adaptés à l'exploitation agricole, à l'atelier artisanal ou au bureau PME. Vos équipes repartent autonomes sur les outils IA métier adaptés à votre activité.",
    },
    implementation: {
      fr: "Implémentation IA à Grand-Champ : automatisation traçabilité et gestion stocks, agents conversationnels relation client, chatbots prise de RDV, classification produits agroalimentaires. Adapté tissu agricole et artisanal arrière-pays vannetais.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Grand-Champ et dans l'arrière-pays vannetais ?",
      a: "Oui, Axion-IA intervient à Grand-Champ et dans tout l'arrière-pays vannetais (Locminé, Plaudren, Moustoir-Ac, Brandivy, Colpo). Couverture Vannes (15 min) et axe Vannes-Pontivy.",
    },
    {
      q: "Travaillez-vous avec les exploitations agricoles et PME agroalimentaires de Grand-Champ ?",
    ...
    },
    {
      ...
      a: "Nos consultants se déplacent dans vos locaux à Grand-Champ ou interviennent en visio. Vannes est à 15 min. Pour les missions multi-jours, hébergement local possible. Frais de déplacement transparents en sus du forfait.",
    },
  ],
};
