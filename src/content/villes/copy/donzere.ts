...
export const DONZERE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Donzère (26), commune du sud-Drôme à l'entrée du défilé de Donzère, est associée au grand aménagement hydraulique du canal Donzère-Mondragon (Compagnie Nationale du Rhône). Tissu agricole vallée Rhône, PME industrielles bassin Tricastin, TPE artisans BTP, commerces. Axion-IA opère pour toutes les structures économiques de la commune tricastines.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Donzère (26). Nous accompagnons tous types d'activités : PME industrielles bassin Tricastin, agriculteurs et viticulteurs vallée du Rhône (AOC Grignan-les-Adhémar à proximité), TPE artisans BTP, commerçants, indépendants et services aux entreprises sud-Drôme.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Donzère (26). Nous accompagnons tous types d'activités : PME industrielles bassin Tricastin, agriculteurs et viticulteurs vallée du Rhône (AOC Grignan-les-Adhémar à proximité), TPE artisans BTP, commerçants, indépendants et services aux entreprises sud-Drôme.",
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Donzère : sessions dans votre atelier, exploitation, commerce ou en visio. Dirigeants industriels, viticulteurs, agriculteurs, artisans, gérants TPE/PME donzéroises.",
      en: "Coaching 1-to-1 à Donzère : sessions dans votre atelier, exploitation, commerce ou en visio. Dirigeants industriels, viticulteurs, agriculteurs, artisans, gérants TPE/PME donzéroises.",
    },
  },
  faqGeolocalisee: [
    {
