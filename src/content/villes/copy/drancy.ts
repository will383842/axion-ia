  ...
  faqGeolocalisee: [
    {
      ...
      a: "Nos interventions sur site à Drancy démarrent à {{price:intervention-4h|flat}}. Les audits flash sont à partir de {{price:audit-flash|flat}} et les implémentations sur mesure à partir de {{price:impl-poc|entry}}. Tarifs publics consultables sur axion-ia.com.",
    },
    {
