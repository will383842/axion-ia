...
// Riedisheim (68, Haut-Rhin) — commune résidentielle à l'est de Mulhouse, services et artisanat.
...
export const RIEDISHEIM_COPY: VilleCopy = {
  ...
  pitchEn:
    "Riedisheim (68), ville résidentielle de 12 200 habitants à l'est immédiat de Mulhouse en Haut-Rhin, est un bassin de vie tourné vers les services, l'artisanat et le commerce de proximité. Tissu TPE/PME services, professions libérales, commerces, artisanat. Axion-IA opère sur l'ensemble des activités professionnelles locales.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Riedisheim (68). Nous accompagnons tous types d'activités : TPE/PME services et professions libérales, artisans, commerces de proximité et acteurs du bassin de vie mulhousien est.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Riedisheim (68). Nous accompagnons tous types d'activités : TPE/PME services et professions libérales, artisans, commerces de proximité et acteurs du bassin de vie mulhousien est.",
  ecosystemFr:
  ...
  distancesEn:
    "Mulhouse centre à 5 min. Autoroute A36 accès à 10 min. Bâle (Suisse) à 35 min. Colmar à 40 min. Aéroport Bâle-Mulhouse-Fribourg à 20 min. Gare Mulhouse-Ville à 10 min. Strasbourg à 1h15.",
  seoHook: "services, libérales & artisanat",
  topSectorsNaf: [
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Riedisheim : formats adaptés au cabinet, au commerce, à l'atelier d'artisan, au bureau. Vos équipes repartent autonomes.",
    },
    implementation: {
      fr: "Implémentation IA à Riedisheim : automatisation prise de rendez-vous, gestion clients libérales, agents conversationnels, workflow administratif, comptabilité.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Riedisheim ?",
    ...
    },
    {
      ...
      a: "Oui, commerçants de proximité et artisans riedisheimois : gestion stocks, relation client, présence en ligne, automatisation administrative, devis et facturation. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
