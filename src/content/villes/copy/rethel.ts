...
// Rethel (08, Ardennes) — Sous-préfecture, boudin blanc, bords Aisne.
...
export const RETHEL_COPY: VilleCopy = {
  ...
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Rethel (08). Nous accompagnons tous types d'activités : TPE artisans, PME agroalimentaires (boudin blanc, charcuterie), commerçants, exploitations agricoles et professions libérales du Rethélois. Audit sur place sur mesure, démarrage sous 5 jours.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Rethel (08). Nous accompagnons tous types d'activités : TPE artisans, PME agroalimentaires (boudin blanc, charcuterie), commerçants, exploitations agricoles et professions libérales du Rethélois. Audit sur place sur mesure, démarrage sous 5 jours.",
  ecosystemFr:
  ...
  ecosystemEn:
    "Rethel (environ 7 400 habitants) est sous-préfecture des Ardennes et carrefour de la plaine agricole champenoise. La ville est célèbre pour le boudin blanc de Rethel IGP, fleuron de son patrimoine agroalimentaire. L'économie locale repose sur l'agroalimentaire (charcuterie, transformation viande), l'agriculture céréalière, le commerce de proximité, l'artisanat et les services tertiaires. Située en bord d'Aisne, la commune bénéficie d'un axe ferroviaire Reims-Charleville stratégique.",
  distancesFr:
    "Reims à 40 km via A34. Charleville-Mézières à 40 km via A34. Aéroport Reims-Champagne à 45 min. Gare de Rethel (axe Reims-Charleville-Mézières, Paris-Est en 2h). Sedan à 45 min.",
  distancesEn:
    "Reims à 40 km via A34. Charleville-Mézières à 40 km via A34. Aéroport Reims-Champagne à 45 min. Gare de Rethel (axe Reims-Charleville-Mézières, Paris-Est en 2h). Sedan à 45 min.",
  topSectorsNaf: [
    "Agroalimentaire & charcuterie IGP",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Rethel : formations pratiques pour équipes agroalimentaires, exploitations agricoles, commerce et services du Rethélois. Vos collaborateurs repartent autonomes sur les outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Rethel : traçabilité IGP boudin blanc, contrôle qualité agroalimentaire, optimisation rendement cultures, gestion documentaire exploitations, agents conversationnels commerce. Adapté au tissu agroalimentaire rural.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Rethel et dans le Rethélois ?",
      a: "Oui, Axion-IA intervient à Rethel et dans tout le Rethélois (Acy-Romance, Sault-lès-Rethel, Bourg-Fidèle). Couverture Reims à 40 km et Charleville-Mézières à 40 km par l'A34.",
    },
    {
    ...
    },
    {
      ...
      a: "Après un premier échange gratuit, nous planifions l'intervention sous 5 jours. Nos consultants se déplacent depuis Reims (40 min) ou Paris (2h en train). Intervention sur site ou en visio. Livrable actionnable et suivi post-mission de 30 jours inclus.",
    },
  ],
};
