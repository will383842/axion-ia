...
// Nieul-sur-Mer (17, Charente-Maritime) — Agglo La Rochelle nord.
...
export const NIEUL_SUR_MER_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Nieul-sur-Mer ?",
      a: "Oui, Axion-IA intervient à Nieul-sur-Mer et toute l'agglomération de La Rochelle nord (Lagord, Puilboreau, Saint-Xandre). Nos consultants accèdent facilement via la gare TGV de La Rochelle à 12 min.",
    },
    {
      q: "Quels services IA pour les professions libérales à Nieul-sur-Mer ?",
    ...
    },
    {
      ...
      a: "L'audit sur place IA à Nieul-sur-Mer démarre à {{price:audit-flash|flat}}. Diagnostic complet de vos processus tertiaires ou artisanaux, identification des cas d'usage IA prioritaires, ROI chiffré et plan d'action concret.",
    },
    {
