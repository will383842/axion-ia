...
export const GUILHERAND_GRANGES_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Guilherand-Granges : diagnostic adapté aux PME tertiaires/industrielles agglomération Valence, professions libérales, TPE artisans. Audit Flash {{price:audit-flash|flat}} avec ROI quantifié.",
      en: "Audit IA à Guilherand-Granges : diagnostic adapté aux PME tertiaires/industrielles agglomération Valence, professions libérales, TPE artisans. Audit Flash {{price:audit-flash|flat}} avec ROI quantifié.",
    },
    interventions: {
