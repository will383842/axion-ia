...
// Coursan (11, Aude) — Agglomération narbonnaise, viticulture, canal de la Robine.
...
export const COURSAN_COPY: VilleCopy = {
  ...
  pitchEn:
    "Coursan (11), commune de l'agglomération narbonnaise en Aude, traversée par le canal de la Robine (patrimoine UNESCO). Tissu viticole historique, TPE artisans, PME négoce et services, commerces de proximité, professions libérales. Axion-IA opère pour toutes les structures économiques de la commune.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Coursan (11). Nous accompagnons TPE viticoles, artisans, PME négoce, commerçants, professions libérales et services de l'agglomération narbonnaise. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Coursan (11). Nous accompagnons TPE viticoles, artisans, PME négoce, commerçants, professions libérales et services de l'agglomération narbonnaise. Audit sur place sur mesure.",
  ...
  ecosystemEn:
    "Coursan est une commune viticole de l'agglomération narbonnaise, traversée par le canal de la Robine (classé UNESCO). Économie dominée par la viticulture (AOC Corbières, Coteaux de Narbonne), le négoce vinicole, les services à la personne et les commerces de proximité. Proximité immédiate de Narbonne (5 km) avec son bassin d'emploi tertiaire.",
  distancesFr:
    "Narbonne centre à 5 min (D6009). Gare SNCF Narbonne à 10 min. Béziers à 25 min. Perpignan à 45 min. Aéroport Béziers-Cap d'Agde à 35 min.",
  distancesEn:
    "Narbonne centre à 5 min (D6009). Gare SNCF Narbonne à 10 min. Béziers à 25 min. Perpignan à 45 min. Aéroport Béziers-Cap d'Agde à 35 min.",
  topSectorsNaf: [
    "Viticulture & vinification (AOC Corbières)",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Coursan : formats adaptés au domaine viticole, au négoce, au commerce ou au cabinet libéral. Vos équipes repartent autonomes sur les outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Coursan : automatisation traçabilité viticole, gestion stocks négoce, agents conversationnels clients, classification documents pour les entreprises narbonnaises.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Coursan et agglo narbonnaise ?",
      a: "Oui, Axion-IA intervient à Coursan et dans toute l'agglomération narbonnaise (Narbonne, Cuxac-d'Aude, Vinassan, Salles-d'Aude). Nos consultants se déplacent depuis Narbonne en 5 min.",
    },
    {
