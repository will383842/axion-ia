  ...
  faqGeolocalisee: [
    {
      ...
      a: "Les audits IA au Plessis-Trévise débutent à 590 € HT pour un Audit Flash de 4 heures sur site, déplacement William depuis Paris via RER E inclus. Tarifs publics consultables sur axion-ia.com.",
    },
    {
      q: "Comment se déroule une intervention IA au Plessis-Trévise ?",
      a: "William se déplace sur site au Plessis-Trévise (18 km de Paris via RER E ou A4) pour des interventions à partir de 590 € HT. Nous développons du code custom (pas de no-code) adapté aux besoins des TPE et PME locales.",
    },
    {
