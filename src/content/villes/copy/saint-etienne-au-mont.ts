...
export const SAINT_ETIENNE_AU_MONT_COPY: VilleCopy = {
  ...
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient a Saint-Etienne-au-Mont (62). Nous accompagnons les TPE, PME et ETI de l'agglomeration boulonnaise : entreprises de services, artisans BTP, commercants, professions liberales et acteurs du tourisme cotier. Audit Flash a partir de 490 EUR HT.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient a Saint-Etienne-au-Mont (62). Nous accompagnons les TPE, PME et ETI de l'agglomeration boulonnaise : entreprises de services, artisans BTP, commercants, professions liberales et acteurs du tourisme cotier. Audit Flash a partir de 490 EUR HT.",
  ecosystemFr:
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA a Saint-Etienne-au-Mont : diagnostic adapte aux TPE artisanales, PME de services et commercants de l'agglo boulonnaise. ROI chiffre, Audit Flash 490 EUR HT.",
      en: "Audit IA a Saint-Etienne-au-Mont : diagnostic adapte aux TPE artisanales, PME de services et commercants de l'agglo boulonnaise. ROI chiffre, Audit Flash 490 EUR HT.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Pour les TPE et PME du bassin boulonnais, nous proposons : automatisation administrative, agents conversationnels, CRM augmente, IA predictive et formations equipes. Audit Flash 490 EUR HT.",
    },
    {
