...
export const AUCH_COPY: VilleCopy = {
        ...
        methodology: [
          {
            step: "Cadrage à Auch",
            detail:
              "Atelier sur site — centre historique au pied de l'escalier monumental, zone du Mouliot ou du Grand Chêne, domaine viticole ou exploitation céréalière : objectifs, parcours utilisateurs, audit de la stack, des contenus et de la saisonnalité touristique. Devis ferme à partir de 48 h selon la complexité.",
          },
          {
            step: "Conception UX/UI",
            detail:
              "Wireframes, design system et maquettes Figma à votre marque, accessibilité et mobile-first ; prototype cliquable testé avant tout développement, pensé pour la clientèle locale auscitaine comme pour les visiteurs et acheteurs en ligne de la Gascogne, sur tous écrans.",
          },
          {
            step: "Développement par sprints",
            detail:
              "Greffe IA sur l'existant ou build IA-native : boutique e-commerce multi-CMS (WordPress, Shopify, WooCommerce, PrestaShop, Magento), chatbot RAG multilingue, recherche sémantique, agents et automatisations devis/stocks. Démos hebdomadaires en visio, code versionné et livré au fil de l'eau.",
          },
          {
            step: "Recette + mise en ligne",
            detail:
              "Tests d'acceptation, Web Vitals, accessibilité et SEO/AEO validés, puis mise en production sans downtime depuis nos zones d'hébergement UE — y compris en pleine saison de ventes d'Armagnac, de fêtes gasconnes ou de pics commerciaux au Mouliot.",
          },
          {
            step: "Livraison + autonomie",
            detail:
              "Code source, bases et modèles livrés chez vous (hébergement UE possible). Vos équipes pilotent l'outil en autonomie depuis Auch, sans verrou ni abonnement imposé, avec documentation et transfert de compétences ; reprise possible par tout prestataire du Gers ou de Toulouse.",
          },
        ],
        pricing: [
          {
          ...
          },
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une boutique avec UX/UI et IA intégrée pour un domaine viticole, une maison d'Armagnac, une conserverie ou une PME agroalimentaire gasconne (vente directe, multilingue, expéditions) ou un commerce du Grand Chêne en click-and-collect.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Plateforme métier, configurateur ou portail client sur mesure pour les industriels et acteurs structurants du Gers — aéronautique (type JCB Aéro), connectique (type Positronic), agroalimentaire (type Nataïs) et coopération céréalière — IA intégrée, branchée sur votre SI (CRM, ERP, PLM, traçabilité).",
          },
          {
            sizeLabel: "Grande entreprise",
            price: "Programme produit",
            detail:
              "Programmes pluriannuels pour les grands employeurs, enseignes (Auch Hyper Distribution / E.Leclerc) et coopératives régionaux : refonte de plateformes, design system, e-commerce à fort volume, équipe dédiée Axion-IA en mode produit avec roadmap partagée.",
          },
        ],
        faq: [
          {
            q: "Faites-vous l'UX/UI et l'e-commerce, pas seulement l'IA ?",
            a: "Oui. On conçoit l'expérience complète — research, wireframes, design system, maquettes Figma, prototype cliquable — pour un site vitrine, une boutique de vente d'Armagnac ou de produits gascons, ou une plateforme métier, avec ou sans brique IA. On travaille en multi-CMS (WordPress, Shopify, WooCommerce, PrestaShop, Magento) ou en code sur mesure, mobile-first et accessible.",
          },
          {
            q: "Pouvez-vous vendre de l'Armagnac et des produits gascons en ligne avec contrôle d'âge ?",
            a: "Oui. On construit des boutiques e-commerce pour les domaines, maisons d'eaux-de-vie et conserveries du Gers : vente directe, abonnements, expéditions, vérification d'âge à l'achat d'alcool, gestion multilingue, paniers cadeaux gastronomiques et paiement sécurisé. Le tout est hébergeable en UE, conforme RGPD, avec une recherche sémantique pour guider l'acheteur vers le bon millésime ou coffret.",
          },
          {
            q: "Travaillez-vous avec les industriels des zones d'activité d'Auch ?",
            a: "Oui. Pour les acteurs des zones du Mouliot, d'Engachies, de Clarac ou de Lamothe — aéronautique (type JCB Aéro), connectique (type Positronic Industries), agroalimentaire (type Nataïs) — on développe des portails clients, configurateurs produit, moteurs de recherche documentaire et automatisations branchés sur l'ERP et le PLM. Code custom, hébergement UE et propriété totale des données techniques.",
          },
          {
            q: "Mes données restent-elles en Europe ?",
            a: "Oui. Toute la chaîne IA est hébergeable en UE, conforme RGPD et AI Act, sans transit hors UE sans DPA. Vous gardez la propriété complète de vos données clients, viticoles, commerciales et industrielles, sans verrou technique ni dépendance à un prestataire unique. Le code et les modèles vous sont livrés et restent transférables à tout moment.",
          },
          {
            q: "Le devis est-il ferme et pouvez-vous reprendre un site existant ?",
            a: "Oui aux deux. Après le cadrage à Auch, on remet un devis ferme en forfait fixe, sans régie ni dérive horaire cachée — à partir de 48 h pour un projet simple selon la complexité. On peut repartir d'un site WordPress, Shopify ou PrestaShop existant pour le refondre ou simplement y greffer une brique IA, sans tout reconstruire ni interrompre vos ventes.",
          },
        ],
        guarantees:
          "Devis ferme en forfait fixe (à partir de 48 h selon la complexité) : pas de régie ni de dérive horaire cachée. Mise en ligne sans downtime quand on augmente l'existant, y compris en pleine saison commerciale au Mouliot ou de ventes d'Armagnac. Web Vitals, performance et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD et AI Act : propriété totale, aucun abonnement ni lock-in imposé, projet entièrement transférable à tout prestataire du Gers ou de la région toulousaine, ou repris en interne par vos équipes auscitaines.",
      },
      en: {
        hero: "Axion-IA conçoit et augmente à Auch des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure mobile-first, boutiques e-commerce multi-CMS, chatbot RAG multilingue ancré sur vos contenus, recherche sémantique, agents et automatisations. Pensé pour la capitale gasconne du Gers, où le tissu mêle TPE commerçantes du centre ancien, PME agroalimentaires, domaines viticoles et maisons d'Armagnac, producteurs céréaliers, industriels des zones d'activité (Mouliot, Engachies, Clarac, Lamothe) et professions libérales du Grand Auch Cœur de Gascogne. Industrie présente aussi avec l'aéronautique de JCB Aéro et les connecteurs de Positronic Industries, sans oublier la grande distribution du Grand Chêne et l'agroalimentaire type Nataïs. Qu'on parte de zéro, qu'on reprenne un site WordPress ou Shopify ou qu'on greffe une brique IA sur l'existant, on couvre toute la chaîne — design, dev, e-commerce et IA. Devis à partir de 48 h selon la complexité, hébergement UE, code et données à vous. Kick-off en présentiel à Auch, à 69 km de Toulouse, puis itérations à distance.",
        whyHere: [
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Audit sur place à partir de {{price:audit-flash|flat}}, Formation 4 h à partir de {{price:intervention-4h|flat}}, session 1-to-1 dirigeants à partir de {{price:intervention-dirigeants|flat}}. Tarifs publics, sans devis opaque.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les domaines viticoles et producteurs d'Armagnac sur la traçabilité parcelles, la gestion commerciale, la classification d'avis client et la prédiction de millésime. Audit sur place à {{price:audit-flash|flat}}.",
    },
  ],
};
