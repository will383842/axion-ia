      ...
      fr: {
        ...
        methodology: [
          {
            step: "Cadrage à Auch",
            detail:
              "Atelier sur site — centre historique au pied de l'escalier monumental, zone du Mouliot ou du Grand Chêne, domaine viticole ou exploitation céréalière : objectifs, parcours utilisateurs, audit de la stack, des contenus et de la saisonnalité touristique. Devis ferme à partir de 24-48 h selon la complexité.",
          },
          {
        ...
        faq: [
          ...
          },
          {
            ...
            a: "Oui aux deux. Après le cadrage à Auch, on remet un devis ferme en forfait fixe, sans régie ni dérive horaire cachée — à partir de 24-48 h pour un projet simple selon la complexité. On peut repartir d'un site WordPress, Shopify ou PrestaShop existant pour le refondre ou simplement y greffer une brique IA, sans tout reconstruire ni interrompre vos ventes.",
          },
        ],
        guarantees:
