...
export const PONTOISE_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les TPE pontoisiennes (artisans, commerçants, indépendants) sur des cas IA accessibles : automatisation devis/facturation, agents IA pour relation client, gestion administrative simplifiée. Audit Flash à 490 € HT adapté aux petites structures.",
    },
    {
