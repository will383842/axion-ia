...
// Saint-Hilaire-de-Riez (85, Vendée) — Littoral vendéen, station balnéaire.
...
export const SAINT_HILAIRE_DE_RIEZ_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Saint-Hilaire-de-Riez est une station balnéaire majeure du littoral vendéen, entre la corniche vendéenne et le marais breton. Forte densité de campings, résidences de tourisme, hôtels-restaurants. Population multipliée par 5 en été. Saint-Jean-de-Monts à 10 min, Saint-Gilles-Croix-de-Vie à 5 min.",
  distancesFr:
    "Saint-Gilles-Croix-de-Vie à 5 min. Saint-Jean-de-Monts à 10 min. La Roche-sur-Yon à 45 min. Nantes à 1h10. Challans à 20 min.",
  distancesEn:
    "Saint-Gilles-Croix-de-Vie à 5 min. Saint-Jean-de-Monts à 10 min. La Roche-sur-Yon à 45 min. Nantes à 1h10. Challans à 20 min.",
  topSectorsNaf: [
    "Camping & hôtellerie de plein air",
    "Hôtellerie-restauration balnéaire",
    "Commerce saisonnier & détail",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Hilaire-de-Riez et sur le littoral vendéen ?",
      a: "Oui, Axion-IA intervient à Saint-Hilaire-de-Riez et sur tout le littoral vendéen (Saint-Gilles-Croix-de-Vie, Saint-Jean-de-Monts, Les Sables-d'Olonne). Consultants depuis La Roche-sur-Yon (45 min) ou Nantes (1h10).",
    },
    {
      q: "Quels services IA pour les campings de Saint-Hilaire-de-Riez ?",
      a: "Audit sur place {{price:audit-flash|flat}}, interventions sur site, coaching 1-to-1, implémentation IA. Cas campings : pricing dynamique, réservation en ligne IA, gestion saisonnalité, agents multilingues, prédiction affluence.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants interviennent depuis La Roche-sur-Yon (45 min) ou Nantes (1h10). Déplacement sur site dans votre camping, hôtel, restaurant ou commerce. Interventions possibles hors-saison ou en pré-saison.",
    },
  ],
};
