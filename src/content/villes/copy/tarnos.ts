...
// Tarnos (40, Landes) — agglo Bayonne sud, zone industrielle et logistique, portes du Pays basque.
...
export const TARNOS_COPY: VilleCopy = {
  ...
  topSectorsNaf: [
    ...
    "Logistique & transport (proximité port Bayonne)",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Tarnos et dans l'agglomération de Bayonne ?",
      a: "Oui, Axion-IA intervient à Tarnos et toute l'agglomération bayonnaise côté Landes (Ondres, Labenne, Saint-Martin-de-Seignanx). Couverture également Bayonne, Anglet, Biarritz côté Pyrénées-Atlantiques.",
    },
    {
      q: "Proposez-vous des audits IA pour les PME industrielles tarnosiennes ?",
      a: "Oui, audit sur place {{price:audit-flash|flat}} adapté aux PME industrielles de Tarnos (chimie, métallurgie, sous-traitance). Diagnostic automatisation production, prédiction maintenance, contrôle qualité par vision, classification documents techniques.",
    },
    {
