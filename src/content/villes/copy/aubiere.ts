...
// Aubière (63, Puy-de-Dôme) — campus universitaire Cézeaux (UCA), zone commerciale sud Clermont, agglomération clermontoise.

import type { VilleCopy } from "./types";

export const AUBIERE_COPY: VilleCopy = {
  pitchFr:
  ...
  ecosystemEn:
    "Aubière accueille le campus des Cézeaux de l'Université Clermont Auvergne (UCA), pôle recherche et innovation. Startups deeptech, incubateurs, zone commerciale sud dynamique, PME tertiaires, services aux entreprises et étudiants.",
  distancesFr:
    "Clermont-Ferrand centre à 10 min. Cournon-d'Auvergne à 5 min. Beaumont à 5 min. Aéroport Clermont-Ferrand Auvergne à 25 min.",
  distancesEn:
    "Clermont-Ferrand centre à 10 min. Cournon-d'Auvergne à 5 min. Beaumont à 5 min. Aéroport Clermont-Ferrand Auvergne à 25 min.",
  topSectorsNaf: [
    "Recherche universitaire (Cézeaux UCA)",
    "Startups / deeptech campus",
    "Commerce zone commerciale sud",
    "PME tertiaires",
    "Services aux entreprises",
  ],
  servicesContext: {
    audit: {
      fr: "Audit IA à Aubière : diagnostic adapté aux startups deeptech, laboratoires recherche UCA, commerces zone commerciale, PME tertiaires. ROI chiffré, audit sur place {{price:audit-flash|flat}}.",
      en: "Audit IA à Aubière : diagnostic adapté aux startups deeptech, laboratoires recherche UCA, commerces zone commerciale, PME tertiaires. ROI chiffré, audit sur place {{price:audit-flash|flat}}.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Aubière et campus Cézeaux ?",
      a: "Oui, Axion-IA intervient à Aubière, campus Cézeaux et toute l'agglomération clermontoise (Clermont à 10 min, Cournon, Beaumont). Aéroport Clermont à 25 min.",
    },
    {
      q: "Travaillez-vous avec les startups deeptech du campus ?",
      a: "Oui, prototypage IA, MVP augmenté, automatisation pipelines données, intégration modèles ML, accompagnement levée de fonds tech.",
    },
    {
      q: "Accompagnez-vous les laboratoires de recherche UCA ?",
