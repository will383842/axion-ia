...
// Saint-Lô (50, Manche) — préfecture de la Manche, "capitale des ruines" reconstruite après 1944, haras national.
...
export const SAINT_LO_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Saint-Lô : formats adaptés à la laiterie, l'exploitation agricole, le commerce, l'administration départementale. Vos équipes repartent autonomes sur les outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Saint-Lô : automatisation traçabilité agroalimentaire, gestion planning haras, agents IA accueil administrations, optimisation logistique laitière, CRM commerce centre-ville.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Lô et dans la Manche ?",
    ...
    },
    {
      ...
      a: "Nous accompagnons les professionnels de la filière équine autour du haras national de Saint-Lô : gestion planning élevage, suivi sanitaire IA, automatisation administrative, prédiction performances. Coaching 1-to-1 ou intervention sur site.",
    },
    {
      q: "Travaillez-vous avec les services publics départementaux ?",
      a: "Oui, nous accompagnons les administrations et services publics à Saint-Lô sur leurs cas IA : agents conversationnels accueil usagers, classification documents, automatisation workflow, conformité RGPD intégrée.",
    },
    {
