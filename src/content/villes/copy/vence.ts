...
// Vence (06, Alpes-Maritimes) — Arrière-pays niçois, chapelle Matisse, art.
...
export const VENCE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Vence (06), cité d'art de l'arrière-pays niçois en Alpes-Maritimes, est célèbre pour la chapelle du Rosaire décorée par Matisse. Tissu TPE artisans d'art, PME tourisme/hôtellerie, commerçants, professions libérales et services. Axion-IA accompagne tout le tissu professionnel local du Pays vençois.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Vence (06). Nous accompagnons tous types d'activités : TPE artisans d'art, PME tourisme et hôtellerie, galeries, commerçants, professions libérales, indépendants et services aux entreprises de l'arrière-pays niçois.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Vence (06). Nous accompagnons tous types d'activités : TPE artisans d'art, PME tourisme et hôtellerie, galeries, commerçants, professions libérales, indépendants et services aux entreprises de l'arrière-pays niçois.",
  ...
  distancesEn:
    "Nice centre à 20 min (D2210/M2210). Saint-Paul-de-Vence à 5 min. Cagnes-sur-Mer à 15 min. Aéroport Nice-Côte d'Azur à 25 min. Grasse à 20 min ouest. Accès autoroute A8 depuis Cagnes-sur-Mer.",
  topSectorsNaf: [
    "Art, galeries & artisanat d'art",
    "Tourisme culturel & hôtellerie",
    "Professions libérales & services",
    "Commerce de proximité & charme",
    "Immobilier résidentiel arrière-pays",
  ],
  servicesContext: {
    audit: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Vence : formats adaptés aux galeries d'art, hébergements, cabinets ou commerces de charme. Vos équipes repartent autonomes sur outils IA configurés métier.",
    },
    implementation: {
      fr: "Implémentation IA à Vence : classification œuvres d'art, agents conversationnels galerie/hôtel multilingue, automatisation gestion réservations, catalogue numérique artisanat d'art.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Vence et dans l'arrière-pays niçois ?",
      a: "Oui, Axion-IA intervient à Vence et dans tout l'arrière-pays niçois (Saint-Paul-de-Vence, Tourrettes-sur-Loup, La Gaude, Gattières). Nos consultants viennent de Nice (20 min) ou Sophia Antipolis (30 min).",
    },
    {
      q: "Travaillez-vous avec les galeries et artisans d'art ?",
      a: "Oui, nous accompagnons les galeries et artisans d'art vençois : classification et catalogage œuvres par IA, agents conversationnels galerie multilingue, automatisation inventaire, création catalogue numérique interactif.",
    },
    {
      q: "Accompagnez-vous les professions libérales à Vence ?",
