...
export const SAINT_ETIENNE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA opérationnel à Saint-Étienne : nous cartographions ce qui peut être automatisé dans votre structure et chiffrons le ROI. 4 niveaux du Sur place au Stratégique ETI, adaptés à l'industrie manufacturière, au textile médical, au design et aux services B2B stéphanois.",
    ...
    sitesWeb: {
      ...
      en: "Custom web platforms and SaaS AI for Saint-Étienne SMEs/mid-caps — premium showcase site for design players (Cité du Design, UNESCO Creative City) and medical textile firms, customer space for industrial SMEs and distribution (Casino, Thuasne), business dashboard connected to your industrial ERP or CMMS. Senior experts, Axion-IA design system, European hosting.",
    },
  },
    ...
    sitesWeb: {
      fr: {
        ...
        whyHere: [
          ...
          "Ville UNESCO du design : une exigence forte sur l'UX/UI et l'identité de marque — c'est exactement notre métier, au-delà de la seule brique IA.",
        ],
        methodology: [
          {
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une application avec UX/UI et IA intégrée, pour studios design, industriels et PME stéphanoises.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Plateforme métier, industrielle ou e-commerce sur mesure, IA intégrée, branchée sur votre SI (PLM, ERP, datalake).",
          },
          {
            sizeLabel: "Grande entreprise",
        ...
        faq: [
          {
            ...
            a: "Oui, et c'est particulièrement pertinent à Saint-Étienne, ville UNESCO du design. On conçoit l'expérience complète — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA.",
          },
          {
            q: "Vous travaillez pour l'industrie et le manufacturing ?",
            a: "Oui : portails techniques, plateformes data, RAG sur documentation, agents et automatisations métier branchés sur votre SI (PLM, ERP) — un terrain naturel dans la Loire industrielle. Hébergement UE, RGPD strict.",
          },
          {
      ...
      en: {
        ...
        whyHere: [
          ...
          "UNESCO City of Design: high expectations on UX/UI and brand identity — exactly our craft, beyond the AI brick alone.",
        ],
        methodology: [
          {
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Design or rebuild of a site or app with UX/UI and built-in AI, for design studios, manufacturers and Saint-Étienne SMEs.",
          },
          {
            sizeLabel: "Mid-cap",
            price: "AI-native SaaS platform",
            detail:
              "Bespoke business, industrial or e-commerce platform, AI built in, wired into your IS (PLM, ERP, datalake).",
          },
          {
            sizeLabel: "Large enterprise",
        ...
        faq: [
          {
            ...
            a: "Yes, and it's especially relevant in Saint-Étienne, a UNESCO City of Design. We design the full experience — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick.",
          },
          {
            q: "Do you work for industry and manufacturing?",
            a: "Yes: technical portals, data platforms, RAG on documentation, agents and business automations wired to your IS (PLM, ERP) — a natural fit in the industrial Loire. EU hosting, strict GDPR.",
          },
          {
