...
// Octeville-sur-Mer (76, Seine-Maritime) — Agglo Le Havre, littoral, 6 172 hab.
...
export const OCTEVILLE_SUR_MER_COPY: VilleCopy = {
  ...
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient a Octeville-sur-Mer (76). Nous accompagnons les TPE, PME et professions liberales du littoral havrais : medecins, commercants, artisans et prestataires de services. Audit Flash a partir de 490 EUR HT.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient a Octeville-sur-Mer (76). Nous accompagnons les TPE, PME et professions liberales du littoral havrais : medecins, commercants, artisans et prestataires de services. Audit Flash a partir de 490 EUR HT.",
  ecosystemFr:
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA a Octeville-sur-Mer : diagnostic adapte aux professions liberales, TPE de services et commercants du littoral havrais. ROI chiffre, audit Flash 490 EUR HT.",
      en: "Audit IA a Octeville-sur-Mer : diagnostic adapte aux professions liberales, TPE de services et commercants du littoral havrais. ROI chiffre, audit Flash 490 EUR HT.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il a Octeville-sur-Mer et dans l'agglo du Havre ?",
      a: "Oui, Axion-IA intervient a Octeville-sur-Mer et dans toute l'agglomeration havraise (Le Havre, Sainte-Adresse, Harfleur, Montivilliers). Consultants depuis Le Havre (10 min) ou Paris (2h15).",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, toutes nos interventions a Octeville-sur-Mer sont conformes au RGPD. Protection des donnees de votre cabinet/entreprise et de vos clients garantie contractuellement.",
    },
  ],
};
