...
export const PELISSANNE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Pélissanne (13), commune résidentielle de l'agglomération de Salon-de-Provence dans les Bouches-du-Rhône, allie qualité de vie provençale et dynamisme économique local. TPE artisans, PME services, commerces de centre-bourg et professions libérales. Axion-IA y intervient pour tous types d'activités du bassin salonais.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Pélissanne (13). Nous accompagnons TPE artisans, PME de services de l'agglomération de Salon-de-Provence, commerces de centre-bourg et professions libérales. Audit sur place sur mesure, sans engagement.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Pélissanne (13). Nous accompagnons TPE artisans, PME de services de l'agglomération de Salon-de-Provence, commerces de centre-bourg et professions libérales. Audit sur place sur mesure, sans engagement.",
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Pélissanne : sessions pour dirigeants TPE/PME, artisans et professions libérales du bassin de Salon-de-Provence souhaitant maîtriser l'IA.",
      en: "Coaching 1-to-1 à Pélissanne : sessions pour dirigeants TPE/PME, artisans et professions libérales du bassin de Salon-de-Provence souhaitant maîtriser l'IA.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les TPE artisans de Pélissanne : automatisation devis, gestion planning, facturation, suivi chantiers, relances clients. Solutions adaptées aux petites structures.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants interviennent sur site à Pélissanne sous 5 jours ouvrés. Salon-de-Provence à 10 min, Aix à 25 min. Frais de déplacement inclus agglomération salonaise.",
    },
  ],
};
