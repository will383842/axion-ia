...
// La Bassée (59, Nord) — Sud-ouest Lille, bourg, 6 650 hab.
...
export const LA_BASSEE_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à La Bassée : formats adaptés à l'entrepôt logistique, chantier BTP, exploitation agricole, commerce. Vos équipes repartent autonomes sur les outils IA du quotidien.",
    },
    implementation: {
      fr: "Implémentation IA à La Bassée : optimisation tournées transport, traçabilité logistique, automatisation devis BTP, outils IA agriculture de précision, agents conversationnels commerce.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à La Bassée ?",
      a: "Oui, Axion-IA intervient à La Bassée et dans tout le pays de Weppes (Illies, Herlies, Salomé, Violaines). Nos consultants viennent via gare La Bassée-Violaines (TER Lille-Béthune) ou A1/A26. Lille à 25 min.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les PME transport et logistique basséennes situées au carrefour A26/A1 : optimisation tournées, traçabilité expéditions, automatisation planning, gestion documentaire, agents IA relation client B2B.",
    },
    {
      q: "Travaillez-vous avec les agriculteurs et exploitations du Weppes ?",
      a: "Oui, nous accompagnons les exploitations agricoles périurbaines de La Bassée : outils IA agriculture de précision, automatisation gestion parcellaire, prédiction rendements, optimisation approvisionnement, gestion administrative PAC.",
    },
    {
