...
// Delle (90, Territoire de Belfort) — frontalier Suisse, deuxième ville du département, industrie.
...
export const DELLE_COPY: VilleCopy = {
  ...
  topSectorsNaf: [
    ...
    "Prestataires transfrontaliers Suisse",
  ],
  servicesContext: {
    audit: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Delle : formats adaptés atelier industriel, commerce, cabinet, bureau, contexte transfrontalier. Vos équipes repartent autonomes.",
    },
    implementation: {
      fr: "Implémentation IA à Delle : automatisation production et qualité PME industrielles, CRM augmenté commerces, prise de rendez-vous IA professions libérales, gestion clients transfrontaliers, reporting multilingue FR/DE.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Delle et frontière suisse ?",
      a: "Oui, Axion-IA intervient à Delle et tout le bassin transfrontalier sud Territoire de Belfort (Belfort à 25 min en train, Montbéliard à 30 min, Bâle à 45 min, Boncourt Suisse à 5 min).",
    },
    {
    ...
    },
    {
      ...
      a: "Audit sur place {{price:audit-flash|flat}}, outils relation client multilingue FR/DE, gestion devis et facturation transfrontalière, automatisation reporting, optimisation cycles commerciaux Suisse-France.",
    },
    {
