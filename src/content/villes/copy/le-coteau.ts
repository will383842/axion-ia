...
export const LE_COTEAU_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA au Coteau : diagnostic adapté aux PME tertiaires/industrielles Roannais, professions libérales, TPE artisans. ROI chiffré, audit Flash {{price:audit-flash|flat}}.",
      en: "Audit IA au Coteau : diagnostic adapté aux PME tertiaires/industrielles Roannais, professions libérales, TPE artisans. ROI chiffré, audit Flash {{price:audit-flash|flat}}.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Pour les TPE artisans BTP et commerçants au Coteau, audit Flash {{price:audit-flash|flat}}, intervention 1 journée formation, coaching 1-to-1. Cas typiques : automatisation devis, agents IA prise de RDV.",
    },
    {
