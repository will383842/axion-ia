...
// Saint-Pol-de-Léon (29, Finistère) — Ceinture dorée, légumes primeurs, cathédrale.
...
export const SAINT_POL_DE_LEON_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Saint-Pol-de-Léon est la capitale de la Ceinture dorée, premier bassin de production de légumes primeurs en France (artichauts, choux-fleurs, échalotes). La ville abrite le siège de grandes coopératives maraîchères et une criée historique. Le tourisme patrimonial (cathédrale, chapelle du Kreisker) et les commerces de centre-bourg complètent une économie tournée vers la terre et la mer.",
  distancesFr:
    "Morlaix à 20 min. Brest à 55 min. Gare TGV de Morlaix (Paris en 3h15). Roscoff et ferry Irlande/Angleterre à 10 min. Aéroport Brest-Bretagne à 1h.",
  distancesEn:
    "Morlaix à 20 min. Brest à 55 min. Gare TGV de Morlaix (Paris en 3h15). Roscoff et ferry Irlande/Angleterre à 10 min. Aéroport Brest-Bretagne à 1h.",
  topSectorsNaf: [
    "Agriculture maraîchère & coopératives légumières",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Pol-de-Léon et dans la Ceinture dorée ?",
      a: "Oui, Axion-IA intervient à Saint-Pol-de-Léon et dans toute la Ceinture dorée du nord Finistère (Roscoff, Cléder, Plouescat, Sibiril). Déplacement depuis Morlaix en 20 min, depuis Brest en 55 min.",
    },
    {
      q: "Travaillez-vous avec les coopératives maraîchères et les PME agroalimentaires ?",
