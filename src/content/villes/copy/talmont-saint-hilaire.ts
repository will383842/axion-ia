...
// Talmont-Saint-Hilaire (85, Vendée) — Château Richard Cœur Lion, littoral.
...
export const TALMONT_SAINT_HILAIRE_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Talmont-Saint-Hilaire est une commune littorale vendéenne avec le château de Talmont (XIe siècle, Richard Cœur de Lion) et le port ostréicole du Payré. Tourisme patrimonial et balnéaire, ostréiculture, camping, artisanat. Les Sables-d'Olonne à 10 min, La Roche-sur-Yon à 30 min.",
  distancesFr:
    "Les Sables-d'Olonne à 10 min. La Roche-sur-Yon à 30 min. Nantes à 1h15. Gare SNCF Les Sables-d'Olonne à 15 min. Autoroute A87 à 25 min.",
  distancesEn:
    "Les Sables-d'Olonne à 10 min. La Roche-sur-Yon à 30 min. Nantes à 1h15. Gare SNCF Les Sables-d'Olonne à 15 min. Autoroute A87 à 25 min.",
  topSectorsNaf: [
    "Tourisme patrimonial & balnéaire",
    "Ostréiculture & conchyliculture (port du Payré)",
    "Camping & hôtellerie-restauration",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Talmont-Saint-Hilaire et sur le littoral vendéen ?",
      a: "Oui, Axion-IA intervient à Talmont-Saint-Hilaire et sur tout le littoral vendéen (Les Sables-d'Olonne, Jard-sur-Mer). Consultants depuis La Roche-sur-Yon (30 min) ou Les Sables (10 min).",
    },
    {
      q: "Accompagnez-vous les ostréiculteurs du port du Payré ?",
      a: "Oui, nous accompagnons les ostréiculteurs et conchyliculteurs du Payré : traçabilité IA production, prédiction qualité, gestion stocks saisonniers, automatisation vente directe, marketing digital.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants interviennent depuis La Roche-sur-Yon (30 min) ou Les Sables-d'Olonne (10 min). Déplacement sur site dans votre exploitation, camping, hôtel ou commerce.",
    },
  ],
};
