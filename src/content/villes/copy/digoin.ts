...
// Digoin (71, Saône-et-Loire) — confluence Loire/Arroux, pont-canal, céramique/faïence.
...
export const DIGOIN_COPY: VilleCopy = {
  ...
  pitchEn:
    "Digoin (71), commune de Saône-et-Loire à la confluence de la Loire et de l'Arroux. Pont-canal emblématique, tradition céramique et faïence. Tissu TPE artisanat, PME industrielles céramique, commerce centre-bourg, tourisme fluvial, agriculture. Axion-IA opère pour entreprises et indépendants du secteur.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Digoin (71). Nous accompagnons TPE et PME : artisans céramistes et faïenciers, commerçants centre-bourg, acteurs tourisme fluvial (pont-canal, Loire), PME industrielles, agriculteurs. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Digoin (71). Nous accompagnons TPE et PME : artisans céramistes et faïenciers, commerçants centre-bourg, acteurs tourisme fluvial (pont-canal, Loire), PME industrielles, agriculteurs. Audit sur place sur mesure.",
  ecosystemFr:
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Digoin et dans le Charolais ?",
      a: "Oui, Axion-IA intervient à Digoin et tout le Charolais (Paray-le-Monial à 20 min, Moulins à 30 min, Roanne à 45 min). Le Creusot-TGV à 50 min, Lyon à 1h45.",
    },
    {
      q: "Travaillez-vous avec les artisans céramistes et faïenciers ?",
      a: "Oui, gestion vente directe en ligne, automatisation catalogue produits, promotion artisanat local, suivi commandes et expéditions. Accompagnement adapté atelier céramique.",
    },
    {
      q: "Accompagnez-vous les acteurs du tourisme fluvial ?",
