...
// Saint-Nicolas-de-Port (54, Meurthe-et-Moselle) — basilique, pèlerinage, bords Meurthe.
...
export const SAINT_NICOLAS_DE_PORT_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Saint-Nicolas-de-Port est une commune historique du sud-est de la Métropole du Grand Nancy, sur les bords de la Meurthe, célèbre pour sa basilique gothique flamboyant Saint-Nicolas et son pèlerinage. Son tissu économique repose sur les services, le commerce de proximité, l'artisanat BTP, la restauration et les professions libérales. Patrimoine touristique, gare TER, axe Nancy-Lunéville.",
  distancesFr:
    "Nancy centre à 15 min. Gare de Nancy à 18 min (TGV Paris 1h30). Lunéville à 20 min. Dombasle-sur-Meurthe à 5 min. Aéroport Metz-Nancy-Lorraine à 35 min. Gare TER Saint-Nicolas-de-Port (axe Nancy-Strasbourg).",
  distancesEn:
    "Nancy centre à 15 min. Gare de Nancy à 18 min (TGV Paris 1h30). Lunéville à 20 min. Dombasle-sur-Meurthe à 5 min. Aéroport Metz-Nancy-Lorraine à 35 min. Gare TER Saint-Nicolas-de-Port (axe Nancy-Strasbourg).",
  seoHook: "patrimoine, commerce & services",
  topSectorsNaf: [
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Saint-Nicolas-de-Port : formats adaptés au bureau tertiaire, au commerce, au restaurant ou au cabinet libéral. Vos équipes repartent autonomes sur les outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Saint-Nicolas-de-Port : agents conversationnels relation client, chatbots prise de RDV & réservation restaurant, automatisation workflow, classification documentaire, gestion stocks commerce.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Nicolas-de-Port et au sud-est de Nancy ?",
      a: "Oui, Axion-IA intervient à Saint-Nicolas-de-Port et tout le sud-est de la Métropole du Grand Nancy (Varangéville, Dombasle-sur-Meurthe, Rosières-aux-Salines, Lunéville). Consultants depuis Nancy centre (15 min).",
    },
    {
