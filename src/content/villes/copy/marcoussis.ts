...
// Marcoussis (91, Essonne) — centre national du rugby (FFR), Hurepoix, 8 618 hab.
...
export const MARCOUSSIS_COPY: VilleCopy = {
  ...
  pitchEn:
    "Marcoussis (91), commune du Hurepoix en Essonne connue pour le centre national du rugby (FFR), accueille un tissu de TPE artisans, commerces, professions libérales, PME de services et activités liées au sport. Axion-IA y intervient pour tous types d'activités du Hurepoix essonnien.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Marcoussis (91). Nous accompagnons tous types d'activités : TPE artisans, commerçants de proximité, professions libérales, PME de services, indépendants et structures du Hurepoix essonnien. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Marcoussis (91). Nous accompagnons tous types d'activités : TPE artisans, commerçants de proximité, professions libérales, PME de services, indépendants et structures du Hurepoix essonnien. Audit sur place sur mesure.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Marcoussis et dans le Hurepoix ?",
