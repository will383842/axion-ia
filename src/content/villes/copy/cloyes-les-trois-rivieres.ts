...
export const CLOYES_LES_TROIS_RIVIERES_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Cloyes-les-Trois-Rivières : diagnostic adapté aux TPE artisans, PME agricoles et agroalimentaires de la vallée du Loir, commerçants, professions libérales et acteurs du tourisme vert. ROI chiffré, audit Flash 490 € HT accessible.",
      en: "Audit IA à Cloyes-les-Trois-Rivières : diagnostic adapté aux TPE artisans, PME agricoles et agroalimentaires de la vallée du Loir, commerçants, professions libérales et acteurs du tourisme vert. ROI chiffré, audit Flash 490 € HT accessible.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Cloyes-les-Trois-Rivières et dans la vallée du Loir ?",
      a: "Oui, Axion-IA intervient à Cloyes-les-Trois-Rivières et dans toute la vallée du Loir eurélienne (Châteaudun, Bonneval, Saint-Denis-les-Ponts). Couverture également Vendôme à 30 min, Chartres à 50 min et Tours à 1h15.",
    },
    {
      q: "Travaillez-vous avec les exploitations agricoles et PME agroalimentaires de Beauce ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les TPE artisans BTP et commerçants de Cloyes-les-Trois-Rivières sur des cas IA pratiques : automatisation devis, agents IA prise de rendez-vous, gestion stocks, optimisation planning. Audit Flash 490 € HT adapté aux petites structures.",
    },
    {
      q: "Quels services pour le tourisme vert de la vallée du Loir ?",
      a: "Pour les acteurs du tourisme vert de la vallée du Loir, nous proposons des implémentations IA adaptées : agents conversationnels réservation hébergement, automatisation gestion avis en ligne, chatbots information touristique patrimoine et randonnée, optimisation planning saisonnier.",
    },
    {
