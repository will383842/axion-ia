...
export const LA_COURONNE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à La Couronne : diagnostic adapté aux PME industrielles, TPE artisans, professionnels de la papeterie et commerces de l'agglomération GrandAngoulême sud. Audit Flash 490 € HT.",
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'audit Flash IA à La Couronne démarre à 490 € HT. Diagnostic complet de vos processus industriels, artisanaux ou commerciaux, identification des cas d'usage IA prioritaires, ROI chiffré et plan d'action concret.",
    },
    {
