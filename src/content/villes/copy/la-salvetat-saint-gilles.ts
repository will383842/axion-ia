...
export const LA_SALVETAT_SAINT_GILLES_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à La Salvetat-Saint-Gilles : diagnostic adapté aux TPE artisans, PME de services et professions libérales de l'ouest Toulouse. Audit Flash 490 € HT.",
