...
// La Salvetat-Saint-Gilles (31, Haute-Garonne) — Ouest Toulouse.
...
export const LA_SALVETAT_SAINT_GILLES_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à La Salvetat-Saint-Gilles : diagnostic adapté aux TPE artisans, PME de services et professions libérales de l'ouest Toulouse. Audit Flash {{price:audit-flash|flat}}.",
      en: "Audit IA à La Salvetat-Saint-Gilles : diagnostic adapté aux TPE artisans, PME de services et professions libérales de l'ouest Toulouse. Audit Flash {{price:audit-flash|flat}}.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à La Salvetat-Saint-Gilles ?",
      a: "Oui, Axion-IA intervient à La Salvetat-Saint-Gilles et dans tout l'ouest de Toulouse (Plaisance-du-Touch, Fonsorbes, Léguevin). Déplacement en 22 min depuis Toulouse.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants se déplacent à La Salvetat-Saint-Gilles depuis Toulouse (22 min D632). Intervention 1 journée minimum, atelier pratique.",
    },
    {
