...
export const AJACCIO_COPY: VilleCopy = {
  pitchFr:
    "Axion-IA, cabinet d'architectes IA seniors, accompagne les TPE et PME d'Ajaccio, préfecture de la Corse-du-Sud et ville natale de Napoléon. Hôtellerie, restauration, port de commerce, tourisme insulaire, commerce et services : nous transformons l'IA en gains concrets, sans jargon ni dépendance technique.",
  pitchEn:
    "Axion-IA, cabinet d'architectes IA seniors, accompagne les TPE et PME d'Ajaccio, préfecture de la Corse-du-Sud et ville natale de Napoléon. Hôtellerie, restauration, port de commerce, tourisme insulaire, commerce et services : nous transformons l'IA en gains concrets, sans jargon ni dépendance technique.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui accompagne les TPE et PME d'Ajaccio en priorité, les PME ensuite. Nous ciblons l'économie touristique insulaire (hôtellerie, restauration, locations), le commerce, les services portuaires et les services aux entreprises. Audit Flash sur mesure avec ROI chiffré, puis accompagnement sur site ou en visio, vos équipes restant autonomes.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui accompagne les TPE et PME d'Ajaccio en priorité, les PME ensuite. Nous ciblons l'économie touristique insulaire (hôtellerie, restauration, locations), le commerce, les services portuaires et les services aux entreprises. Audit Flash sur mesure avec ROI chiffré, puis accompagnement sur site ou en visio, vos équipes restant autonomes.",
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Optimisation du yield et des réservations, agents conversationnels multilingues pour la clientèle de croisière, analyse des avis et automatisation administrative. Chaque piste est chiffrée en ROI dans l'Audit Flash avant toute mise en oeuvre.",
    },
    {
