...
// Vigneux-de-Bretagne (44, Loire-Atlantique) — Nord-ouest Nantes.
...
export const VIGNEUX_DE_BRETAGNE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Vigneux-de-Bretagne : diagnostic adapté aux TPE artisans, PME tertiaires, professions libérales et entreprises des zones d'activités nord-ouest nantais. ROI chiffré, Audit Flash 490 € HT.",
      en: "Audit IA à Vigneux-de-Bretagne : diagnostic adapté aux TPE artisans, PME tertiaires, professions libérales et entreprises des zones d'activités nord-ouest nantais. ROI chiffré, Audit Flash 490 € HT.",
    },
    interventions: {
      ...
      en: "Interventions IA sur site à Vigneux-de-Bretagne : formats adaptés au bureau, au cabinet, au commerce ou à l'atelier. Vos équipes repartent autonomes sur outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Vigneux-de-Bretagne : agents conversationnels B2B, automatisation workflow tertiaire, gestion planning, extraction données commerciales. Nord-ouest Nantes.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Vigneux-de-Bretagne ?",
      a: "Oui, Axion-IA intervient à Vigneux-de-Bretagne et tout le nord-ouest nantais (Treillières, Sautron, Couëron, Savenay). Consultants depuis Nantes centre (20 min). Couverture complète nord-ouest métropole.",
    },
    {
      q: "Accompagnez-vous les PME tertiaires des zones d'activités ?",
      a: "Oui, nous accompagnons les PME tertiaires des zones d'activités sur des cas IA : automatisation workflow, agents conversationnels B2B, extraction données, gestion planning. Audit Flash 490 € HT.",
    },
    {
    ...
    {
      q: "Quel est le tarif d'un audit IA à Vigneux-de-Bretagne ?",
      a: "L'Audit Flash démarre à 490 € HT (4 heures, diagnostic complet avec ROI chiffré). Tarifs publics et transparents adaptés aux TPE et PME du nord-ouest nantais.",
    },
    {
