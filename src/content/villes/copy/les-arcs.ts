...
// Les Arcs (83, Var) — centre-Var, gare TGV Les Arcs-Draguignan, vignoble Côtes de Provence.
...
export const LES_ARCS_COPY: VilleCopy = {
  ...
  pitchEn:
    "Les Arcs (83), commune du centre-Var dotée de la gare TGV Les Arcs-Draguignan (porte du Var), est ancrée dans le vignoble Côtes de Provence et la Maison des Vins. Tissu de TPE viticulteurs, artisans, restaurateurs et PME logistique, tourisme et services autour du hub TGV. Axion-IA y travaille avec les organisations du territoire.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient aux Arcs (83). Nous accompagnons TPE viticulteurs Côtes de Provence, artisans, restaurateurs, PME logistique, tourisme et services du centre-Var autour du hub TGV. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient aux Arcs (83). Nous accompagnons TPE viticulteurs Côtes de Provence, artisans, restaurateurs, PME logistique, tourisme et services du centre-Var autour du hub TGV. Audit sur place sur mesure.",
  ...
  distancesEn:
    "Draguignan à 10 min. Gare TGV Les Arcs-Draguignan en commune. Saint-Raphaël à 30 min par A8. Cannes à 50 min. Toulon à 1 h. Aéroport Nice Côte d'Azur à 1 h 10. Brignoles à 30 min.",
  topSectorsNaf: [
    "Viticulture Côtes de Provence & Maison des Vins",
    "Hub TGV & services logistiques",
    "Artisanat & commerce de proximité",
    "Restauration & œnotourisme",
    "Services aux entreprises centre-Var",
  ],
  servicesContext: {
    audit: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site aux Arcs : ateliers pour vignerons Côtes de Provence, artisans, restaurateurs et PME services. Outils IA configurés métier réel.",
    },
    implementation: {
      fr: "Implémentation IA aux Arcs : gestion parcellaire viticole, vente directe et export, agents IA œnotourisme multilingues, automatisation devis artisans, marketing IA tourisme rural. RGPD strict.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il aux Arcs et dans le centre-Var ?",
      a: "Oui, Axion-IA intervient aux Arcs et dans tout le centre-Var (Draguignan, Vidauban, Trans-en-Provence, Le Luc, Lorgues, Le Muy). Hub TGV Les Arcs-Draguignan facilitant l'accès Paris en 4 h.",
    },
    {
    ...
    {
      q: "Comment l'IA peut-elle aider l'œnotourisme autour des Arcs ?",
      a: "L'IA dynamise l'œnotourisme : agents conversationnels réservation visites caveau multilingues, marketing ciblé international, personnalisation des parcours, automatisation gestion groupes, storytelling digital du terroir.",
    },
  ],
};
