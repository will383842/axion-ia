...
export const LUTTERBACH_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Lutterbach : diagnostic adapté aux TPE artisanat, PME industrie et services, commerces et professions libérales de l'agglomération mulhousienne. ROI chiffré, Audit Flash 490 € HT.",
      en: "Audit IA à Lutterbach : diagnostic adapté aux TPE artisanat, PME industrie et services, commerces et professions libérales de l'agglomération mulhousienne. ROI chiffré, Audit Flash 490 € HT.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'Audit Flash IA à Lutterbach démarre à 490 € HT. Ce diagnostic couvre l'analyse de vos processus métier, l'identification des cas d'usage IA prioritaires et un plan d'action chiffré avec ROI estimé.",
    },
    {
