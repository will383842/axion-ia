...
// Essarts-en-Bocage (85, Vendée) — Commune nouvelle, bocage.
...
export const ESSARTS_EN_BOCAGE_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Essarts-en-Bocage est une commune nouvelle du bocage vendéen (fusion 2016), entre La Roche-sur-Yon (20 min) et Les Herbiers (25 min). Zones d'activités industrielles, agriculture (élevage, cultures), artisanat BTP, commerces. Axe D160 La Roche / Les Herbiers.",
  distancesFr:
    "La Roche-sur-Yon à 20 min. Les Herbiers à 25 min. Nantes à 55 min. Cholet à 40 min. Autoroute A87 accessible à 15 min.",
  distancesEn:
    "La Roche-sur-Yon à 20 min. Les Herbiers à 25 min. Nantes à 55 min. Cholet à 40 min. Autoroute A87 accessible à 15 min.",
  topSectorsNaf: [
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Essarts-en-Bocage et dans le bocage vendéen ?",
      a: "Oui, Axion-IA intervient à Essarts-en-Bocage et dans tout le bocage vendéen. La Roche-sur-Yon à 20 min, Les Herbiers à 25 min. Déplacements sur site couverts.",
    },
    {
      q: "Quels services IA pour les exploitations agricoles d'Essarts-en-Bocage ?",
      a: "Audit sur place {{price:audit-flash|flat}}, interventions sur site, coaching 1-to-1, implémentation IA. Cas agriculture : gestion parcellaire prédictive, optimisation élevage, traçabilité, automatisation facturation.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants interviennent depuis La Roche-sur-Yon (20 min) ou Les Herbiers (25 min). Déplacement sur site dans vos locaux professionnels, atelier ou exploitation.",
    },
  ],
};
