...
export const GIGEAN_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Gigean : diagnostic pour TPE commerçants (32 % du tissu), PME services, artisans BTP, exploitants viticoles et professions libérales du bassin de Thau. Audit Flash 4 h à {{price:audit-flash|flat}}, livrable ROI chiffré.",
      en: "Audit IA à Gigean : diagnostic pour TPE commerçants (32 % du tissu), PME services, artisans BTP, exploitants viticoles et professions libérales du bassin de Thau. Audit Flash 4 h à {{price:audit-flash|flat}}, livrable ROI chiffré.",
    },
    interventions: {
      fr: "Interventions IA sur site à Gigean : ateliers adaptés TPE commerce, PME services, cabinets libéraux, artisans BTP et exploitants viticoles. Équipes autonomes sur outils IA métier. Intervention Essentielle à {{price:intervention-4h|flat}}.",
      en: "Interventions IA sur site à Gigean : ateliers adaptés TPE commerce, PME services, cabinets libéraux, artisans BTP et exploitants viticoles. Équipes autonomes sur outils IA métier. Intervention Essentielle à {{price:intervention-4h|flat}}.",
    },
    implementation: {
      fr: "Implémentation IA à Gigean : automatisation gestion PME, chatbot client, classification documents, optimisation processus artisans, commerces et exploitations viticoles du bassin de Thau. À partir de {{price:impl-poc|entry}}.",
      en: "Implémentation IA à Gigean : automatisation gestion PME, chatbot client, classification documents, optimisation processus artisans, commerces et exploitations viticoles du bassin de Thau. À partir de {{price:impl-poc|entry}}.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Gigean : sessions sur site ou en visio pour dirigeants TPE, gérants PME, professions libérales, artisans et exploitants viticoles du bassin de Thau. À partir de {{price:intervention-dirigeants|flat}}.",
      en: "Coaching 1-to-1 à Gigean : sessions sur site ou en visio pour dirigeants TPE, gérants PME, professions libérales, artisans et exploitants viticoles du bassin de Thau. À partir de {{price:intervention-dirigeants|flat}}.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    },
    {
      ...
      a: "Oui. À Gigean, où le commerce représente 32,2 % du tissu (au-dessus de la moyenne 34), nous adaptons l'Audit Flash 4 h à {{price:audit-flash|flat}} aux TPE commerce et PME services : automatisation processus, chatbot client, classification emails, optimisation CRM.",
    },
    {
      q: "Quels services pour les artisans BTP ?",
      a: "Pour les artisans BTP à Gigean, Audit Flash {{price:audit-flash|flat}}, Intervention Essentielle {{price:intervention-4h|flat}} et coaching 1-to-1. Cas typiques : automatisation devis, classification photos chantier, planification interventions, suivi clients résidentiels.",
    },
    {
    ...
    },
    {
      ...
      a: "L'Audit Flash 4 h démarre à {{price:audit-flash|flat}}. Intervention Essentielle sur site à {{price:intervention-4h|flat}}. Implémentation et coaching 1-to-1 dès {{price:intervention-dirigeants|flat}}. Tarifs publics identiques partout en France, pas de devis opaque.",
    },
    {
