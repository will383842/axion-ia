...
export const GIGEAN_COPY: VilleCopy = {
  pitchFr:
    "Gigean (34), commune de l'agglomération de Sète, entre garrigue et étang de Thau. Abbaye Saint-Félix-de-Montceau, accès A9. Tissu TPE commerçants, PME services, artisans BTP, professions libérales. Axion-IA y intervient pour tous types d'activités.",
  pitchEn:
    "Gigean (34), commune de l'agglomération de Sète, entre garrigue et étang de Thau. Abbaye Saint-Félix-de-Montceau, accès A9. Tissu TPE commerçants, PME services, artisans BTP, professions libérales. Axion-IA y intervient pour tous types d'activités.",
  directAnswerFr:
