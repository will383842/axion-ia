...
const VILLE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit Flash à Carpentras pour TPE viticoles, commerçants du marché ou artisans BTP : 4 heures sur site, cartographie des tâches répétitives (saisie compta, devis manuels, relances), plan d'action chiffré. {{price:audit-flash|flat}}.",
      en: "Audit Flash à Carpentras pour TPE viticoles, commerçants du marché ou artisans BTP : 4 heures sur site, cartographie des tâches répétitives (saisie compta, devis manuels, relances), plan d'action chiffré. {{price:audit-flash|flat}}.",
    },
    interventions: {
