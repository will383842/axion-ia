...
export const LINGOLSHEIM_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Non. Axion-IA n'a pas d'agence à Lingolsheim : nos architectes IA se déplacent depuis Strasbourg, avec des frais de transport transparents distincts du forfait.",
    },
  ],
};
