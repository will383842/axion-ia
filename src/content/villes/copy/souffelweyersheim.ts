...
export const SOUFFELWEYERSHEIM_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, les artisans BTP, services aux entreprises et commerçants de Souffelweyersheim bénéficient de l'audit Flash 490 € HT et d'interventions sur site adaptées. Automatisation devis, relances, gestion clients, prospection.",
    },
    {
