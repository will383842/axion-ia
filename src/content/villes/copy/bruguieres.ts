...
// Bruguières (31, Haute-Garonne) — Nord Toulouse.
...
export const BRUGUIERES_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Bruguières : diagnostic adapté aux TPE artisans, PME de services et professions libérales du nord Toulouse. Audit Flash 490 € HT.",
      en: "Audit IA à Bruguières : diagnostic adapté aux TPE artisans, PME de services et professions libérales du nord Toulouse. Audit Flash 490 € HT.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Bruguières ?",
      a: "Oui, Axion-IA intervient à Bruguières et dans tout le nord de Toulouse (Saint-Jory, Castelginest, Castelnau-d'Estrétefonds). Nos consultants se déplacent en 18 min depuis Toulouse.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants se déplacent à Bruguières depuis Toulouse (18 min A62). Intervention 1 journée minimum, atelier pratique dans vos locaux.",
    },
    {
      q: "Proposez-vous du coaching individuel à Bruguières ?",
      a: "Oui, sessions 1-to-1 pour dirigeants TPE et PME à Bruguières. Format flexible : locaux, visio. À partir de 990 € HT.",
    },
  ],
};
