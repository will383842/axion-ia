// AUTO-GENERATED 2026-05-27 — T4 batch #24 + refactor anti-doorway HCU 2026-05-28 Claude Code (Will).
// Saint-Georges-d'Orques (34, Hérault) — 5 676 hab. (2023), à 8 km ouest de Montpellier, AOC viticole historique.
...
export const SAINT_GEORGES_D_ORQUES_COPY: VilleCopy = {
  ...
  topSectorsNaf: [
    ...
    "Viticulture AOC Languedoc-Saint-Georges-d'Orques & œnotourisme",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Saint-Georges-d'Orques : ateliers adaptés au commerce de proximité, à l'artisan BTP, au cabinet libéral, au domaine viticole ou au caveau de dégustation. Équipes formées et autonomes sur outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Saint-Georges-d'Orques : automatisation devis BTP, chatbot client commerces, agents IA prise de RDV professions libérales, gestion AOC viticole, chatbot œnotouristique multilingue, classification d'avis. Code custom RGPD.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Georges-d'Orques et dans quelles communes proches ?",
      a: "Oui, Axion-IA intervient à Saint-Georges-d'Orques et dans les communes limitrophes : Pignan, Lavérune, Juvignac, Grabels, Murviel-lès-Montpellier, Montarnaud. Nos consultants se déplacent depuis Montpellier en 10 min.",
    },
    {
      q: "Quels sont vos tarifs pour une mission IA à Saint-Georges-d'Orques ?",
      a: "L'Audit sur place démarre à {{price:audit-flash|flat}} (diagnostic 2 jours). La formation collective démarre à {{price:intervention-4h|flat}}. Le coaching 1-to-1 démarre à {{price:intervention-dirigeants|flat}}. Tarifs publics affichés, pas de devis opaque.",
    },
    {
