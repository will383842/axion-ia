...
// Valognes (50, Manche) — "Versailles normand", ville aristocratique du Cotentin, hôtels particuliers.
...
export const VALOGNES_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Valognes, le « Versailles normand », conserve un patrimoine d'hôtels particuliers XVIIe-XVIIIe et un centre historique animé. L'économie locale repose sur le commerce de centre-ville, l'artisanat, l'agroalimentaire cidricole (cidreries, calvados, poiré), l'élevage normand, les services de proximité et le tourisme patrimonial. Carrefour routier du Cotentin, entre Cherbourg (20 min) et Carentan (25 min).",
  distancesFr:
    "Gare de Valognes (TER Cherbourg-Caen-Paris, 2 h 45 Paris). Cherbourg à 20 min. Carentan à 25 min. Saint-Lô à 45 min. Caen à 1 h 10. Aéroport Cherbourg-Maupertus à 15 min.",
  distancesEn:
    "Gare de Valognes (TER Cherbourg-Caen-Paris, 2 h 45 Paris). Cherbourg à 20 min. Carentan à 25 min. Saint-Lô à 45 min. Caen à 1 h 10. Aéroport Cherbourg-Maupertus à 15 min.",
  topSectorsNaf: [
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Valognes : formats adaptés à la cidrerie, au commerce, à l'exploitation d'élevage, au site patrimonial. Vos équipes repartent autonomes sur les outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Valognes : automatisation traçabilité cidre AOC, prédiction fermentation, agents IA accueil tourisme patrimonial, gestion stocks commerces, CRM éleveurs normands.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Valognes et dans le Cotentin ?",
      a: "Oui, Axion-IA intervient à Valognes et dans tout le Cotentin (Cherbourg, Carentan, Bricquebec, Saint-Sauveur-le-Vicomte). Nos consultants se déplacent depuis Cherbourg (20 min) ou Caen (1 h 10), ou en visio.",
    },
    {
      q: "Accompagnez-vous les producteurs cidricoles du Cotentin ?",
      a: "Oui, nous accompagnons les PME cidricoles du Cotentin (cidre, calvados, poiré) : automatisation traçabilité AOC, prédiction fermentation, optimisation logistique, classification qualité, marketing digital. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
