...
export const INZINZAC_LOCHRIST_COPY: VilleCopy = {
  ...
  pitchEn:
    "Inzinzac-Lochrist (56), commune de la vallée du Blavet héritière des historiques forges d'Hennebont, accueille un tissu de TPE/PME industrielles, agroalimentaires, artisans BTP, commerces, professions libérales et entreprises tertiaires de l'agglomération lorientaise. Axion-IA opère pour toutes les structures économiques de la commune du bassin lorientais.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Inzinzac-Lochrist (56). Nous accompagnons TPE et PME : PME industrielles héritières des forges, PME agroalimentaires, artisans BTP, commerçants, professions libérales et entreprises tertiaires de Lorient Agglomération.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Inzinzac-Lochrist (56). Nous accompagnons TPE et PME : PME industrielles héritières des forges, PME agroalimentaires, artisans BTP, commerçants, professions libérales et entreprises tertiaires de Lorient Agglomération.",
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Inzinzac-Lochrist : sessions dans vos locaux, atelier, cabinet ou en visio. Dirigeants TPE/PME de la vallée du Blavet souhaitant maîtriser l'IA dans leur activité industrielle, agroalimentaire, artisanale ou tertiaire.",
      en: "Coaching 1-to-1 à Inzinzac-Lochrist : sessions dans vos locaux, atelier, cabinet ou en visio. Dirigeants TPE/PME de la vallée du Blavet souhaitant maîtriser l'IA dans leur activité industrielle, agroalimentaire, artisanale ou tertiaire.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les TPE artisans BTP à Inzinzac-Lochrist (construction, rénovation, second œuvre, paysagistes) sur des cas IA pratiques : automatisation devis chantier, agents IA prise de RDV, suivi photos chantier, gestion planning et stocks matériaux.",
    },
    {
