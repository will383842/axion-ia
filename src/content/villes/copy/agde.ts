...
export const AGDE_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Agde concentre une économie balnéaire dense autour du Cap d'Agde (port de plaisance de 3 000 anneaux, plage naturiste de 1,4 km — la plus grande d'Europe, hôtellerie de plein air massive) et du Grau d'Agde (pêche méditerranéenne). Les TPE et PME structurent quatre filières clés : hôtellerie-restauration saisonnière, conchyliculture et ostréiculture de l'étang de Thau (Bouzigues, Mèze à proximité), viticulture AOC Languedoc / Picpoul-de-Pinet / Côtes-de-Thau, et commerce de proximité plus BTP de rénovation résidentielle. Le patrimoine (cathédrale fortifiée Saint-Étienne, Musée Agathois) ajoute un levier tourisme culturel hors saison à valoriser via l'IA.",
  distancesFr:
    "Agde est connectée à l'A9 (sortie 34 Agde / Pézenas), avec sa propre gare SNCF / TGV (Paris ~4 h direct). Béziers est à 25 km à l'ouest, Sète à 25 km à l'est, Montpellier à 50 km au nord-est, et l'aéroport Béziers Cap d'Agde à 12 km. Nos architectes IA seniors se déplacent en intra-journée depuis l'axe Marseille — Montpellier — Toulouse.",
  distancesEn:
    "Agde est connectée à l'A9 (sortie 34 Agde / Pézenas), avec sa propre gare SNCF / TGV (Paris ~4 h direct). Béziers est à 25 km à l'ouest, Sète à 25 km à l'est, Montpellier à 50 km au nord-est, et l'aéroport Béziers Cap d'Agde à 12 km. Nos architectes IA seniors se déplacent en intra-journée depuis l'axe Marseille — Montpellier — Toulouse.",
  topSectorsNaf: [
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Oui, nos architectes IA seniors interviennent directement au Cap d'Agde, au Grau d'Agde, à la Tamarissière et dans le centre historique d'Agde. Les déplacements depuis l'axe Marseille — Montpellier — Toulouse sont organisés en intra-journée pour les hôtels, campings, restaurants et conciergeries de la station.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos architectes IA seniors démarrent généralement sous 5 à 10 jours ouvrés à Agde, en privilégiant les fenêtres hors pic de saison pour les hôteliers et restaurateurs. En urgence (avant ouverture estivale ou pour un dossier conchylicole sensible), nous pouvons mobiliser une équipe en intra-semaine.",
    },
  ],
};
