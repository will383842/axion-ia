...
// Lamorlaye (60, Oise) — Forêt de Chantilly, hippisme, 9 082 hab.
...
export const LAMORLAYE_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Lamorlaye est une commune résidentielle prisée en lisière de la forêt de Chantilly, au cœur du bassin hippique de l'Oise. Son économie s'appuie sur la filière équestre (centres d'entraînement, haras, prestataires équins), les services aux particuliers, le commerce de proximité et les professions libérales. Le bassin d'emploi s'articule avec Chantilly, Gouvieux et Coye-la-Forêt, et bénéficie de la proximité de la gare TER Chantilly-Gouvieux et de l'aéroport Paris-CDG.",
  distancesFr:
    "Paris à 40 min via A1. Chantilly à 5 min. Senlis à 15 min via D924. Aéroport Paris-CDG à 25 min. Gare SNCF Chantilly-Gouvieux à 5 min (TER Paris-Nord en 25 min).",
  distancesEn:
    "Paris à 40 min via A1. Chantilly à 5 min. Senlis à 15 min via D924. Aéroport Paris-CDG à 25 min. Gare SNCF Chantilly-Gouvieux à 5 min (TER Paris-Nord en 25 min).",
  seoHook: "filière équestre, résidentiel & professions libérales",
  topSectorsNaf: [
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Lamorlaye : formats adaptés au centre d'entraînement, au commerce, au cabinet libéral ou en visio. Vos équipes repartent autonomes.",
    },
    implementation: {
      fr: "Implémentation IA à Lamorlaye : gestion planning centres équestres, automatisation facturation haras, OCR documents professions libérales, optimisation stocks commerce, suivi clientèle et comptabilité.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Lamorlaye et dans le bassin de Chantilly ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les professions libérales de Lamorlaye et du bassin de Chantilly : automatisation secrétariat, OCR documents, gestion agenda et rendez-vous, analyse données clients, conformité RGPD et facturation automatisée.",
    },
    {
