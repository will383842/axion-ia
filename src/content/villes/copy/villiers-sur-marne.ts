...
export const VILLIERS_SUR_MARNE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "À Villiers-sur-Marne, un Audit Flash sur site ({{price:audit-flash|flat}}, 4 h) permet à un dirigeant de TPE ou PME du commerce, du BTP ou de la logistique de cartographier les processus automatisables et de chiffrer un plan d'action concret.",
      en: "À Villiers-sur-Marne, un Audit Flash sur site ({{price:audit-flash|flat}}, 4 h) permet à un dirigeant de TPE ou PME du commerce, du BTP ou de la logistique de cartographier les processus automatisables et de chiffrer un plan d'action concret.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Nos tarifs publics s'appliquent à Villiers-sur-Marne comme partout en France : Audit Flash 4 h à {{price:audit-flash|flat}}, Intervention Essentielle à {{price:intervention-4h|flat}}, accompagnement un-à-un dès {{price:intervention-dirigeants|flat}}. Devis envoyé sous 48 h, pas de forfait caché.",
    },
    {
