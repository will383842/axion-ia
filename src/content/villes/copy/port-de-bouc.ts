...
// Port-de-Bouc (13, Bouches-du-Rhône) — Golfe Fos, industrie portuaire.
...
export const PORT_DE_BOUC_COPY: VilleCopy = {
  ...
  pitchEn:
    "Port-de-Bouc (13), commune industrielle et portuaire sur le golfe de Fos dans les Bouches-du-Rhône, accueille un tissu économique dense autour de la pétrochimie, la logistique maritime et les services associés. TPE sous-traitants industriels, PME maintenance et ingénierie, commerces de centre-ville. Axion-IA répond aux besoins des activités professionnelles présentes du bassin de Fos-sur-Mer.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Port-de-Bouc (13). Nous accompagnons TPE sous-traitants industriels, PME maintenance et ingénierie du golfe de Fos, commerces de proximité et entreprises de la zone industrialo-portuaire. Audit sur place sur mesure, sans engagement.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Port-de-Bouc (13). Nous accompagnons TPE sous-traitants industriels, PME maintenance et ingénierie du golfe de Fos, commerces de proximité et entreprises de la zone industrialo-portuaire. Audit sur place sur mesure, sans engagement.",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Port-de-Bouc : formats adaptés à l'industrie, la maintenance et la logistique portuaire. Vos équipes repartent autonomes sur les outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Port-de-Bouc : automatisation reporting maintenance, agents conversationnels logistique, extraction données industrielles. Bassin de Fos.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Port-de-Bouc et sur le golfe de Fos ?",
      a: "Oui, Axion-IA intervient à Port-de-Bouc et sur l'ensemble du golfe de Fos (Martigues, Fos-sur-Mer, Istres). Nos consultants couvrent tout le bassin industrialo-portuaire des Bouches-du-Rhône ouest.",
    },
    {
      q: "Quels sont les tarifs pour un audit IA à Port-de-Bouc ?",
      a: "L'Audit sur place de 4 heures est proposé à {{price:audit-flash|flat}}. Pour les PME industrielles du golfe de Fos, l'audit Stratégique approfondi est disponible. Tous les tarifs sont publics et sans engagement.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous intervenons auprès des entreprises de logistique maritime et portuaire du golfe de Fos : optimisation flux, agents IA traçabilité, automatisation documents douaniers, analyse prédictive stocks.",
    },
    {
