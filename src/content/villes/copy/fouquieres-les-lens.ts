...
export const FOUQUIERES_LES_LENS_COPY: VilleCopy = {
  ...
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient a Fouquieres-les-Lens (62). Nous accompagnons les TPE, PME et ETI du bassin minier lensois : artisans, commercants, prestataires de services et professions liberales. Audit sur place a partir de {{price:audit-flash|flat}}.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient a Fouquieres-les-Lens (62). Nous accompagnons les TPE, PME et ETI du bassin minier lensois : artisans, commercants, prestataires de services et professions liberales. Audit sur place a partir de {{price:audit-flash|flat}}.",
  ecosystemFr:
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Pour les artisans du bassin lensois, nous proposons : automatisation devis et facturation, planning chantiers IA, suivi client numerique, gestion stocks. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les restaurateurs du Lensois : gestion reservations IA, automatisation commandes fournisseurs, agents conversationnels, gestion avis clients. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
