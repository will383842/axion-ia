...
// Ploemeur (56, Morbihan) — Agglomération de Lorient, littoral atlantique, nautisme.
...
export const PLOEMEUR_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Ploemeur et dans le pays de Lorient ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les professionnels du nautisme et de la plaisance (chantiers navals, ports, écoles de voile, loueurs) sur leurs cas IA : automatisation réservations, gestion flotte, maintenance prédictive, traduction multilingue et présence en ligne augmentée.",
    },
    {
      q: "Quels services IA pour les hôteliers et restaurateurs de Ploemeur ?",
      a: "Pour les hôteliers et restaurateurs ploemeurois, nous proposons : Audit sur place {{price:audit-flash|flat}}, intervention formation 1 journée, coaching 1-to-1. Cas typiques : agents IA réservation, yield management saisonnier, fidélisation, traduction multilingue, automatisation menus et avis clients.",
    },
    {
      q: "Comment se déroule une mission Axion-IA à Ploemeur ?",
      a: "Après un premier échange gratuit, nous planifions l'intervention sous 5 jours. Nos consultants interviennent sur site à Ploemeur ou en visio. Chaque mission inclut un livrable actionnable, un plan IA chiffré et un suivi post-mission de 30 jours.",
    },
  ],
};
