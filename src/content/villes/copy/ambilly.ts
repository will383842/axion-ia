...
// Ambilly (74, Haute-Savoie) — agglomération Grand Genève/Annemasse, commune frontalière suisse.
...
export const AMBILLY_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Ambilly et dans le Grand Genève ?",
      a: "Oui, Axion-IA intervient à Ambilly et toute l'agglomération du Grand Genève côté français : Annemasse, Gaillard, Ville-la-Grand, Vétraz-Monthoux, Cranves-Sales. Couverture également Genève et bassin lémanique.",
    },
    {
      q: "Accompagnez-vous les entreprises sur la gestion transfrontalière ?",
      a: "Oui, nous accompagnons les commerces et PME frontaliers sur leurs cas IA spécifiques : automatisation facturation CHF/EUR, gestion douanière, chatbot multilingue clientèle suisse, classification documents import/export, réconciliation comptable multi-devises.",
    },
    {
