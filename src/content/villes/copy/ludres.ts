...
// Ludres (54, Meurthe-et-Moselle) — sud Nancy, zones d'activités, résidentielle.
...
export const LUDRES_COPY: VilleCopy = {
  ...
  distancesEn:
    "Nancy centre à 15 min. Autoroute A330 et A33 accès direct. Gare SNCF Ludres (ligne Nancy–Épinal). Metz à 50 min. Aéroport Metz-Nancy-Lorraine à 30 min. Luxembourg à 1h45.",
  seoHook: "zones d'activités & résidentiel",
  topSectorsNaf: [
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Ludres ?",
      a: "Oui, Axion-IA intervient à Ludres et dans les zones d'activités du sud nancéien (Houdemont, Fléville-devant-Nancy, Heillecourt). Consultants via gare SNCF Ludres ou autoroute A330.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, commerçants et artisans de Ludres : gestion stocks, relation client, automatisation comptabilité, présence en ligne. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
