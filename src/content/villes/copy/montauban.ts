...
export const MONTAUBAN_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit Flash 4h à Montauban pour TPE et PME tarn-et-garonnaises — diagnostic des processus (gestion commerciale, planification transport, suivi chantier). À partir de 490 € HT, livrable sous 5 jours.",
    ...
    implementation: {
      ...
      en: "Implémentation IA code-first à Montauban : intégration API métier, agents internes, automatisations pour PME du commerce Albasud, BTP, transport-logistique A20. À partir de 990 € HT.",
    },
    unAUn: {
      fr: "Sessions un-à-un avec dirigeants de TPE et PME montalbanaises pour cadrer la feuille de route IA : priorisation, ROI, conformité RGPD. À partir de 990 € HT.",
      en: "Sessions un-à-un avec dirigeants de TPE et PME montalbanaises pour cadrer la feuille de route IA : priorisation, ROI, conformité RGPD. À partir de 990 € HT.",
    },
  },
  faqGeolocalisee: [
    {
      q: "Quels sont les tarifs d'Axion-IA pour une intervention à Montauban ?",
      a: "Audit Flash 4h dès 490 € HT, Intervention Essentielle dès 590 € HT, implémentation et sessions un-à-un dès 990 € HT. Frais de déplacement à Montauban (Tarn-et-Garonne, 55 km de Toulouse) inclus dans le devis.",
    },
    {
