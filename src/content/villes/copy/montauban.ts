  ...
  faqGeolocalisee: [
    {
      ...
      a: "Audit Flash 4h dès {{price:audit-flash|flat}}, Intervention Essentielle dès {{price:intervention-4h|flat}}, implémentation et sessions un-à-un dès {{price:intervention-dirigeants|flat}}. Frais de déplacement à Montauban (Tarn-et-Garonne, 55 km de Toulouse) inclus dans le devis.",
    },
    {
