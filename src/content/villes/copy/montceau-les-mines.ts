...
// Montceau-les-Mines (71, Saône-et-Loire) — Bassin minier reconverti, canal du Centre, industrie.

import type { VilleCopy } from "./types";

export const MONTCEAU_LES_MINES_COPY: VilleCopy = {
  pitchFr:
  ...
  ecosystemEn:
    "Montceau-les-Mines est le pôle économique du bassin minier reconverti Blanzy-Montceau (~45 000 hab agglomération) en Saône-et-Loire. Reconversion industrielle réussie : TPE/PME métallurgie, mécanique, plasturgie, logistique canal du Centre, artisanat BTP, commerces, centre hospitalier, IUT et organismes de formation. Proximité Le Creusot (15 min) et Chalon-sur-Saône (40 min).",
  distancesFr:
    "Gare de Montceau-les-Mines (TER vers Paray-le-Monial 30 min). Gare TGV Le Creusot-Montceau-Montchanin à 15 min (Paris 1h20 TGV). Aéroport Lyon-Saint-Exupéry à 1h30. Axe RCEA vers Mâcon et Moulins. Canal du Centre navigable.",
  distancesEn:
    "Gare de Montceau-les-Mines (TER vers Paray-le-Monial 30 min). Gare TGV Le Creusot-Montceau-Montchanin à 15 min (Paris 1h20 TGV). Aéroport Lyon-Saint-Exupéry à 1h30. Axe RCEA vers Mâcon et Moulins. Canal du Centre navigable.",
  topSectorsNaf: [
    ...
    "Santé, formation & services à la personne",
  ],
  servicesContext: {
    audit: {
      fr: "Audit IA à Montceau-les-Mines : diagnostic adapté aux TPE/PME industrielles du bassin montcellien, artisans, commerçants et professions de santé. Audit Flash 490 € HT, ROI chiffré, livrable sous 5 jours.",
    ...
    implementation: {
      ...
      en: "Implémentation IA à Montceau-les-Mines : prédiction maintenance industrielle, contrôle qualité vision, optimisation supply chain, automatisation devis BTP, agents conversationnels. Bassin montcellien.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Montceau-les-Mines : sessions dans votre atelier, bureau, commerce ou en visio. Dirigeants TPE/PME industrielles, artisans, commerçants et formateurs du bassin montcellien souhaitant intégrer l'IA.",
      en: "Coaching 1-to-1 à Montceau-les-Mines : sessions dans votre atelier, bureau, commerce ou en visio. Dirigeants TPE/PME industrielles, artisans, commerçants et formateurs du bassin montcellien souhaitant intégrer l'IA.",
    },
  },
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Montceau-les-Mines et dans le bassin montcellien ?",
    ...
    },
    {
      ...
      a: "Nous accompagnons les TPE/PME industrielles du bassin montcellien : prédiction maintenance, contrôle qualité par vision, optimisation production, classification documents techniques, automatisation reporting et agents conversationnels.",
    },
    {
      q: "Accompagnez-vous les artisans et commerçants de Montceau ?",
      a: "Oui, pour les TPE artisans BTP et commerçants de Montceau-les-Mines : audit Flash 490 € HT, interventions formation, coaching 1-to-1. Automatisation devis, agents IA, gestion stocks, marketing local.",
    },
    {
