...
// Saint-Alban-Leysse (73, Savoie) — agglomération Chambéry (Grand Chambéry), résidentiel, PME tertiaires et professions libérales.
...
export const SAINT_ALBAN_LEYSSE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Saint-Alban-Leysse (73), commune résidentielle de l'agglomération de Chambéry au sein de Grand Chambéry en Savoie. PME tertiaires, professions libérales, TPE artisanat, commerces de proximité, services. Axion-IA y déploie son expertise pour toutes les organisations.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Saint-Alban-Leysse (73). Nous accompagnons TPE et PME : entreprises tertiaires de Grand Chambéry, professions libérales, artisans, commerçants de proximité et sociétés de services.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Saint-Alban-Leysse (73). Nous accompagnons TPE et PME : entreprises tertiaires de Grand Chambéry, professions libérales, artisans, commerçants de proximité et sociétés de services.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Alban-Leysse ?",
      a: "Oui, Axion-IA intervient à Saint-Alban-Leysse et toute l'agglomération Grand Chambéry (Chambéry, La Ravoire, Barberaz, Cognin, Challes-les-Eaux). Couverture étendue Savoie et sillon alpin.",
    },
    {
      q: "Accompagnez-vous les professions libérales de Saint-Alban-Leysse ?",
      a: "Oui, nous accompagnons les professions libérales de Saint-Alban-Leysse (cabinets médicaux, avocats, comptables, architectes) : agents IA gestion agenda, automatisation administratif, classification documents, outils dictée IA.",
    },
    {
      q: "Quels services pour les PME tertiaires de Grand Chambéry ?",
      a: "Pour les PME tertiaires de Grand Chambéry, audit sur place {{price:audit-flash|flat}}, interventions formation sur site, implémentation agents IA, coaching 1-to-1 dirigeants. Cas typiques : automatisation processus, relation client, reporting IA.",
    },
    {
