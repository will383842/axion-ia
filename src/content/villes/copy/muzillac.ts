...
// Muzillac (56, Morbihan) — 5 089 hab, littoral Morbihan, marais Arzal, carrefour Vilaine-océan.
...
export const MUZILLAC_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Muzillac : formats adaptés aux professionnels du tourisme, ostréiculteurs, commerçants, artisans. Vos équipes repartent autonomes sur outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Muzillac : automatisation réservations tourisme littoral, gestion saisonnalité ostréicole, agents conversationnels multilingue, classification avis clients.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Muzillac et littoral Morbihan ?",
      a: "Oui, Axion-IA intervient à Muzillac et sur tout le littoral morbihannais (La Roche-Bernard, Damgan, Ambon, Billiers). Consultants depuis Vannes (25 min) ou Nantes (1h15). Couverture complète bassin Vilaine-océan.",
    },
    {
      q: "Travaillez-vous avec les ostréiculteurs et acteurs de la pêche ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les acteurs du tourisme littoral à Muzillac et alentours : hôtels, campings, restaurants, locations saisonnières. Automatisation réservations, agents conversationnels multilingue, classification avis clients, gestion saisonnalité.",
    },
    {
