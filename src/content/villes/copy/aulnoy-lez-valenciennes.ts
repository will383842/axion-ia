...
// Aulnoy-lez-Valenciennes (59, Nord) — agglo Valenciennes, universite UPHF, 7 080 hab.
...
export const AULNOY_LEZ_VALENCIENNES_COPY: VilleCopy = {
  ...
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient a Aulnoy-lez-Valenciennes (59). Nous accompagnons les TPE, PME et ETI du Valenciennois : PME tertiaires, startups UPHF, artisans, commercants et professions liberales. Audit sur place a partir de {{price:audit-flash|flat}}.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient a Aulnoy-lez-Valenciennes (59). Nous accompagnons les TPE, PME et ETI du Valenciennois : PME tertiaires, startups UPHF, artisans, commercants et professions liberales. Audit sur place a partir de {{price:audit-flash|flat}}.",
  ecosystemFr:
  ...
  ecosystemEn:
    "Aulnoy-lez-Valenciennes heberge le campus principal de l'UPHF (Universite Polytechnique Hauts-de-France), pole d'enseignement superieur et de recherche (ingenierie, numerique, transports). Ce voisinage universitaire nourrit un ecosysteme de startups, PME tertiaires, commerces etudiants et services aux entreprises du Valenciennois.",
  distancesFr:
    "Gare de Valenciennes a 5 min. Lille-Flandres a 45 min en TER. Gare Lille Europe (TGV) a 50 min. Aeroport Lille-Lesquin a 1h. Paris-Nord a 1h50 en TGV depuis Valenciennes.",
  distancesEn:
    "Gare de Valenciennes a 5 min. Lille-Flandres a 45 min en TER. Gare Lille Europe (TGV) a 50 min. Aeroport Lille-Lesquin a 1h. Paris-Nord a 1h50 en TGV depuis Valenciennes.",
  topSectorsNaf: [
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site a Aulnoy-lez-Valenciennes : formations adaptees au bureau tertiaire, a la startup tech ou au commerce. Equipes autonomes sur outils IA.",
    },
    implementation: {
      fr: "Implementation IA a Aulnoy-lez-Valenciennes : agents conversationnels, automatisation workflow, CRM augmentes, outils IA sur mesure pour PME tertiaires et startups UPHF.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il a Aulnoy-lez-Valenciennes et dans le Valenciennois ?",
      a: "Oui, Axion-IA intervient a Aulnoy-lez-Valenciennes et dans tout le Valenciennois (Valenciennes, Marly, Petite-Foret, Anzin). Consultants depuis Lille (45 min TER) ou Paris (TGV Valenciennes 1h50).",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, toutes nos interventions a Aulnoy-lez-Valenciennes sont conformes au RGPD. Protection des donnees de votre entreprise et de vos clients garantie contractuellement.",
    },
  ],
};
