...
// Cournonterral (34, Hérault) — 7 359 hab. (2023), à 15 km nord-est de Montpellier, vignoble AOC Languedoc.
...
export const COURNONTERRAL_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Cournonterral : ateliers adaptés au commerce de proximité, à l'artisan BTP, au cabinet libéral, au domaine viticole ou à la cave coopérative. Équipes formées et autonomes sur outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Cournonterral : automatisation devis artisans BTP, chatbot client commerces, agents IA prise de RDV professions libérales, gestion vignoble et cave coopérative. Code custom RGPD, pas de no-code.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Cournonterral et dans quelles communes proches ?",
      a: "Oui, Axion-IA intervient à Cournonterral et dans les communes limitrophes : Cournonsec, Fabrègues, Pignan, Montbazin, Aumelas, Saint-Paul-et-Valmalle. Nos consultants se déplacent depuis Montpellier en 20 min via la D5.",
    },
    {
