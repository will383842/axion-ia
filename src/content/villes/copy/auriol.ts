...
// Auriol (13, Bouches-du-Rhône) — Est Marseille, Huveaune, vignoble.
...
export const AURIOL_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Auriol : formats adaptés au domaine viticole, à l'atelier artisan et au cabinet. Vos équipes repartent autonomes sur outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Auriol : automatisation traçabilité viticole, agents IA gestion domaine, extraction données comptables, optimisation planning artisan.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Auriol et vallée de l'Huveaune ?",
      a: "Oui, Axion-IA intervient à Auriol et dans toute la vallée de l'Huveaune (Roquevaire à 5 min, Aubagne à 15 min, Trets à 15 min). Couverture complète de l'est marseillais et piémont Sainte-Baume.",
    },
    {
