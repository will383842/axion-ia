...
export const PUTEAUX_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit Flash IA à Puteaux dès {{price:audit-flash|flat}} — William se déplace dans vos locaux à La Défense ou en centre-ville pour cartographier vos processus en 4 heures.",
      en: "Audit Flash IA à Puteaux dès {{price:audit-flash|flat}} — William se déplace dans vos locaux à La Défense ou en centre-ville pour cartographier vos processus en 4 heures.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "À Puteaux, l'Audit Flash débute à {{price:audit-flash|flat}} (4 heures sur site), l'Intervention Essentielle à {{price:intervention-4h|flat}} et l'accompagnement 1-to-1 dirigeant à {{price:intervention-dirigeants|flat}}. Tarifs publics consultables sur axion-ia.com.",
    },
    {
    ...
    },
    {
      ...
      a: "Pour une TPE ou PME implantée à Puteaux, l'Audit Flash est planifiable sous 5 jours ouvrés. Une Intervention Essentielle démarre sous 10 à 15 jours selon périmètre.",
    },
    {
