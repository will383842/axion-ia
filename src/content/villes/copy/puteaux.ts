...
export const PUTEAUX_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit sur place IA à Puteaux dès {{price:audit-flash|flat}} — William se déplace dans vos locaux à La Défense ou en centre-ville pour cartographier vos processus en 4 heures.",
