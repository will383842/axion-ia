...
export const SALON_DE_PROVENCE_COPY: VilleCopy = {
  ...
  topSectorsNaf: [
    ...
    "Services aux entreprises (88 % du tissu local)",
    "Artisanat du bâtiment et construction",
    "Oléiculture, savonnerie et huiles d'olive AOP",
    "Maraîchage et agriculture de la Crau",
    "Hôtellerie-restauration et tourisme provençal",
  ],
  servicesContext: {
    audit: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Nos prestations à Salon-de-Provence démarrent à 490 € HT pour un audit flash 4h et à 590 € HT pour une intervention sur site. La grille tarifaire est publique sur axion-ia.com.",
    },
    {
    ...
    },
    {
      ...
      a: "Nous nous déplaçons depuis Salon-de-Provence vers Pélissanne, Grans, Lançon-Provence, Lamanon, Aurons, Eyguières, Miramas et Saint-Martin-de-Crau, ainsi que vers Aix-en-Provence et Marseille via l'A7.",
    },
    {
