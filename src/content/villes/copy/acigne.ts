...
export const ACIGNE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Acigné : diagnostic adapté aux TPE artisans, PME de services, commerçants et professions libérales de l'est rennais, vallée de la Vilaine. Audit Flash 490 € HT, ROI chiffré.",
      en: "Audit IA à Acigné : diagnostic adapté aux TPE artisans, PME de services, commerçants et professions libérales de l'est rennais, vallée de la Vilaine. Audit Flash 490 € HT, ROI chiffré.",
    },
    interventions: {
