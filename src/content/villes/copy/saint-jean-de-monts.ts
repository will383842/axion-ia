...
// Saint-Jean-de-Monts (85, Vendée) — Station balnéaire, forêt domaniale.
...
export const SAINT_JEAN_DE_MONTS_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Saint-Jean-de-Monts est l'une des premières stations balnéaires de Vendée avec 8 km de plages et une forêt domaniale de 830 ha. Économie dominée par le tourisme : plus de 100 000 estivants en été, forte densité campings et résidences. Noirmoutier à 20 min, Challans à 15 min, Nantes à 1h.",
  distancesFr:
    "Challans à 15 min. Noirmoutier à 20 min. Nantes à 1h. La Roche-sur-Yon à 50 min. Saint-Gilles-Croix-de-Vie à 20 min.",
  distancesEn:
    "Challans à 15 min. Noirmoutier à 20 min. Nantes à 1h. La Roche-sur-Yon à 50 min. Saint-Gilles-Croix-de-Vie à 20 min.",
  topSectorsNaf: [
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Jean-de-Monts et sur la côte vendéenne ?",
      a: "Oui, Axion-IA intervient à Saint-Jean-de-Monts et sur toute la côte vendéenne (Noirmoutier, Saint-Hilaire-de-Riez, Les Sables-d'Olonne). Consultants depuis Nantes (1h) ou La Roche-sur-Yon (50 min).",
    },
    {
      q: "Quels services IA pour les campings de Saint-Jean-de-Monts ?",
      a: "Audit sur place {{price:audit-flash|flat}}, interventions sur site, coaching 1-to-1, implémentation IA. Cas campings : yield management, réservation IA multilingue, prédiction affluence, gestion saisonnalité, marketing automatisé.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants interviennent depuis Nantes (1h) ou La Roche-sur-Yon (50 min). Déplacement sur site dans votre camping, hôtel, restaurant ou commerce. Interventions possibles en pré-saison ou hors-saison.",
    },
  ],
};
