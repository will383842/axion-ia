...
export const CHAVILLE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Chaville : diagnostic des tâches automatisables pour professions libérales, conseil, commerces et services de proximité. Audit Flash dès 490 € HT, livrable priorisé.",
      en: "Audit IA à Chaville : diagnostic des tâches automatisables pour professions libérales, conseil, commerces et services de proximité. Audit Flash dès 490 € HT, livrable priorisé.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'Audit Flash démarre à 490 € HT, avec une grille tarifaire publique. Il est adapté aux TPE et PME chavilloises : professions libérales, conseil, commerces et services de proximité.",
    },
    {
