...
// Ouistreham (14, Calvados) — Port ferry Caen-Portsmouth, plages du Débarquement Sword Beach.
...
export const OUISTREHAM_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Ouistreham : formats adaptés à l'hôtel, restaurant, port de plaisance, commerce saisonnier ou site touristique. Vos équipes repartent autonomes sur outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Ouistreham : agents conversationnels multilingues touristes ferry, gestion saisonnalité hôtelière, automatisation réservations nautiques, classification avis clients.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Ouistreham et sur la Côte de Nacre ?",
      a: "Oui, Axion-IA intervient à Ouistreham et toute la Côte de Nacre (Douvres-la-Délivrande, Lion-sur-Mer, Courseulles-sur-Mer, Langrune). Consultants depuis Caen (15 min D515).",
    },
    {
      q: "Travaillez-vous avec les acteurs du tourisme Débarquement ?",
      a: "Oui, nous accompagnons les acteurs du tourisme Débarquement (Sword Beach, Musée Mur de l'Atlantique) sur leurs cas IA : agents conversationnels multilingues visiteurs, automatisation billetterie, classification avis, gestion flux saisonniers.",
    },
    {
      q: "Quels services pour les hôteliers-restaurateurs d'Ouistreham ?",
      a: "Pour les hôteliers-restaurateurs d'Ouistreham, audit sur place {{price:audit-flash|flat}}, interventions formations, coaching 1-to-1. Cas typiques : agents IA réservation multilingues (clientèle ferry UK), prédiction taux d'occupation, classification avis.",
    },
    {
