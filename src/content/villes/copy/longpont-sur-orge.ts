...
// Longpont-sur-Orge (91, Essonne) — Basilique Notre-Dame, 25km SO Paris, Hurepoix, résidentielle.
...
export const LONGPONT_SUR_ORGE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Longpont-sur-Orge : diagnostic adapté aux TPE artisanales, commerces, PME tertiaires et professions libérales du Hurepoix. Audit Flash {{price:audit-flash|flat}}, ROI documenté en chiffres.",
      en: "Audit IA à Longpont-sur-Orge : diagnostic adapté aux TPE artisanales, commerces, PME tertiaires et professions libérales du Hurepoix. Audit Flash {{price:audit-flash|flat}}, ROI documenté en chiffres.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Longpont-sur-Orge et Hurepoix ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les professions libérales à Longpont-sur-Orge (cabinets, consultants, praticiens) sur leurs cas IA : transcription, automatisation gestion RDV, agents conversationnels clients. RGPD strict.",
    },
    {
      q: "Travaillez-vous avec les PME tertiaires du Hurepoix ?",
      a: "Oui, implémentation IA pour PME tertiaires du Hurepoix : CRM augmentés, classification documents, automatisations workflow. Tarifs publics, ROI chiffré contractuel.",
    },
    {
