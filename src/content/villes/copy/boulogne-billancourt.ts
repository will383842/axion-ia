...
export const BOULOGNE_BILLANCOURT_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA opérationnel à Boulogne-Billancourt : nous cartographions ce qui peut être automatisé dans votre entreprise et chiffrons le ROI. 4 niveaux du Sur place au Stratégique ETI, du cabinet boulonnais au grand groupe du Trapèze ou du Quai du Point-du-Jour.",
  ...
  services: {
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Boulogne-Billancourt des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 24-48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Boulogne-Billancourt, itérations à distance.",
        whyHere: [
          "Projets web & SaaS boulonnais : sièges & grands comptes (Renault, TF1, Boursorama), district médias & finance, quartier d'affaires du Trapèze (1re ZAC tertiaire d'Île-de-France hors La Défense), PME de la proche couronne.",
          ...
          "Médias & finance : plateformes éditoriales, portails, data et agents — pour les grands comptes et scale-ups boulonnaises. Hébergement UE, RGPD strict.",
        ],
        methodology: [
          {
            step: "Cadrage à Boulogne-Billancourt",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une application avec UX/UI et IA intégrée, pour scale-ups, agences et PME boulonnaises.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Plateforme métier, éditoriale ou portail client sur mesure, IA intégrée, branchée sur votre SI (CRM, ERP, datalake).",
          },
          {
            sizeLabel: "Grande entreprise",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Boulogne-Billancourt — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Vous travaillez pour les médias et la finance ?",
            a: "Oui : plateformes éditoriales, portails, recherche sémantique, RAG et agents pour les grands comptes médias/finance (TF1, Boursorama) et scale-ups du Trapèze. Hébergement UE, RGPD strict, confidentialité.",
          },
          {
      ...
      en: {
        hero: "In Boulogne-Billancourt, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 24-48 h depending on project complexity, EU hosting, code and data yours. On-site Boulogne-Billancourt kick-off, remote iterations.",
        whyHere: [
          "Boulogne-Billancourt web & SaaS projects: HQs & large accounts (Renault, TF1, Boursorama), media & finance district, Trapèze business district (greater Paris's leading tertiary development outside La Défense), inner-suburb SMEs.",
          ...
          "Media & finance: editorial platforms, portals, data and agents — for large accounts and Boulogne scale-ups. EU hosting, strict GDPR.",
        ],
        methodology: [
          {
            step: "Scoping in Boulogne-Billancourt",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Design or rebuild of a site or app with UX/UI and built-in AI, for scale-ups, agencies and Boulogne SMEs.",
          },
          {
            sizeLabel: "Mid-cap",
            price: "AI-native SaaS platform",
            detail:
              "Bespoke business, editorial or customer portal platform, AI built in, wired into your IS (CRM, ERP, datalake).",
          },
          {
            sizeLabel: "Large enterprise",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Boulogne-Billancourt — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Do you work for media and finance?",
            a: "Yes: editorial platforms, portals, semantic search, RAG and agents for media/finance large accounts (TF1, Boursorama) and Trapèze scale-ups. EU hosting, strict GDPR, confidentiality.",
          },
          {
