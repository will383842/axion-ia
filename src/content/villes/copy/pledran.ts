...
// Plédran (22, Côtes-d'Armor) — Agglo Saint-Brieuc, résidentielle.
...
export const PLEDRAN_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Plédran est une commune résidentielle de l'agglomération de Saint-Brieuc, à 7 km du centre-ville. L'économie locale repose sur les services aux habitants, l'artisanat BTP, le commerce de proximité, les professions libérales et l'agriculture péri-urbaine. La proximité de Saint-Brieuc offre un accès direct aux zones d'activités et pôles d'emploi de la métropole.",
  distancesFr:
    "Gare de Saint-Brieuc (TGV Paris 2h45) à 10 min. Aéroport Brest-Bretagne à 1h30. Rennes à 1h par voie express. Lamballe à 20 min.",
  distancesEn:
    "Gare de Saint-Brieuc (TGV Paris 2h45) à 10 min. Aéroport Brest-Bretagne à 1h30. Rennes à 1h par voie express. Lamballe à 20 min.",
  topSectorsNaf: [
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Plédran : formats adaptés aux PME de services, artisans BTP et professions libérales de l'agglomération briochine. Vos équipes repartent autonomes sur les outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Plédran : automatisation devis artisans, agents conversationnels cabinets libéraux, gestion planning PME, classification documents comptables. Adapté au tissu péri-urbain briochin.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Plédran et dans l'agglomération de Saint-Brieuc ?",
      a: "Oui, Axion-IA intervient à Plédran et dans toute l'agglomération de Saint-Brieuc (Ploufragan, Trégueux, Plérin, Langueux, Yffiniac). Saint-Brieuc centre à 10 min, Rennes à 1h par voie express.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants se déplacent depuis Saint-Brieuc (10 min) ou Rennes (1h). Gare TGV de Saint-Brieuc sur la ligne Paris-Brest. Frais de déplacement facturés à part du forfait journée, tarifs publics et transparents.",
    },
  ],
};
