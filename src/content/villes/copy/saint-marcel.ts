...
// Saint-Marcel (71, Saône-et-Loire) — agglo Chalon-sur-Saône, zones industrielles.
...
export const SAINT_MARCEL_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Marcel et agglomération Chalon ?",
      a: "Oui, Axion-IA intervient à Saint-Marcel et toute l'agglomération du Grand Chalon (Chalon-sur-Saône, Saint-Rémy, Châtenoy-le-Royal). Consultants depuis Lyon (1h30) ou gare TGV Le Creusot (30 min).",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, optimisation flux logistiques, automatisation gestion stocks, classification documents, agents conversationnels B2B. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
