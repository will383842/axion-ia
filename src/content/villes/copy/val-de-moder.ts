...
export const VAL_DE_MODER_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Val-de-Moder : diagnostic adapté aux TPE artisans, PME industrielles et de services, commerçants et professions libérales de la vallée de la Moder, Alsace du Nord. Audit Flash 490 € HT, ROI chiffré.",
      en: "Audit IA à Val-de-Moder : diagnostic adapté aux TPE artisans, PME industrielles et de services, commerçants et professions libérales de la vallée de la Moder, Alsace du Nord. Audit Flash 490 € HT, ROI chiffré.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'Audit Flash IA démarre à 490 € HT pour une session de 4h. Idéal pour les TPE et PME de Val-de-Moder souhaitant identifier rapidement leurs cas d'usage IA prioritaires avec ROI chiffré sous 10 jours.",
    },
    {
