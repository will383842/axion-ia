...
// Val-de-Moder (67, Bas-Rhin) — Commune nouvelle (Pfaffenhoffen), vallée Moder, Alsace du Nord.
...
export const VAL_DE_MODER_COPY: VilleCopy = {
  ...
  topSectorsNaf: [
    ...
    "Artisanat & BTP",
    "Agroalimentaire & transformation bois",
    "Commerce de proximité",
    "Professions libérales & services",
  ],
  servicesContext: {
    audit: {
      fr: "Audit IA à Val-de-Moder : diagnostic adapté aux TPE artisans, PME industrielles et de services, commerçants et professions libérales de la vallée de la Moder, Alsace du Nord. Audit Flash {{price:audit-flash|flat}}, ROI chiffré.",
      en: "Audit IA à Val-de-Moder : diagnostic adapté aux TPE artisans, PME industrielles et de services, commerçants et professions libérales de la vallée de la Moder, Alsace du Nord. Audit Flash {{price:audit-flash|flat}}, ROI chiffré.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Val-de-Moder et dans la vallée de la Moder ?",
      a: "Oui, Axion-IA intervient à Val-de-Moder (Pfaffenhoffen) et dans toute la vallée de la Moder (Bouxwiller, Ingwiller, Niederbronn-les-Bains). Nos consultants se déplacent depuis Strasbourg en 45 min via l'A4, ou Haguenau en 20 min.",
    },
    {
      q: "Quel est le tarif d'un audit IA à Val-de-Moder  ?",
      a: "L'Audit Flash IA démarre à {{price:audit-flash|flat}} pour une session de 4h. Idéal pour les TPE et PME de Val-de-Moder souhaitant identifier rapidement leurs cas d'usage IA prioritaires avec ROI chiffré sous 10 jours.",
    },
    {
    ...
    },
    {
      ...
      a: "Nos consultants interviennent depuis Strasbourg en 45 min via l'A4, ou depuis Haguenau en 20 min. Val-de-Moder est au centre de la vallée de la Moder, déplacements quotidiens optimisés. Sessions sur site ou en visio selon vos préférences.",
    },
  ],
};
