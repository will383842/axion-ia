...
export const BEAUPREAU_EN_MAUGES_COPY: VilleCopy = {
  pitchFr:
    "Beaupréau-en-Mauges (49), commune nouvelle au cœur des Mauges, conjugue un héritage industriel chaussure-textile, un solide tissu agroalimentaire et de nombreuses TPE et PME familiales d'artisanat, de transformation et de commerce. Axion-IA, cabinet d'architectes seniors en intelligence artificielle, accompagne en priorité ces TPE puis les PME mauclésiennes, plus rarement les ETI, pour déployer une IA opérationnelle qui sert les métiers de terrain sans complexité inutile ni dépendance technique.",
  pitchEn:
    "Beaupréau-en-Mauges (49), commune nouvelle au cœur des Mauges, conjugue un héritage industriel chaussure-textile, un solide tissu agroalimentaire et de nombreuses TPE et PME familiales d'artisanat, de transformation et de commerce. Axion-IA, cabinet d'architectes seniors en intelligence artificielle, accompagne en priorité ces TPE puis les PME mauclésiennes, plus rarement les ETI, pour déployer une IA opérationnelle qui sert les métiers de terrain sans complexité inutile ni dépendance technique.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Beaupréau-en-Mauges (49) auprès des TPE et PME des Mauges : ateliers chaussure et textile, agroalimentaire, artisanat, industrie et commerce. Nous diagnostiquons les tâches automatisables, déployons des outils IA fiables et formons vos équipes, sans dépendance technique. Les ETI sont accompagnées en complément.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Beaupréau-en-Mauges (49) auprès des TPE et PME des Mauges : ateliers chaussure et textile, agroalimentaire, artisanat, industrie et commerce. Nous diagnostiquons les tâches automatisables, déployons des outils IA fiables et formons vos équipes, sans dépendance technique. Les ETI sont accompagnées en complément.",
