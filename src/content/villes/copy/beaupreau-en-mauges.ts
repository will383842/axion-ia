...
export const BEAUPREAU_EN_MAUGES_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    implementation: {
      fr: "Implémentation IA à Beaupréau-en-Mauges : traçabilité agroalimentaire, automatisation devis et planning, contrôle qualité assisté et CRM augmenté pour PME et ETI industrielles.",
      en: "Implémentation IA à Beaupréau-en-Mauges : traçabilité agroalimentaire, automatisation devis et planning, contrôle qualité assisté et CRM augmenté pour PME et ETI industrielles.",
    },
    unAUn: {
      fr: "Accompagnement un-à-un à Beaupréau-en-Mauges : sessions en atelier ou en visio pour dirigeants de PME et d'ETI familiales, ciblées sur vos priorités de production et de gestion.",
      en: "Accompagnement un-à-un à Beaupréau-en-Mauges : sessions en atelier ou en visio pour dirigeants de PME et d'ETI familiales, ciblées sur vos priorités de production et de gestion.",
    },
    sitesWeb: {
    ...
    sitesWeb: {
      fr: {
        ...
        whyHere: [
          ...
          "Tissu rural-industriel de PME et ETI familiales sur les ZA Anjou Actiparc, la Grande Lande et la ZI Èvre et Loire (mécanique, produits métalliques, logistique, commerce des onze bourgs fusionnés) : on greffe une brique IA sur l'existant — widget, API, plugin WordPress ou PrestaShop — sans refonte coûteuse, ou on conçoit une vitrine e-commerce sur mesure.",
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'Audit sur place démarre à {{price:audit-flash|flat}}, avec une grille tarifaire publique. Il est adapté aux PME et ETI des Mauges : industrie, agroalimentaire, artisanat et commerce.",
    },
    {
      q: "Accompagnez-vous l'agroalimentaire des Mauges ?",
      a: "Oui, nous aidons les PME et ETI agroalimentaires à mettre en place traçabilité, prévision de la demande, contrôle qualité assisté et automatisation administrative, par étapes maîtrisées.",
    },
    {
    ...
    },
    {
      ...
      a: "Non. Nous priorisons les PME puis les ETI des Mauges ; les grands groupes sont accompagnés en complément. Chaque mission est calibrée selon votre taille, votre budget et vos cas d'usage réels.",
    },
    {
