...
export const NOGENT_SUR_SEINE_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    implementation: {
      ...
      en: "Implémentation IA à Nogent-sur-Seine : maintenance prédictive sous-traitance nucléaire, automatisation suivi parcelles céréalières, agents conversationnels tourisme Camille Claudel, classification documents TPE/PME.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Nogent-sur-Seine : sessions dans vos locaux ou en visio. Dirigeants TPE/PME industrielles, sous-traitants nucléaires, exploitants agricoles, gérants commerces souhaitant maîtriser l'IA.",
      en: "Coaching 1-to-1 à Nogent-sur-Seine : sessions dans vos locaux ou en visio. Dirigeants TPE/PME industrielles, sous-traitants nucléaires, exploitants agricoles, gérants commerces souhaitant maîtriser l'IA.",
    },
  },
  faqGeolocalisee: [
    {
