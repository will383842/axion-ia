...
export const SERVIAN_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Servian : diagnostic priorisé PME (commerces, artisans BTP, professions libérales) puis PME (viticulteurs AOC Languedoc, cave coopérative « Les Vignerons de l'Occitane », entreprises ZAC La Baume). Audit sur place {{price:audit-flash|flat}}, ROI chiffré, 4 h sur site ou visio.",
      en: "Audit IA à Servian : diagnostic priorisé PME (commerces, artisans BTP, professions libérales) puis PME (viticulteurs AOC Languedoc, cave coopérative « Les Vignerons de l'Occitane », entreprises ZAC La Baume). Audit sur place {{price:audit-flash|flat}}, ROI chiffré, 4 h sur site ou visio.",
    },
    interventions: {
      fr: "Interventions IA sur site à Servian : ateliers adaptés au format de votre PME et ETI — domaine viticole, cave coopérative « Les Vignerons de l'Occitane », entreprise ZAC La Baume, commerce, atelier artisan. Équipes formées et autonomes après une journée.",
      en: "Interventions IA sur site à Servian : ateliers adaptés au format de votre PME et ETI — domaine viticole, cave coopérative « Les Vignerons de l'Occitane », entreprise ZAC La Baume, commerce, atelier artisan. Équipes formées et autonomes après une journée.",
    },
    implementation: {
