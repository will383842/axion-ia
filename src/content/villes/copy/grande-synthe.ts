      ...
      fr: {
        ...
        methodology: [
          {
            ...
            detail:
              "Atelier sur site (zones d'activité portuaires, parc d'entreprises, cœur de ville près du Palais du Littoral) : objectifs, parcours utilisateurs, audit de la stack, des contenus et des flux métier. On repart avec un périmètre clair et un devis ferme à partir de 48 h selon la complexité.",
          },
          {
        ...
        faq: [
          ...
          },
          {
            ...
            a: "Oui. Après le cadrage sur site à Grande-Synthe, on remet un devis ferme en forfait fixe. Le délai dépend de la complexité — à partir de 48 h pour un projet simple. Pas de régie, pas de dérive horaire cachée : vous savez ce que vous payez avant de signer.",
          },
        ],
        guarantees:
          "Devis ferme en forfait fixe (à partir de 48 h selon la complexité) : pas de dérive horaire cachée, vous validez le périmètre avant de signer. Mise en ligne sans downtime quand on augmente l'existant, y compris pendant les pics d'activité portuaire ou de production sidérurgique. Web Vitals (LCP, INP, CLS) et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD et AI Act : propriété totale, aucun abonnement imposé, aucun lock-in. Le tout est transférable à tout prestataire local des Hauts-de-France ou repris en interne par vos équipes.",
      },
      en: {
        hero: "Axion-IA conçoit et augmente à Grande-Synthe des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure et mobile-first, e-commerce multi-CMS (WordPress, Shopify, WooCommerce, PrestaShop, Magento), chatbot RAG multilingue ancré sur vos contenus, recherche sémantique, agents et automatisations. Pensé pour une économie portuaire et industrielle adossée au Grand Port Maritime de Dunkerque, troisième port français, et au tissu de sous-traitants qui gravite autour d'ArcelorMittal Dunkerque, d'Aluminium Dunkerque (électrolyse, 285 000 t/an) et d'Industeel. Que vous soyez un commerçant du cœur de ville, un transporteur des zones portuaires ou un sous-traitant de la sidérurgie, on construit ou on augmente votre outil web autour de vos vrais flux métier. Devis à partir de 48 h selon la complexité, hébergement UE, code et données à vous, sans verrou ni abonnement imposé. Kick-off en présentiel à Grande-Synthe, près du Palais du Littoral, puis itérations à distance par sprints avec démos hebdomadaires.",
        whyHere: [
