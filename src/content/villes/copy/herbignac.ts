...
// Herbignac (44, Loire-Atlantique) — Brière, bourg.
...
export const HERBIGNAC_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Herbignac et en Brière ?",
      a: "Oui, Axion-IA intervient à Herbignac et tout le nord Brière (Guérande, Pontchâteau, Assérac, Saint-Lyphard). Consultants depuis Saint-Nazaire (25 min) ou Nantes (1h10). Couverture complète du secteur.",
    },
    {
      q: "Accompagnez-vous les exploitations agricoles ?",
      a: "Oui, nous accompagnons les exploitations agricoles d'Herbignac sur des cas IA pratiques : automatisation suivi parcellaire, gestion stocks et commandes, optimisation logistique, agents IA relation client. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
