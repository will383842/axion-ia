...
// Wissembourg (67, Bas-Rhin) — Sous-préfecture, frontière allemande, cité médiévale.
...
export const WISSEMBOURG_COPY: VilleCopy = {
  ...
  distancesEn:
    "Haguenau à 30 min. Strasbourg à 1h. Karlsruhe (Allemagne) à 45 min. Gare SNCF Wissembourg (ligne Strasbourg–Neustadt). Autoroute A35 puis D263. Aéroport Karlsruhe-Baden-Baden à 35 min. Aéroport Strasbourg-Entzheim à 1h10.",
  seoHook: "tourisme transfrontalier & viticulture",
  topSectorsNaf: [
    "Tourisme et hôtellerie-restauration transfrontalière",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Wissembourg : formats adaptés à l'atelier industriel, domaine viticole, hôtel-restaurant, chantier ou commerce. Vos équipes repartent autonomes. Sessions bilingues franco-allemandes possibles.",
    },
    implementation: {
      fr: "Implémentation IA à Wissembourg : automatisation réservations tourisme multilingue (FR/DE), gestion vendanges et stocks viticoles, contrôle qualité industrie, agents conversationnels B2B et B2C transfrontaliers.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Wissembourg ?",
      a: "Oui, Axion-IA intervient à Wissembourg et dans toute l'Outre-Forêt (Cleebourg, Soultz-sous-Forêts, Lauterbourg, Seebach). Consultants via gare SNCF Wissembourg ou autoroute A35 puis D263. Strasbourg accessible en 1h, Karlsruhe à 45 min.",
    },
    {
      q: "Travaillez-vous avec les professionnels du tourisme transfrontalier ?",
      a: "Oui, nous accompagnons hôteliers, restaurateurs et opérateurs touristiques wissembourgeois : automatisation réservations multilingues FR/DE, sites web augmentés, optimisation parcours visiteurs allemands et français, gestion avis.",
    },
    {
      q: "Accompagnez-vous les PME industrielles et viticoles ?",
      a: "Oui, le tissu industriel et viticole de Wissembourg bénéficie de notre expertise : contrôle qualité, traçabilité production, gestion vendanges, automatisation commandes transfrontalières et relations donneurs d'ordres. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
