...
// Plouguerneau (29, Finistère) — Littoral Abers, phare Île Vierge (plus haut Europe), tourisme.
...
export const PLOUGUERNEAU_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Plouguerneau est une commune littorale étendue du pays des Abers, entre Aber Wrac'h et Aber Benoît. Son économie repose sur le tourisme balnéaire (phare de l'Île Vierge, sentier côtier GR34), la récolte et la transformation du goémon, l'ostréiculture, l'agriculture et les commerces de proximité. La commune attire résidents et touristes grâce à son patrimoine maritime exceptionnel.",
  distancesFr:
    "Brest à 30 min. Lannilis à 10 min. Gare TGV de Brest (Paris en 3h30). Aéroport Brest-Bretagne à 40 min. Aber Wrac'h port à 5 min.",
  distancesEn:
    "Brest à 30 min. Lannilis à 10 min. Gare TGV de Brest (Paris en 3h30). Aéroport Brest-Bretagne à 40 min. Aber Wrac'h port à 5 min.",
  topSectorsNaf: [
    "Tourisme balnéaire & hôtellerie-restauration",
    "Goémon & algues marines",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Plouguerneau : formats adaptés aux hébergeurs touristiques, goémoniers, ostréiculteurs ou commerces littoraux. Vos équipes repartent autonomes sur les outils IA métier.",
    },
    implementation: {
      fr: "Implémentation IA à Plouguerneau : agents conversationnels accueil touristique, automatisation réservations hébergements, gestion stocks goémon, traçabilité ostréicole. Adapté filière maritime du pays des Abers.",
      en: "Implémentation IA à Plouguerneau : agents conversationnels accueil touristique, automatisation réservations hébergements, gestion stocks goémon, traçabilité ostréicole. Adapté filière maritime du pays des Abers.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Plouguerneau : sessions sur site ou en visio. Gérants campings et gîtes, ostréiculteurs, goémoniers, commerçants et indépendants du pays des Abers souhaitant maîtriser l'IA au quotidien.",
      en: "Coaching 1-to-1 à Plouguerneau : sessions sur site ou en visio. Gérants campings et gîtes, ostréiculteurs, goémoniers, commerçants et indépendants du pays des Abers souhaitant maîtriser l'IA au quotidien.",
    },
  },
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Plouguerneau et dans le pays des Abers ?",
      a: "Oui, Axion-IA intervient à Plouguerneau et dans tout le pays des Abers (Lannilis, Landéda, Plabennec, Saint-Pabu). Déplacement depuis Brest en 30 min, couverture de tout le littoral nord Finistère.",
    },
    {
      q: "Travaillez-vous avec les professionnels du tourisme et de la mer ?",
