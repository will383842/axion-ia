...
export const PIERRELATTE_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Pierrelatte : sessions dans vos bureaux, exploitation viticole, atelier ou en visio. Dirigeants sous-traitants techniques, viticulteurs AOC, agriculteurs, artisans, gérants TPE/PME pierrelattines.",
      en: "Coaching 1-to-1 à Pierrelatte : sessions dans vos bureaux, exploitation viticole, atelier ou en visio. Dirigeants sous-traitants techniques, viticulteurs AOC, agriculteurs, artisans, gérants TPE/PME pierrelattines.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    },
    {
      ...
      a: "Pour les TPE artisans BTP et commerçants à Pierrelatte, audit Flash 490 € HT, intervention 1 journée formation, coaching 1-to-1. Cas typiques : automatisation devis, agents IA prise de RDV, classification photos.",
    },
    {
