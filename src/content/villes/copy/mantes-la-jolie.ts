...
export const MANTES_LA_JOLIE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Mantes-la-Jolie : diagnostic des tâches automatisables pour sous-traitance automobile, mécanique, logistique de la Seine et BTP. Audit Flash dès 490 € HT, livrable priorisé.",
      en: "Audit IA à Mantes-la-Jolie : diagnostic des tâches automatisables pour sous-traitance automobile, mécanique, logistique de la Seine et BTP. Audit Flash dès 490 € HT, livrable priorisé.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'Audit Flash démarre à 490 € HT, avec une grille tarifaire publique. Il est adapté aux TPE et PME mantaises : sous-traitance automobile, mécanique, logistique, BTP et commerce.",
    },
    {
