...
export const ROSNY_SOUS_BOIS_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Audit Flash livré sous 5 jours ouvrés. Interventions sur site planifiées sous 2 à 3 semaines selon disponibilité de votre équipe. Implémentations sur 4 à 8 semaines selon complexité (commerce détail, BTP, services numériques).",
    },
    {
