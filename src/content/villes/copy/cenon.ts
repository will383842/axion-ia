      ...
      fr: {
        ...
        methodology: [
          ...
          },
          {
            ...
            detail:
              "Wireframes, design system et maquettes Figma à votre marque, pensés mobile-first pour une clientèle de la rive droite qui consulte d'abord sur smartphone, dans le tramway A ou la gare TER Cenon. Prototype cliquable testé et validé avec vous avant la moindre ligne de code.",
          },
          {
            step: "Développement par sprints",
            detail:
              "Greffe IA sur l'existant ou build IA-native : boutique e-commerce multi-CMS, réservation et prise de commande en ligne, chatbot RAG multilingue, recherche sémantique, agents et automatisations. Démos hebdomadaires en visio, code versionné et documenté à chaque livraison.",
          },
          {
            step: "Recette + mise en ligne",
            detail:
              "Tests d'acceptation, Web Vitals (LCP, INP, CLS) et SEO/AEO validés, mise en production sans downtime — y compris pour un commerce du centre cenonnais ou un restaurant des abords du Rocher de Palmer en pleine activité, sans la moindre coupure de service.",
          },
          {
            step: "Livraison + autonomie",
            detail:
              "Code source, bases de données et modèles livrés dans votre infrastructure (hébergement UE possible). Vos équipes pilotent l'outil en autonomie depuis Cenon, sans verrou ni abonnement imposé, le tout transférable à n'importe quel prestataire de Bordeaux Métropole.",
          },
        ],
        pricing: [
          {
          ...
          },
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une boutique avec UX/UI sur mesure et IA intégrée : e-commerce multi-CMS, clic-and-collect, réservation directe, pour les commerces, restaurateurs et services de la rive droite et des Hauts de Garonne.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Plateforme métier ou portail client sur mesure pour les acteurs tertiaires, logistiques et des industries culturelles et créatives (ICC) de Bordeaux Métropole, IA intégrée, branchée sur votre SI (CRM, ERP, caisse, billetterie).",
          },
          {
            sizeLabel: "Grande entreprise",
            price: "Programme produit",
            detail:
              "Programmes pluriannuels pour les employeurs structurants de l'aire bordelaise et les acteurs fédérés autour du Club d'Entreprises de Cenon : refonte de plateformes, design system, équipe dédiée Axion-IA en mode produit.",
          },
        ],
        faq: [
          {
            q: "Faites-vous l'UX/UI et l'e-commerce, pas seulement l'IA ?",
            a: "Oui. On conçoit l'expérience complète — recherche utilisateur, wireframes, design system, maquettes Figma, prototype cliquable — pour un site vitrine, une boutique e-commerce ou une plateforme, avec ou sans brique IA. Multi-CMS (WordPress, Shopify, WooCommerce, PrestaShop, Magento) ou code sur mesure, mobile-first et optimisé Web Vitals pour une clientèle cenonnaise qui consulte d'abord sur smartphone.",
          },
          {
            q: "Pouvez-vous gérer la prise de commande pour un restaurant ou un commerce de la rive droite ?",
          ...
          },
          {
            ...
            a: "Oui. Pour les services aux entreprises, les acteurs tertiaires fédérés par le Club d'Entreprises de Cenon (plus de 200 sociétés) et les industries culturelles et créatives hébergées au Forum du Rocher de Palmer, on construit des plateformes SaaS, portails clients, agents et automatisations sur mesure, branchés sur votre SI (CRM, ERP, billetterie), hébergés en UE et sans verrou propriétaire.",
          },
          {
