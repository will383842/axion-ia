...
// Marquise (62, Pas-de-Calais) — Boulonnais, carrieres marbre, 5 217 hab.
...
export const MARQUISE_COPY: VilleCopy = {
  ...
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient a Marquise (62). Nous accompagnons les TPE, PME et ETI du Boulonnais : industriels carriers, artisans, commercants, agriculteurs et prestataires de services. Audit Flash a partir de 490 EUR HT.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient a Marquise (62). Nous accompagnons les TPE, PME et ETI du Boulonnais : industriels carriers, artisans, commercants, agriculteurs et prestataires de services. Audit Flash a partir de 490 EUR HT.",
  ecosystemFr:
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA a Marquise : diagnostic adapte aux PME industrielles carriers, TPE artisanales et agriculteurs du Boulonnais. ROI chiffre, audit Flash 490 EUR HT.",
      en: "Audit IA a Marquise : diagnostic adapte aux PME industrielles carriers, TPE artisanales et agriculteurs du Boulonnais. ROI chiffre, audit Flash 490 EUR HT.",
    },
    interventions: {
      ...
      en: "Interventions IA sur site a Marquise : formations adaptees aux sites carriers, ateliers artisanaux, exploitations agricoles et commerces. Equipes autonomes sur outils IA.",
    },
    implementation: {
      fr: "Implementation IA a Marquise : optimisation production carriere, maintenance predictive equipements, automatisation logistique granulats, CRM augmentes pour PME du Boulonnais.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il a Marquise et dans le Boulonnais ?",
      a: "Oui, Axion-IA intervient a Marquise et dans tout le Boulonnais (Boulogne-sur-Mer, Wimereux, Calais). Consultants depuis Lille (1h25 TER) ou via Calais-Frethun (Eurostar 15 min).",
    },
    {
      q: "Quels services IA pour les carrieres de Marquise ?",
      a: "Pour les industries extractives de Marquise, nous proposons : optimisation production IA, maintenance predictive equipements, automatisation logistique granulats, gestion qualite. Audit Flash 490 EUR HT.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les exploitants agricoles du Boulonnais : IA predictive rendements, gestion parcellaire, optimisation elevage, agents conversationnels cooperatives. Audit Flash 490 EUR HT.",
    },
    {
      q: "Vos interventions respectent-elles le RGPD a Marquise ?",
      a: "Oui, toutes nos interventions a Marquise sont conformes au RGPD. Protection des donnees de votre entreprise et de vos clients garantie contractuellement.",
    },
  ],
};
