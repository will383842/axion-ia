...
export const ROANNE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit Flash IA à Roanne ({{price:intervention-4h|flat}}) pour TPE/PME — diagnostic ciblé pour un industriel de la mécanique, un acteur textile, un commerce du centre-ville ou un prestataire de services aux entreprises de Roannais Agglomération.",
      en: "Audit Flash IA à Roanne ({{price:intervention-4h|flat}}) pour TPE/PME — diagnostic ciblé pour un industriel de la mécanique, un acteur textile, un commerce du centre-ville ou un prestataire de services aux entreprises de Roannais Agglomération.",
    },
    interventions: {
