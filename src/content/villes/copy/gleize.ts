...
// Gleizé (69, Rhône) — banlieue ouest Villefranche-sur-Saône, Beaujolais, péri-urbain.
...
export const GLEIZE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Gleizé (69), commune en banlieue ouest immédiate de Villefranche-sur-Saône dans le Rhône, est positionnée à l'entrée du vignoble du Beaujolais. Tissu péri-urbain : PME tertiaires, viticulture périphérique, TPE artisans BTP, commerces. Axion-IA y travaille avec les organisations du territoire du Beaujolais-Villefranche.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Gleizé (69). Nous accompagnons tous types d'activités : PME tertiaires Villefranche, viticulteurs Beaujolais, TPE artisans BTP, commerçants, indépendants et services aux entreprises de la communauté d'agglomération Villefranche Beaujolais Saône.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Gleizé (69). Nous accompagnons tous types d'activités : PME tertiaires Villefranche, viticulteurs Beaujolais, TPE artisans BTP, commerçants, indépendants et services aux entreprises de la communauté d'agglomération Villefranche Beaujolais Saône.",
  seoHook: "vignoble du",
  ecosystemFr:
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Gleizé : formats adaptés au bureau, domaine viticole, commerce. Vos équipes repartent autonomes sur outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Gleizé : prédiction vendanges, classification photos cépages, agents conversationnels B2B, automatisation workflow. Villefranche Beaujolais Saône.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Gleizé et agglo Villefranche ?",
      a: "Oui, Axion-IA intervient à Gleizé et toute l'agglomération Villefranche Beaujolais Saône (Villefranche limitrophe, Anse, Limas, Belleville à 15 min). Consultants depuis Lyon (35 min A6).",
    },
    {
      q: "Travaillez-vous avec les viticulteurs Beaujolais ?",
      a: "Oui, nous accompagnons les viticulteurs AOC Beaujolais et Beaujolais-Villages sur leurs cas IA : prédiction vendanges, classification photos cépages, traçabilité AOC, oenotourisme.",
    },
    {
