...
export const CHATEAUDUN_COPY: VilleCopy = {
  ...
  pitchEn:
    "Châteaudun (28), sous-préfecture d'Eure-et-Loir, est une cité historique dominée par son château médiéval (donjon XIIe siècle). Tissu TPE/PME industrielles, services défense (base aérienne 279), commerces centre-ville, agroalimentaire Beauce. Axion-IA couvre les activités professionnelles du bassin.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Châteaudun (28). Nous accompagnons tous types d'activités : TPE/PME industrielles, sous-traitants défense, commerçants centre-ville, acteurs agroalimentaires Beauce, services aux entreprises du Dunois.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à Châteaudun (28). Nous accompagnons tous types d'activités : TPE/PME industrielles, sous-traitants défense, commerçants centre-ville, acteurs agroalimentaires Beauce, services aux entreprises du Dunois.",
  seoHook: "industrielles & défense sous-traitance",
  ecosystemFr:
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Châteaudun : diagnostic adapté aux TPE/PME industrielles, sous-traitants défense, acteurs agroalimentaires Beauce, commerçants. ROI mesurable, audit sur place dès {{price:audit-flash|flat}}.",
      en: "Audit IA à Châteaudun : diagnostic adapté aux TPE/PME industrielles, sous-traitants défense, acteurs agroalimentaires Beauce, commerçants. ROI mesurable, audit sur place dès {{price:audit-flash|flat}}.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, automatisation processus, maintenance prédictive, classification qualité, optimisation chaîne logistique. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
