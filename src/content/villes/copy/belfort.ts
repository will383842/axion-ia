...
export const BELFORT_COPY: VilleCopy = {
  pitchFr:
    "Belfort (90), ville-symbole du Lion de Bartholdi et capitale industrielle du nord Franche-Comté, vit au rythme des grandes turbines (Alstom, General Electric), de la sous-traitance mécanique et du technopôle Techn'Hom. Axion-IA, cabinet d'experts IA seniors, accompagne en priorité les TPE et PME du bassin, les ETI en complément.",
  pitchEn:
    "Belfort (90), ville-symbole du Lion de Bartholdi et capitale industrielle du nord Franche-Comté, vit au rythme des grandes turbines (Alstom, General Electric), de la sous-traitance mécanique et du technopôle Techn'Hom. Axion-IA, cabinet d'experts IA seniors, accompagne en priorité les TPE et PME du bassin, les ETI en complément.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient sur site à Belfort et dans tout le nord Franche-Comté. Nous accompagnons en priorité les TPE et PME industrielles du bassin — sous-traitants mécaniques et métalliers, bureaux d'études, fournisseurs de la filière énergie/transport, commerces et services — puis les ETI en complément. Audit, intervention sur site, implémentation et coaching un-à-un, à tarifs publics.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient sur site à Belfort et dans tout le nord Franche-Comté. Nous accompagnons en priorité les TPE et PME industrielles du bassin — sous-traitants mécaniques et métalliers, bureaux d'études, fournisseurs de la filière énergie/transport, commerces et services — puis les ETI en complément. Audit, intervention sur site, implémentation et coaching un-à-un, à tarifs publics.",
