...
// Montmagny (95, Val-d'Oise) — nord Paris, résidentielle, 15 105 hab.
...
export const MONTMAGNY_COPY: VilleCopy = {
  ...
  pitchEn:
    "Montmagny, commune résidentielle du Val-d'Oise (95) en proche banlieue nord de Paris, entre Deuil-la-Barre et Groslay. Tissu TPE artisans BTP, commerçants de proximité, PME de services, professions libérales et indépendants. Axion-IA y conduit ses missions auprès des entreprises locales du sud Val-d'Oise.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Montmagny (95). Nous accompagnons tous types d'activités : TPE artisans BTP, commerçants, PME de services, professions libérales et indépendants du sud Val-d'Oise et nord parisien. Audit Flash sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Montmagny (95). Nous accompagnons tous types d'activités : TPE artisans BTP, commerçants, PME de services, professions libérales et indépendants du sud Val-d'Oise et nord parisien. Audit Flash sur mesure.",
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Montmagny : diagnostic adapté aux TPE artisans, commerçants, PME de services et professions libérales du sud Val-d'Oise. ROI chiffré, Audit Flash {{price:audit-flash|flat}}.",
      en: "Audit IA à Montmagny : diagnostic adapté aux TPE artisans, commerçants, PME de services et professions libérales du sud Val-d'Oise. ROI chiffré, Audit Flash {{price:audit-flash|flat}}.",
    },
    interventions: {
      ...
      en: "Interventions IA sur site à Montmagny : formats adaptés au commerce, cabinet ou atelier. Vos équipes repartent autonomes sur les outils IA configurés pour leur métier.",
    },
    implementation: {
      fr: "Implémentation IA à Montmagny : automatisation devis artisans, agents conversationnels pour commerces, gestion relation client PME, digitalisation cabinets libéraux. Sud Val-d'Oise et nord Paris.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Montmagny dans le Val-d'Oise ?",
      a: "Oui, Axion-IA intervient à Montmagny et dans tout le sud du Val-d'Oise (Deuil-la-Barre, Groslay, Enghien-les-Bains, Villetaneuse, Saint-Gratien). Nos consultants se déplacent sur site ou en visio.",
    },
    {
      q: "Quel est le prix d'un audit IA à Montmagny ?",
      a: "L'Audit Flash IA à Montmagny démarre à {{price:audit-flash|flat}}. Ce diagnostic couvre l'analyse de vos processus métier, l'identification des cas d'usage IA prioritaires et un plan d'action chiffré avec ROI estimé.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nos interventions IA sur site à Montmagny sont adaptées aux PME de services et commerces du sud Val-d'Oise. Formats demi-journée ou journée complète, vos équipes repartent autonomes sur les outils IA.",
    },
    {
