...
// Thuir (66, Pyrénées-Orientales) — Caves Byrrh, Aspres, piémont canigou.
...
export const THUIR_COPY: VilleCopy = {
  ...
  pitchEn:
    "Thuir (66), bourg historique des Aspres célèbre pour les caves Byrrh (plus grande cuve en chêne du monde), fait partie de la Communauté de communes des Aspres. Tissu TPE artisans, PME viticulture et agroalimentaire, commerces, agriculture Aspres. Axion-IA y déploie son expertise pour toutes les organisations du piémont catalan.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Thuir (66). Nous accompagnons tous types d'activités : TPE artisans, PME viticulture et agroalimentaire, commerçants, agriculteurs des Aspres, indépendants et professions libérales du piémont catalan.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Thuir (66). Nous accompagnons tous types d'activités : TPE artisans, PME viticulture et agroalimentaire, commerçants, agriculteurs des Aspres, indépendants et professions libérales du piémont catalan.",
  seoHook: "massif du",
  ecosystemFr:
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Thuir et dans les Aspres ?",
      a: "Oui, Axion-IA intervient à Thuir et toute la Communauté de communes des Aspres (Trouillas, Montauriol, Terrats, Ponteilla). Nos consultants sont basés à proximité de Perpignan (15 min).",
    },
    {
      q: "Travaillez-vous avec les viticulteurs Côtes du Roussillon ?",
      a: "Oui, nous accompagnons les viticulteurs des Côtes du Roussillon sur leurs cas IA : classification qualité raisin, prédiction vendanges, gestion cave, vente directe e-commerce, traçabilité parcellaire.",
    },
    {
      q: "Accompagnez-vous les arboriculteurs et agriculteurs des Aspres ?",
