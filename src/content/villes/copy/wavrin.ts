...
export const WAVRIN_COPY: VilleCopy = {
  ...
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient a Wavrin (59). Nous accompagnons les TPE, PME et ETI de l'agglomeration lilloise sud-ouest : logisticiens, PME industrielles, artisans BTP, commercants et professions liberales. Audit sur place a partir de {{price:audit-flash|flat}}, intervention sur site sous 5 jours ouvres.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient a Wavrin (59). Nous accompagnons les TPE, PME et ETI de l'agglomeration lilloise sud-ouest : logisticiens, PME industrielles, artisans BTP, commercants et professions liberales. Audit sur place a partir de {{price:audit-flash|flat}}, intervention sur site sous 5 jours ouvres.",
  ecosystemFr:
