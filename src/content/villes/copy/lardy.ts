...
// Lardy (91, Essonne) — 38km SO Paris, vallée de la Juine, résidentielle rurale.
...
export const LARDY_COPY: VilleCopy = {
  ...
  pitchEn:
    "Lardy (91), commune de l'Essonne dans la vallée de la Juine, à 38 km au sud-ouest de Paris. Cadre résidentiel rural, tissu TPE artisanales, commerces de proximité, PME tertiaires, agriculteurs, indépendants. Axion-IA couvre les activités professionnelles du bassin de la vallée de la Juine.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Lardy (91). Nous accompagnons tous types d'activités : TPE artisanales, commerces de proximité, PME tertiaires, agriculteurs, indépendants et professions libérales de la vallée de la Juine.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Lardy (91). Nous accompagnons tous types d'activités : TPE artisanales, commerces de proximité, PME tertiaires, agriculteurs, indépendants et professions libérales de la vallée de la Juine.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Lardy et vallée de la Juine ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les agriculteurs à Lardy et vallée de la Juine : prédiction récoltes, automatisation traçabilité, classification photos cultures, vente directe optimisée.",
    },
    {
      q: "Travaillez-vous avec les PME tertiaires sud-Essonne ?",
      a: "Oui, implémentation IA pour PME tertiaires du sud-Essonne depuis Lardy : CRM augmentés, classification documents, automatisations workflow. Tarifs publics, ROI chiffré contractuel.",
    },
    {
