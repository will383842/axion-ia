...
// Bannalec (29, Finistère) — Est Cornouaille, agriculture/agroalimentaire.
...
export const BANNALEC_COPY: VilleCopy = {
  ...
  pitchEn:
    "Bannalec (29), commune de l'est Cornouaille en Finistère, est un bourg rural dynamique entre Quimperlé et Rosporden. Tissu TPE agricoles (élevage, polyculture), PME agroalimentaires (volailles, transformation), artisans BTP, commerces de proximité et services. Axion-IA collabore avec toutes les structures locales de l'Est Cornouaille.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Bannalec (29). Nous accompagnons tous types d'activités : TPE agricoles et éleveurs, PME agroalimentaires (volailles, transformation), artisans BTP, commerçants, indépendants, professions libérales et services aux entreprises de l'Est Cornouaille / Quimperlé.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Bannalec (29). Nous accompagnons tous types d'activités : TPE agricoles et éleveurs, PME agroalimentaires (volailles, transformation), artisans BTP, commerçants, indépendants, professions libérales et services aux entreprises de l'Est Cornouaille / Quimperlé.",
  ...
  ecosystemEn:
    "Bannalec est un bourg rural de l'est Cornouaille, entre Quimperlé (15 min) et Rosporden (15 min), intégré à Quimperlé Communauté. Forte vocation agricole (élevage avicole, bovin, polyculture), tissu PME agroalimentaires (transformation volailles, abattoirs, conditionnement), artisanat BTP, commerces et services. Axe routier Quimper-Lorient (RN165) à proximité.",
  distancesFr:
    "Gare Bannalec (TER Quimper-Lorient, 15 min Quimperlé, 45 min Quimper). Quimperlé à 15 min. Lorient à 40 min. Aéroport Quimper-Pluguffan à 40 min. Aéroport Lorient-Bretagne-Sud à 45 min. Axe RN165 Quimper-Lorient à 5 min.",
  distancesEn:
    "Gare Bannalec (TER Quimper-Lorient, 15 min Quimperlé, 45 min Quimper). Quimperlé à 15 min. Lorient à 40 min. Aéroport Quimper-Pluguffan à 40 min. Aéroport Lorient-Bretagne-Sud à 45 min. Axe RN165 Quimper-Lorient à 5 min.",
  topSectorsNaf: [
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Bannalec et Est Cornouaille ?",
      a: "Oui, Axion-IA intervient à Bannalec et tout l'Est Cornouaille (Quimperlé, Rosporden, Scaër, Mellac, Moëlan-sur-Mer). Nos consultants viennent de Quimper (45 min) ou Lorient (40 min).",
    },
    {
      q: "Travaillez-vous avec les éleveurs avicoles du Finistère ?",
      a: "Oui, nous accompagnons les éleveurs avicoles du Finistère sur leurs cas IA : suivi sanitaire troupeaux, prédiction ponte et croissance, classification photos bâtiments, automatisation traçabilité, optimisation alimentation et ventilation.",
    },
    {
      q: "Accompagnez-vous les PME agroalimentaires de Quimperlé Communauté ?",
