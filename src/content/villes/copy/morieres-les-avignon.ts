...
// Morières-lès-Avignon (84, Vaucluse) — Agglomération sud-est d'Avignon, périurbain résidentiel.
...
export const MORIERES_LES_AVIGNON_COPY: VilleCopy = {
  ...
  pitchEn:
    "Morières-lès-Avignon (84), commune périurbaine du sud-est d'Avignon, conjugue cadre de vie résidentiel, zones d'activités locales et fonction de banlieue du Grand Avignon. TPE artisans BTP et services, PME commerciales, professions libérales (santé, conseil), commerces de proximité et agriculture maraîchère résiduelle. Axion-IA y intervient pour tous types d'activités.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Morières-lès-Avignon (84). Nous accompagnons TPE artisans, PME commerciales, professions libérales, commerces et exploitations maraîchères du sud-est d'Avignon. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Morières-lès-Avignon (84). Nous accompagnons TPE artisans, PME commerciales, professions libérales, commerces et exploitations maraîchères du sud-est d'Avignon. Audit sur place sur mesure.",
  ...
  topSectorsNaf: [
    ...
    "Agriculture maraîchère & viticulture",
  ],
  servicesContext: {
    audit: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Morières-lès-Avignon et dans le sud-est avignonnais ?",
      a: "Oui, Axion-IA intervient à Morières-lès-Avignon et dans tout le sud-est avignonnais (Saint-Saturnin-lès-Avignon, Châteauneuf-de-Gadagne, Le Pontet). Proximité immédiate d'Avignon TGV via A7.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les professions libérales sur prise de rendez-vous automatisée, gestion patients, rédaction comptes-rendus assistés, agents conversationnels et conformité RGPD santé.",
    },
    {
      q: "Travaillez-vous avec les artisans BTP et commerces de proximité ?",
      a: "Oui, nous intervenons en BTP et commerce de proximité sur automatisation devis et chiffrage, gestion planning chantiers, content marketing local, fiches Google Business et SAV conversationnel.",
    },
    {
