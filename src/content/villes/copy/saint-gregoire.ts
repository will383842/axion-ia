...
// Saint-Grégoire (35, Ille-et-Vilaine) — nord Rennes, zones d'activités tertiaires.
...
export const SAINT_GREGOIRE_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Grégoire ?",
      a: "Oui, Axion-IA intervient à Saint-Grégoire et dans tout le nord de Rennes Métropole (Betton, La Chapelle-des-Fougeretz, Pacé, Montgermont). Nos consultants accèdent via rocade nord (10 min depuis Rennes centre).",
    },
    {
      q: "Accompagnez-vous les PME tertiaires de Saint-Grégoire ?",
      a: "Oui, nous accompagnons les PME tertiaires et services B2B des zones d'activités de Saint-Grégoire (Espace Performance, Saint-Sulpice) : automatisation workflow, agents conversationnels, veille augmentée, CRM. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les cabinets de conseil et services B2B de Saint-Grégoire : analyse documentaire augmentée, veille concurrentielle IA, automatisation reporting, agents conversationnels client. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
