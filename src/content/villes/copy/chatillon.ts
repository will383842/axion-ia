  ...
  faqGeolocalisee: [
    {
      ...
      a: "À Châtillon, l'Audit Flash débute à {{price:audit-flash|flat}} (4 heures sur site), la Formation 4 h à {{price:intervention-4h|flat}} et l'accompagnement 1-to-1 dirigeant à {{price:intervention-dirigeants|flat}}. Tarifs publics consultables sur axion-ia.com.",
    },
    {
    ...
    },
    {
      ...
      a: "Pour une TPE ou PME implantée à Châtillon, l'Audit Flash est planifiable sous 5 jours ouvrés après validation. Une Intervention Essentielle démarre généralement sous 10 à 15 jours selon le périmètre.",
    },
    {
