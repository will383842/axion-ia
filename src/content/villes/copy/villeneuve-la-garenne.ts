...
// Villeneuve-la-Garenne (92, Hauts-de-Seine) — commune des bords de Seine au nord des Hauts-de-Seine, pôle commercial Qwartz, zones d'activités et logistique.
...
export const VILLENEUVE_LA_GARENNE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Villeneuve-la-Garenne : une journée pour cartographier les tâches répétitives d'un commerce ou d'une PME de distribution proche du Qwartz — gestion de commandes, relances, devis — et prioriser ce qui mérite d'être automatisé.",
    ...
    sitesWeb: {
      ...
      en: "Sites web augmentés à Villeneuve-la-Garenne : pour les commerces et distributeurs locaux, nous bâtissons des sites et boutiques dopés à l'IA — recommandations, qualification de contacts, contenus assistés — orientés conversion.",
    },
  },
  services: {
    sitesWeb: {
      fr: {
        ...
        methodology: [
          ...
          },
          {
            ...
            detail:
              "Wireframes, design system et maquettes Figma à votre marque ; prototype cliquable testé avant tout développement, pensé mobile-first pour une audience de proximité, de zone commerciale et de parcs d'activités. Accessibilité et hiérarchie de conversion validées dès la maquette.",
          },
          {
            step: "Développement par sprints",
            detail:
              "Greffe IA sur l'existant ou build IA-native : boutique e-commerce multi-CMS, suivi de commandes, chatbot RAG multilingue, recherche sémantique, agents de relance et de planification logistique. Démos hebdomadaires en visio, code versionné et documenté à chaque incrément.",
          },
          {
            step: "Recette + mise en ligne",
            detail:
              "Tests d'acceptation, Web Vitals, accessibilité et SEO/AEO validés, mise en production sans downtime — y compris en pic d'activité commerciale au Qwartz ou de flux logistiques sur la plaine des Chanteraines. Plan de bascule et rollback préparés.",
          },
          {
            step: "Livraison + autonomie",
            detail:
              "Code, bases et modèles livrés chez vous, hébergement UE possible. Vos équipes pilotent l'outil en autonomie, avec passation documentée, sans verrou ni abonnement imposé. Transfert possible à un prestataire francilien de votre choix à tout moment.",
          },
        ],
        pricing: [
          {
          ...
          },
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une boutique pour les distributeurs, grossistes et prestataires des parcs d'activités (Reniers, Étoile, Bongarde) : UX/UI mobile-first, e-commerce multi-CMS, recommandations et qualification de contacts intégrées.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Portail client ou plateforme métier sur mesure pour les acteurs structurants de la logistique et de la distribution de la plaine des Chanteraines et du Val de Seine, IA intégrée, branchée sur votre SI (CRM, ERP, gestion de stock, WMS).",
          },
          {
            sizeLabel: "Grande entreprise",
            price: "Programme produit",
            detail:
              "Programmes pluriannuels pour les grands employeurs du commerce et de la logistique francilienne implantés sur les bords de Seine : refonte de plateformes, design system, équipe dédiée Axion-IA en mode produit.",
          },
        ],
        faq: [
          {
            q: "Faites-vous l'UX/UI et l'e-commerce, pas seulement l'IA ?",
            a: "Oui. On conçoit l'expérience complète — research, wireframes, design system, maquettes Figma, prototype cliquable — pour un site vitrine, une boutique e-commerce ou une plateforme, avec ou sans brique IA. Multi-CMS (WordPress, Shopify, WooCommerce, PrestaShop, Magento) ou code sur mesure, toujours pensé mobile-first, accessible et orienté conversion. L'IA est une option, pas un passage obligé.",
          },
          {
            q: "Pouvez-vous outiller le commerce et la distribution autour du Qwartz et des Chanteraines ?",
            a: "Oui. Pour les commerces proches du Qwartz et les distributeurs de la plaine industrielle des Chanteraines ou de la zone industrielle du Val de Seine, on connecte e-commerce, suivi de commandes, relances et planification logistique à vos outils existants (caisse, CRM, gestion de stock, ERP). Des agents IA automatisent les tâches répétitives sans complexité inutile, en respectant vos process.",
          },
          {
            q: "Mes données clients restent-elles en Europe ?",
            a: "Oui. Toute la chaîne IA est hébergeable en UE, conforme RGPD et AI Act, sans transit hors UE sans DPA. Vous gardez la propriété complète de vos données, de vos modèles et de votre code, sans verrou ni dépendance à un prestataire unique. Pour les commerces et distributeurs garenneux gérant des données clients, c'est un point de départ non négociable.",
          },
          {
            q: "Travaillez-vous avec les jeunes entreprises de la pépinière et des parcs d'activités ?",
            a: "Oui. La pépinière d'entreprises et les parcs d'activités Reniers, Étoile et Bongarde hébergent de jeunes structures qui ont besoin d'un premier site solide, rapide et évolutif. On livre une base mobile-first prête à grandir, à laquelle on pourra greffer plus tard chatbot, recherche sémantique ou e-commerce, sans tout refaire ni vous enfermer.",
          },
          {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui. Le voisinage du Qwartz et des zones d'activités attire commerces et acteurs de la distribution, dont les tâches — gestion de commandes, relances, suivi de stock — sont répétitives et se prêtent bien à des automatisations ciblées, à fort retour sur investissement.",
    },
    {
    ...
    {
      q: "Comment garantissez-vous la conformité RGPD à Villeneuve-la-Garenne ?",
      a: "La conformité RGPD est intégrée dès le cadrage : minimisation des données, hébergement maîtrisé, traçabilité des traitements. Pour des commerces et distributeurs gérant des données clients, c'est un point de départ non négociable.",
    },
  ],
};
