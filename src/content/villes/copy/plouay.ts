...
// Plouay (56, Morbihan) — centre Morbihan, cyclisme (vélodrome Raymond Poulidor), forêt de Pontcallec.
...
export const PLOUAY_COPY: VilleCopy = {
  ...
  distancesEn:
    "Lorient centre à 25 min voiture N24. Pontivy à 35 min. Gare de Lorient (TGV Paris 3h15). Aéroport Lorient Bretagne Sud à 30 min. Hennebont à 15 min. Vannes à 50 min.",
  seoHook: "cyclisme, agroalimentaire & rural",
  topSectorsNaf: [
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Plouay : formats adaptés à l'exploitation agricole, atelier agroalimentaire, structure sportive ou commerce. Vos équipes repartent autonomes sur outils IA configurés métier.",
    },
    implementation: {
      fr: "Implémentation IA à Plouay : gestion événementielle cyclisme (billetterie, logistique compétitions), traçabilité agroalimentaire, optimisation production agricole, agents conversationnels tourisme sportif. Adapté sport + agro.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Plouay et dans le centre Morbihan ?",
      a: "Oui, Axion-IA intervient à Plouay et tout le centre Morbihan (Hennebont, Inzinzac-Lochrist, Bubry, Inguiniel, Lanvaudan). Nos consultants se déplacent depuis Lorient (25 min) ou Vannes (50 min).",
    },
    {
      q: "Travaillez-vous avec les acteurs du cyclisme et du vélodrome de Plouay ?",
      a: "Oui, nous accompagnons les structures sportives liées au cyclisme à Plouay (vélodrome Raymond Poulidor, organisateurs de compétitions) sur leurs cas IA : gestion événementielle automatisée, billetterie, logistique compétitions, agents conversationnels spectateurs, analyse performance.",
    },
    {
      q: "Accompagnez-vous les PME agroalimentaires et agriculteurs du secteur ?",
