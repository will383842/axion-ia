...
export const MULHOUSE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA opérationnel à Mulhouse : nous cartographions ce qui peut être automatisé dans votre entreprise et chiffrons le ROI. 4 niveaux du Sur place au Stratégique ETI selon votre taille, du cabinet mulhousien à l'ETI automobile ou industrielle du bassin Haut-Rhin.",
    ...
    sitesWeb: {
      ...
      en: "Custom web platforms and SaaS AI for Mulhouse SMEs and mid-caps — premium showcase site for automotive, industry and chemicals, tri-national FR/DE/EN customer space, dashboard connected to your CRM/ERP and production systems. Senior experts, Axion-IA design system, European hosting.",
    },
  },
  ...
  services: {
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Mulhouse des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Mulhouse, itérations à distance.",
        whyHere: [
          "Projets web & SaaS mulhousiens : position trinationale (France-Suisse-Allemagne), automobile & mobilité (Pôle Véhicule du Futur, Stellantis), campus numérique KMØ, PME et ETI du bassin rhénan.",
          ...
          "Marché trinational France-Suisse-Allemagne : sites & plateformes multilingues (FR/DE/EN), hreflang propre, traduction IA — un atout fort à Mulhouse pour vendre des trois côtés du Rhin.",
        ],
        methodology: [
          {
            step: "Cadrage à Mulhouse",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Plateforme métier, industrielle ou portail client sur mesure, multilingue, IA intégrée, branchée sur votre SI (PLM, ERP, datalake).",
          },
          {
            sizeLabel: "Grande entreprise",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Mulhouse — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Vous gérez le multilingue pour le marché trinational ?",
            a: "Oui, c'est un atout clé à Mulhouse : sites et plateformes multilingues (français, allemand, anglais), traduction IA, hreflang propre, contenu localisé. Un vrai levier pour vendre des trois côtés du Rhin (France, Suisse, Allemagne). Hébergement UE, RGPD strict.",
          },
          {
        ...
        guarantees:
          "Devis ferme en forfait fixe (à partir de 48 h selon la complexité) : pas de dérive horaire cachée. Mise en ligne sans downtime quand on augmente l'existant. Web Vitals et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD : propriété totale, aucun abonnement imposé, transférable à tout prestataire de la région mulhousienne ou repris en interne.",
      },
      en: {
        hero: "In Mulhouse, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 48 h depending on project complexity, EU hosting, code and data yours. On-site Mulhouse kick-off, remote iterations.",
        whyHere: [
          "Mulhouse web & SaaS projects: trinational position (France-Switzerland-Germany), automotive & mobility (Pôle Véhicule du Futur, Stellantis), KMØ digital campus, Rhine-basin SMEs and mid-caps.",
          ...
          "Trinational France-Switzerland-Germany market: multilingual sites and platforms (FR/DE/EN), clean hreflang, AI translation — a strong asset in Mulhouse to sell on all three sides of the Rhine.",
        ],
        methodology: [
          {
            step: "Scoping in Mulhouse",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Bespoke business, industrial or customer portal platform, multilingual, AI built in, wired into your IS (PLM, ERP, datalake).",
          },
          {
            sizeLabel: "Large enterprise",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Mulhouse — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Do you handle multilingual for the trinational market?",
            a: "Yes, a key asset in Mulhouse: multilingual sites and platforms (French, German, English), AI translation, clean hreflang, localised content. A real lever to sell on all three sides of the Rhine (France, Switzerland, Germany). EU hosting, strict GDPR.",
          },
          {
