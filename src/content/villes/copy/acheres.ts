...
export const ACHERES_COPY: VilleCopy = {
  ...
  pitchEn:
    "À Achères (78), ville cheminote au bord de la Seine qui abrite la plus grande gare de triage d'Europe et l'une des plus importantes stations d'épuration de France, Axion-IA accompagne les TPE et PME de la logistique, de l'industrie et des services. Prestataires ferroviaires et logistiques, PME de maintenance et d'environnement, artisans du bâtiment, commerces et professions libérales : nous concevons des usages IA concrets pour fiabiliser planning, devis et reporting.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Achères (Yvelines) auprès des TPE et PME, en priorité les très petites entreprises, puis les PME. Nous accompagnons les prestataires ferroviaires et logistiques liés à la grande gare de triage, les PME de maintenance et d'environnement, les artisans du bâtiment et les commerces de cette ville cheminote de la Seine. Tout commence par un audit qui chiffre le retour sur investissement avant tout engagement.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Achères (Yvelines) auprès des TPE et PME, en priorité les très petites entreprises, puis les PME. Nous accompagnons les prestataires ferroviaires et logistiques liés à la grande gare de triage, les PME de maintenance et d'environnement, les artisans du bâtiment et les commerces de cette ville cheminote de la Seine. Tout commence par un audit qui chiffre le retour sur investissement avant tout engagement.",
