...
export const SEYSSINS_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Seyssins : diagnostic adapté aux TPE artisans, professions libérales, commerçants et PME tertiaires du bassin grenoblois ouest. ROI chiffré, audit Flash 490 € HT accessible aux indépendants.",
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Seyssins : sessions dans votre cabinet, commerce, atelier ou en visio. Médecins, avocats, artisans, commerçants, gérants TPE/PME seyssinois souhaitant intégrer l'IA dans leur métier.",
      en: "Coaching 1-to-1 à Seyssins : sessions dans votre cabinet, commerce, atelier ou en visio. Médecins, avocats, artisans, commerçants, gérants TPE/PME seyssinois souhaitant intégrer l'IA dans leur métier.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les TPE artisans BTP à Seyssins (plombiers, électriciens, menuisiers, paysagistes) sur des cas IA pratiques : automatisation devis chantier, agents IA prise de RDV, classification photos chantier, gestion stocks et planning. Audit Flash 490 € HT adapté.",
    },
    {
      q: "Quels services pour les commerces et PME tertiaires ?",
      a: "Pour les commerces et PME tertiaires à Seyssins, nous proposons les 5 services Axion-IA : audit IA (Flash à Stratégique), interventions sur site, implémentation IA (agents conversationnels, automatisations workflow, CRM augmentés), coaching 1-to-1 dirigeants, et plateformes web/SaaS IA sur mesure.",
    },
    {
