...
// Chantepie (35, Ille-et-Vilaine) — sud-est Rennes, résidentielle, zones d'activités.
...
export const CHANTEPIE_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Chantepie ?",
      a: "Oui, Axion-IA intervient à Chantepie et dans tout le sud-est de Rennes Métropole (Vern-sur-Seiche, Cesson-Sévigné, Noyal-Châtillon-sur-Seiche). Nos consultants accèdent via métro ligne b ou rocade sud (10 min depuis Rennes centre).",
    },
    {
      q: "Accompagnez-vous les PME tertiaires de Chantepie ?",
      a: "Oui, nous accompagnons les PME tertiaires et bureaux d'études des zones d'activités de Chantepie sur leurs cas IA : automatisation workflow, agents conversationnels B2B, analyse documentaire, CRM augmenté. Audit sur place {{price:audit-flash|flat}} pour démarrer.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les PME informatiques et bureaux d'études de Chantepie sur leurs cas IA : agents conversationnels support technique, automatisation tests, analyse code augmentée, classification tickets. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
