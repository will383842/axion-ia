...
// Mainvilliers (28, Eure-et-Loir) — Agglo Chartres, zones activités, 10 629 hab.
...
export const MAINVILLIERS_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Mainvilliers est une commune dynamique de l'agglomération de Chartres (Chartres Métropole), qui concentre zones d'activités économiques et commerces de périphérie. L'économie locale repose sur les TPE/PME logistique, services aux entreprises, commerces de zone (grande distribution, retail), artisanat BTP et professions libérales.",
  distancesFr:
    "Chartres centre à 5 min. Gare de Chartres (TER Paris-Montparnasse 1h10). Dreux à 40 min. Paris à 1h20 via A11. Orléans à 1h15.",
  distancesEn:
    "Chartres centre à 5 min. Gare de Chartres (TER Paris-Montparnasse 1h10). Dreux à 40 min. Paris à 1h20 via A11. Orléans à 1h15.",
  topSectorsNaf: [
    "Logistique & entreposage",
    "Commerce de zone (retail, grande distribution)",
    "TPE artisanat BTP",
  ...
  servicesContext: {
    ...
    implementation: {
      ...
      en: "Implémentation IA à Mainvilliers : optimisation flux logistiques zone d'activités, automatisation gestion stocks retail, agents conversationnels B2B, prédiction maintenance équipements commerciaux.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Mainvilliers : sessions dans votre entrepôt, commerce, atelier, cabinet ou en visio. Dirigeants TPE/PME, commerçants, artisans, professions libérales de l'agglo Chartres.",
      en: "Coaching 1-to-1 à Mainvilliers : sessions dans votre entrepôt, commerce, atelier, cabinet ou en visio. Dirigeants TPE/PME, commerçants, artisans, professions libérales de l'agglo Chartres.",
    },
  },
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Mainvilliers et dans l'agglomération de Chartres ?",
      a: "Oui, Axion-IA intervient à Mainvilliers et toute l'agglomération de Chartres (Lucé, Luisant, Lèves, Champhol). Consultants depuis Paris (1h20 A11) ou gare de Chartres (TER 1h10).",
    },
    {
      q: "Travaillez-vous avec les entreprises des zones d'activités de Mainvilliers ?",
      a: "Oui, nous accompagnons les TPE/PME des zones d'activités de Mainvilliers et Chartres Métropole : logistique, commerce de zone, services aux entreprises. Audit Flash 490 € HT adapté à chaque secteur.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nos formats sont adaptés aux TPE artisans BTP et professions libérales : automatisation devis, agents IA plannings, classification documents, gestion comptable assistée par IA.",
    },
    {
