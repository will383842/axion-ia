  ...
  faqGeolocalisee: [
    {
      ...
      a: "Nos prestations à Étampes démarrent à {{price:audit-flash|flat}} pour un audit flash 4h et à {{price:intervention-4h|flat}} pour une intervention sur site. L'intégralité de la grille est publique sur axion-ia.com.",
    },
    {
