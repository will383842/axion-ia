...
export const LA_FERRIERE_COPY: VilleCopy = {
  ...
  pitchEn:
    "La Ferrière (85), commune périurbaine de l'agglomération de La Roche-sur-Yon en Pays de la Loire, plus de 5 400 habitants. Pôle résidentiel et économique dynamique au nord-est de la préfecture vendéenne. Tissu TPE artisans, PME industrielles et BTP, commerces et professions libérales. Axion-IA accompagne tout le tissu professionnel local de l'agglomération yonnaise.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à La Ferrière (85). Nous accompagnons TPE artisans, PME industrielles et BTP, commerçants et professions libérales de l'agglomération de La Roche-sur-Yon. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient à La Ferrière (85). Nous accompagnons TPE artisans, PME industrielles et BTP, commerçants et professions libérales de l'agglomération de La Roche-sur-Yon. Audit sur place sur mesure.",
  ...
  servicesContext: {
    ...
    implementation: {
      fr: "Implémentation IA à La Ferrière : planification chantiers BTP, gestion production industrielle, CRM clients, automatisation devis et facturation, agents conversationnels pour les TPE/PME yonnaises.",
      en: "Implémentation IA à La Ferrière : planification chantiers BTP, gestion production industrielle, CRM clients, automatisation devis et facturation, agents conversationnels pour les TPE/PME yonnaises.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à La Ferrière : sessions dans vos locaux ou en visio. Dirigeants TPE artisans, gérants PME industrielles et BTP, commerçants et professions libérales de l'agglomération yonnaise.",
      en: "Coaching 1-to-1 à La Ferrière : sessions dans vos locaux ou en visio. Dirigeants TPE artisans, gérants PME industrielles et BTP, commerçants et professions libérales de l'agglomération yonnaise.",
    },
  },
  faqGeolocalisee: [
    {
