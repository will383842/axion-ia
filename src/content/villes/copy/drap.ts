...
// Drap (06, Alpes-Maritimes) — vallée du Paillon, agglo Nice.
...
export const DRAP_COPY: VilleCopy = {
  ...
  pitchEn:
    "Drap (06), dans la vallée du Paillon entre Nice et Contes, est une commune résidentielle de la Métropole Nice Côte d'Azur au cadre verdoyant. Tissu TPE/PME artisanat BTP, commerces de proximité, services à la personne, professions libérales et petites entreprises. Axion-IA accompagne entreprises et indépendants.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Drap (06). Nous accompagnons tous types d'activités : TPE artisans BTP, commerçants, professions libérales, PME services et entreprises de la vallée du Paillon entre Nice et Contes.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Drap (06). Nous accompagnons tous types d'activités : TPE artisans BTP, commerçants, professions libérales, PME services et entreprises de la vallée du Paillon entre Nice et Contes.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Drap et vallée du Paillon ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les commerces et services de proximité de Drap sur leurs cas IA : gestion stocks, agents conversationnels client, automatisation commandes, CRM fidélisation. Coaching 1-to-1 ou audit sur place {{price:audit-flash|flat}}.",
    },
    {
      q: "Quels services pour les professions libérales ?",
      a: "Pour les professions libérales de Drap (médecins, avocats, comptables), nous proposons : automatisation secrétariat, transcription, classification dossiers, agents IA prise de RDV. Audit sur place {{price:audit-flash|flat}} ou coaching 1-to-1 personnalisé.",
    },
    {
