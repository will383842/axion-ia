...
// Soustons (40, Landes) — 5 lacs, forêt landaise, plage océane, résidence Mitterrand (Latche).
...
export const SOUSTONS_COPY: VilleCopy = {
  ...
  distancesEn:
    "Hossegor à 15 min. Dax à 30 min par D17. Bayonne à 35 min par D810. Bordeaux à 1h40 par A63. Aéroport Biarritz-Pays Basque à 35 min. Capbreton à 15 min.",
  topSectorsNaf: [
    "Tourisme nature & lacustre (5 lacs)",
    "Campings & hébergement de plein air",
    "Agriculture (maïs, élevage, forêt)",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Soustons : formations adaptées aux campings, hébergements nature, exploitations agricoles, commerces et artisans. Vos équipes repartent autonomes sur les outils IA configurés métier.",
    },
    implementation: {
      fr: "Implémentation IA à Soustons : chatbot réservation multilingue campings, gestion saisonnalité, automatisation facturation hébergeurs, prédiction météo/affluence lacs, optimisation exploitation agricole (irrigation, stocks).",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Soustons et alentours ?",
      a: "Oui, Axion-IA intervient à Soustons et les communes voisines de la côte d'Argent (Azur, Messanges, Vieux-Boucau, Tosse, Seignosse). Couverture lacs, plage et bourg. Déplacement depuis Dax ou Bayonne.",
    },
    {
      q: "Proposez-vous des audits IA pour les campings et hébergeurs ?",
      a: "Oui, audit sur place {{price:audit-flash|flat}} adapté aux campings et hébergeurs de plein air à Soustons. Diagnostic chatbot réservation multilingue, gestion saisonnière, automatisation facturation, prédiction taux d'occupation.",
    },
    {
      q: "Accompagnez-vous les exploitations agricoles landaises ?",
      a: "Oui, nous accompagnons les agriculteurs autour de Soustons (maïs, élevage, sylviculture) sur leurs cas IA : optimisation irrigation, prédiction rendements, gestion stocks et traçabilité, automatisation documents PAC.",
    },
    {
