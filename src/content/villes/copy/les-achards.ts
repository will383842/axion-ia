...
// Les Achards (85, Vendée) — Bocage vendéen.
...
export const LES_ACHARDS_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Les Achards est une commune nouvelle créée en 2017 (fusion de La Mothe-Achard et La Chapelle-Achard) dans le bocage vendéen, à mi-chemin entre La Roche-sur-Yon et le littoral des Sables-d'Olonne. Bassin économique structuré autour de l'industrie mécanique, de l'agroalimentaire, de l'artisanat BTP, du commerce de proximité et du tissu PME familial vendéen.",
  distancesFr:
    "La Roche-sur-Yon à 22 km, Les Sables-d'Olonne à 20 km, Nantes à 80 km. Accès A87 (Angers-La Roche) à 25 km. Gare TER La Roche-sur-Yon à 22 km (Nantes en 50 min, Paris en 3h).",
  distancesEn:
    "La Roche-sur-Yon à 22 km, Les Sables-d'Olonne à 20 km, Nantes à 80 km. Accès A87 (Angers-La Roche) à 25 km. Gare TER La Roche-sur-Yon à 22 km (Nantes en 50 min, Paris en 3h).",
  topSectorsNaf: [
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il aux Achards et dans le bocage vendéen ?",
      a: "Oui, Axion-IA intervient aux Achards et dans tout le bocage vendéen central (La Roche-sur-Yon, Aizenay, Coëx, Beaulieu-sous-la-Roche, Le Girouard). Nos consultants se déplacent entre La Roche-sur-Yon et le littoral vendéen.",
    },
    {
      q: "Travaillez-vous avec les PME industrielles et agroalimentaires vendéennes ?",
    ...
    },
    {
      ...
      a: "Oui, nos interventions forment vos équipes aux outils IA pratiques : devis automatisé, RDV intelligents, agents conversationnels clients, génération de documents, marketing local, gestion stocks. Sur site aux Achards ou en visio.",
    },
    {
