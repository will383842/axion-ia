...
export const LE_LOROUX_BOTTEREAU_COPY: VilleCopy = {
  ...
  pitchEn:
    "Le Loroux-Bottereau (44), bourg du vignoble Muscadet à l'est de Nantes en Loire-Atlantique, vit de la viticulture, du maraîchage, de l'artisanat et des commerces de proximité. Axion-IA opère pour entreprises et indépendants du secteur du vignoble nantais.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient au Loroux-Bottereau (44). Nous accompagnons les TPE viticoles, artisans, commerçants, PME du vignoble nantais et exploitations agricoles sur leurs cas IA opérationnels. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui intervient au Loroux-Bottereau (44). Nous accompagnons les TPE viticoles, artisans, commerçants, PME du vignoble nantais et exploitations agricoles sur leurs cas IA opérationnels. Audit sur place sur mesure.",
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 au Loroux-Bottereau : sessions dans vos locaux (domaine, atelier, bureau) ou en visio. Vignerons, artisans, gérants TPE/PME du vignoble souhaitant intégrer l'IA.",
      en: "Coaching 1-to-1 au Loroux-Bottereau : sessions dans vos locaux (domaine, atelier, bureau) ou en visio. Vignerons, artisans, gérants TPE/PME du vignoble souhaitant intégrer l'IA.",
    },
  },
  faqGeolocalisee: [
    {
