...
export const GAGNY_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      fr: "Intervention sur site à Gagny pour commerces, artisans BTP et restaurateurs — Intervention Essentielle dès 590 € HT, avec déplacement William depuis Paris.",
      en: "Intervention sur site à Gagny pour commerces, artisans BTP et restaurateurs — Intervention Essentielle dès 590 € HT, avec déplacement William depuis Paris.",
    },
    implementation: {
