...
// Eybens (38, Isère) — banlieue sud-est Grenoble, route Napoléon (retour Île d'Elbe), Grenoble-Alpes Métropole.
...
export const EYBENS_COPY: VilleCopy = {
  ...
  topSectorsNaf: [
    ...
    "Tourisme patrimoine (route Napoléon)",
  ],
  servicesContext: {
    audit: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Eybens : formats adaptés au cabinet professionnel, commerce, atelier artisan ou bureau PME. Vos équipes (assistants, secrétaires médicales, commerciaux) repartent autonomes sur outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Eybens : agents conversationnels client/patient, automatisation gestion RDV (santé/juridique), classification dossiers, transcription consultations, CRM augmentés. Adapté professions libérales.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Eybens et sud-est grenoblois ?",
      a: "Oui, Axion-IA intervient à Eybens et tout le sud-est grenoblois (Échirolles, Pont-de-Claix, Poisat, Bresson, Brié-et-Angonnes). Couverture Grenoble-Alpes Métropole et accès rapide via tramway A ou A480.",
    },
    {
      q: "Accompagnez-vous les professions libérales eybinois ?",
    ...
    },
    {
      ...
      a: "Pour les PME tertiaires de l'agglomération grenobloise sud-est, nous proposons les 5 services Axion-IA : audit IA (Sur place à Stratégique), interventions sur site, implémentation IA (agents, automatisations), coaching 1-to-1 dirigeants, et plateformes web/SaaS IA sur mesure.",
    },
    {
