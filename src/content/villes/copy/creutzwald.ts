...
export const CREUTZWALD_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, commerçants et artisans creutzwaldois : gestion stocks, relation client, automatisation comptabilité, présence en ligne, agents conversationnels bilingues FR/DE. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
