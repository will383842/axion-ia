...
// Creutzwald (57, Moselle) — bassin houiller, frontière allemande, région naturelle du Warndt.
...
export const CREUTZWALD_COPY: VilleCopy = {
  ...
  distancesEn:
    "Sarrebruck (Allemagne) à 25 min. Forbach à 15 min. Metz à 50 min. Autoroute A4 accès à 20 min. Luxembourg à 1h. Aéroport Sarrebruck à 30 min. Aéroport Metz-Nancy-Lorraine à 1h.",
  seoHook: "industrie, transfrontalier & logistique",
  topSectorsNaf: [
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Creutzwald : diagnostic adapté aux TPE/PME industrie reconvertie, logistique transfrontalière, commerces, artisans, services. ROI chiffré, audit Flash 490 € HT.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Creutzwald ?",
    ...
    },
    {
      ...
      a: "Oui, commerçants et artisans creutzwaldois : gestion stocks, relation client, automatisation comptabilité, présence en ligne, agents conversationnels bilingues FR/DE. Audit Flash 490 € HT.",
    },
    {
