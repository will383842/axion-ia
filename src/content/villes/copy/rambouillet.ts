...
export const RAMBOUILLET_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      fr: "Intervenir à Rambouillet pour automatiser devis, réservations et relances d'une TPE/PME — Intervention Essentielle à partir de {{price:intervention-4h|flat}}, code custom sans no-code.",
      en: "Intervenir à Rambouillet pour automatiser devis, réservations et relances d'une TPE/PME — Intervention Essentielle à partir de {{price:intervention-4h|flat}}, code custom sans no-code.",
    },
    implementation: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "À Rambouillet (78120), l'Audit Flash 4h démarre à {{price:audit-flash|flat}}, l'Intervention Essentielle à {{price:intervention-4h|flat}}, et l'Implémentation à {{price:impl-poc|entry}}. Tarifs publics, sans abonnement, déplacement Transilien N ou RN10 inclus.",
    },
    {
