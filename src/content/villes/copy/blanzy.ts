...
// Blanzy (71, Saône-et-Loire) — bassin minier Le Creusot-Montceau, musée de la mine, 5 955 hab.

import type { VilleCopy } from "./types";

export const BLANZY_COPY: VilleCopy = {
  pitchFr:
    "Blanzy (71), commune du bassin minier Le Creusot-Montceau en Saône-et-Loire, conjugue héritage industriel minier et reconversion économique. Tissu de TPE artisanales, PME industrielles, commerces de proximité et services à la personne. Axion-IA y intervient pour tous types d'activités.",
  pitchEn:
    "Blanzy (71), commune du bassin minier Le Creusot-Montceau en Saône-et-Loire, conjugue héritage industriel minier et reconversion économique. Tissu de TPE artisanales, PME industrielles, commerces de proximité et services à la personne. Axion-IA y intervient pour tous types d'activités.",
  directAnswerFr:
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Blanzy et dans le bassin Le Creusot-Montceau ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les PME industrielles et sous-traitants mécaniques du bassin Le Creusot-Montceau. Cas IA typiques : maintenance prédictive, contrôle qualité automatisé, planification production, reporting augmenté.",
    },
    {
