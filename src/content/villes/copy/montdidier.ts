...
// Montdidier (80, Somme) — Sous-préfecture, bourg picard.

import type { VilleCopy } from "./types";

export const MONTDIDIER_COPY: VilleCopy = {
  pitchFr:
    "Montdidier (80), sous-préfecture de la Somme en Picardie, bourg historique sur le plateau picard. Tissu de TPE artisans BTP, PME agroalimentaires, commerces de proximité, exploitations agricoles grandes cultures et services aux entreprises. Axion-IA y intervient pour tous types d'activités du Santerre.",
  pitchEn:
    "Montdidier (80), sous-préfecture de la Somme en Picardie, bourg historique sur le plateau picard. Tissu de TPE artisans BTP, PME agroalimentaires, commerces de proximité, exploitations agricoles grandes cultures et services aux entreprises. Axion-IA y intervient pour tous types d'activités du Santerre.",
  directAnswerFr:
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Montdidier : formats adaptés à l'exploitation agricole, l'atelier agroalimentaire, le commerce ou le cabinet libéral. Vos équipes repartent autonomes sur outils IA configurés métier.",
    },
    implementation: {
      fr: "Implémentation IA à Montdidier : optimisation rendements agricoles, automatisation gestion stocks agroalimentaire, agents conversationnels commerce, prédiction météo cultures Santerre.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Montdidier et dans le Santerre ?",
      a: "Oui, Axion-IA intervient à Montdidier et tout le Santerre (Roye, Péronne, Moreuil, Ailly-sur-Noye). Nos consultants viennent depuis Amiens (40 min voiture) ou Paris (1h30 A1/A16).",
    },
    {
