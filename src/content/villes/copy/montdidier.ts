...
export const MONTDIDIER_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'audit sur place IA à Montdidier démarre à {{price:audit-flash|flat}}. Diagnostic complet de vos processus, identification des cas d'usage IA prioritaires, ROI chiffré et plan d'action concret adapté à votre secteur du Santerre.",
    },
    {
