...
export const CHANTILLY_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Chantilly : sessions dans votre hôtel, restaurant, centre d'entraînement ou en visio. Dirigeants TPE/PME du sud de l'Oise souhaitant maîtriser l'IA appliquée à leur métier.",
      en: "Coaching 1-to-1 à Chantilly : sessions dans votre hôtel, restaurant, centre d'entraînement ou en visio. Dirigeants TPE/PME du sud de l'Oise souhaitant maîtriser l'IA appliquée à leur métier.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    {
      q: "Quel est le tarif d'un audit IA à Chantilly ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les TPE/PME du tourisme et de l'hôtellerie-restauration du bassin cantilien. Cas IA typiques : yield management, gestion réservations, analyse avis clients, automatisation check-in/check-out, optimisation planning et marketing digital.",
    },
    {
