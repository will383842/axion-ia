...
// Checy (45, Loiret) — Agglo Orleans est, bords Loire.
...
export const CHECY_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Checy est situee en bords de Loire a l'est d'Orleans Metropole, sur l'axe logistique Orleans-Montargis. L'economie locale s'appuie sur des PME industrielles, les services aux entreprises, le commerce, l'artisanat du batiment et la viticulture AOC Orleans-Clery en bordure du Val de Loire UNESCO.",
  distancesFr:
    "Orleans centre a 12 min. Paris a 1h25 A10/A19. Gare Orleans (TER/Intercites) a 15 min. Gare Checy-Mardié TER a proximite. Aeroport Paris-Orly a 1h20.",
  distancesEn:
    "Orleans centre a 12 min. Paris a 1h25 A10/A19. Gare Orleans (TER/Intercites) a 15 min. Gare Checy-Mardié TER a proximite. Aeroport Paris-Orly a 1h20.",
  seoHook: "industrie & viticulture Loire",
  topSectorsNaf: [
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA a Checy : diagnostic adapte aux PME industrielles, prestataires de services, commercants et viticulteurs de l'est de l'agglomeration orleanaise. ROI chiffre, Audit sur place {{price:audit-flash|flat}}.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il a Checy et dans l'est de l'agglomeration orleanaise ?",
      a: "Oui, Axion-IA intervient a Checy et dans tout l'est d'Orleans Metropole (Bou, Mardie, Combleux, Saint-Jean-de-Braye). Orleans centre a 12 min, Paris a 1h25 A10/A19.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, l'IA optimise les processus industriels : maintenance predictive, controle qualite automatise, planification production, gestion stocks, optimisation supply chain et sous-traitance.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, l'IA optimise la viticulture : prevision meteo parcellaire, gestion tracabilite AOC, optimisation vendanges, analyse qualite raisin, automatisation gestion cave et commercialisation.",
    },
  ],
};
