...
// Wervicq-Sud (59, Nord) — frontière Belgique, bords de la Lys, 5 426 hab.
...
export const WERVICQ_SUD_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Wervicq-Sud et dans la vallée de la Lys ?",
    ...
    },
    {
      ...
      a: "L'audit sur place IA à Wervicq-Sud démarre à {{price:audit-flash|flat}}. Il couvre le diagnostic de vos processus, l'identification des cas d'usage IA prioritaires et un ROI chiffré. Tous nos tarifs sont publics.",
    },
    {
      q: "Accompagnez-vous les entreprises transfrontalières à Wervicq-Sud ?",
      a: "Oui, nous accompagnons les acteurs transfrontaliers à Wervicq-Sud. Cas typiques IA : agents conversationnels bilingues FR/NL, automatisation documents douaniers, optimisation flux logistique cross-border Lys-Flandre occidentale.",
    },
    {
