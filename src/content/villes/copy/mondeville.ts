...
// Mondeville (14, Calvados) — Agglomération Caen est, reconversion industrielle (ex-SMN).
...
export const MONDEVILLE_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Mondeville et est agglomération Caen ?",
      a: "Oui, Axion-IA intervient à Mondeville et toute l'agglomération caennaise est (Colombelles, Hérouville-Saint-Clair, Giberville, Démouville). Consultants sur place en 10 min depuis Caen centre.",
    },
    {
      q: "Accompagnez-vous les entreprises des zones d'activités de Mondeville ?",
    ...
    },
    {
      ...
      a: "Pour les TPE artisans BTP et commerçants à Mondeville, audit Flash 490 € HT, intervention 1 journée formation, coaching 1-to-1. Cas typiques : automatisation devis, agents IA prise de RDV, gestion stocks.",
    },
    {
      q: "Quel est le tarif d'un audit IA à Mondeville ?",
