...
const AUDIT_FR: VilleServiceCopyLocale = {
  hero: "L'audit IA Axion-IA cartographie ce qui peut être automatisé dans votre organisation dyonisienne et chiffre le retour sur investissement à 12-24 mois. Quatre niveaux du Flash au Stratégique ETI couvrent toutes les tailles, des structures ESS et studios audiovisuels de la Plaine Saint-Denis aux grandes directions logistiques et BTP de l'intercommunalité Plaine Commune.",
  whyHere: [
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Le tarif dépend du niveau retenu — Audit Flash, Ciblé, Stratégique PME ou Stratégique ETI. Tarifs publics affichés sur la page Audit, calibrés selon votre taille (TPE, PME, ETI, grande entreprise). Aucun supplément géographique : le tarif est identique à Saint-Denis et partout en France.",
    },
    {
