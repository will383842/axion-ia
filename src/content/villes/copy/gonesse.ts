...
export const GONESSE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Gonesse (95, Val-d'Oise) compte 27 707 habitants (recensement 2023) à 16 km au nord-nord-est de Paris, dans la Communauté d'agglomération Roissy Pays de France. Son économie repose sur le Triangle de Gonesse (zone d'activités stratégique entre A1 et D170), la proximité immédiate de l'aéroport Paris-Charles-de-Gaulle, la logistique, le commerce de gros et de détail, ainsi qu'un tissu dense de TPE/PME de services. Patrimoine : église Saint-Pierre-Saint-Paul (XIIe-XIIIe). Axion-IA accompagne dirigeants TPE et PME locales avec du code custom.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Gonesse (95) et dans tout l'est du Val-d'Oise. Nous accompagnons en priorité les TPE et PME (logistique aéroportuaire CDG, commerce de gros et détail, transports terrestres, services aux entreprises, artisanat BTP) avec du code custom — sans no-code — adapté à votre métier. Audit Flash dès 590 € HT, intervention sur site, conformité RGPD systématique, déplacement rapide depuis Paris (16 km).",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Gonesse (95) et dans tout l'est du Val-d'Oise. Nous accompagnons en priorité les TPE et PME (logistique aéroportuaire CDG, commerce de gros et détail, transports terrestres, services aux entreprises, artisanat BTP) avec du code custom — sans no-code — adapté à votre métier. Audit Flash dès 590 € HT, intervention sur site, conformité RGPD systématique, déplacement rapide depuis Paris (16 km).",
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Gonesse : diagnostic terrain pour TPE et PME logistique CDG, commerce, transports et services Val-d'Oise. Audit Flash 590 € HT, ROI quantifié sous 5 jours ouvrés.",
      en: "Audit IA à Gonesse : diagnostic terrain pour TPE et PME logistique CDG, commerce, transports et services Val-d'Oise. Audit Flash 590 € HT, ROI quantifié sous 5 jours ouvrés.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "L'Intervention Essentielle et l'Audit Flash débutent à 590 € HT. Les frais de déplacement depuis Paris (16 km, 25 min en RER D) sont facturés en sus de manière transparente. Tarifs publics détaillés sur notre site.",
    },
    {
