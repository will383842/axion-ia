...
// Gravelines (59, Nord) — Côte Mer du Nord, citadelle Vauban, centrale nucléaire, 11 430 hab.
...
export const GRAVELINES_COPY: VilleCopy = {
  ...
  distancesEn:
    "Dunkerque à 15 min. Calais à 25 min. Lille centre à 1 h. Boulogne-sur-Mer à 40 min. Gare SNCF Gravelines (TER Dunkerque–Calais). Port de Dunkerque à 10 min. Autoroute A16 à proximité. Aéroport Lille-Lesquin à 1 h 10.",
  seoHook: "énergie nucléaire, littoral & port Dunkerque",
  topSectorsNaf: [
    "Sous-traitance nucléaire et énergie",
    "Pêche et mareyage",
    "Tourisme balnéaire et patrimoine",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Gravelines et sur le littoral dunkerquois ?",
    ...
    },
    {
      ...
      a: "Pour la pêche et le tourisme à Gravelines : traçabilité produits de la mer, gestion stocks criée, revenue management hébergements balnéaires Petit-Fort-Philippe, agents conversationnels touristes multilingues, automatisation réservations.",
    },
    {
