...
export const PRADES_LE_LEZ_COPY: VilleCopy = {
  pitchFr:
    "Prades-le-Lez (34), commune résidentielle du nord de Montpellier, source du Lez (alimentation en eau de Montpellier). Cadre naturel garrigue, forte croissance. Tissu TPE professions libérales, PME services, artisans, commerces de proximité. Axion-IA y intervient pour tous types d'activités.",
  pitchEn:
    "Prades-le-Lez (34), commune résidentielle du nord de Montpellier, source du Lez (alimentation en eau de Montpellier). Cadre naturel garrigue, forte croissance. Tissu TPE professions libérales, PME services, artisans, commerces de proximité. Axion-IA y intervient pour tous types d'activités.",
  directAnswerFr:
