...
// Flines-lez-Râches (59, Nord) — commune de la Pévèle, sud-est de Douai.
...
export const FLINES_LEZ_RACHES_COPY: VilleCopy = {
  ...
  pitchEn:
    "Flines-lez-Râches (59), commune de la Pévèle au sud-est de Douai, entre Orchies et Marchiennes. Tissu économique : TPE et PME agricoles et agroalimentaires de la plaine pévéloise, artisanat, commerce de proximité, services aux entreprises du Douaisis, logistique liée à l'axe autoroutier A23. Axion-IA y intervient pour tous types d'activités du bassin douaisien et de la Pévèle.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Flines-lez-Râches (59). Nous accompagnons TPE et PME : exploitations agricoles et PME agroalimentaires de la Pévèle, artisans, commerçants, prestataires de services B2B du bassin douaisien et professions libérales.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Flines-lez-Râches (59). Nous accompagnons TPE et PME : exploitations agricoles et PME agroalimentaires de la Pévèle, artisans, commerçants, prestataires de services B2B du bassin douaisien et professions libérales.",
  ...
  ecosystemEn:
    "Flines-lez-Râches est une commune rurale de la Pévèle, entre Douai (15 min) et Orchies (10 min). L'économie locale est portée par les exploitations agricoles et PME agroalimentaires de la plaine pévéloise (cultures céréalières, betteraves, maraîchage), l'artisanat du bâtiment, le commerce de bourg et les services aux entreprises irriguant le Douaisis. L'axe autoroutier A23 (Lille-Valenciennes) favorise la logistique et les échanges régionaux.",
  distancesFr:
    "Douai à 15 min, Orchies à 10 min, Lille à 35 min, Valenciennes à 30 min, Aéroport Lille-Lesquin à 30 min. Autoroute A23 Lille-Valenciennes à proximité, gare TGV Douai à 15 min.",
  distancesEn:
    "Douai à 15 min, Orchies à 10 min, Lille à 35 min, Valenciennes à 30 min, Aéroport Lille-Lesquin à 30 min. Autoroute A23 Lille-Valenciennes à proximité, gare TGV Douai à 15 min.",
  topSectorsNaf: [
    "Agriculture et agroalimentaire pévélois",
    "Artisanat du bâtiment",
    "Commerce de proximité",
    "Services aux entreprises Douaisis",
    "Logistique axe A23",
  ],
  servicesContext: {
    audit: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Flines-lez-Râches et dans la Pévèle ?",
      a: "Oui, Axion-IA intervient à Flines-lez-Râches et dans toute la Pévèle (Orchies, Marchiennes, Coutiches, Râches) ainsi que le bassin douaisien (Douai, Sin-le-Noble, Lambres-lez-Douai). Nos consultants couvrent l'ensemble du Douaisis-Pévèle depuis Lille (35 min).",
    },
    {
    ...
    },
    {
      ...
      a: "Pour les artisans et commerçants de Flines-lez-Râches et la Pévèle, nous proposons : automatisation devis-facturation, CRM augmenté gestion clients récurrents, copilotes IA planification chantiers et interventions, agents conversationnels prise de rendez-vous, génération contenus marketing local et réseaux sociaux.",
    },
    {
