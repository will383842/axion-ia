...
export const MONTIGNY_LES_METZ_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Montigny-lès-Metz pour les commerçants, artisans et cabinets libéraux de la commune — cartographie des automatisations à {{price:audit-flash|flat}}.",
