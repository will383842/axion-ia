...
export const LA_FERTE_BERNARD_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "La Ferté-Bernard est un bourg du Perche sarthois, au patrimoine Renaissance exceptionnel (église Notre-Dame-des-Marais, portes fortifiées). Pôle agroalimentaire (volaille, charcuterie, plats préparés), industrie, artisanat, commerces de centre-ville. Carrefour A11/RN23 entre Le Mans et Chartres.",
  distancesFr:
    "Gare TGV Le Mans à 45 km (TGV Paris 55 min). Gare de La Ferté-Bernard (TER Le Mans-Paris). Accès A11 (Paris-Le Mans). Aéroport Paris-CDG à 190 km.",
  distancesEn:
    "Gare TGV Le Mans à 45 km (TGV Paris 55 min). Gare de La Ferté-Bernard (TER Le Mans-Paris). Accès A11 (Paris-Le Mans). Aéroport Paris-CDG à 190 km.",
  topSectorsNaf: [
    "Agroalimentaire (volaille, charcuterie)",
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à La Ferté-Bernard : diagnostic adapté aux TPE artisans, PME agroalimentaires, industriels et commerçants du Perche sarthois. ROI chiffré, Audit Flash 490 € HT.",
      en: "Audit IA à La Ferté-Bernard : diagnostic adapté aux TPE artisans, PME agroalimentaires, industriels et commerçants du Perche sarthois. ROI chiffré, Audit Flash 490 € HT.",
    },
    interventions: {
      fr: "Interventions IA sur site à La Ferté-Bernard : formations adaptées aux PME agroalimentaires (volaille, charcuterie), industriels, artisans et commerçants du Perche sarthois. Vos équipes repartent autonomes.",
      en: "Interventions IA sur site à La Ferté-Bernard : formations adaptées aux PME agroalimentaires (volaille, charcuterie), industriels, artisans et commerçants du Perche sarthois. Vos équipes repartent autonomes.",
    },
    implementation: {
      fr: "Implémentation IA à La Ferté-Bernard : traçabilité filière volaille, contrôle qualité charcuterie/plats préparés, automatisation processus industriels, agents conversationnels commerces.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à La Ferté-Bernard et dans le Perche sarthois ?",
      a: "Oui, Axion-IA intervient à La Ferté-Bernard et dans tout le Perche sarthois (Montmirail, Tuffé, Vibraye, Bouloire). Nos consultants se déplacent depuis Le Mans (45 min A11) ou Paris (TER direct).",
    },
    {
      q: "Travaillez-vous avec les PME agroalimentaires du Perche sarthois ?",
    ...
    },
    {
      ...
      a: "L'Audit Flash démarre à 490 € HT pour 4 heures de diagnostic complet. Adapté aux TPE artisans, PME agroalimentaires et industriels du Perche sarthois. Tarifs publics, sans surprise.",
    },
    {
      q: "Proposez-vous des formations IA pour la filière volaille ?",
      a: "Oui, nos interventions forment vos équipes aux outils IA adaptés à la filière volaille : contrôle qualité par vision, traçabilité lots, optimisation élevage, prédiction demande et automatisation conditionnement.",
    },
    {
