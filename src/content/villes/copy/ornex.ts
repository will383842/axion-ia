...
export const ORNEX_COPY: VilleCopy = {
  ...
  distancesEn:
    "Ornex est à quelques minutes de la frontière suisse : le centre de Genève est à un quart d'heure, l'aéroport de Genève-Cointrin à 15 minutes, Ferney-Voltaire et le CERN à 5 minutes, Gex à 5 minutes également. Lyon et sa gare TGV sont à environ une heure trente par l'autoroute. Cette position frontalière unique facilite nos interventions sur tout le pays de Gex, de Saint-Genis-Pouilly à Divonne-les-Bains.",
  topSectorsNaf: [
    "Services aux entreprises transfrontaliers",
    "Artisanat et travaux de construction BTP",
    "Commerce de proximité",
    "Tertiaire et professions libérales",
    "Activités liées à l'économie frontalière Genève",
  ],
  servicesContext: {
    audit: {
    ...
    sitesWeb: {
      ...
      en: "Sites web augmentés à Ornex : plateformes multilingues sur mesure avec IA intégrée pour services, commerces et artisans souhaitant capter la clientèle franco-genevoise.",
    },
  },
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Ornex et dans le pays de Gex ?",
      a: "Oui. Nos architectes IA se déplacent à Ornex et dans tout le pays de Gex, de Ferney-Voltaire à Gex, Saint-Genis-Pouilly et Divonne-les-Bains, pour audits, interventions et implémentations, généralement sous cinq jours ouvrés après validation.",
    },
    {
      q: "Travaillez-vous avec l'économie frontalière de Genève ?",
      a: "Oui. C'est une spécificité d'Ornex. Nous déployons des agents conversationnels multilingues FR/EN/DE, automatisons les workflows transfrontaliers et la classification de documents pour les entreprises tournées vers le bassin genevois.",
    },
    {
      q: "Accompagnez-vous les PME tertiaires du pays de Gex ?",
