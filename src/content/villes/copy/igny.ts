...
// Igny (91, Essonne) — nord Essonne, vallée de la Bièvre, résidentielle, proximité plateau de Saclay.
...
export const IGNY_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Igny et dans le nord de l'Essonne ?",
      a: "Oui, Axion-IA intervient à Igny et dans tout le nord de l'Essonne (Bièvres, Vauhallan, Palaiseau, Massy). Couverture vallée de la Bièvre et plateau de Saclay.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les PME ingénierie et conseil proches de Paris-Saclay sur leurs cas IA : automatisation reporting, classification données techniques, prédiction délais projets, optimisation ressources.",
    },
    {
