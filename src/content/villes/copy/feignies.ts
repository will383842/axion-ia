...
// Feignies (59, Nord) — Agglo Maubeuge, Vauban, 6 703 hab.
...
export const FEIGNIES_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Feignies : formats adaptés à l'atelier industriel, chantier BTP, commerce, bureau. Vos équipes repartent autonomes sur les outils IA du quotidien.",
    },
    implementation: {
      fr: "Implémentation IA à Feignies : contrôle qualité production métallurgique, traçabilité sous-traitance automobile, automatisation devis BTP, agents IA service client, outils transfrontaliers FR/BE.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Feignies et Maubeuge ?",
      a: "Oui, Axion-IA intervient à Feignies et dans toute l'agglomération Maubeuge-Val de Sambre (Louvroil, Jeumont, Hautmont, Ferrière-la-Grande). Nos consultants viennent via gare de Maubeuge (5 min) ou en visio selon vos contraintes.",
    },
    {
