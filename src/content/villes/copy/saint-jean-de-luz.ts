...
// Saint-Jean-de-Luz (64, Pyrénées-Atlantiques) — Port, tourisme Côte Basque, maison Louis XIV, 14 857 hab.
...
export const SAINT_JEAN_DE_LUZ_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Saint-Jean-de-Luz est un port de pêche historique et une station balnéaire emblématique de la Côte Basque. La maison Louis XIV rappelle le mariage royal de 1660. Son économie s'appuie sur le tourisme (plage, patrimoine, gastronomie), l'hôtellerie-restauration haut de gamme, le port de pêche (thon, anchois, sardine), le commerce de centre-ville (boutiques basques, artisanat), les professions libérales et les services. Le bassin d'emploi s'étend à Ciboure, Hendaye et au BAB.",
  distancesFr:
    "Bayonne à 25 min via A63. Biarritz à 20 min. Hendaye à 15 min. San Sebastián (Espagne) à 35 min. Gare SNCF Saint-Jean-de-Luz—Ciboure (TGV Paris, TER). Aéroport Biarritz Pays Basque à 20 min.",
  distancesEn:
    "Bayonne à 25 min via A63. Biarritz à 20 min. Hendaye à 15 min. San Sebastián (Espagne) à 35 min. Gare SNCF Saint-Jean-de-Luz—Ciboure (TGV Paris, TER). Aéroport Biarritz Pays Basque à 20 min.",
  seoHook: "tourisme, pêche & port Côte Basque",
  topSectorsNaf: [
    "Tourisme balnéaire & hôtellerie-restauration",
    "Pêche, filière halieutique & mareyage",
    "Commerce centre-ville & artisanat basque",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Saint-Jean-de-Luz : formats adaptés à l'hôtel, au restaurant, à la criée, au commerce ou au cabinet. Vos équipes repartent autonomes sur les outils IA configurés métier.",
    },
    implementation: {
      fr: "Implémentation IA à Saint-Jean-de-Luz : yield management hôtelier saisonnier, traçabilité pêche et mareyage, agents conversationnels tourisme multilingues, gestion saisonnalité, classification avis clients.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Jean-de-Luz et sur la Côte Basque ?",
    ...
    },
    {
      ...
      a: "Nos consultants interviennent sur site à Saint-Jean-de-Luz et sur la Côte Basque. Déplacement direct sur votre hôtel, restaurant, commerce ou bureau. Gare TGV Saint-Jean-de-Luz—Ciboure, aéroport Biarritz à 20 min.",
    },
  ],
};
