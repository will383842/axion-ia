...
export const BORDEAUX_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    sitesWeb: {
      ...
      en: "Custom web platforms and SaaS AI for Gironde SMEs and mid-caps — premium showcase site for wine estates and export trading, B2B client portal for Aerospace Valley sub-contractors, business dashboard connected to your CRM/ERP. Senior experts, Axion-IA design system, European hosting.",
    },
  },
  ...
  services: {
    audit: {
      fr: {
        hero: "L'audit IA Axion-IA à Bordeaux cartographie ce qui peut être automatisé dans votre organisation et chiffre le retour sur investissement à 12-24 mois. De la PME viticole au groupe aéronautique de la Métropole, quatre niveaux du Sur place au Stratégique ETI couvrent toute l'échelle. Restitution toujours en présentiel dans vos locaux bordelais, livrable PDF chiffré remis en main propre.",
        whyHere: [
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Bordeaux des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 24-48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Bordeaux, itérations à distance.",
        whyHere: [
          "Projets web & SaaS bordelais : aéronautique-défense (Aerospace Valley, Dassault, ArianeGroup), filière vin & œnotourisme (8 AOC, Cité du Vin), hub numérique French Tech (OVH, Cdiscount, H7 Bassins à Flot), tertiaire Euratlantique.",
          ...
          "E-commerce vin & œnotourisme : recommandation, fiches générées, assistant d'achat multilingue — un levier fort pour la filière bordelaise à l'export.",
        ],
        methodology: [
          {
            step: "Cadrage à Bordeaux",
            detail:
        ...
        pricing: [
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une boutique avec UX/UI et IA intégrée, pour propriétés viticoles, scale-ups et PME bordelaises.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Plateforme métier ou portail client sur mesure pour la défense, le négoce ou l'e-commerce, IA intégrée, branchée sur votre SI (CRM, ERP, datalake).",
          },
          {
            sizeLabel: "Grande entreprise",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Bordeaux — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Vous gérez l'e-commerce vin et l'export multilingue ?",
            a: "Oui : recommandation produit, génération de fiches, assistant d'achat et traduction multilingue (Shopify, WooCommerce, PrestaShop). Un vrai levier pour la filière vin bordelaise à l'international, conforme HCU et AI Act. Hébergement UE, RGPD strict.",
          },
          {
        ...
        guarantees:
          "Devis ferme en forfait fixe (à partir de 24-48 h selon la complexité) : pas de dérive horaire cachée. Mise en ligne sans downtime quand on augmente l'existant. Web Vitals et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD : propriété totale, aucun abonnement imposé, transférable à tout prestataire de la région bordelaise ou repris en interne.",
      },
      en: {
        hero: "In Bordeaux, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 24-48 h depending on project complexity, EU hosting, code and data yours. On-site Bordeaux kick-off, remote iterations.",
        whyHere: [
          "Bordeaux web & SaaS projects: aeronautics-defence (Aerospace Valley, Dassault, ArianeGroup), wine & wine-tourism (8 AOC, Cité du Vin), French Tech digital hub (OVH, Cdiscount, H7 Bassins à Flot), Euratlantique business district.",
          ...
          "Wine e-commerce & wine-tourism: recommendation, generated sheets, multilingual shopping assistant — a strong lever for Bordeaux's export wine sector.",
        ],
        methodology: [
          {
            step: "Scoping in Bordeaux",
            detail:
        ...
        pricing: [
          {
            ...
            detail:
              "Design or rebuild of a site or shop with UX/UI and built-in AI, for wine estates, scale-ups and Bordeaux SMEs.",
          },
          {
            sizeLabel: "Mid-cap",
            price: "AI-native SaaS platform",
            detail:
              "Bespoke business platform or customer portal for defence, trade or e-commerce, AI built in, wired into your IS (CRM, ERP, datalake).",
          },
          {
            sizeLabel: "Large enterprise",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Bordeaux — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Do you handle wine e-commerce and multilingual export?",
            a: "Yes: product recommendation, sheet generation, shopping assistant and multilingual translation (Shopify, WooCommerce, PrestaShop). A real lever for Bordeaux's wine sector internationally, HCU and AI Act compliant. EU hosting, strict GDPR.",
          },
          {
