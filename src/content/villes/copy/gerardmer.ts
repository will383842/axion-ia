...
export const GERARDMER_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Gérardmer : sessions dans votre hôtel, restaurant, commerce, atelier ou en visio. Dirigeants TPE/PME du tourisme et artisans du massif vosgien souhaitant maîtriser l'IA au quotidien.",
      en: "Coaching 1-to-1 à Gérardmer : sessions dans votre hôtel, restaurant, commerce, atelier ou en visio. Dirigeants TPE/PME du tourisme et artisans du massif vosgien souhaitant maîtriser l'IA au quotidien.",
    },
  },
  faqGeolocalisee: [
    {
