...
export const TOULON_COPY: VilleCopy = {
  ...
  services: {
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Toulon des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 24-48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Toulon, itérations à distance.",
        whyHere: [
          "Projets web & SaaS toulonnais : défense & naval (Naval Group, Thales Underwater, Marine nationale), Pôle Mer Méditerranée, PME et ETI de la défense maritime, tourisme varois.",
          ...
          "Secteur défense : confidentialité contractuelle stricte, hébergement UE souverain, code et données chez vous — adapté aux exigences du 1er port militaire d'Europe.",
        ],
        methodology: [
          {
            step: "Cadrage à Toulon",
            detail:
        ...
        pricing: [
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une application avec UX/UI et IA intégrée, pour PME, sous-traitants défense et acteurs du tourisme varois.",
          },
          {
            sizeLabel: "ETI",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Toulon — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Vous gérez les exigences de confidentialité du secteur défense ?",
            a: "Oui : confidentialité contractuelle stricte, hébergement UE souverain, code et données livrés dans votre infrastructure, jamais de transit hors UE. Un cadre adapté à l'écosystème naval et défense toulonnais (Naval Group, Thales Underwater).",
          },
          {
        ...
        guarantees:
          "Devis ferme en forfait fixe (à partir de 24-48 h selon la complexité) : pas de dérive horaire cachée. Mise en ligne sans downtime quand on augmente l'existant. Web Vitals et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD : propriété totale, aucun abonnement imposé, transférable à tout prestataire de la région toulonnaise ou repris en interne.",
      },
      en: {
        hero: "In Toulon, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 24-48 h depending on project complexity, EU hosting, code and data yours. On-site Toulon kick-off, remote iterations.",
        whyHere: [
          "Toulon web & SaaS projects: defence & naval (Naval Group, Thales Underwater, French Navy), Pôle Mer Méditerranée, maritime defence SMEs and mid-caps, Var tourism.",
          ...
          "Defence sector: strict contractual confidentiality, sovereign EU hosting, code and data with you — fit for the requirements of Europe's leading military port.",
        ],
        methodology: [
          {
            step: "Scoping in Toulon",
            detail:
        ...
        pricing: [
          {
            ...
            detail:
              "Design or rebuild of a site or app with UX/UI and built-in AI, for SMEs, defence subcontractors and Var tourism players.",
          },
          {
            sizeLabel: "Mid-cap",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Toulon — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Do you handle defence-sector confidentiality requirements?",
            a: "Yes: strict contractual confidentiality, sovereign EU hosting, code and data delivered into your infrastructure, never any transit outside the EU. A framework fit for the Toulon naval and defence ecosystem (Naval Group, Thales Underwater).",
          },
          {
