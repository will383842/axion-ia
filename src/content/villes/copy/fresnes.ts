...
export const FRESNES_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Fresnes pour cartographier les processus prioritaires des TPE et PME de l'écosystème Sanofi Pasteur, des opérateurs logistiques Rungis-Orly et des sièges tertiaires du Grand Paris Sud.",
      en: "Audit IA à Fresnes pour cartographier les processus prioritaires des TPE et PME de l'écosystème Sanofi Pasteur, des opérateurs logistiques Rungis-Orly et des sièges tertiaires du Grand Paris Sud.",
    },
    interventions: {
      fr: "Intervention sur site à Fresnes pour déployer des solutions IA opérationnelles (automatisation logistique, qualité bioproduction, relation client) chez les TPE et PME du Val-de-Marne Sud.",
      en: "Intervention sur site à Fresnes pour déployer des solutions IA opérationnelles (automatisation logistique, qualité bioproduction, relation client) chez les TPE et PME du Val-de-Marne Sud.",
    },
    implementation: {
      fr: "Implémentation d'outils IA à Fresnes pour les TPE et PME logistiques connectées au MIN de Rungis, les sous-traitants biotech et les sièges du tertiaire desservis par l'A86 et le RER B.",
      en: "Implémentation d'outils IA à Fresnes pour les TPE et PME logistiques connectées au MIN de Rungis, les sous-traitants biotech et les sièges du tertiaire desservis par l'A86 et le RER B.",
    },
    unAUn: {
      fr: "Accompagnement un-à-un à Fresnes pour les dirigeants de TPE et PME du Sud parisien souhaitant intégrer l'IA dans leurs décisions opérationnelles et leur stratégie sectorielle.",
      en: "Accompagnement un-à-un à Fresnes pour les dirigeants de TPE et PME du Sud parisien souhaitant intégrer l'IA dans leurs décisions opérationnelles et leur stratégie sectorielle.",
    },
    sitesWeb: {
      fr: "Plateformes web et SaaS augmentés par IA conçus à Fresnes pour les TPE et PME locales : portails clients, outils métiers internes, automatisation des flux logistiques et e-commerce.",
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Nous adressons en priorité les TPE et PME de quatre filières locales : l'écosystème santé-biotech autour de Sanofi Pasteur, la logistique et l'e-commerce gravitant autour du MIN de Rungis (5 km) et de l'aéroport d'Orly (8 km), les sièges tertiaires du Grand Paris Sud et le BTP lié au NPNRU.",
    },
    {
      q: "Combien de temps faut-il pour démarrer un projet IA à Fresnes ?",
      a: "Pour une TPE ou PME basée à Fresnes ou dans le Val-de-Marne, le démarrage opérationnel intervient sous 5 jours ouvrés après signature. La proximité de l'A86 et du RER B Antony nous permet d'organiser une première session sur site sans contrainte logistique pour vos équipes.",
    },
    {
      q: "Travaillez-vous avec les sous-traitants de l'écosystème Sanofi Pasteur à Fresnes ?",
      a: "Oui. Nous accompagnons régulièrement les TPE et PME sous-traitantes des grands acteurs santé-biotech, sur des sujets de qualité bioproduction, traçabilité documentaire, gestion des écarts, automatisation des rapports réglementaires et conformité RGPD-données de santé.",
    },
    {
      q: "Comment Axion-IA aide-t-elle les acteurs logistiques connectés au MIN de Rungis ?",
      a: "Nous concevons pour les TPE et PME logistiques de Fresnes des outils d'IA opérationnelle : optimisation des tournées Rungis-Orly, prévision de la demande, automatisation des bordereaux, qualité du dernier kilomètre et tableaux de bord temps réel adaptés au tempo du marché.",
    },
    {
