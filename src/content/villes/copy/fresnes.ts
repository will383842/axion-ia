...
// Fresnes (94, Val-de-Marne) — Sanofi Pasteur, MIN Rungis 5 km, Orly 8 km, axe A86 Grand Paris Sud.

import type { VilleCopy } from "./types";

export const FRESNES_COPY: VilleCopy = {
  pitchFr:
    "À Fresnes (94, Val-de-Marne), Axion-IA accompagne les PME et ETI du Sud parisien dans leur transition vers l'IA opérationnelle. Notre cabinet d'architectes seniors en intelligence artificielle intervient sur site dans cette commune de 27 000 habitants, idéalement positionnée sur l'A86 entre Paris Porte d'Italie (12 km) et l'aéroport d'Orly (8 km). Nous adressons en priorité les PME et ETI de l'écosystème santé-biotech gravitant autour du site historique Sanofi Pasteur, les acteurs logistiques et e-commerce profitant de la proximité immédiate du MIN de Rungis (5 km), les sièges sociaux du tertiaire bien desservis par le RER B Antony et le futur Grand Paris Express, ainsi que les artisans et commerçants du tissu local. Audit, intervention sur site, implémentation, accompagnement un-à-un et plateformes web augmentées.",
  pitchEn:
    "À Fresnes (94, Val-de-Marne), Axion-IA accompagne les PME et ETI du Sud parisien dans leur transition vers l'IA opérationnelle. Notre cabinet d'architectes seniors en intelligence artificielle intervient sur site dans cette commune de 27 000 habitants, idéalement positionnée sur l'A86 entre Paris Porte d'Italie (12 km) et l'aéroport d'Orly (8 km). Nous adressons en priorité les PME et ETI de l'écosystème santé-biotech gravitant autour du site historique Sanofi Pasteur, les acteurs logistiques et e-commerce profitant de la proximité immédiate du MIN de Rungis (5 km), les sièges sociaux du tertiaire bien desservis par le RER B Antony et le futur Grand Paris Express, ainsi que les artisans et commerçants du tissu local. Audit, intervention sur site, implémentation, accompagnement un-à-un et plateformes web augmentées.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui se déplace à Fresnes (Val-de-Marne, 94260) pour accompagner les PME et ETI dans l'adoption opérationnelle de l'intelligence artificielle. Nous intervenons sur site auprès des entreprises de l'écosystème Sanofi Pasteur, des opérateurs logistiques connectés au MIN de Rungis (5 km) et aux plateformes d'Orly (8 km), ainsi que des sièges sociaux du Grand Paris Sud Seine-Bièvre. Notre offre couvre cinq services : audit IA, intervention sur site, implémentation, accompagnement un-à-un des dirigeants et plateformes web augmentées. Tarifs publics affichés, déplacement intra-A86 inclus, démarrage sous 5 jours ouvrés.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes seniors en intelligence artificielle qui se déplace à Fresnes (Val-de-Marne, 94260) pour accompagner les PME et ETI dans l'adoption opérationnelle de l'intelligence artificielle. Nous intervenons sur site auprès des entreprises de l'écosystème Sanofi Pasteur, des opérateurs logistiques connectés au MIN de Rungis (5 km) et aux plateformes d'Orly (8 km), ainsi que des sièges sociaux du Grand Paris Sud Seine-Bièvre. Notre offre couvre cinq services : audit IA, intervention sur site, implémentation, accompagnement un-à-un des dirigeants et plateformes web augmentées. Tarifs publics affichés, déplacement intra-A86 inclus, démarrage sous 5 jours ouvrés.",
  seoHook: "santé-biotech, logistique Rungis & tertiaire Orly",
  ecosystemFr:
    "Fresnes structure son économie autour de trois pôles complémentaires. Le pôle santé-biotech est ancré par Sanofi Pasteur, implanté historiquement depuis 1947 pour la recherche et la production de vaccins, qui draine un tissu de PME et ETI sous-traitantes (bioproduction, qualité, instrumentation). Le pôle logistique et e-commerce profite de l'adjacence au MIN de Rungis (5 km, premier marché mondial de produits frais) et à la plateforme aéroportuaire d'Orly (8 km), avec zones d'activités dédiées aux entrepôts, transporteurs et opérateurs du dernier kilomètre. Le pôle tertiaire concentre sièges sociaux, centres de relation client et services aux entreprises attirés par la desserte RER B Antony, le tram T7 et le futur Grand Paris Express (lignes 14 et 15). À cela s'ajoutent le BTP du Grand Paris (NPNRU), la restauration et le commerce de proximité.",
  ecosystemEn:
    "Fresnes structure son économie autour de trois pôles complémentaires. Le pôle santé-biotech est ancré par Sanofi Pasteur, implanté historiquement depuis 1947 pour la recherche et la production de vaccins, qui draine un tissu de PME et ETI sous-traitantes (bioproduction, qualité, instrumentation). Le pôle logistique et e-commerce profite de l'adjacence au MIN de Rungis (5 km, premier marché mondial de produits frais) et à la plateforme aéroportuaire d'Orly (8 km), avec zones d'activités dédiées aux entrepôts, transporteurs et opérateurs du dernier kilomètre. Le pôle tertiaire concentre sièges sociaux, centres de relation client et services aux entreprises attirés par la desserte RER B Antony, le tram T7 et le futur Grand Paris Express (lignes 14 et 15). À cela s'ajoutent le BTP du Grand Paris (NPNRU), la restauration et le commerce de proximité.",
  distancesFr:
    "Fresnes est positionnée sur l'A86 (rocade Grand Paris) à 12 km de Paris Porte d'Italie, 8 km de l'aéroport d'Orly, 5 km du MIN de Rungis, 3 km du RER B Antony et 5 km de Cachan. Tram T7 Villejuif-Athis et futures lignes 14 et 15 du Grand Paris Express (mise en service progressive 2025-2030).",
  distancesEn:
    "Fresnes est positionnée sur l'A86 (rocade Grand Paris) à 12 km de Paris Porte d'Italie, 8 km de l'aéroport d'Orly, 5 km du MIN de Rungis, 3 km du RER B Antony et 5 km de Cachan. Tram T7 Villejuif-Athis et futures lignes 14 et 15 du Grand Paris Express (mise en service progressive 2025-2030).",
  topSectorsNaf: [
    "Industrie pharmaceutique et biotechnologies (écosystème Sanofi Pasteur)",
    "Logistique, entreposage et e-commerce (corridor MIN Rungis - Orly)",
    "Services aux entreprises et centres de relation client (sièges tertiaires Grand Paris Sud)",
    "Construction et rénovation BTP (NPNRU et programmes Grand Paris)",
    "Commerce alimentaire et restauration (proximité MIN de Rungis)",
  ],
  servicesContext: {
    audit: {
      fr: "Audit IA à Fresnes pour cartographier les processus prioritaires des PME et ETI de l'écosystème Sanofi Pasteur, des opérateurs logistiques Rungis-Orly et des sièges tertiaires du Grand Paris Sud.",
      en: "Audit IA à Fresnes pour cartographier les processus prioritaires des PME et ETI de l'écosystème Sanofi Pasteur, des opérateurs logistiques Rungis-Orly et des sièges tertiaires du Grand Paris Sud.",
    },
    interventions: {
      fr: "Intervention sur site à Fresnes pour déployer des solutions IA opérationnelles (automatisation logistique, qualité bioproduction, relation client) chez les PME et ETI du Val-de-Marne Sud.",
      en: "Intervention sur site à Fresnes pour déployer des solutions IA opérationnelles (automatisation logistique, qualité bioproduction, relation client) chez les PME et ETI du Val-de-Marne Sud.",
    },
    implementation: {
      fr: "Implémentation d'outils IA à Fresnes pour les PME et ETI logistiques connectées au MIN de Rungis, les sous-traitants biotech et les sièges du tertiaire desservis par l'A86 et le RER B.",
      en: "Implémentation d'outils IA à Fresnes pour les PME et ETI logistiques connectées au MIN de Rungis, les sous-traitants biotech et les sièges du tertiaire desservis par l'A86 et le RER B.",
    },
    unAUn: {
      fr: "Accompagnement un-à-un à Fresnes pour les dirigeants de PME et d'ETI du Sud parisien souhaitant intégrer l'IA dans leurs décisions opérationnelles et leur stratégie sectorielle.",
      en: "Accompagnement un-à-un à Fresnes pour les dirigeants de PME et d'ETI du Sud parisien souhaitant intégrer l'IA dans leurs décisions opérationnelles et leur stratégie sectorielle.",
    },
    sitesWeb: {
      fr: "Plateformes web et SaaS augmentés par IA conçus à Fresnes pour les PME et ETI locales : portails clients, outils métiers internes, automatisation des flux logistiques et e-commerce.",
      en: "Plateformes web et SaaS augmentés par IA conçus à Fresnes pour les PME et ETI locales : portails clients, outils métiers internes, automatisation des flux logistiques et e-commerce.",
    },
  },
  services: {
    sitesWeb: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Oui. Nos experts IA seniors se déplacent à Fresnes et dans toute la couronne Sud de l'A86, y compris Antony, Cachan, L'Haÿ-les-Roses, Rungis et Villejuif. Le déplacement intra-Val-de-Marne est inclus dans nos forfaits publics, sans frais cachés.",
    },
    {
      q: "Quels secteurs d'activité accompagnez-vous en priorité à Fresnes ?",
      a: "Nous adressons en priorité les PME et ETI de quatre filières locales : l'écosystème santé-biotech autour de Sanofi Pasteur, la logistique et l'e-commerce gravitant autour du MIN de Rungis (5 km) et de l'aéroport d'Orly (8 km), les sièges tertiaires du Grand Paris Sud et le BTP lié au NPNRU.",
    },
    {
      q: "Combien de temps faut-il pour démarrer un projet IA à Fresnes ?",
      a: "Pour une PME ou ETI basée à Fresnes ou dans le Val-de-Marne, le démarrage opérationnel intervient sous 5 jours ouvrés après signature. La proximité de l'A86 et du RER B Antony nous permet d'organiser une première session sur site sans contrainte logistique pour vos équipes.",
    },
    {
      q: "Travaillez-vous avec les sous-traitants de l'écosystème Sanofi Pasteur à Fresnes ?",
      a: "Oui. Nous accompagnons régulièrement les PME et ETI sous-traitantes des grands acteurs santé-biotech, sur des sujets de qualité bioproduction, traçabilité documentaire, gestion des écarts, automatisation des rapports réglementaires et conformité RGPD-données de santé.",
    },
    {
      q: "Comment Axion-IA aide-t-elle les acteurs logistiques connectés au MIN de Rungis ?",
      a: "Nous concevons pour les PME et ETI logistiques de Fresnes des outils d'IA opérationnelle : optimisation des tournées Rungis-Orly, prévision de la demande, automatisation des bordereaux, qualité du dernier kilomètre et tableaux de bord temps réel adaptés au tempo du marché.",
    },
    {
      q: "Garantissez-vous la conformité RGPD pour vos interventions à Fresnes ?",
      a: "Oui. Toutes nos implémentations à Fresnes respectent le RGPD européen et l'AI Act 2024, avec hébergement de données en France ou en UE, documentation des traitements et clauses de réversibilité (pas de lock-in fournisseur).",
    },
  ],
};
