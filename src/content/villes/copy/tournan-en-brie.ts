...
export const TOURNAN_EN_BRIE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Tournan-en-Brie : diagnostic adapté aux TPE artisans, PME de services, commerçants et professions libérales de la Brie est francilienne. ROI chiffré, Audit Flash 490 € HT.",
      en: "Audit IA à Tournan-en-Brie : diagnostic adapté aux TPE artisans, PME de services, commerçants et professions libérales de la Brie est francilienne. ROI chiffré, Audit Flash 490 € HT.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'Audit Flash IA à Tournan-en-Brie démarre à 490 € HT. Ce diagnostic couvre l'analyse de vos processus métier, l'identification des cas d'usage IA prioritaires et un plan d'action chiffré avec ROI estimé.",
    },
    {
