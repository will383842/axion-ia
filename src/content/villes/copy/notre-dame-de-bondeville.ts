...
export const NOTRE_DAME_DE_BONDEVILLE_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Pour les commercants, nous proposons : gestion stocks IA, agents conversationnels, fidelisation client, comptabilite augmentee, analyse ventes. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
