...
// Farébersviller (57, Moselle) — Bassin houiller lorrain.
...
export const FAREBERSVILLER_COPY: VilleCopy = {
  ...
  distancesEn:
    "Freyming-Merlebach à 5 min. Saint-Avold à 10 min. Forbach à 15 min. Metz à 50 min. Sarrebruck (Allemagne) à 30 min. Autoroute A4 accès proche. Gare SNCF Freyming-Merlebach à 5 min. Aéroport Metz-Nancy-Lorraine à 45 min.",
  seoHook: "bassin houiller & reconversion",
  topSectorsNaf: [
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Farébersviller ?",
      a: "Oui, Axion-IA intervient à Farébersviller et dans tout le Bassin houiller mosellan (Freyming-Merlebach, Hombourg-Haut, Saint-Avold, Forbach). Consultants via autoroute A4 ou gare SNCF Freyming-Merlebach.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les artisans BTP et entreprises du second œuvre de Farébersviller pour intégrer l'IA dans leur quotidien : devis automatisés, planification chantier, gestion fournisseurs.",
    },
    {
