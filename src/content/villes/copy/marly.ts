...
// Marly (59, Nord) — commune de l'agglomération de Valenciennes sud, 11 995 hab.
...
export const MARLY_COPY: VilleCopy = {
  ...
  topSectorsNaf: [
    ...
    "Services aux entreprises (conseil, comptabilité)",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Marly et dans le sud valenciennois ?",
      a: "Oui, Axion-IA intervient à Marly et dans toute l'agglomération sud de Valenciennes (Aulnoy-lez-Valenciennes, Famars, Artres, Querenaing, Prouvy, Rouvignies) ainsi que l'ensemble du Valenciennois. Nos consultants couvrent la zone depuis Valenciennes centre (5 min).",
    },
    {
    ...
    },
    {
      ...
      a: "Pour les cabinets de professions libérales à Marly (santé, juridique, comptabilité), nous proposons : agents IA prise de rendez-vous et gestion planning, automatisation rédaction comptes-rendus et actes, copilotes IA conformité réglementaire et RGPD, génération documents clients, chatbots accueil et orientation patients ou clients.",
    },
    {
