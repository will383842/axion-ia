...
export const AUBAGNE_COPY: VilleCopy = {
  pitchFr:
    "Aubagne (13), patrie de Marcel Pagnol et capitale du santon d'argile, prolonge sa tradition céramique et tuilière par un tissu dense de TPE et PME : artisanat d'art, agroalimentaire, commerce de proximité et logistique de l'est marseillais. La ville accueille aussi le commandement de la Légion étrangère. Axion-IA, cabinet d'experts IA seniors, accompagne en priorité ces TPE puis les PME, plus rarement les ETI, pour intégrer une IA concrète et rentable sans jargon ni dépendance technique.",
  pitchEn:
    "Aubagne (13), patrie de Marcel Pagnol et capitale du santon d'argile, prolonge sa tradition céramique et tuilière par un tissu dense de TPE et PME : artisanat d'art, agroalimentaire, commerce de proximité et logistique de l'est marseillais. La ville accueille aussi le commandement de la Légion étrangère. Axion-IA, cabinet d'experts IA seniors, accompagne en priorité ces TPE puis les PME, plus rarement les ETI, pour intégrer une IA concrète et rentable sans jargon ni dépendance technique.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Aubagne (13) auprès des TPE et PME : santonniers et céramistes, agroalimentaire, commerces de proximité, artisans BTP et logistique de l'est marseillais. Nous diagnostiquons les tâches automatisables, déployons des outils IA fiables et formons vos équipes, sans dépendance technique. Les ETI sont accompagnées en complément.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Aubagne (13) auprès des TPE et PME : santonniers et céramistes, agroalimentaire, commerces de proximité, artisans BTP et logistique de l'est marseillais. Nous diagnostiquons les tâches automatisables, déployons des outils IA fiables et formons vos équipes, sans dépendance technique. Les ETI sont accompagnées en complément.",
