...
export const SAINT_ALBAN_COPY: VilleCopy = {
  ...
  pitchEn:
    "Saint-Alban (31), commune du nord de Toulouse avec plus de 6 500 habitants. Tissu TPE artisans, PME de services, commerces de proximité, professions libérales. Axion-IA opère sur l'ensemble des activités professionnelles locales de la couronne nord de Toulouse.",
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Saint-Alban (31). Nous accompagnons TPE artisans, PME de services, professions libérales et commerçants du nord Toulouse. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Saint-Alban (31). Nous accompagnons TPE artisans, PME de services, professions libérales et commerçants du nord Toulouse. Audit sur place sur mesure.",
  ...
  servicesContext: {
    ...
    implementation: {
      ...
      en: "Implémentation IA à Saint-Alban : automatisation gestion clients, classification documents, agents conversationnels, reporting pour TPE-PME du nord Toulouse.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Saint-Alban : sessions dirigeants TPE et PME du nord toulousain, dans vos locaux ou en visio.",
      en: "Coaching 1-to-1 à Saint-Alban : sessions dirigeants TPE et PME du nord toulousain, dans vos locaux ou en visio.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    },
    {
      ...
      a: "Oui, sessions 1-to-1 pour dirigeants TPE et PME à Saint-Alban. Format flexible : locaux, visio. À partir de {{price:intervention-dirigeants|flat}}.",
    },
  ],
};
