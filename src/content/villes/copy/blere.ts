...
// Bléré (37, Indre-et-Loire) — Vallée du Cher, bourg tourangeau, proche château de Chenonceau, viticulture AOC Touraine.
...
export const BLERE_COPY: VilleCopy = {
  ...
  distancesEn:
    "Tours centre à 25 min. Château de Chenonceau à 10 min. Gare TGV Saint-Pierre-des-Corps à 20 min (Paris 1h05). Amboise à 15 min. A85 Vierzon-Angers à 10 min.",
  topSectorsNaf: [
    "Tourisme patrimonial (Chenonceau, châteaux de la Loire)",
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Bléré : diagnostic adapté aux acteurs touristiques (Chenonceau, hébergeurs), viticulteurs AOC Touraine, maraîchers, TPE artisans et commerçants du sud-tourangeau. ROI mesurable, audit Flash dès {{price:audit-flash|flat}}.",
      en: "Audit IA à Bléré : diagnostic adapté aux acteurs touristiques (Chenonceau, hébergeurs), viticulteurs AOC Touraine, maraîchers, TPE artisans et commerçants du sud-tourangeau. ROI mesurable, audit Flash dès {{price:audit-flash|flat}}.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Bléré et vallée du Cher ?",
      a: "Oui, Axion-IA intervient à Bléré et toute la vallée du Cher tourangelle (Chenonceaux, Athée-sur-Cher, Cigogné, Sublaines). Consultants depuis Tours centre (25 min) ou gare TGV Saint-Pierre-des-Corps (20 min).",
    },
    {
      q: "Travaillez-vous avec les acteurs du tourisme patrimonial Loire ?",
      a: "Oui, nous accompagnons les acteurs du tourisme patrimonial de la vallée du Cher et des châteaux de la Loire sur leurs cas IA : agents conversationnels multilingues visiteurs, automatisation réservations, classification avis, gestion saisonnalité, optimisation tarification dynamique.",
    },
    {
    ...
    },
    {
      ...
      a: "Pour les TPE artisans et commerçants à Bléré, audit Flash {{price:audit-flash|flat}}, intervention 1 journée formation, coaching 1-to-1. Cas typiques : automatisation devis, agents IA prise de RDV, classification documents, gestion stocks.",
    },
    {
