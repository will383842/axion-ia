...
export const SAINT_NAZAIRE_COPY: VilleCopy = {
  pitchFr:
    "Cabinet d'architectes IA seniors, Axion-IA accompagne les TPE et PME de Saint-Nazaire : sous-traitants des Chantiers de l'Atlantique et d'Airbus, PME de la filière naval-aéronautique, commerces et services de l'estuaire. On déploie des automatisations utiles, pas des effets d'annonce.",
  pitchEn:
    "Cabinet d'architectes IA seniors, Axion-IA accompagne les TPE et PME de Saint-Nazaire : sous-traitants des Chantiers de l'Atlantique et d'Airbus, PME de la filière naval-aéronautique, commerces et services de l'estuaire. On déploie des automatisations utiles, pas des effets d'annonce.",
  directAnswerFr:
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, nos architectes IA viennent dans vos locaux, des zones d'activités proches des Chantiers de l'Atlantique et d'Airbus aux PME de la presqu'île. L'observation terrain est le meilleur point de départ pour cibler des automatisations vraiment utiles.",
    },
    {
