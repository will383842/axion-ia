...
// Saint-Saulve (59, Nord) — Agglomération Valenciennes, 10 947 hab.
...
export const SAINT_SAULVE_COPY: VilleCopy = {
  ...
  distancesEn:
    "Valenciennes centre à 5 min. Douai à 30 min. Lille centre à 45 min. Maubeuge à 35 min. Gare SNCF Valenciennes à 10 min (TGV Paris 1 h 40). Autoroutes A2 et A23 à proximité. Aéroport Lille-Lesquin à 50 min.",
  seoHook: "agglo Valenciennes, automobile & ferroviaire",
  topSectorsNaf: [
    "Sous-traitance automobile et ferroviaire",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Saint-Saulve : formats adaptés à l'atelier automobile, l'entrepôt logistique, le chantier BTP ou le cabinet de services. Vos équipes repartent autonomes sur outils IA configurés métier.",
    },
    implementation: {
      fr: "Implémentation IA à Saint-Saulve : contrôle qualité automobile, maintenance prédictive ferroviaire, optimisation flux logistiques, automatisation devis BTP, CRM augmenté prestataires B2B du Valenciennois.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Saulve et dans le Valenciennois ?",
    ...
    },
    {
      ...
      a: "Pour la logistique à Saint-Saulve et le Valenciennois : optimisation flux entrepôts, planification tournées, traçabilité expéditions, agents IA gestion commandes, automatisation reporting, maintenance prédictive équipements manutention.",
    },
    {
