...
export const CHERBOURG_EN_COTENTIN_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit Flash IA à Cherbourg-en-Cotentin (590 € HT) pour TPE/PME locales — diagnostic des processus opérationnels d'un commerce de centre-ville, d'un sous-traitant maritime ou d'un acteur agroalimentaire des cinq communes déléguées.",
      en: "Audit Flash IA à Cherbourg-en-Cotentin (590 € HT) pour TPE/PME locales — diagnostic des processus opérationnels d'un commerce de centre-ville, d'un sous-traitant maritime ou d'un acteur agroalimentaire des cinq communes déléguées.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Nos tarifs publics commencent à 590 € HT pour une Intervention Essentielle, et 590 € HT pour un Audit Flash IA. Les tarifs détaillés (audit, interventions, implémentation, un-à-un) figurent sur la page tarifs publics du site Axion-IA.",
    },
    {
