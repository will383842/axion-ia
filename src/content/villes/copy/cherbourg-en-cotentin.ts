...
export const CHERBOURG_EN_COTENTIN_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit Flash IA à Cherbourg-en-Cotentin ({{price:intervention-4h|flat}}) pour TPE/PME locales — diagnostic des processus opérationnels d'un commerce de centre-ville, d'un sous-traitant maritime ou d'un acteur agroalimentaire des cinq communes déléguées.",
      en: "Audit Flash IA à Cherbourg-en-Cotentin ({{price:intervention-4h|flat}}) pour TPE/PME locales — diagnostic des processus opérationnels d'un commerce de centre-ville, d'un sous-traitant maritime ou d'un acteur agroalimentaire des cinq communes déléguées.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Nos tarifs publics commencent à {{price:intervention-4h|flat}} pour une Intervention Essentielle, et {{price:intervention-4h|flat}} pour un Audit Flash IA. Les tarifs détaillés (audit, interventions, implémentation, un-à-un) figurent sur la page tarifs publics du site Axion-IA.",
    },
    {
