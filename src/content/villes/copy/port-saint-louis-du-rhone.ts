...
// Port-Saint-Louis-du-Rhône (13, Bouches-du-Rhône) — embouchure du Rhône, port industriel, Camargue.
...
export const PORT_SAINT_LOUIS_DU_RHONE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Port-Saint-Louis-du-Rhône (13), à l'embouchure du Grand Rhône aux portes de la Camargue, est une ville portuaire et industrielle. Tissu de TPE artisans, PME logistique et transport maritime, industries pétrochimiques, saliculture. Axion-IA y déploie son expertise pour toutes les organisations.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Port-Saint-Louis-du-Rhône (13). Nous accompagnons TPE artisans, PME de logistique portuaire et transport maritime, entreprises pétrochimiques, acteurs du tourisme camarguais et commerces de proximité. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Port-Saint-Louis-du-Rhône (13). Nous accompagnons TPE artisans, PME de logistique portuaire et transport maritime, entreprises pétrochimiques, acteurs du tourisme camarguais et commerces de proximité. Audit sur place sur mesure.",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Port-Saint-Louis-du-Rhône : ateliers pratiques pour équipes logistique, maintenance industrielle, accueil touristique. Outils IA configurés métier réel.",
    },
    implementation: {
      fr: "Implémentation IA à Port-Saint-Louis-du-Rhône : optimisation flux portuaires, maintenance prédictive industrielle, agents conversationnels tourisme, automatisation gestion stocks. RGPD strict.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Port-Saint-Louis-du-Rhône ?",
      a: "Oui, Axion-IA intervient à Port-Saint-Louis-du-Rhône et dans tout le golfe de Fos (Fos-sur-Mer, Istres, Martigues). Couverture Métropole Aix-Marseille-Provence sud-ouest.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les entreprises industrielles et pétrochimiques du golfe de Fos sur des cas IA concrets : maintenance prédictive, optimisation flux logistiques, classification documents qualité, automatisation reporting HSE.",
    },
    {
      q: "Proposez-vous des solutions IA pour le tourisme en Camargue ?",
      a: "Oui, nous accompagnons les acteurs du tourisme camarguais (hébergements, guides, restaurateurs) sur des cas IA : agents conversationnels réservation, traduction multilingue, optimisation gestion saisonnière, marketing personnalisé.",
    },
    {
