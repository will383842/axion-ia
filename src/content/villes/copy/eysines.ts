...
export const EYSINES_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit Flash 4 h à Eysines dès {{price:audit-flash|flat}} : cartographie des processus automatisables côté maraîchage, artisanat ou commerce, livré sous 5 jours ouvrés.",
