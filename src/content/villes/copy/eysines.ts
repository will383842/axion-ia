...
export const EYSINES_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit sur place 4 h à Eysines dès {{price:audit-flash|flat}} : cartographie des processus automatisables côté maraîchage, artisanat ou commerce, livré sous 5 jours ouvrés.",
      en: "Audit sur place 4 h à Eysines dès {{price:audit-flash|flat}} : cartographie des processus automatisables côté maraîchage, artisanat ou commerce, livré sous 5 jours ouvrés.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "À Eysines, l'Audit sur place 4 h démarre à {{price:audit-flash|flat}} et la Formation 4 h à {{price:intervention-4h|flat}}. Les implémentations et sessions 1-to-1 commencent à {{price:intervention-dirigeants|flat}}. Tous nos tarifs sont publics et sans engagement.",
    },
    {
