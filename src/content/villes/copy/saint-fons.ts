...
// Saint-Fons (69, Rhône) — banlieue sud Lyon, métropole de Lyon, vallée de la chimie historique.
...
export const SAINT_FONS_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Saint-Fons : diagnostic adapté aux PME industrielles et sous-traitants techniques Vallée de la Chimie, TPE artisans. Audit Flash à {{price:audit-flash|flat}}, retour sur investissement chiffré.",
      en: "Audit IA à Saint-Fons : diagnostic adapté aux PME industrielles et sous-traitants techniques Vallée de la Chimie, TPE artisans. Audit Flash à {{price:audit-flash|flat}}, retour sur investissement chiffré.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Saint-Fons et Vallée de la Chimie sud lyonnais ?",
      a: "Oui, Axion-IA intervient à Saint-Fons et toute la Vallée de la Chimie sud lyonnaise (Vénissieux limitrophe, Feyzin, Pierre-Bénite, Solaize, Givors). Couverture Métropole de Lyon. Consultants stéphanois ou lyonnais (15 min métro/tramway).",
    },
    {
      q: "Travaillez-vous avec les sous-traitants techniques chimie ?",
      a: "Oui, nous accompagnons les sous-traitants techniques de la Vallée de la Chimie (avec exigences sécurité renforcées sites Seveso) sur leurs cas IA : prédiction maintenance équipements, contrôle qualité par vision, classification incidents HSE, agents conversationnels B2B sous-traitance.",
    },
    {
      q: "Accompagnez-vous les PME industrielles diversifiées ?",
    ...
    },
    {
      ...
      a: "Pour les TPE artisans BTP et commerçants à Saint-Fons, audit Flash {{price:audit-flash|flat}}, intervention 1 journée formation, coaching 1-to-1. Cas typiques : automatisation devis, classification photos.",
    },
    {
