...
// Trélazé (49, Maine-et-Loire) — ardoisières historiques, est Angers.
...
export const TRELAZE_COPY: VilleCopy = {
  ...
  topSectorsNaf: [
    ...
    "Industrie légère & reconversion ardoisière",
  ],
  servicesContext: {
    audit: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Trélazé et dans l'est angevin ?",
    ...
    },
    {
      ...
      a: "Axion-IA accompagne tous types d'activités à Trélazé : artisanat BTP, commerce de détail, professions de santé et libérales, PME services, logistique et industrie légère. Pas de restriction sectorielle.",
    },
    {
