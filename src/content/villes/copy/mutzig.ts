...
// Mutzig (67, Bas-Rhin) — brasserie historique, vallée de la Bruche.
...
export const MUTZIG_COPY: VilleCopy = {
  ...
  distancesEn:
    "Strasbourg à 30 min. Molsheim à 5 min. Obernai à 15 min. Autoroute A352 accès à 5 min. Gare TGV de Strasbourg à 35 min. Aéroport Strasbourg-Entzheim à 20 min. Schirmeck à 25 min.",
  seoHook: "industrie agroalimentaire & artisanat",
  topSectorsNaf: [
    ...
    "Sous-traitance industrielle locale",
  ],
  servicesContext: {
    audit: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Mutzig ?",
    ...
    },
    {
      ...
      a: "Oui, commerçants, artisans et restaurateurs mutzigeois : gestion stocks, prise de réservations, relation client, automatisation comptabilité, présence en ligne. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
