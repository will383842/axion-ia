...
// Amboise (37, Indre-et-Loire) — Château royal, Clos Lucé/Vinci, UNESCO Val de Loire, tourisme patrimonial.
...
export const AMBOISE_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Amboise : formats adaptés au site patrimonial, hôtellerie-restauration, domaine viticole, commerce. Vos équipes repartent autonomes.",
    },
    implementation: {
      fr: "Implémentation IA à Amboise : agents conversationnels visiteurs patrimoine multilingue, yield management hôtelier, prédiction vendanges AOC Touraine-Amboise, automatisation réservations.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Amboise et Val de Loire ?",
      a: "Oui, Axion-IA intervient à Amboise et tout le Val de Loire tourangeau (Chargé, Pocé-sur-Cisse, Nazelles-Négron, Limeray). Consultants depuis Tours (25 min) ou gare TGV Saint-Pierre-des-Corps (20 min).",
    },
    {
      q: "Travaillez-vous avec les acteurs tourisme patrimonial ?",
      a: "Oui, agents conversationnels visiteurs multilingue, automatisation réservations, classification feedback, recommandations parcours culturels patrimoine Renaissance.",
    },
    {
      q: "Accompagnez-vous les viticulteurs AOC Touraine-Amboise ?",
      a: "Oui, prédiction vendanges, classification photos parcelles, traçabilité AOC, agents conversationnels oenotourisme multilingue, gestion vente directe.",
    },
    {
      q: "Quels services pour les hôteliers et restaurateurs ?",
