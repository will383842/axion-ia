...
// Fouesnant (29, Finistère) — Littoral sud Finistère, cidre AOP Cornouaille, tourisme balnéaire.
...
export const FOUESNANT_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Fouesnant : formats adaptés à l'hôtel, au camping, à la cidrerie ou au commerce saisonnier. Vos équipes repartent autonomes sur outils IA configurés métier.",
    },
    implementation: {
      fr: "Implémentation IA à Fouesnant : chatbot réservation multilingue, pricing dynamique saisonnier, traçabilité cidricole, automatisation gestion campings, agents conversationnels. Cornouaille et littoral sud Finistère.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Fouesnant et en Cornouaille ?",
      a: "Oui, Axion-IA intervient à Fouesnant et toute la Cornouaille (Quimper, Concarneau, Bénodet, Pont-l'Abbé, Pont-Aven). Nos consultants viennent via TGV Quimper (20 min depuis Fouesnant) ou par Quimper Cornouaille aéroport (25 min).",
    },
    {
    ...
    },
    {
      ...
      a: "Nous adaptons nos interventions au rythme saisonnier fouesnantais : audit et formation en basse saison (octobre-mars), implémentation pré-saison (avril-mai), support haute saison (juin-septembre). Formats courts compatibles avec les pics d'activité.",
    },
  ],
};
