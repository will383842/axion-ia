...
export const MEAUX_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit Flash 4 h à Meaux dès {{price:audit-flash|flat}} : cartographie des processus automatisables côté agroalimentaire, commerce ou services, livré sous 5 jours ouvrés.",
