...
// Labenne (40, Landes) — agglo Bayonne sud, littoral, entre océan et forêt.
...
export const LABENNE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Labenne (40), commune littorale du sud des Landes dans l'agglomération bayonnaise, se situe entre océan Atlantique et forêt landaise. Tourisme balnéaire, zoo, centre commercial, TPE hébergement/restauration, artisans BTP, commerces, agriculture. Axion-IA y intervient pour tous types d'activités.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Labenne (40). Nous accompagnons TPE et PME du tourisme balnéaire, hébergeurs, restaurateurs, commerçants de la zone commerciale, artisans BTP, agriculteurs et prestataires de services du sud des Landes.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Labenne (40). Nous accompagnons TPE et PME du tourisme balnéaire, hébergeurs, restaurateurs, commerçants de la zone commerciale, artisans BTP, agriculteurs et prestataires de services du sud des Landes.",
  ...
  topSectorsNaf: [
    ...
    "Commerce (zone commerciale Labenne)",
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Labenne : formations adaptées aux commerces, campings, hébergeurs, restaurateurs et artisans. Vos équipes repartent autonomes sur les outils IA configurés métier.",
    },
    implementation: {
      fr: "Implémentation IA à Labenne : chatbot réservation multilingue campings, gestion stocks commerce, automatisation facturation hébergeurs, prédiction affluence saisonnière, classification avis clients.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Labenne et le sud des Landes ?",
      a: "Oui, Axion-IA intervient à Labenne et tout le sud des Landes (Capbreton, Ondres, Tarnos, Saint-Martin-de-Seignanx). Couverture plage, zone commerciale et bourg. Déplacement depuis Bayonne (15 min A63).",
    },
    {
      q: "Proposez-vous des audits IA pour les campings labennais ?",
      a: "Oui, audit sur place {{price:audit-flash|flat}} adapté aux campings et hébergeurs de plein air à Labenne. Diagnostic chatbot réservation multilingue, gestion saisonnière, automatisation check-in, prédiction taux d'occupation, analyse avis.",
    },
    {
      q: "Accompagnez-vous les commerçants de la zone commerciale ?",
      a: "Oui, nous accompagnons les commerçants de la zone commerciale de Labenne sur leurs cas IA : gestion stocks prédictive, automatisation commandes, chatbot service client, analyse données ventes, optimisation flux magasin.",
    },
    {
