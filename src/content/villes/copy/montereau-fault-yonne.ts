...
export const MONTEREAU_FAULT_YONNE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Montereau-Fault-Yonne : diagnostic pour TPE artisans, PME industrielles et logistiques du port, commerces de centre-ville et services aux entreprises. Audit Flash 490 € HT, ROI chiffré.",
      en: "Audit IA à Montereau-Fault-Yonne : diagnostic pour TPE artisans, PME industrielles et logistiques du port, commerces de centre-ville et services aux entreprises. Audit Flash 490 € HT, ROI chiffré.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'Audit Flash IA à Montereau-Fault-Yonne démarre à 490 € HT. Diagnostic vos processus industriels, logistiques ou commerciaux, cas d'usage IA prioritaires et plan d'action ROI chiffré. Tarifs publics, pas de devis opaque.",
    },
    {
