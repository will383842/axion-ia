...
// Vendenheim (67, Bas-Rhin) — agglo Strasbourg nord, zones d'activités.
...
export const VENDENHEIM_COPY: VilleCopy = {
  ...
  distancesEn:
    "Strasbourg centre à 15 min. Gare TGV de Strasbourg à 15 min. Aéroport Strasbourg-Entzheim à 25 min. Autoroute A4/A35 accès direct à 5 min. Haguenau à 25 min. Allemagne (Kehl) à 25 min.",
  seoHook: "logistique, services & zones d'activités",
  topSectorsNaf: [
    "Logistique, transport et entreposage",
    "Commerce de gros et distribution",
    "Services aux entreprises",
    "Industrie légère et sous-traitance",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Vendenheim ?",
    ...
    },
    {
      ...
      a: "Oui, artisans, industriels légers et services aux entreprises vendenheimois : automatisation production, gestion commerciale, relation client, ERP. Audit Flash 490 € HT.",
    },
    {
