...
export const CHELLES_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      fr: "Intervenir à Chelles pour automatiser devis, relances et planning d'une TPE ou PME — Intervention Essentielle à partir de {{price:intervention-4h|flat}}, code custom sans no-code.",
      en: "Intervenir à Chelles pour automatiser devis, relances et planning d'une TPE ou PME — Intervention Essentielle à partir de {{price:intervention-4h|flat}}, code custom sans no-code.",
    },
    implementation: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "À Chelles (77500), l'Audit Flash 4h démarre à {{price:audit-flash|flat}}, l'Intervention Essentielle à {{price:intervention-4h|flat}}, et l'Implémentation à {{price:impl-poc|entry}}. Tarifs publics, sans abonnement, sans frais cachés.",
    },
    {
