...
// Tarascon (13, Bouches-du-Rhône) — Château roi René, bords Rhône, textile.
...
export const TARASCON_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Tarascon et environs ?",
      a: "Oui, Axion-IA intervient à Tarascon et dans tout le bassin rhodanien (Arles à 20 min, Avignon à 25 min, Beaucaire, Saint-Rémy-de-Provence). Couverture complète des Bouches-du-Rhône nord.",
    },
    {
