...
export const SAINT_YRIEIX_SUR_CHARENTE_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Saint-Yrieix-sur-Charente : formats adaptés au cabinet, au bureau, au commerce ou à l'atelier. Vos équipes acquièrent l'autonomie sur les outils IA déployés.",
    },
    implementation: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'audit sur place IA à Saint-Yrieix-sur-Charente démarre à {{price:audit-flash|flat}}. Diagnostic complet de vos processus tertiaires, commerciaux ou artisanaux, identification des cas d'usage IA prioritaires, ROI chiffré et plan d'action concret.",
    },
    {
