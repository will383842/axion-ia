...
export const PEYPIN_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Peypin : diagnostic adapté aux artisans BTP rénovation énergétique, plombiers-chauffagistes, électriciens, maçons et sous-traitants industriels de la vallée de l'Huveaune. Audit sur place {{price:audit-flash|flat}}, ROI mesuré sur les premiers chantiers (devis, planning, suivi matériel).",
      en: "Audit IA à Peypin : diagnostic adapté aux artisans BTP rénovation énergétique, plombiers-chauffagistes, électriciens, maçons et sous-traitants industriels de la vallée de l'Huveaune. Audit sur place {{price:audit-flash|flat}}, ROI mesuré sur les premiers chantiers (devis, planning, suivi matériel).",
    },
    interventions: {
