...
export const LIEVIN_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit Flash 4 h à Liévin ({{price:audit-flash|flat}}) pour identifier les automatisations IA prioritaires des TPE et PME tertiaires, commerciales et de la construction du bassin Lens-Liévin.",
      en: "Audit Flash 4 h à Liévin ({{price:audit-flash|flat}}) pour identifier les automatisations IA prioritaires des TPE et PME tertiaires, commerciales et de la construction du bassin Lens-Liévin.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Audit Flash 4 h à {{price:audit-flash|flat}}, intervention sur site à {{price:intervention-4h|flat}}, implémentation à {{price:intervention-dirigeants|flat}}, accompagnement 1-to-1 à {{price:intervention-dirigeants|flat}}. Tarifs publics fixes sur axion-ia.com, sans licence no-code à payer en plus.",
    },
    {
