...
export const VITRY_LE_FRANCOIS_COPY: VilleCopy = {
  ...
  directAnswerFr:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Vitry-le-François (51). Nous accompagnons TPE et PME de cette sous-préfecture marnaise : PME logistique et transport fluvial, industries agroalimentaires, artisans BTP, commerçants, exploitants agricoles et services. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'experts IA seniors qui intervient à Vitry-le-François (51). Nous accompagnons TPE et PME de cette sous-préfecture marnaise : PME logistique et transport fluvial, industries agroalimentaires, artisans BTP, commerçants, exploitants agricoles et services. Audit sur place sur mesure.",
  ecosystemFr:
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Vitry-le-François : formats adaptés à la PME logistique, à l'industrie agroalimentaire, à la TPE artisanale ou à l'exploitation agricole. Vos collaborateurs gèrent leurs solutions IA configurées sur-mesure.",
    },
    implementation: {
    ...
    unAUn: {
      fr: "Coaching 1-to-1 à Vitry-le-François : sessions dans vos locaux ou en visio. Dirigeants TPE/PME logistique, responsables agroalimentaire, exploitants agricoles, gérants commerces de la Marne souhaitant maîtriser l'IA.",
      en: "Coaching 1-to-1 à Vitry-le-François : sessions dans vos locaux ou en visio. Dirigeants TPE/PME logistique, responsables agroalimentaire, exploitants agricoles, gérants commerces de la Marne souhaitant maîtriser l'IA.",
    },
  },
  faqGeolocalisee: [
    {
