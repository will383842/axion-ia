...
// Albertville (73, Savoie) — ville olympique (JO hiver 1992), carrefour des quatre vallées, sous-préfecture.
...
export const ALBERTVILLE_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Albertville et dans les vallées savoyardes ?",
      a: "Oui, Axion-IA intervient à Albertville et les quatre vallées (Chambéry à 50 min, Annecy à 45 min, Bourg-Saint-Maurice à 45 min). Gare TGV Albertville, aéroport Lyon à 1h30.",
    },
    {
      q: "Travaillez-vous avec les stations de montagne et sports d'hiver ?",
      a: "Oui, revenue management dynamique forfaits ski, maintenance prédictive remontées mécaniques, chatbot touristes multilingue, automatisation réservations hébergements.",
    },
    {
