...
export const PAVILLY_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Pour les commercants de Pavilly, nous proposons : gestion stocks IA, fidelisation client, agents conversationnels, comptabilite augmentee. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
