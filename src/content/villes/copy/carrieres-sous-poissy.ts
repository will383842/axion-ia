...
export const CARRIERES_SOUS_POISSY_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "L'économie de Carrières-sous-Poissy s'appuie sur le centre technique PSA Peugeot Citroën (recherche autoroutière, moteurs électriques) et sur les zones d'activité du bord de Seine et du quartier des Trois Cèdres, qui couvrent environ 15 hectares. La ville est rattachée à la communauté urbaine Grand Paris Seine et Oise et bénéficie d'une desserte ferroviaire via la gare de Poissy (RER A et Transilien J).",
  distancesFr:
    "Carrières-sous-Poissy est située à environ 10 km au nord-ouest de Saint-Germain-en-Laye et à 30 km de Paris. La gare de Poissy (RER A, Transilien J) est la plus proche.",
  distancesEn:
    "Carrières-sous-Poissy est située à environ 10 km au nord-ouest de Saint-Germain-en-Laye et à 30 km de Paris. La gare de Poissy (RER A, Transilien J) est la plus proche.",
  topSectorsNaf: [
  ...
  faqGeolocalisee: [
    {
      ...
      a: "L'Audit sur place 4 heures à Carrières-sous-Poissy démarre à {{price:audit-flash|flat}}. Les interventions ciblées sur site commencent à {{price:intervention-4h|flat}}. Les tarifs publics complets sont consultables sur notre page tarifs.",
    },
    {
    ...
    },
    {
      ...
      a: "Nous intervenons également dans les communes limitrophes : Triel-sur-Seine, Chanteloup-les-Vignes, Andrésy, Achères, Poissy et Villennes-sur-Seine, ainsi que dans tout le département des Yvelines.",
    },
    {
      q: "Comment Axion-IA garantit-il la conformité RGPD à Carrières-sous-Poissy ?",
      a: "Toutes nos implémentations IA respectent le RGPD : minimisation des données, hébergement UE, journalisation des accès, droit à l'effacement. Nous fournissons une fiche conformité par projet, alignée AI Act.",
    },
    {
