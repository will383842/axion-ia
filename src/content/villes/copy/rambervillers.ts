...
// Rambervillers (88, Vosges) — Plaine des Vosges, bourg, tradition faïencière.
...
export const RAMBERVILLERS_COPY: VilleCopy = {
  ...
  distancesEn:
    "Épinal à 30 min. Saint-Dié-des-Vosges à 35 min. Lunéville à 35 min. Nancy à 1h. Gare SNCF Rambervillers (ligne TER Lorraine). RN420 et RD32 accès direct. Aéroport Metz-Nancy-Lorraine à 1h15.",
  seoHook: "Plaine Vosges & faïence",
  topSectorsNaf: [
    "Industrie céramique, faïence et bois",
    "BTP et second œuvre",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Rambervillers ?",
      a: "Oui, Axion-IA intervient à Rambervillers et dans toute la Plaine des Vosges (Épinal, Saint-Dié, Bruyères, Charmes). Consultants via gare SNCF Rambervillers ou RN420.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, artisans BTP, commerçants et services rambuvetais : automatisation devis, gestion planning chantier, fidélisation client, présence numérique locale. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
