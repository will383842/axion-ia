...
export const CARBONNE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Carbonne (31), bastide médiévale fondée en 1256 dans un méandre protecteur de la Garonne, 5 563 habitants (Carbonnais), au sud de Toulouse en Haute-Garonne. Tissu économique équilibré dominé par le commerce et la restauration (25 % des actifs), l'administration-éducation-santé (16 %), la construction (15 %) et les services spécialisés (15 %). On y trouve plusieurs entreprises notables : Agronutrition (fertilisants spécialisés), Carbonne Distribution (hypermarché) et Cazorro Matériaux (négoce BTP). Axion-IA y accompagne les TPE, PME et commerces du Volvestre et du sud Haute-Garonne.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Carbonne (31). Nous accompagnons en priorité les TPE artisans, commerçants et professions libérales du Volvestre, ainsi que les PME locales (négoce BTP, agroalimentaire, fabrication) et les exploitations agricoles. Audit sur place dès {{price:audit-flash|flat}}, code custom (jamais de no-code). Nos consultants se déplacent en 40 min depuis Toulouse via l'A64, ou par train sur la ligne Toulouse–Tarbes.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Carbonne (31). Nous accompagnons en priorité les TPE artisans, commerçants et professions libérales du Volvestre, ainsi que les PME locales (négoce BTP, agroalimentaire, fabrication) et les exploitations agricoles. Audit sur place dès {{price:audit-flash|flat}}, code custom (jamais de no-code). Nos consultants se déplacent en 40 min depuis Toulouse via l'A64, ou par train sur la ligne Toulouse–Tarbes.",
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Carbonne : diagnostic 4 heures adapté aux TPE artisans, commerçants du centre-bourg, PME du négoce BTP, agroalimentaire et exploitants agricoles du Volvestre. Audit sur place dès {{price:audit-flash|flat}}, livrable écrit avec 3 cas d'usage prioritaires.",
      en: "Audit IA à Carbonne : diagnostic 4 heures adapté aux TPE artisans, commerçants du centre-bourg, PME du négoce BTP, agroalimentaire et exploitants agricoles du Volvestre. Audit sur place dès {{price:audit-flash|flat}}, livrable écrit avec 3 cas d'usage prioritaires.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'Audit sur place démarre à {{price:audit-flash|flat}} (4 heures, livrable écrit, 3 cas d'usage prioritaires). Pour une PME du négoce ou de l'agroalimentaire, audit approfondi entre {{price:audit-cible-solo|num}} et {{price:audit-cible-avance}}. Implémentation dès {{price:impl-poc|entry}}. Tarifs publics affichés.",
    },
    {
