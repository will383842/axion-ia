...
export const PLAISANCE_DU_TOUCH_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit Flash chez les TPE et PME de Plaisance-du-Touch dès {{price:audit-flash|flat}} : diagnostic des process commerce, restauration, construction et services, avec plan d'automatisation priorisé.",
      en: "Audit Flash chez les TPE et PME de Plaisance-du-Touch dès {{price:audit-flash|flat}} : diagnostic des process commerce, restauration, construction et services, avec plan d'automatisation priorisé.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "L'Audit Flash démarre à {{price:audit-flash|flat}} (4 h sur site). Les interventions code custom démarrent à {{price:intervention-4h|flat}}. Les sessions un-à-un dirigeants débutent à {{price:intervention-dirigeants|flat}}. Grille complète sur axion-ia.com.",
    },
    {
