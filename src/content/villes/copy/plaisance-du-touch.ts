  ...
  faqGeolocalisee: [
    {
      ...
      a: "L'Audit sur place démarre à {{price:audit-flash|flat}} (4 h sur site). Les interventions code custom démarrent à {{price:intervention-4h|flat}}. Les sessions un-à-un dirigeants débutent à {{price:intervention-dirigeants|flat}}. Grille complète sur axion-ia.com.",
    },
    {
