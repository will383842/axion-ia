...
export const PESSAC_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "À Pessac, un Audit Flash sur site ({{price:audit-flash|flat}}, 4 h) permet à un dirigeant de TPE ou PME d'identifier les processus métier automatisables — gestion documentaire, reporting, support client, traitement de candidatures — et de chiffrer un plan d'action concret.",
      en: "À Pessac, un Audit Flash sur site ({{price:audit-flash|flat}}, 4 h) permet à un dirigeant de TPE ou PME d'identifier les processus métier automatisables — gestion documentaire, reporting, support client, traitement de candidatures — et de chiffrer un plan d'action concret.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Nos tarifs publics s'appliquent à Pessac comme partout en France : Audit Flash 4 h à {{price:audit-flash|flat}}, Formation 4 h à {{price:intervention-4h|flat}}, accompagnement un-à-un dès {{price:intervention-dirigeants|flat}}. Devis envoyé sous 48 h, pas de forfait caché.",
    },
    {
