...
export const BETHENY_COPY: VilleCopy = {
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Bétheny : formats adaptés à l'exploitation viticole, au négoce Champagne, à la TPE artisanale ou au cabinet libéral. Vos équipes repartent autonomes sur outils IA configurés métier.",
    },
    implementation: {
      fr: "Implémentation IA à Bétheny : prédiction vendanges et maturité raisin, automatisation traçabilité Champagne, agents conversationnels oenotourisme, classification documents comptables TPE/PME.",
      en: "Implémentation IA à Bétheny : prédiction vendanges et maturité raisin, automatisation traçabilité Champagne, agents conversationnels oenotourisme, classification documents comptables TPE/PME.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Bétheny : sessions dans vos locaux, exploitation viticole ou en visio. Viticulteurs, dirigeants négoce Champagne, gérants TPE/PME, professions libérales du nord rémois souhaitant maîtriser l'IA.",
      en: "Coaching 1-to-1 à Bétheny : sessions dans vos locaux, exploitation viticole ou en visio. Viticulteurs, dirigeants négoce Champagne, gérants TPE/PME, professions libérales du nord rémois souhaitant maîtriser l'IA.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    },
    {
      ...
      a: "Nos consultants se déplacent à Bétheny depuis la gare TGV de Reims (10 min). Intervention dans vos locaux, atelier pratique avec vos équipes. Sessions en visio également possibles pour les TPE éloignées.",
    },
  ],
};
