...
// Vern-sur-Seiche (35, Ille-et-Vilaine) — sud-est de Rennes, commune résidentielle dynamique.
...
export const VERN_SUR_SEICHE_COPY: VilleCopy = {
  ...
  pitchEn:
    "Vern-sur-Seiche (35), commune résidentielle du sud-est de Rennes en Ille-et-Vilaine, bénéficie de la proximité immédiate de la métropole rennaise. TPE et PME tertiaires, artisans du bâtiment, commerces et services de proximité, professions libérales et de santé, sous-traitants industriels, agences immobilières. Axion-IA couvre les activités professionnelles du bassin.",
  directAnswerFr:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Vern-sur-Seiche (35). Nous accompagnons TPE et PME : sociétés tertiaires périurbaines, artisans du bâtiment, commerces et services de proximité, professions libérales et de santé, sous-traitants industriels. Audit sur place sur mesure.",
  directAnswerEn:
    "Axion-IA est un cabinet d'architectes IA seniors qui intervient à Vern-sur-Seiche (35). Nous accompagnons TPE et PME : sociétés tertiaires périurbaines, artisans du bâtiment, commerces et services de proximité, professions libérales et de santé, sous-traitants industriels. Audit sur place sur mesure.",
  ...
  topSectorsNaf: [
    ...
    "Sous-traitance industrielle et immobilier",
  ],
  servicesContext: {
    audit: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Vern-sur-Seiche : formats adaptés bureau tertiaire, chantier artisan, commerce de proximité, cabinet libéral ou atelier sous-traitance. Équipes formées à l'autonomie sur les outils IA.",
    },
    implementation: {
      fr: "Implémentation IA à Vern-sur-Seiche : CRM augmenté tertiaire, devis automatisés artisans, gestion stocks commerces, prise de rendez-vous santé, suivi production sous-traitants, gestion annonces immobilières.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Vern-sur-Seiche et au sud-est de Rennes ?",
      a: "Oui, Axion-IA intervient à Vern-sur-Seiche et dans tout le sud-est rennais (Cesson-Sévigné, Chantepie, Noyal-Châtillon-sur-Seiche, Châteaugiron). Rennes centre à 15 min en voiture.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, prise de rendez-vous automatisée, gestion administrative, suivi patients, rappels et fidélisation, conformité RGPD santé pour médecins, kinés, dentistes et professions libérales.",
    },
    {
      q: "Accompagnez-vous les artisans du bâtiment et commerces de proximité ?",
      a: "Oui, devis automatisés, planning chantiers, suivi clients, gestion stocks, fidélisation locale, présence Google Business Profile pour artisans, commerçants et services de proximité.",
    },
    {
