...
// Amilly (45, Loiret) — agglo Montargis, zones d'activites, bassin Gatinais.
...
export const AMILLY_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Amilly est une commune dynamique de l'agglomeration montargoise, dotee de zones d'activites commerciales et artisanales structurantes pour le Gatinais. Son economie repose sur le commerce, la logistique liee au carrefour A77/D943, les services aux entreprises, l'artisanat du batiment et l'industrie legere. Communes voisines : Montargis, Chalette-sur-Loing, Villemandeur, Paucourt, Treilles-en-Gatinais.",
  distancesFr:
    "Montargis centre a 5 min. Gare de Montargis (TER Paris-Gare de Lyon 1 h 20) a 10 min. Paris a 1 h 20 via A77. Orleans a 1 h. Acces A77 sortie Montargis-Sud et D943.",
  distancesEn:
    "Montargis centre a 5 min. Gare de Montargis (TER Paris-Gare de Lyon 1 h 20) a 10 min. Paris a 1 h 20 via A77. Orleans a 1 h. Acces A77 sortie Montargis-Sud et D943.",
  seoHook: "zones d'activites & logistique",
  topSectorsNaf: [
    "Commerce de detail & grande distribution",
    "Logistique & transport",
    "Services aux entreprises & conseil",
    "Artisanat & BTP",
    "Industrie legere & manufacturing",
  ],
  servicesContext: {
    audit: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il a Amilly et dans l'agglomeration montargoise ?",
      a: "Oui, Axion-IA intervient a Amilly et dans toute l'agglomeration montargoise (Montargis, Chalette-sur-Loing, Villemandeur, Paucourt). Nos consultants rejoignent Amilly via la gare de Montargis a 10 min ou l'A77.",
    },
    {
      q: "Quel est le tarif d'un audit IA a Amilly ?",
      a: "L'Audit sur place IA a Amilly demarre a {{price:audit-flash|flat}} pour 4 heures de diagnostic. Il couvre l'analyse de vos processus metier, l'identification des cas d'usage IA prioritaires et un plan d'action chiffre avec ROI estime.",
    },
    {
