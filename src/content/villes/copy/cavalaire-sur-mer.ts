...
export const CAVALAIRE_SUR_MER_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'audit sur place (4 heures, diagnostic + ROI chiffré) démarre à {{price:audit-flash|flat}}. Adapté aux campings, hôteliers, restaurateurs et professionnels du nautisme cavalairois. Tarifs publics, sans engagement.",
    },
    {
