...
export const CAEN_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA opérationnel à Caen : nous cartographions ce qui peut être automatisé dans votre entreprise et chiffrons le ROI. 4 niveaux du Sur place au Stratégique ETI, des TPE caennaises aux ETI industrielles du bassin (NXP, Bosch, Renault Trucks).",
  ...
  faqGeolocalisee: [
    {
      ...
      a: "Le tarif dépend du niveau retenu — Audit sur place, Ciblé, Stratégique PME ou Stratégique ETI. Tarifs publics affichés sur la page Audit, choix calibré selon votre taille (TPE, PME, ETI, grande entreprise) et votre périmètre. Aucun supplément géographique : le tarif est identique à Caen et partout en France.",
    },
    {
  ...
  services: {
    audit: {
      fr: {
        hero: "L'audit IA Axion-IA cartographie ce qui peut être automatisé dans votre entreprise caennaise et chiffre le retour sur investissement à 12-24 mois. Quatre niveaux du Sur place au Stratégique ETI couvrent toutes les tailles, des TPE de l'hypercentre aux ETI industrielles du bassin — NXP Semiconductors, Robert Bosch, Renault Trucks — et aux directions recherche du plateau Nord.",
        whyHere: [
    ...
    sitesWeb: {
      fr: {
        hero: "Axion-IA conçoit et augmente à Caen des sites web, applications et plateformes SaaS avec l'IA intégrée : UX/UI sur mesure, chatbot RAG ancré sur vos contenus, recherche sémantique, agents et automatisations. Devis à partir de 24-48 h selon la complexité du projet, hébergement UE, code et données à vous. Kick-off en présentiel à Caen, itérations à distance.",
        whyHere: [
          "Projets web & SaaS caennais : électronique & automobile (NXP Semiconductors, Bosch, Renault Trucks), recherche IA & cybersécurité (GREYC, ENSICAEN), filière équine (pôle Hippolia), PME de Caen la Mer.",
          ...
          "Recherche IA & cybersécurité : plateformes data, RAG et agents avec sécurité renforcée — un écho à l'écosystème GREYC/ENSICAEN. Hébergement UE souverain, RGPD strict.",
        ],
        methodology: [
          {
            step: "Cadrage à Caen",
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Conception ou refonte d'un site ou d'une application avec UX/UI et IA intégrée, pour industriels, scale-ups et PME caennaises.",
          },
          {
            sizeLabel: "ETI",
            price: "Plateforme SaaS IA-native",
            detail:
              "Plateforme métier, industrielle ou portail sécurisé sur mesure, IA intégrée, branchée sur votre SI (PLM, ERP, datalake).",
          },
          {
            sizeLabel: "Grande entreprise",
        ...
        faq: [
          {
            ...
            a: "Oui. On conçoit l'expérience complète à Caen — research, wireframes, design system, maquettes Figma, prototype — pour un site, une app ou une plateforme SaaS, avec ou sans brique IA. C'est un métier à part entière chez nous.",
          },
          {
            q: "Vous gérez la sécurité et l'électronique embarquée ?",
            a: "Oui : plateformes data, RAG, agents avec sécurité renforcée pour l'électronique, l'automobile et l'industrie (NXP, Bosch) — un écho à l'écosystème recherche GREYC/ENSICAEN. Hébergement UE souverain, RGPD strict, confidentialité.",
          },
          {
        ...
        guarantees:
          "Devis ferme en forfait fixe (à partir de 24-48 h selon la complexité) : pas de dérive horaire cachée. Mise en ligne sans downtime quand on augmente l'existant. Web Vitals et accessibilité contrôlés à la livraison. Code source, bases et modèles livrés dans votre infrastructure (hébergement UE possible), conformes RGPD : propriété totale, aucun abonnement imposé, transférable à tout prestataire de la région caennaise ou repris en interne.",
      },
      en: {
        hero: "In Caen, Axion-IA designs and augments websites, applications and SaaS platforms with built-in AI: bespoke UX/UI, RAG chatbot grounded in your content, semantic search, agents and automations. Quote from 24-48 h depending on project complexity, EU hosting, code and data yours. On-site Caen kick-off, remote iterations.",
        whyHere: [
          "Caen web & SaaS projects: electronics & automotive (NXP Semiconductors, Bosch, Renault Trucks), AI & cybersecurity research (GREYC, ENSICAEN), equine sector (Hippolia cluster), Caen la Mer SMEs.",
          ...
          "AI & cybersecurity research: data platforms, RAG and agents with reinforced security — echoing the GREYC/ENSICAEN ecosystem. Sovereign EU hosting, strict GDPR.",
        ],
        methodology: [
          {
            step: "Scoping in Caen",
            detail:
        ...
        pricing: [
          ...
          },
          {
            ...
            detail:
              "Design or rebuild of a site or app with UX/UI and built-in AI, for manufacturers, scale-ups and Caen SMEs.",
          },
          {
            sizeLabel: "Mid-cap",
            price: "AI-native SaaS platform",
            detail:
              "Bespoke business, industrial or secure portal platform, AI built in, wired into your IS (PLM, ERP, datalake).",
          },
          {
            sizeLabel: "Large enterprise",
        ...
        faq: [
          {
            ...
            a: "Yes. We design the full experience in Caen — research, wireframes, design system, Figma mockups, prototype — for a website, app or SaaS platform, with or without an AI brick. It's a discipline in its own right for us.",
          },
          {
            q: "Do you handle security and embedded electronics?",
            a: "Yes: data platforms, RAG, agents with reinforced security for electronics, automotive and industry (NXP, Bosch) — echoing the GREYC/ENSICAEN research ecosystem. Sovereign EU hosting, strict GDPR, confidentiality.",
          },
          {
