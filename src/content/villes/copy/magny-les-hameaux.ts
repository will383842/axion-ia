...
export const MAGNY_LES_HAMEAUX_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Magny-les-Hameaux : diagnostic adapté aux consultants, PME tertiaires, professions libérales et TPE artisans de la vallée de Chevreuse. ROI chiffré, Audit Flash 490 € HT.",
      en: "Audit IA à Magny-les-Hameaux : diagnostic adapté aux consultants, PME tertiaires, professions libérales et TPE artisans de la vallée de Chevreuse. ROI chiffré, Audit Flash 490 € HT.",
    },
    interventions: {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "L'Audit Flash IA à Magny-les-Hameaux démarre à 490 € HT pour 4 heures de diagnostic. Il couvre l'analyse de vos processus métier, l'identification des cas d'usage IA prioritaires et un plan d'action chiffré avec ROI estimé.",
    },
    {
