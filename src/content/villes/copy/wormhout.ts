...
// Wormhout (59, Nord) — Flandre intérieure, culture flamande, 5 584 hab.

import type { VilleCopy } from "./types";

export const WORMHOUT_COPY: VilleCopy = {
  pitchFr:
    "Wormhout (59), bourg flamand de Flandre intérieure dans le Nord, est un pôle rural dynamique au patrimoine flamand affirmé (moulin Deschodt, musée Jeanne-Devos). Tissu TPE artisans, PME agricoles et agroalimentaires, commerces, professions libérales. Axion-IA y intervient pour tous types d'activités.",
  pitchEn:
    "Wormhout (59), bourg flamand de Flandre intérieure dans le Nord, est un pôle rural dynamique au patrimoine flamand affirmé (moulin Deschodt, musée Jeanne-Devos). Tissu TPE artisans, PME agricoles et agroalimentaires, commerces, professions libérales. Axion-IA y intervient pour tous types d'activités.",
  directAnswerFr:
  ...
  distancesEn:
    "Dunkerque à 25 min via D916. Cassel à 15 min. Hazebrouck à 20 min. Lille centre à 1h via A25. Aéroport Lille-Lesquin à 1h10.",
  seoHook: "agriculture, artisanat & patrimoine flamand",
  topSectorsNaf: [
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Wormhout : diagnostic adapté aux TPE artisans, PME agricoles et agroalimentaires, commerçants de Flandre intérieure. ROI chiffré, audit Flash 490 € HT.",
      en: "Audit IA à Wormhout : diagnostic adapté aux TPE artisans, PME agricoles et agroalimentaires, commerçants de Flandre intérieure. ROI chiffré, audit Flash 490 € HT.",
    },
    interventions: {
      fr: "Interventions IA sur site à Wormhout : formats adaptés aux exploitations agricoles, ateliers artisans, commerces et cabinets. Vos équipes repartent autonomes sur outils IA configurés métier.",
      en: "Interventions IA sur site à Wormhout : formats adaptés aux exploitations agricoles, ateliers artisans, commerces et cabinets. Vos équipes repartent autonomes sur outils IA configurés métier.",
    },
    implementation: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Wormhout et en Flandre intérieure ?",
    ...
    },
    {
      ...
      a: "Oui, nous accompagnons les exploitations agricoles de Flandre intérieure. Cas typiques IA : prédiction rendements, optimisation assolement, automatisation gestion parcelles, classification images satellites, suivi troupeaux.",
    },
    {
      q: "Comment se passe une mission à Wormhout depuis Dunkerque ou Lille ?",
      a: "Nos consultants rejoignent Wormhout en 25 min depuis Dunkerque ou 1h depuis Lille via A25. Pour les missions multi-jours, hébergement local possible. Frais de déplacement facturés à part, tarifs publics.",
    },
    {
