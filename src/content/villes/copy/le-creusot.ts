...
export const LE_CREUSOT_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Audit Flash livré sous 5 jours ouvrés. Interventions sur site planifiées sous 2 à 3 semaines. Implémentations industrielles (maintenance prédictive, vision) sur 6 à 12 semaines selon complexité et contraintes qualité nucléaire/ferroviaire.",
    },
    {
