...
// Gauchy (02, Aisne) — Agglomération de Saint-Quentin, pôle industriel et logistique.
...
export const GAUCHY_COPY: VilleCopy = {
  ...
  distancesEn:
    "Saint-Quentin centre à 5 min. Laon à 45 min. Cambrai à 35 min. Reims à 1h. Paris à 1h30 via TGV depuis Saint-Quentin. Gare TGV Saint-Quentin à 5 min. Autoroutes A26 et A29 accès direct.",
  seoHook: "Agglo Saint-Quentin & logistique",
  topSectorsNaf: [
  ...
  servicesContext: {
    ...
    interventions: {
      ...
      en: "Interventions IA sur site à Gauchy : formats adaptés à l'atelier industriel, entrepôt logistique, chantier, boutique ou bureau. Vos équipes repartent autonomes.",
    },
    implementation: {
      fr: "Implémentation IA à Gauchy : contrôle qualité production, optimisation tournées logistiques, traçabilité sous-traitance, automatisation devis BTP, agents conversationnels B2B, gestion fournisseurs et donneurs d'ordres.",
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Gauchy ?",
      a: "Oui, Axion-IA intervient à Gauchy et dans toute l'agglomération de Saint-Quentin (Saint-Quentin, Harly, Rouvroy, Fayet, Omissy). Consultants via gare TGV Saint-Quentin ou autoroutes A26 et A29.",
    },
    {
    ...
    },
    {
      ...
      a: "Oui, services aux entreprises et artisans BTP gauchois : automatisation devis et facturation, gestion clientèle B2B, suivi chantiers, conformité administrative, agents conversationnels. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
