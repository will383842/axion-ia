...
export const SAINT_JORY_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Saint-Jory : diagnostic adapté aux TPE artisans, PME de services et logistique du nord Toulouse. Audit Flash 490 € HT.",
  ...
  faqGeolocalisee: [
    ...
    },
    {
      ...
      a: "Oui, sessions 1-to-1 pour dirigeants TPE et PME à Saint-Jory. Format flexible : locaux, visio. À partir de 990 € HT.",
    },
  ],
};
