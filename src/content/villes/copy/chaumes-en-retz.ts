...
// Chaumes-en-Retz (44, Loire-Atlantique) — Commune nouvelle, Côte de Jade.
...
export const CHAUMES_EN_RETZ_COPY: VilleCopy = {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il à Chaumes-en-Retz et Pays de Retz ?",
      a: "Oui, Axion-IA intervient à Chaumes-en-Retz et tout le Pays de Retz (Pornic, Sainte-Pazanne, Machecoul-Saint-Même). Consultants depuis Nantes (40 min). Couverture complète du sud-ouest Loire-Atlantique.",
    },
    {
      q: "Accompagnez-vous les exploitations agricoles de Chaumes-en-Retz ?",
      a: "Oui, nous accompagnons les exploitations agricoles sur des cas IA pratiques : automatisation suivi parcellaire, gestion stocks et commandes, optimisation logistique récoltes, agents IA relation client. Audit sur place {{price:audit-flash|flat}}.",
    },
    {
      q: "Quels services pour les PME tourisme littoral ?",
      a: "Pour les PME tourisme de la Côte de Jade, nous proposons audit IA, interventions sur site, implémentation (chatbot réservation, automatisation billetterie, analyse données visiteurs), coaching 1-to-1 et plateformes web IA sur mesure.",
    },
    {
