...
export const VAISON_LA_ROMAINE_COPY: VilleCopy = {
  ...
  servicesContext: {
    audit: {
      fr: "Audit IA à Vaison-la-Romaine : diagnostic adapté aux TPE artisans, domaines viticoles Cairanne, PME agroalimentaires et hébergements du Haut-Vaucluse. ROI chiffré, Audit Flash 490 € HT.",
    ...
    implementation: {
      ...
      en: "Implémentation IA à Vaison-la-Romaine : traçabilité parcellaire Cairanne, gestion réservations hébergements, agents conversationnels multilingues tourisme, fiches Google Business, automatisation devis artisans. Adapté TPE/PME Haut-Vaucluse.",
    },
    unAUn: {
      fr: "Coaching 1-to-1 à Vaison-la-Romaine : sessions dans vos locaux ou en visio. Dirigeants TPE/PME viticulture, tourisme, hébergement, restauration et commerce du Haut-Vaucluse.",
      en: "Coaching 1-to-1 à Vaison-la-Romaine : sessions dans vos locaux ou en visio. Dirigeants TPE/PME viticulture, tourisme, hébergement, restauration et commerce du Haut-Vaucluse.",
    },
  },
  faqGeolocalisee: [
    {
    ...
    },
    {
      ...
      a: "Audit Flash 490 € HT, interventions sur site, coaching 1-to-1, implémentation IA. Cas viticulture Cairanne : traçabilité parcellaire, gestion vendanges, optimisation cave, relation client B2B export, oenotourisme et fiches Google Business multilingues.",
    },
    {
    ...
    {
      q: "Quel est le tarif d'un audit IA à Vaison-la-Romaine ?",
