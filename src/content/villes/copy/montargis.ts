...
// Montargis (45, Loiret) — sous-prefecture, "Venise du Gatinais", canaux, pralines.
...
export const MONTARGIS_COPY: VilleCopy = {
  ...
  ecosystemEn:
    "Montargis est la sous-prefecture du Loiret, surnommee la Venise du Gatinais grace a ses 131 ponts et passerelles enjambant canaux et rivieres. Pole economique du Gatinais, son tissu repose sur le commerce de centre-ville, l'agroalimentaire (celebres pralines de Montargis), les services aux entreprises, l'artisanat et le tourisme fluvial. Communes voisines : Amilly, Chalette-sur-Loing, Villemandeur, Pannes, Conflans-sur-Loing.",
  distancesFr:
    "Paris a 1 h 15 via A77. Gare de Montargis (TER Centre-Val de Loire, Paris-Gare de Lyon 1 h 20). Orleans a 1 h. Sens a 45 min. Nemours a 30 min. Acces A77 et D2007.",
  distancesEn:
    "Paris a 1 h 15 via A77. Gare de Montargis (TER Centre-Val de Loire, Paris-Gare de Lyon 1 h 20). Orleans a 1 h. Sens a 45 min. Nemours a 30 min. Acces A77 et D2007.",
  seoHook: "commerce, agroalimentaire & canaux",
  topSectorsNaf: [
    "Commerce de detail & distribution",
    "Agroalimentaire & pralines artisanales",
    "Services aux entreprises & conseil",
    "Artisanat & BTP",
    "Tourisme fluvial & hotellerie-restauration",
  ],
  servicesContext: {
    audit: {
  ...
  faqGeolocalisee: [
    {
      q: "Axion-IA intervient-il a Montargis et dans le Gatinais ?",
      a: "Oui, Axion-IA intervient a Montargis et dans tout le bassin montargois (Amilly, Chalette-sur-Loing, Villemandeur, Pannes). Nos consultants rejoignent Montargis via la gare TER ou l'A77 depuis Paris en 1 h 15.",
    },
    {
      q: "Quel est le tarif d'un audit IA a Montargis ?",
      a: "L'Audit sur place IA a Montargis demarre a {{price:audit-flash|flat}} pour 4 heures de diagnostic. Il couvre l'analyse de vos processus metier, l'identification des cas d'usage IA prioritaires et un plan d'action chiffre avec ROI estime.",
    },
    {
    ...
    },
    {
      ...
      a: "Nous accompagnons tous types d'activites a Montargis : commerce, agroalimentaire, artisanat, services aux entreprises, tourisme fluvial, professions liberales et BTP. L'IA s'adapte a chaque metier.",
    },
  ],
};
