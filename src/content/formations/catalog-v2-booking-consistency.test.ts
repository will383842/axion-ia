...
//   1. le catalogue compte 18 entrées (17 formations + 1 séminaire) ;
...
describe("catalog-v2 — offre AXION « Sur devis », découplée du calendrier", () => {
  it("le catalogue compte 18 entrées (17 formations + 1 séminaire)", () => {
    expect(FORMATIONS_V2).toHaveLength(18);
  });
