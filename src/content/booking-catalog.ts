  ...
  // --------------------------------------------------------------------------
  {
    ...
    formats: [
      ...
      // (centrés outil) ont été retirés. Tous « sur devis » (bookable:false).
      {
        ...
        scheduleHintFr: "1 journée · 1-to-1 · sur site",
        scheduleHintEn: "1 day · 1-on-1 · on site",
        previewFr:
      ...
      },
      {
        ...
        iconKey: "compass",
        accent: "mocha",
        priceFr: flat("intervention-dirigeant-vision-2j").fr,
        priceEn: flat("intervention-dirigeant-vision-2j").en,
        scheduleHintFr: "2 jours · 1-to-1 · sur site",
        scheduleHintEn: "2 days · 1-on-1 · on site",
        previewFr:
      ...
      },
      {
        ...
        labelFr: "Collaborateur · Optimisation du poste · 1 jour",
        labelEn: "Team member · Workstation optimization · 1 day",
        bookable: false,
        durationDays: 1,
        iconKey: "user",
        accent: "terracotta",
        priceFr: flat("intervention-membre-equipe").fr,
        priceEn: flat("intervention-membre-equipe").en,
        scheduleHintFr: "1 journée · 1-to-1 · sur votre poste",
        scheduleHintEn: "1 day · 1-on-1 · at your workstation",
        previewFr:
      ...
      },
      {
        ...
        labelFr: "Collaborateur · Optimisation du poste · 2 jours",
        labelEn: "Team member · Workstation optimization · 2 days",
        bookable: false,
        durationDays: 2,
        iconKey: "user",
        accent: "terracotta",
        priceFr: flat("intervention-membre-equipe-2j").fr,
        priceEn: flat("intervention-membre-equipe-2j").en,
        scheduleHintFr: "2 jours · 1-to-1 · sur votre poste",
        scheduleHintEn: "2 days · 1-on-1 · at your workstation",
        previewFr:
