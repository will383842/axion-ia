// Landing de réception de l'annonce leboncoin — servie à la RACINE, de la même forme
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return buildPartenaireMetadata(locale, "leboncoin");
}

export default async function Page({ params }: Props) {
  return PartenaireLandingPage({ params, source: "leboncoin" });
}
