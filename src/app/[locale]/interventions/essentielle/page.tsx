  ...
  return (
    <>
      ...
      <Section
        ...
        description={
          isFr
            ? "Programme identique pour les 2 tranches. Le prix dépend uniquement du nombre de participants présents à la journée."
            : "Same programme for both tiers. Price depends only on the number of participants on the day."
        }
      >
