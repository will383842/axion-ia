    ...
    <>
      ...
      <Section>
        <Container className="text-fg-soft max-w-2xl space-y-6 text-base leading-relaxed">
          ...
          <p>
            {isFr
              ? "Trois outils sont soumis à votre consentement. Microsoft Clarity (heatmaps et session replay anonymisé, transfert UE → US encadré par des clauses contractuelles types) dépose les cookies _clck et _clsk et n'est chargé qu'après votre accord explicite via le bandeau ; votre choix est conservé 13 mois et révocable ci-dessous. Le pixel Meta (Facebook / Instagram), limité aux pages /apporteur-affaires et /apporteur-affaires/merci, dépose les cookies _fbp et _fbc après ce même accord, que le bandeau nomme sur ces pages. Le calendrier de réservation Calendly, sur la page /appel, n'est chargé qu'après un clic sur « Afficher le calendrier » ; ce choix n'est volontairement PAS conservé — il vous est redemandé à chaque visite, et ne pas cliquer suffit à le retirer."
              : "Three tools are subject to your consent. Microsoft Clarity (anonymised heatmaps and session replay, EU → US transfer under standard contractual clauses) sets the _clck and _clsk cookies and only loads after your explicit agreement via the banner; your choice is kept for 13 months and can be withdrawn below. The Meta pixel (Facebook / Instagram), limited to the /apporteur-affaires and /apporteur-affaires/merci pages, sets the _fbp and _fbc cookies after that same agreement, which the banner names on those pages. The Calendly booking calendar, on the /appel page, only loads after you click “Show the calendar”; that choice is deliberately NOT stored — it is asked again on every visit, and simply not clicking is enough to withdraw it."}
          </p>
