...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const base = buildProductMetadata({
    ...
    description: isFr
      ? "Votre demande de devis a bien été reçue. Williams vous recontactera sous 48 h ouvrées."
      : "Your quote request has been received. Williams will get back to you within 48 business hours.",
    alternates: {
        ...
        <Container className="relative">
          <div className="bg-paper shadow-card border-sage/40 mx-auto max-w-2xl rounded-3xl border-2 p-8 text-center sm:p-10 lg:p-12">
            ...
            <p className="text-fg-soft mt-5 text-lg leading-relaxed">
              {isFr
                ? "Merci, votre demande de devis qualifiée est entre nos mains. Williams vous recontactera sous 48 heures ouvrées pour un appel de cadrage personnalisé."
                : "Thank you, your qualified quote request is in our hands. Williams will get back to you within 48 business hours for a personalized scoping call."}
            </p>
