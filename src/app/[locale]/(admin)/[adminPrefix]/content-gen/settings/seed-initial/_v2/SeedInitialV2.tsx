    ...
    <AdminPageShell>
      ...
      <AdminCard>
        <p className="admin-meta-block">
          Ce bouton exécute deux seeds en base de données :
        </p>
        <ul className="admin-meta-block" style={{ paddingLeft: "1.25rem", listStyle: "disc" }}>
          <li>
            <strong>KB sectorielle</strong> — 130 facts vérifiés sur tes 5 services
            (Audits, Interventions/Formations, Un-à-un, Implémentations, Web IA).
            Le robot s'en sert pour écrire des articles précis sur ton offre.
          </li>
          <li>
            <strong>6 presets de campagne</strong> — PME audits, Interventions weekly,
            TPE burst, ETI pilier, Cities Paris, RSS daily. Disponibles dans le wizard
            de nouvelle campagne.
          </li>
        </ul>
        <p className="admin-meta-block">
          <strong>Idempotent</strong> : tu peux cliquer plusieurs fois sans risque —
          les entrées existantes sont mises à jour, rien n'est dupliqué.
        </p>
