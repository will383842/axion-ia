    ...
    <AdminPageShell>
            ...
            return (
              <div key={v}>
                ...
                <div className="h-2 w-full rounded bg-gray-100">
                  <div
                    className={`h-2 rounded ${count >= 250 ? "bg-green-500" : count >= 150 ? "bg-yellow-400" : "bg-red-400"}`}
                    style={{
      ...
      <form method="GET" action={basePath} className="flex flex-wrap gap-3">
        ...
        <input
          ...
          className="flex-1 rounded-md border border-gray-300 bg-white px-3 py-1.5 text-sm shadow-sm"
        />
