...
//
// Table de 7 colonnes. La sonde volumetrique `sessions_liste` mesure exactement
// cette lecture : 10 ms a 1 200 sessions. Le temps perdu n'est donc PAS dans la
// requete — il est dans l'attente sans forme, et c'est ce que ce fichier soigne.
//
  ...
  return (
    <div className="mx-auto w-full max-w-[1280px] px-[var(--space-admin-6)] py-[var(--space-admin-7)]">
      <AdminLoadingState
        ...
        count={8}
        cols={7}
        ariaLabel="Chargement de la liste des sessions"
      />
    </div>
  );
}
