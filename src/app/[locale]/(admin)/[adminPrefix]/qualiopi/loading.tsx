...
//
// Le hub ouvre sur une grille d'indicateurs, pas sur une liste : un squelette de
// cartes y ferait sauter la mise en page a l'arrivee des vraies tuiles.
//
  ...
  return (
    <div className="mx-auto w-full max-w-[1280px] px-[var(--space-admin-6)] py-[var(--space-admin-7)]">
      <AdminLoadingState
        variant="stat-grid"
        count={4}
        ariaLabel="Chargement du tableau de bord Qualiopi"
      />
    </div>
  );
}
