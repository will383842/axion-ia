...
export default async function About({ params }: Props) {
  ...
  const localBusinessRootJsonLd = buildLocalBusinessJsonLd({
    ...
    description: isFr
      ? "Axion-IA est un cabinet IA opérationnel dont le siège est à Grenoble (Auvergne-Rhône-Alpes) et qui intervient sur toute la France — notamment à Paris et en Île-de-France — auprès de PME, ETI et grands groupes : interventions IA, audits, implémentations, coaching 1-to-1 et sites web augmentés."
    ...
    ? [
        {
          ...
          answer:
            "Axion-IA est un cabinet de conseil en intelligence artificielle opérationnelle, basé en France (siège à Grenoble). Il accompagne les PME, ETI et grands groupes sur l'audit IA, la formation, l'implémentation de solutions IA en production, le coaching 1-à-1 et les sites web augmentés, avec une approche centrée sur des résultats concrets et mesurables.",
        },
        {
          id: "siege",
          question: "Où est le siège d'Axion-IA ?",
          answer:
            "Le siège d'Axion-IA est à Grenoble (Auvergne-Rhône-Alpes), en France. C'est un cabinet IA opérationnel français qui intervient sur toute la France — notamment à Paris et en Île-de-France — auprès des PME, ETI et grands groupes.",
        },
        {
          id: "couverture-paris",
