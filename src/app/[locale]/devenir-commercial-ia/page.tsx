...
export default async function DevenirCommercialHub({ params }: Props) {
  ...
  const jobJsonLd = {
    ...
    description: isFr
      ? `Axion-IA recrute des commerciaux indépendants partout en France pour vendre ses formations, audits, accompagnements 1-to-1 et intégrations IA aux PME, ETI et grands groupes, artisans, commerçants et grands groupes. L'AI Act impose à toute entreprise qui utilise l'IA de former ses équipes (article 4, en vigueur) et les formations sont finançables OPCO : la demande est déjà là. ${formatAmount(COMMISSION_FORMATION_PAR_JOURNEE_EUR, "fr", { compact: true })} par journée de formation vendue, quel que soit le format. Statut indépendant, revenus non plafonnés, emploi du temps libre.`
