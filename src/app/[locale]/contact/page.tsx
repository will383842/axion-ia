...
export default async function Contact({ params }: Props) {
  ...
  // Trust pills hero — réassurance dimension-1 (cf. audit V14, D3 pills 0→3).
  const pills = isFr
    ? [
  ...
  const faqItems = isFr
    ? [
        ...
        },
        {
          ...
          answer:
            "Non. L'échange initial — message, appel découverte, envoi d'informations — est sans engagement. L'engagement contractuel commence uniquement à la réservation d'une intervention payante (Essentielle 490 € ou plus) ou d'un audit cadré, et fait l'objet d'un devis explicite.",
        },
        {
          id: "rgpd",
