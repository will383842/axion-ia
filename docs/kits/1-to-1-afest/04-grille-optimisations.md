# Grille d'identification des optimisations (gains temps & argent)
...
## Fiches d'optimisation

> Une fiche par candidat (3 à 5 au total).
...
| Optimisation | Gain temps (h/sem) | Gain € | Facilité (1-5) | Priorité |
| ------------ | ------------------ | ------ | -------------- | -------- |
|              |                    |        |                |          |
|              |                    |        |                |          |
|              |                    |        |                |          |
...
**Gain de temps total estimé :** \_**\_ h/semaine → \*\*\_\_** jours/an\*\*
**Estimation gain annuel (temps × coût horaire) :** \_\_\_\_ €/an

> Règle de priorisation : **impact (temps/€) × facilité**. Commencer par les quick wins
> (fort impact, faible effort) pour créer la dynamique.

→ Reporter les optimisations retenues dans **`05-plan-optimisation-personnalise.md`**.
